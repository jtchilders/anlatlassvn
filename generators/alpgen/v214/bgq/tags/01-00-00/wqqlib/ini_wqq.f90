...
!
     if(npr.eq.9) then
      dim(d_offshcol)=450; dim(d_offsh)=570; dim(d_ampcol)=140; dim(d_ampfld)=  270
     elseif(npr.eq.8) then
      dim(d_offshcol)=240; dim(d_offsh)=310; dim(d_ampcol)=70; dim(d_ampfld)=  140
     elseif(npr.eq.7) then
      dim(d_offshcol)=130; dim(d_offsh)=160; dim(d_ampcol)=40; dim(d_ampfld)=  80
     elseif(npr.eq.6) then
      dim(d_offshcol)=70; dim(d_offsh)=90; dim(d_ampcol)=20; dim(d_ampfld)=  40
     elseif(npr.eq.5) then
      dim(d_offshcol)=40; dim(d_offsh)=40; dim(d_ampcol)=10; dim(d_ampfld)=  20
     else
