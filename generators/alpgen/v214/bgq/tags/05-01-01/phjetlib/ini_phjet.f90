...
!!$                      xpp,wm,wm,ypp,wp,wp,gluon,gluon,gluon,higgs,higgs,higgs /) 
  tabint(1:52,1)=(/17,qupl,qupbrl,gluon, qupr,qupbrr,gluon, qdr,qdbrr,gluon, qdl,qdbrl,gluon,  &
                      qcr,qcbrr,gluon, qcl,qcbrl,gluon, qsr,qsbrr,gluon, qsl,qsbrl,gluon,      & 
...
!
  chdim : select case (npr)
    ...
    case (8)
      dim(d_offsh)=3060; dim(d_offshcol)=3000; dim(d_ampfld)=2400; dim(d_ampcol)=2200
    case (7)
      dim(d_offsh)=1500; dim(d_offshcol)=1430; dim(d_ampfld)=1210; dim(d_ampcol)=1110
    case (6)
      dim(d_offsh)=800; dim(d_offshcol)=730; dim(d_ampfld)=610; dim(d_ampcol)=610
    case (5)
      dim(d_offsh)=410; dim(d_offshcol)=390; dim(d_ampfld)=350; dim(d_ampcol)=330
    case (4)
      dim(d_offsh)=150; dim(d_offshcol)=140; dim(d_ampfld)=120; dim(d_ampcol)=110
    case (3)
