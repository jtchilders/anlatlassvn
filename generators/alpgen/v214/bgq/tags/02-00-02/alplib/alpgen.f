...
c   work in unique directory work/rankstring
      retval = chdir('work/'//rankstring//CHAR(0))
      if(retval.ne.0) then
         write(6,*) 'Error changing directory to "work/',rankstring,'"'
      endif
      call cpu_time(timestamp)
      write(6,*) ' INITIALIZE RANK ',rankstring,' AT ',timestamp
c end of MPI block
...
c     assuming 32-bit signed integer (2147483647 = 2**31 - 1)
      iseed(2)=mod(iseed(2)+mpirank,2147483647)
