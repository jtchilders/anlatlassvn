...
!
   tabint(1:94,1)=(/31,qupl,qupbrl,gluon, qdl,qdbrl,gluon, qcbrr,gluon,qcr,     &
                       qcbrl,gluon,qcl, qupbrr,gluon,qupr, qdbrr,gluon,qdr,     &
                       qsbrl,gluon,qsl, qsbrr,gluon,qsr, qtop,qtopbr,gluon,     &
                       gluon,gluon,gluon, qtop,qtopbr,photon,                   &
                       ...
                       ebrl,photon,el,photon,wp,wm,photon,photon,zzww,          &
!                       zzww,wp,wm,qbt,qbtbr,glu    /)
                       zzww,wp,wm,qbt,qbtbr,glu,qbt,qbtbr,photon    /)
!!$  tabint(1:130,1)=(/43, qupbrl,qdl,wp,qupl,qdbrl,wm,qcbrl,qsl,wp,qcl,qsbrl,wm, & 
...
!!$                      qbt,qbtbr,glu,qbt,qbtbr,photon ,el,wp,nuebr,ebrl,wm,nue,ebrl,photon,el,ebrl,z,el   /)
