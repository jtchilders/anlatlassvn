...
!!$    case (8)
!!$      dim(d_offsh)=540; dim(d_offshcol)=370; dim(d_ampfld)=220; dim(d_ampcol)=110
!!$    case (7)
!!$      dim(d_offsh)=210; dim(d_offshcol)=140; dim(d_ampfld)=70; dim(d_ampcol)=40
!!$    case (6)
!!$      dim(d_offsh)=100; dim(d_offshcol)=70; dim(d_ampfld)=30; dim(d_ampcol)=20
!!$    case (10)
!!$      dim(d_offsh)=2070; dim(d_offshcol)=1400; dim(d_ampfld)=820; dim(d_ampcol)=410
!!$    case (9)
!!$      dim(d_offsh)=1070; dim(d_offshcol)=720; dim(d_ampfld)=430; dim(d_ampcol)=220
    case (6,7,8,9,10)
      dim(d_offsh)=3070; dim(d_offshcol)=3400; dim(d_ampfld)=3820; dim(d_ampcol)=3410
    case default
