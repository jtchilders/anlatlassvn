...
! initializing on/off interactions
 tabint(1:40,1)=(/13,gluon,gluon,higgs,gluon,gluon,gluon,gluon,xglu,higgs,   &
                    gluon,gluon,yglu,xglu,xglu,higgs,qupl,qupbrl,gluon,      &
                    qupr,qupbrr,gluon, qdr,qdbrr,gluon,qdl,qdbrl,gluon,      &
                    qcr,qcbrr,gluon,qcl,qcbrl,gluon,qsr,qsbrr,gluon,         &
                    qsl,qsbrl,gluon/)
...
!
  ...
  masses(qtopbr)=masses(qtop); ggh=apar(61)
!
