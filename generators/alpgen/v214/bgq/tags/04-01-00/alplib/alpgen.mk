...
# fortran 90 version with ramdisk
gen90_mpi_ramdisk: $(usrfile).o $(prcfile).o $(prclib)/$(prc).inc\
	$(alp)/alputi.o \
	$(alp)/Aint90.o $(prclib)/XXX.o90 $(alp)/alpgen.inc 
	$(FFF) -c $(BGQ_SUFFIX) $(BGQ_CPP_DEFINE)-DUSE_MPI=1 -o $(alp)/alppdf.o $(alp)/alppdf.f
	$(FFF) -c $(BGQ_SUFFIX) $(BGQ_CPP_DEFINE)-DUSE_MPI=1 $(BGQ_CPP_DEFINE)-DUSE_BGQ_RAMDISK -o $(alp)/alpgen.o $(alp)/alpgen.f
	$(FFL90) -o $(execfile)90_mpi_ramdisk $(usrfile).o $(prcfile).o \
	$(alp)/alpgen.o $(alp)/alputi.o $(alp)/alppdf.o \
	$(alp)/Aint90.o $(prclib)/XXX.o

gen90_mpi_ramdisk_nomrstpdfs: $(usrfile).o $(prcfile).o $(prclib)/$(prc).inc\
	$(alp)/alputi.o \
	$(alp)/Aint90.o $(prclib)/XXX.o90 $(alp)/alpgen.inc 
	$(FFF) -c $(BGQ_SUFFIX) $(BGQ_CPP_DEFINE)-DUSE_MPI=1 $(BGQ_CPP_DEFINE)-DDISABLE_MRST_PDFS -o $(alp)/alppdf.o $(alp)/alppdf.f
	$(FFF) -c $(BGQ_SUFFIX) $(BGQ_CPP_DEFINE)-DUSE_MPI=1 $(BGQ_CPP_DEFINE)-DUSE_BGQ_RAMDISK -o $(alp)/alpgen.o $(alp)/alpgen.f
	$(FFL90) -o $(execfile)90_mpi_ramdisk_nomrstpdfs $(usrfile).o $(prcfile).o \
	$(alp)/alpgen.o $(alp)/alputi.o $(alp)/alppdf.o \
	$(alp)/Aint90.o $(prclib)/XXX.o

# these are for profiling only
gen90_mpi_ramdisk_hpm: $(usrfile).o $(prcfile).o $(prclib)/$(prc).inc\
	$(alp)/alputi.o \
	$(alp)/Aint90.o $(prclib)/XXX.o90 $(alp)/alpgen.inc 
	$(FFF) -c $(BGQ_SUFFIX) $(BGQ_CPP_DEFINE)-DUSE_MPI=1 -o $(alp)/alppdf.o $(alp)/alppdf.f
	$(FFF) -c $(BGQ_SUFFIX) $(BGQ_CPP_DEFINE)-DUSE_MPI=1 $(BGQ_CPP_DEFINE)-DUSE_BGQ_RAMDISK -o $(alp)/alpgen.o $(alp)/alpgen.f
	$(FFL90) -o $(execfile)90_mpi_ramdisk_hpm $(usrfile).o $(prcfile).o \
	$(alp)/alpgen.o $(alp)/alputi.o $(alp)/alppdf.o \
	$(alp)/Aint90.o $(prclib)/XXX.o -L/home/morozov/HPM/lib -lmpihpm -L/bgsys/drivers/ppcfloor/bgpm/lib -lbgpm

gen90_mpi_ramdisk_hpm_nomrstpdfs: $(usrfile).o $(prcfile).o $(prclib)/$(prc).inc\
	$(alp)/alputi.o \
	$(alp)/Aint90.o $(prclib)/XXX.o90 $(alp)/alpgen.inc 
	$(FFF) -c $(BGQ_SUFFIX) $(BGQ_CPP_DEFINE)-DUSE_MPI=1 $(BGQ_CPP_DEFINE)-DDISABLE_MRST_PDFS -o $(alp)/alppdf.o $(alp)/alppdf.f
	$(FFF) -c $(BGQ_SUFFIX) $(BGQ_CPP_DEFINE)-DUSE_MPI=1 $(BGQ_CPP_DEFINE)-DUSE_BGQ_RAMDISK -o $(alp)/alpgen.o $(alp)/alpgen.f
	$(FFL90) -o $(execfile)90_mpi_ramdisk_hpm_nomrstpdfs $(usrfile).o $(prcfile).o \
	$(alp)/alpgen.o $(alp)/alputi.o $(alp)/alppdf.o \
	$(alp)/Aint90.o $(prclib)/XXX.o -L/home/morozov/HPM/lib -lmpihpm -L/bgsys/drivers/ppcfloor/bgpm/lib -lbgpm
