...
C ----------
     ...
     &     11  ))                                                          
      ...
      CALL FVIXXX(W(1,10  ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,12  ))     
     ...
     &     13  ))                                                          
      ...
      CALL IOVXXX(W(1,10  ),W(1,6   ),W(1,14  ),GG ,AMP(3   ))             
      CALL FSIXXX(W(1,1   ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     15  ))                                                          
      CALL JIOXXX(W(1,15  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,10  ),W(1,6   ),W(1,16  ),GG ,AMP(4   ))             
      CALL FVIXXX(W(1,2   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL IOVXXX(W(1,17  ),W(1,6   ),W(1,8   ),GWFUB ,AMP(5   ))          
      CALL FVIXXX(W(1,2   ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,18  ),W(1,6   ),W(1,8   ),GWFUB ,AMP(6   ))          
      CALL JVSXXX(W(1,8   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     19  ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,19  ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     20  ))                                                          
      CALL IOVXXX(W(1,20  ),W(1,6   ),W(1,9   ),GG ,AMP(7   ))             
      CALL FVIXXX(W(1,2   ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL FVIXXX(W(1,21  ),W(1,8   ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     22  ))                                                          
      CALL IOSXXX(W(1,22  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(8   ))          
      CALL IOVXXX(W(1,21  ),W(1,6   ),W(1,19  ),GWFUB ,AMP(9   ))          
      CALL JIOXXX(W(1,10  ),W(1,13  ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,23  ),GG ,AMP(10  ))             
      CALL JIOXXX(W(1,11  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,24  ),GG ,AMP(11  ))             
      CALL JIOXXX(W(1,10  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL FVIXXX(W(1,1   ),W(1,25  ),GG ,BMASS   ,ZERO    ,W(1,26  ))     
     ...
     &     27  ))                                                          
      ...
      CALL FVIXXX(W(1,1   ),W(1,28  ),GG ,BMASS   ,ZERO    ,W(1,29  ))     
      CALL IOSXXX(W(1,29  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(13  ))          
      CALL IOVXXX(W(1,15  ),W(1,6   ),W(1,28  ),GG ,AMP(14  ))             
      CALL IOVXXX(W(1,15  ),W(1,6   ),W(1,25  ),GG ,AMP(15  ))             
      CALL FVOXXX(W(1,13  ),W(1,8   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     30  ))                                                          
      CALL JIOXXX(W(1,2   ),W(1,30  ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,31  ),GG ,AMP(16  ))             
      CALL FVOXXX(W(1,7   ),W(1,19  ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     32  ))                                                          
      CALL JIOXXX(W(1,2   ),W(1,32  ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,33  ),GG ,AMP(17  ))             
      CALL JIOXXX(W(1,20  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,34  ),GG ,AMP(18  ))             
