...
C ----------
     ...
     &     26  ))                                                          
      ...
      CALL FVOXXX(W(1,7   ),W(1,24  ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     28  ))                                                          
      CALL FVOXXX(W(1,28  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL IOVXXX(W(1,6   ),W(1,29  ),W(1,1   ),GG ,AMP(11  ))             
      CALL FVOXXX(W(1,17  ),W(1,24  ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     30  ))                                                          
      ...
      CALL IOVXXX(W(1,6   ),W(1,33  ),W(1,24  ),GWFUB ,AMP(15  ))          
      CALL FVOXXX(W(1,9   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,6   ),W(1,34  ),W(1,24  ),GWFUB ,AMP(16  ))          
