...
C ----------
     ...
     &     12  ))                                                          
      ...
      CALL IOVXXX(W(1,6   ),W(1,11  ),W(1,13  ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,1   ),W(1,10  ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,6   ),W(1,14  ),W(1,8   ),GWFUB ,AMP(3   ))          
      CALL FVOXXX(W(1,1   ),W(1,13  ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,8   ),GWFUB ,AMP(4   ))          
      CALL FSOXXX(W(1,1   ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     16  ))                                                          
      CALL JIOXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL FVOXXX(W(1,16  ),W(1,8   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     18  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,18  ),W(1,17  ),GG ,AMP(5   ))             
      CALL FVOXXX(W(1,16  ),W(1,17  ),GG ,BMASS   ,ZERO    ,W(1,19  ))     
      CALL IOVXXX(W(1,6   ),W(1,19  ),W(1,8   ),GWFUB ,AMP(6   ))          
      CALL JVSXXX(W(1,8   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     20  ))                                                          
      CALL FVOXXX(W(1,1   ),W(1,20  ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     21  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,21  ),W(1,17  ),GG ,AMP(7   ))             
      CALL FVOXXX(W(1,1   ),W(1,17  ),GG ,BMASS   ,ZERO    ,W(1,22  ))     
      CALL IOVXXX(W(1,6   ),W(1,22  ),W(1,20  ),GWFUB ,AMP(8   ))          
      CALL FSOXXX(W(1,22  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     23  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,23  ),W(1,8   ),GWFUB ,AMP(9   ))          
      CALL JIOXXX(W(1,12  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL FVOXXX(W(1,7   ),W(1,24  ),GG ,BMASS   ,ZERO    ,W(1,25  ))     
      CALL IOVXXX(W(1,6   ),W(1,25  ),W(1,8   ),GWFUB ,AMP(10  ))          
      CALL FVOXXX(W(1,7   ),W(1,8   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     26  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,26  ),W(1,24  ),GG ,AMP(11  ))             
      CALL JIOXXX(W(1,2   ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL FVOXXX(W(1,7   ),W(1,27  ),GG ,BMASS   ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,6   ),W(1,28  ),W(1,8   ),GWFUB ,AMP(12  ))          
      CALL IOVXXX(W(1,6   ),W(1,26  ),W(1,27  ),GG ,AMP(13  ))             
      CALL JIOXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL FVOXXX(W(1,9   ),W(1,8   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     30  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,30  ),W(1,29  ),GG ,AMP(14  ))             
      CALL FVOXXX(W(1,7   ),W(1,29  ),GG ,BMASS   ,ZERO    ,W(1,31  ))     
      CALL IOVXXX(W(1,6   ),W(1,31  ),W(1,20  ),GWFUB ,AMP(15  ))          
      CALL FVOXXX(W(1,7   ),W(1,20  ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     32  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,32  ),W(1,29  ),GG ,AMP(16  ))             
      CALL FVOXXX(W(1,9   ),W(1,29  ),GG ,BMASS   ,ZERO    ,W(1,33  ))     
      CALL IOVXXX(W(1,6   ),W(1,33  ),W(1,8   ),GWFUB ,AMP(17  ))          
      CALL FSOXXX(W(1,31  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     34  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,34  ),W(1,8   ),GWFUB ,AMP(18  ))          
      JAMP(   1) = +AMP(   1)+AMP(   2)+AMP(   3)+AMP(   4)+AMP(   5)
     &             +AMP(   6)+AMP(   7)+AMP(   8)+AMP(   9)
      JAMP(   2) = -AMP(  10)-AMP(  11)-AMP(  12)-AMP(  13)-AMP(  14)
