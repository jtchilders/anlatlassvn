...
C ----------
      ...
      CALL FVIXXX(W(1,9   ),W(1,8   ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     10  ))                                                          
     ...
     &     14  ))                                                          
      CALL IOVXXX(W(1,14  ),W(1,6   ),W(1,12  ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,14  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,15  ),W(1,6   ),W(1,7   ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,13  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL FSIXXX(W(1,16  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     17  ))                                                          
      CALL IOVXXX(W(1,17  ),W(1,6   ),W(1,2   ),GG ,AMP(4   ))             
      CALL FVIXXX(W(1,14  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,18  ),W(1,6   ),W(1,2   ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,10  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,19  ))     
      CALL IOSXXX(W(1,19  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(6   ))          
      CALL FVIXXX(W(1,13  ),W(1,12  ),GG ,BMASS   ,ZERO    ,W(1,20  ))     
      CALL IOSXXX(W(1,20  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(7   ))          
      CALL FVIXXX(W(1,13  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,21  ))     
      CALL FSIXXX(W(1,21  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     22  ))                                                          
      CALL IOVXXX(W(1,22  ),W(1,6   ),W(1,7   ),GG ,AMP(8   ))             
      CALL FVIXXX(W(1,16  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,23  ))     
     ...
     &     25  ))                                                          
      CALL FVIXXX(W(1,9   ),W(1,25  ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     26  ))                                                          
      CALL IOVXXX(W(1,26  ),W(1,6   ),W(1,2   ),GG ,AMP(11  ))             
      CALL FVIXXX(W(1,1   ),W(1,25  ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     27  ))                                                          
      CALL IOVXXX(W(1,27  ),W(1,6   ),W(1,12  ),GG ,AMP(12  ))             
      CALL FVIXXX(W(1,27  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,28  ),W(1,6   ),W(1,7   ),GG ,AMP(13  ))             
      CALL FVIXXX(W(1,27  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,29  ))     
      CALL IOVXXX(W(1,29  ),W(1,6   ),W(1,2   ),GG ,AMP(14  ))             
      CALL FVIXXX(W(1,9   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL FVIXXX(W(1,30  ),W(1,8   ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     31  ))                                                          
      CALL IOSXXX(W(1,31  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(15  ))          
      CALL FVIXXX(W(1,1   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,32  ))     
