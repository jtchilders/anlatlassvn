      SUBROUTINE SREALMTRX_338(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_338/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_338(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_338(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     10  ))                                                          
      CALL FVIXXX(W(1,9   ),W(1,10  ),GWFCD ,ZERO    ,ZERO    ,W(1,        
     &     11  ))                                                          
      CALL IOVXXX(W(1,11  ),W(1,6   ),W(1,1   ),GG ,AMP(1   ))             
      CALL FVIXXX(W(1,7   ),W(1,10  ),GWFCD ,ZERO    ,ZERO    ,W(1,        
     &     12  ))                                                          
      ...
      CALL FVIXXX(W(1,14  ),W(1,10  ),GWFCD ,ZERO    ,ZERO    ,W(1,        
     &     15  ))                                                          
      CALL IOVXXX(W(1,15  ),W(1,6   ),W(1,2   ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,12  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,16  ),W(1,6   ),W(1,2   ),GG ,AMP(4   ))             
      CALL FVIXXX(W(1,14  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL IOVXXX(W(1,17  ),W(1,6   ),W(1,10  ),GWFCD ,AMP(5   ))          
      CALL FVIXXX(W(1,9   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,18  ),W(1,6   ),W(1,10  ),GWFCD ,AMP(6   ))          
      CALL JVVXXX(W(1,1   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,19  ))      
      CALL FVIXXX(W(1,7   ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL IOVXXX(W(1,20  ),W(1,6   ),W(1,10  ),GWFCD ,AMP(7   ))          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_338 =REALMTRX_338+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
