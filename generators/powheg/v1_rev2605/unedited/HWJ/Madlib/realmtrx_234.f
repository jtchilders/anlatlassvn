      SUBROUTINE SREALMTRX_234(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_234/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_234(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_234(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     14  ))                                                          
      ...
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,10  ),GWFCS ,AMP(4   ))          
      JAMP(   1) = +AMP(   1)+AMP(   2)
      JAMP(   2) = -AMP(   3)-AMP(   4)
      REALMTRX_234 = 0.D0 
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_234 =REALMTRX_234+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
