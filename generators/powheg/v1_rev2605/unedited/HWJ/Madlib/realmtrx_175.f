...
C ----------
     ...
     &     11  ))                                                          
      ...
      CALL JIOXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL FVIXXX(W(1,1   ),W(1,10  ),GWFCD ,ZERO    ,ZERO    ,W(1,        
     &     14  ))                                                          
      CALL IOVXXX(W(1,14  ),W(1,6   ),W(1,13  ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,1   ),W(1,13  ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,15  ),W(1,6   ),W(1,10  ),GWFCD ,AMP(4   ))          
      JAMP(   1) = +AMP(   1)+AMP(   2)
      JAMP(   2) = -AMP(   3)-AMP(   4)
      REALMTRX_175 = 0.D0 
      DO I = 1, NCOLOR
