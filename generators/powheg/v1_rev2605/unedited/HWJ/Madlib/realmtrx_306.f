...
C ----------
     ...
     &     12  ))                                                          
      ...
      CALL IOVXXX(W(1,6   ),W(1,14  ),W(1,8   ),GWFCB ,AMP(3   ))          
      CALL FVOXXX(W(1,1   ),W(1,13  ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,8   ),GWFCB ,AMP(4   ))          
     ...
     &     20  ))                                                          
      CALL FVOXXX(W(1,1   ),W(1,20  ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     21  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,21  ),W(1,17  ),GG ,AMP(7   ))             
      CALL FVOXXX(W(1,1   ),W(1,17  ),GG ,BMASS   ,ZERO    ,W(1,22  ))     
      CALL IOVXXX(W(1,6   ),W(1,22  ),W(1,20  ),GWFCB ,AMP(8   ))          
     ...
     &     23  ))                                                          
      ...
      CALL IOVXXX(W(1,6   ),W(1,25  ),W(1,8   ),GWFCB ,AMP(10  ))          
      CALL FVOXXX(W(1,7   ),W(1,8   ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     26  ))                                                          
