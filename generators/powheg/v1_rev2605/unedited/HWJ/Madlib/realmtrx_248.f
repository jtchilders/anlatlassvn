      SUBROUTINE SREALMTRX_248(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_248/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_248(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_248(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     10  ))                                                          
      CALL FVOXXX(W(1,9   ),W(1,10  ),GWFCS ,ZERO    ,ZERO    ,W(1,        
     &     11  ))                                                          
     ...
     &     13  ))                                                          
      ...
      CALL IOVXXX(W(1,6   ),W(1,16  ),W(1,10  ),GWFCS ,AMP(5   ))          
      CALL FVOXXX(W(1,1   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL IOVXXX(W(1,6   ),W(1,17  ),W(1,10  ),GWFCS ,AMP(6   ))          
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL FVOXXX(W(1,18  ),W(1,10  ),GWFCS ,ZERO    ,ZERO    ,W(1,        
     &     19  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,19  ),W(1,7   ),GG ,AMP(7   ))             
      CALL FVOXXX(W(1,18  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL IOVXXX(W(1,6   ),W(1,20  ),W(1,10  ),GWFCS ,AMP(8   ))          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_248 =REALMTRX_248+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
