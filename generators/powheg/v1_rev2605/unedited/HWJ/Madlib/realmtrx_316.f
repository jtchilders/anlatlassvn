...
C ----------
     ...
     &     15  ))                                                          
      ...
      CALL IOVXXX(W(1,17  ),W(1,6   ),W(1,8   ),GWFCB ,AMP(5   ))          
      CALL FVIXXX(W(1,2   ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,18  ),W(1,6   ),W(1,8   ),GWFCB ,AMP(6   ))          
      CALL JVSXXX(W(1,8   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     19  ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,19  ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     20  ))                                                          
      CALL IOVXXX(W(1,20  ),W(1,6   ),W(1,9   ),GG ,AMP(7   ))             
      CALL FVIXXX(W(1,2   ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL FVIXXX(W(1,21  ),W(1,8   ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     22  ))                                                          
      CALL IOSXXX(W(1,22  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(8   ))          
      CALL IOVXXX(W(1,21  ),W(1,6   ),W(1,19  ),GWFCB ,AMP(9   ))          
     ...
     &     30  ))                                                          
      ...
      CALL FVOXXX(W(1,7   ),W(1,19  ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     32  ))                                                          
