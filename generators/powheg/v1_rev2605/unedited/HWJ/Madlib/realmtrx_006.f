...
C ----------
     ...
     &     10  ))                                                          
      CALL FVOXXX(W(1,10  ),W(1,9   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     11  ))                                                          
     ...
     &     13  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,12  ),W(1,13  ),GWFUB ,AMP(2   ))          
      CALL FVOXXX(W(1,7   ),W(1,13  ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     14  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,14  ),W(1,8   ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,10  ),W(1,8   ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,9   ),GWFUB ,AMP(4   ))          
