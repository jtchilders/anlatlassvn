...
C ----------
     ...
     &     9   ))                                                          
      ...
      CALL FVOXXX(W(1,7   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,10  ))     
      CALL IOVXXX(W(1,6   ),W(1,10  ),W(1,8   ),GWFUB ,AMP(2   ))          
      CALL JVSXXX(W(1,8   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     11  ))                                                          
      CALL FVOXXX(W(1,1   ),W(1,11  ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     12  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,12  ),W(1,2   ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,6   ),W(1,13  ),W(1,11  ),GWFUB ,AMP(4   ))          
      CALL FSOXXX(W(1,13  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     14  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,14  ),W(1,8   ),GWFUB ,AMP(5   ))          
      do i=1,ngraphs
