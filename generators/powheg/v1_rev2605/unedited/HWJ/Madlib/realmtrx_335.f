...
C ----------
     ...
     &     8   ))                                                          
      ...
      CALL FVOXXX(W(1,8   ),W(1,9   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     11  ))                                                          
     ...
     &     13  ))                                                          
      CALL FVOXXX(W(1,13  ),W(1,9   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     14  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,14  ),W(1,1   ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,11  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,7   ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,8   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL FVOXXX(W(1,16  ),W(1,9   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     17  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,17  ),W(1,1   ),GG ,AMP(4   ))             
      CALL FVOXXX(W(1,11  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,6   ),W(1,18  ),W(1,1   ),GG ,AMP(5   ))             
      CALL FVOXXX(W(1,8   ),W(1,10  ),GG ,BMASS   ,ZERO    ,W(1,19  ))     
      CALL IOVXXX(W(1,6   ),W(1,19  ),W(1,9   ),GWFUB ,AMP(6   ))          
      CALL FVOXXX(W(1,13  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,20  ))     
      CALL IOVXXX(W(1,6   ),W(1,20  ),W(1,9   ),GWFUB ,AMP(7   ))          
      CALL FVOXXX(W(1,8   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,21  ))     
      CALL FVOXXX(W(1,21  ),W(1,9   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     22  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,22  ),W(1,7   ),GG ,AMP(8   ))             
      CALL FVOXXX(W(1,16  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,23  ))     
      CALL IOVXXX(W(1,6   ),W(1,23  ),W(1,9   ),GWFUB ,AMP(9   ))          
      CALL FVOXXX(W(1,21  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,24  ))     
      CALL IOVXXX(W(1,6   ),W(1,24  ),W(1,9   ),GWFUB ,AMP(10  ))          
      CALL JVSXXX(W(1,9   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     25  ))                                                          
      CALL FVOXXX(W(1,2   ),W(1,25  ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     26  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,26  ),W(1,10  ),GG ,AMP(11  ))             
      CALL FVOXXX(W(1,12  ),W(1,25  ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     27  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,27  ),W(1,1   ),GG ,AMP(12  ))             
      CALL FVOXXX(W(1,26  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,6   ),W(1,28  ),W(1,7   ),GG ,AMP(13  ))             
      CALL FVOXXX(W(1,26  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL IOVXXX(W(1,6   ),W(1,29  ),W(1,1   ),GG ,AMP(14  ))             
      CALL FVOXXX(W(1,2   ),W(1,10  ),GG ,BMASS   ,ZERO    ,W(1,30  ))     
      CALL IOVXXX(W(1,6   ),W(1,30  ),W(1,25  ),GWFUB ,AMP(15  ))          
      CALL FVOXXX(W(1,12  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,31  ))     
      CALL IOVXXX(W(1,6   ),W(1,31  ),W(1,25  ),GWFUB ,AMP(16  ))          
      CALL FVOXXX(W(1,2   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,32  ))     
