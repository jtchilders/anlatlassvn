...
C ----------
     ...
     &     12  ))                                                          
      ...
      CALL IOVXXX(W(1,6   ),W(1,14  ),W(1,8   ),GWFUD ,AMP(3   ))          
      CALL FVOXXX(W(1,2   ),W(1,13  ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,8   ),GWFUD ,AMP(4   ))          
      CALL JIOXXX(W(1,7   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL JVSXXX(W(1,8   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     17  ))                                                          
      CALL FVOXXX(W(1,2   ),W(1,17  ),GWFUD ,ZERO    ,ZERO    ,W(1,        
     &     18  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,18  ),W(1,16  ),GG ,AMP(5   ))             
      CALL FVOXXX(W(1,2   ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL IOVXXX(W(1,6   ),W(1,19  ),W(1,17  ),GWFUD ,AMP(6   ))          
