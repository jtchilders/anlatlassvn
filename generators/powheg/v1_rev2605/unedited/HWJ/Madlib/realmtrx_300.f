...
C ----------
     ...
     &     11  ))                                                          
      ...
      CALL FVOXXX(W(1,8   ),W(1,10  ),GG ,BMASS   ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,6   ),W(1,12  ),W(1,9   ),GWFCB ,AMP(2   ))          
     ...
     &     16  ))                                                          
      ...
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,17  ),GG ,AMP(4   ))             
      CALL FVOXXX(W(1,2   ),W(1,14  ),GG ,BMASS   ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,6   ),W(1,18  ),W(1,9   ),GWFCB ,AMP(5   ))          
      CALL FVOXXX(W(1,2   ),W(1,17  ),GG ,BMASS   ,ZERO    ,W(1,19  ))     
      CALL IOVXXX(W(1,6   ),W(1,19  ),W(1,9   ),GWFCB ,AMP(6   ))          
      CALL JVSXXX(W(1,9   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     20  ))                                                          
      CALL FVOXXX(W(1,2   ),W(1,20  ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     21  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,21  ),W(1,10  ),GG ,AMP(7   ))             
      CALL FVOXXX(W(1,2   ),W(1,10  ),GG ,BMASS   ,ZERO    ,W(1,22  ))     
     ...
     &     23  ))                                                          
      ...
      CALL JIOXXX(W(1,13  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL FVOXXX(W(1,1   ),W(1,9   ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     25  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,25  ),W(1,24  ),GG ,AMP(10  ))             
      CALL JIOXXX(W(1,7   ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,6   ),W(1,25  ),W(1,26  ),GG ,AMP(11  ))             
      CALL FVOXXX(W(1,1   ),W(1,24  ),GG ,BMASS   ,ZERO    ,W(1,27  ))     
      CALL IOVXXX(W(1,6   ),W(1,27  ),W(1,9   ),GWFCB ,AMP(12  ))          
      CALL FVOXXX(W(1,1   ),W(1,26  ),GG ,BMASS   ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,6   ),W(1,28  ),W(1,9   ),GWFCB ,AMP(13  ))          
      CALL JIOXXX(W(1,7   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL FVOXXX(W(1,16  ),W(1,9   ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     30  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,30  ),W(1,29  ),GG ,AMP(14  ))             
      CALL FVOXXX(W(1,16  ),W(1,29  ),GG ,BMASS   ,ZERO    ,W(1,31  ))     
      CALL IOVXXX(W(1,6   ),W(1,31  ),W(1,9   ),GWFCB ,AMP(15  ))          
      CALL FVOXXX(W(1,1   ),W(1,20  ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     32  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,32  ),W(1,29  ),GG ,AMP(16  ))             
      CALL FVOXXX(W(1,1   ),W(1,29  ),GG ,BMASS   ,ZERO    ,W(1,33  ))     
      CALL IOVXXX(W(1,6   ),W(1,33  ),W(1,20  ),GWFCB ,AMP(17  ))          
      CALL FSOXXX(W(1,33  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     34  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,34  ),W(1,9   ),GWFCB ,AMP(18  ))          
