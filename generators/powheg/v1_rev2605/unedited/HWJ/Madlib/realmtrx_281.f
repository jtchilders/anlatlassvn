...
C ----------
     ...
     &     14  ))                                                          
      CALL IOVXXX(W(1,14  ),W(1,1   ),W(1,6   ),GG ,AMP(2   ))             
      CALL JIOXXX(W(1,11  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL VVVXXX(W(1,7   ),W(1,6   ),W(1,15  ),G ,AMP(3   ))              
     ...
     &     17  ))                                                          
      ...
      CALL IOVXXX(W(1,18  ),W(1,1   ),W(1,6   ),GG ,AMP(5   ))             
      CALL FSOXXX(W(1,9   ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     19  ))                                                          
      CALL FVOXXX(W(1,19  ),W(1,8   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     20  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,20  ),W(1,6   ),GG ,AMP(6   ))             
      CALL FSOXXX(W(1,1   ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     21  ))                                                          
      CALL FVOXXX(W(1,21  ),W(1,8   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     22  ))                                                          
      CALL IOVXXX(W(1,12  ),W(1,22  ),W(1,6   ),GG ,AMP(7   ))             
      ...
      CALL FVOXXX(W(1,24  ),W(1,8   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     25  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,25  ),W(1,6   ),GG ,AMP(9   ))             
      CALL FVOXXX(W(1,22  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,2   ),W(1,26  ),W(1,6   ),GG ,AMP(10  ))             
      CALL IOVXXX(W(1,10  ),W(1,19  ),W(1,6   ),GG ,AMP(11  ))             
      CALL IOVXXX(W(1,13  ),W(1,21  ),W(1,6   ),GG ,AMP(12  ))             
      CALL JIOXXX(W(1,10  ),W(1,21  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL VVVXXX(W(1,7   ),W(1,6   ),W(1,27  ),G ,AMP(13  ))              
      CALL IOVXXX(W(1,10  ),W(1,24  ),W(1,6   ),GG ,AMP(14  ))             
      CALL IOVXXX(W(1,16  ),W(1,21  ),W(1,6   ),GG ,AMP(15  ))             
      CALL JVSXXX(W(1,8   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     28  ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,28  ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     29  ))                                                          
      CALL IOVXXX(W(1,29  ),W(1,9   ),W(1,6   ),GG ,AMP(16  ))             
      CALL FVIXXX(W(1,12  ),W(1,28  ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     30  ))                                                          
      CALL IOVXXX(W(1,30  ),W(1,1   ),W(1,6   ),GG ,AMP(17  ))             
      CALL JIOXXX(W(1,29  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      CALL VVVXXX(W(1,7   ),W(1,6   ),W(1,31  ),G ,AMP(18  ))              
      CALL FVIXXX(W(1,29  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,32  ))     
      CALL IOVXXX(W(1,32  ),W(1,1   ),W(1,6   ),GG ,AMP(19  ))             
      CALL FVOXXX(W(1,9   ),W(1,28  ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     33  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,33  ),W(1,6   ),GG ,AMP(20  ))             
      CALL FVOXXX(W(1,1   ),W(1,28  ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     34  ))                                                          
      CALL IOVXXX(W(1,12  ),W(1,34  ),W(1,6   ),GG ,AMP(21  ))             
      CALL JIOXXX(W(1,2   ),W(1,34  ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL VVVXXX(W(1,7   ),W(1,6   ),W(1,35  ),G ,AMP(22  ))              
      CALL FVOXXX(W(1,34  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
      CALL IOVXXX(W(1,2   ),W(1,36  ),W(1,6   ),GG ,AMP(23  ))             
      JAMP(   1) = -AMP(   1)-AMP(   3)-AMP(   6)-AMP(   8)-AMP(   9)
     &             -AMP(  10)-AMP(  11)-AMP(  13)-AMP(  14)-AMP(  16)
     &             -AMP(  18)-AMP(  20)-AMP(  22)-AMP(  23)
      JAMP(   2) = -AMP(   2)+AMP(   3)-AMP(   4)-AMP(   5)-AMP(   7)
     &             +AMP(   8)-AMP(  12)+AMP(  13)-AMP(  15)-AMP(  17)
     &             +AMP(  18)-AMP(  19)-AMP(  21)+AMP(  22)
      REALMTRX_281 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
