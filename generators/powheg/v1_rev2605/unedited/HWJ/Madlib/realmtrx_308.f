...
C ----------
     ...
     &     14  ))                                                          
      ...
      CALL FVOXXX(W(1,16  ),W(1,8   ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     17  ))                                                          
     ...
     &     35  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,35  ),W(1,8   ),GWFCB ,AMP(19  ))          
      CALL FSOXXX(W(1,31  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     36  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,36  ),W(1,8   ),GWFCB ,AMP(20  ))          
      CALL FSOXXX(W(1,32  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     37  ))                                                          
      CALL FVOXXX(W(1,37  ),W(1,8   ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     38  ))                                                          
