...
C ----------
     ...
     &     13  ))                                                          
      CALL FVOXXX(W(1,1   ),W(1,13  ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     14  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,14  ),W(1,10  ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,1   ),W(1,10  ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,13  ),GWFUB ,AMP(4   ))          
      CALL FSOXXX(W(1,15  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     16  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,16  ),W(1,9   ),GWFUB ,AMP(5   ))          
      CALL FVIXXX(W(1,7   ),W(1,9   ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     17  ))                                                          
      CALL JIOXXX(W(1,17  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,18  ),GG ,AMP(6   ))             
      CALL JIOXXX(W(1,7   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,19  ),GG ,AMP(7   ))             
      CALL FVIXXX(W(1,7   ),W(1,13  ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     20  ))                                                          
     ...
     &     22  ))                                                          
      ...
      CALL JIOXXX(W(1,7   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
