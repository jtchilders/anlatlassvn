...
C ----------
      ...
      CALL FVIXXX(W(1,2   ),W(1,7   ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     8   ))                                                          
     ...
     &     10  ))                                                          
      CALL FVOXXX(W(1,10  ),W(1,7   ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     11  ))                                                          
     ...
     &     12  ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,12  ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     13  ))                                                          
      CALL IOVXXX(W(1,13  ),W(1,1   ),W(1,6   ),GG ,AMP(4   ))             
      CALL FVOXXX(W(1,1   ),W(1,12  ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     14  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,14  ),W(1,6   ),GG ,AMP(5   ))             
      do i=1,ngraphs
