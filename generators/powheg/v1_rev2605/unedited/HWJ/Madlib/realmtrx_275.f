...
C ----------
     ...
     &     13  ))                                                          
      ...
      CALL JIOXXX(W(1,9   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,15  ),GG ,AMP(3   ))             
      CALL JVSXXX(W(1,8   ),W(1,3   ),GWWH ,WMASS   ,WWIDTH  ,W(1,         
     &     16  ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,16  ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     17  ))                                                          
      CALL JIOXXX(W(1,17  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,18  ),GG ,AMP(4   ))             
      CALL FVOXXX(W(1,1   ),W(1,16  ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     19  ))                                                          
      CALL JIOXXX(W(1,2   ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,20  ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,7   ),W(1,8   ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     21  ))                                                          
      CALL JIOXXX(W(1,21  ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,22  ),GG ,AMP(6   ))             
      CALL JIOXXX(W(1,7   ),W(1,13  ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,23  ),GG ,AMP(7   ))             
      CALL FVIXXX(W(1,7   ),W(1,16  ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     24  ))                                                          
      CALL JIOXXX(W(1,24  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,25  ),GG ,AMP(8   ))             
      CALL FSIXXX(W(1,21  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     26  ))                                                          
      CALL JIOXXX(W(1,26  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,27  ),GG ,AMP(9   ))             
      CALL JIOXXX(W(1,7   ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
