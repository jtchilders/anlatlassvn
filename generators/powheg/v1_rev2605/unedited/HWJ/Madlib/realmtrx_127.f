...
C ----------
     ...
     &     12  ))                                                          
      ...
      CALL IOVXXX(W(1,11  ),W(1,6   ),W(1,13  ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,1   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,14  ),W(1,6   ),W(1,8   ),GWFUD ,AMP(3   ))          
      CALL FVIXXX(W(1,1   ),W(1,13  ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,15  ),W(1,6   ),W(1,8   ),GWFUD ,AMP(4   ))          
     ...
     &     18  ))                                                          
      CALL IOVXXX(W(1,18  ),W(1,6   ),W(1,16  ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,1   ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL IOVXXX(W(1,19  ),W(1,6   ),W(1,17  ),GWFUD ,AMP(6   ))          
