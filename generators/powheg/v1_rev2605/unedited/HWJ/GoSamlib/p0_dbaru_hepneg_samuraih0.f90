module     p0_dbaru_hepneg_samuraih0
   ...
   use p0_dbaru_hepneg_scalar_cache
   implicit none
   private
...
function     numeval_group0(icut, Q, mu2) result(num)
   use p0_dbaru_hepneg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p0_dbaru_hepneg_model
   use p0_dbaru_hepneg_d70h0l1, only: numerator_d70 => numerator_samurai
   implicit none
...
function     numeval_group1(icut, Q, mu2) result(num)
   use p0_dbaru_hepneg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p0_dbaru_hepneg_model
   use p0_dbaru_hepneg_d61h0l1, only: numerator_d61 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group2(icut, Q, mu2) result(num)
   use p0_dbaru_hepneg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p0_dbaru_hepneg_model
   use p0_dbaru_hepneg_d34h0l1, only: numerator_d34 => numerator_samurai
   use p0_dbaru_hepneg_d40h0l1, only: numerator_d40 => numerator_samurai
   use p0_dbaru_hepneg_d60h0l1, only: numerator_d60 => numerator_samurai
   use p0_dbaru_hepneg_d92h0l1, only: numerator_d92 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group3(icut, Q, mu2) result(num)
   use p0_dbaru_hepneg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p0_dbaru_hepneg_model
   use p0_dbaru_hepneg_d30h0l1, only: numerator_d30 => numerator_samurai
   use p0_dbaru_hepneg_d37h0l1, only: numerator_d37 => numerator_samurai
   use p0_dbaru_hepneg_d59h0l1, only: numerator_d59 => numerator_samurai
   use p0_dbaru_hepneg_d94h0l1, only: numerator_d94 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
subroutine     reduce_group0(scale2,tot,totr,ok)
   ...
   use p0_dbaru_hepneg_config, only: samurai_group_numerators, &
      & samurai_verbosity, samurai_istop, samurai_test, &
      & debug_nlo_diagrams, logfile
   use p0_dbaru_hepneg_kinematics
   use p0_dbaru_hepneg_model
   use p0_dbaru_hepneg_d70h0l1, only: numerator_diagram70 => numerator_samurai
...
subroutine     reduce_group1(scale2,tot,totr,ok)
   ...
   use p0_dbaru_hepneg_kinematics
   use p0_dbaru_hepneg_model
   use p0_dbaru_hepneg_d61h0l1, only: numerator_diagram61 => numerator_samurai
   use p0_dbaru_hepneg_globalsl1, only: epspow
...
subroutine     reduce_group2(scale2,tot,totr,ok)
   ...
   use p0_dbaru_hepneg_kinematics
   use p0_dbaru_hepneg_model
   use p0_dbaru_hepneg_d34h0l1, only: numerator_diagram34 => numerator_samurai
   use p0_dbaru_hepneg_d40h0l1, only: numerator_diagram40 => numerator_samurai
   use p0_dbaru_hepneg_d60h0l1, only: numerator_diagram60 => numerator_samurai
   use p0_dbaru_hepneg_d92h0l1, only: numerator_diagram92 => numerator_samurai
   use p0_dbaru_hepneg_globalsl1, only: epspow
...
subroutine     reduce_group3(scale2,tot,totr,ok)
   ...
   use p0_dbaru_hepneg_kinematics
   use p0_dbaru_hepneg_model
   use p0_dbaru_hepneg_d30h0l1, only: numerator_diagram30 => numerator_samurai
   use p0_dbaru_hepneg_d37h0l1, only: numerator_diagram37 => numerator_samurai
   use p0_dbaru_hepneg_d59h0l1, only: numerator_diagram59 => numerator_samurai
   use p0_dbaru_hepneg_d94h0l1, only: numerator_diagram94 => numerator_samurai
   use p0_dbaru_hepneg_globalsl1, only: epspow
...
!-----#] subroutine reduce_group3:
!---#] reduce groups with samurai:
end module p0_dbaru_hepneg_samuraih0
