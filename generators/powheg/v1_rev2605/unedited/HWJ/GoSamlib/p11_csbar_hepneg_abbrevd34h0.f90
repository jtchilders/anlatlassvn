module     p11_csbar_hepneg_abbrevd34h0
...
contains
   subroutine     init_abbrev()
      use p11_csbar_hepneg_config, only: deltaOS, &
     &    logfile, debug_nlo_diagrams
      use p11_csbar_hepneg_kinematics
      use p11_csbar_hepneg_model
      use p11_csbar_hepneg_color, only: TR
      ...
      abb34(4)=NC**(-1)
      abb34(5)=abb34(4)-NC
      abb34(5)=abb34(5)*gHWW*spbk6e6*spak2e6*c1*gW**2*i_*TR*CVSC*abb34(3)*abb34&
      &(2)*abb34(1)
...
end module p11_csbar_hepneg_abbrevd34h0
