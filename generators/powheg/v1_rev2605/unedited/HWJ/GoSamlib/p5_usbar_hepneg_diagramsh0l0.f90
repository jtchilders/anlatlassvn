module     p5_usbar_hepneg_diagramsh0l0
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HWJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p5_usbar_hepneg/helicity0diagramsl0.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(5)=abb(6)+abb(5)
      abb(5)=2.0_ki*abb(1)*abb(2)*CVSU*gHWW*i_*abb(5)*gW**2
      amplitude=c1*abb(5)
...
!---#] function amplitude:
end module p5_usbar_hepneg_diagramsh0l0
