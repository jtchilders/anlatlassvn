module     p6_ubbar_hepneg_dipoles
   use p6_ubbar_hepneg_config, only: ki
   use p6_ubbar_hepneg_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T6, &
       & T2T6
   use p6_ubbar_hepneg_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p6_ubbar_hepneg_dipoles
