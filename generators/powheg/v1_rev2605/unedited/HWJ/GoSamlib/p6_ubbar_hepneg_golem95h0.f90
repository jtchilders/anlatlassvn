module     p6_ubbar_hepneg_golem95h0
...
subroutine     reconstruct_group0(coeffs)
   use tens_rec
   use p6_ubbar_hepneg_config
   use p6_ubbar_hepneg_groups, only: tensrec_info_group0
   use p6_ubbar_hepneg_d70h0l1, only: numerator_d70 => numerator_golem95
   use p6_ubbar_hepneg_d70h0l1d, only: reconstruct_d70
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use p6_ubbar_hepneg_d61h0l1, only: numerator_d61 => numerator_golem95
   use p6_ubbar_hepneg_d61h0l1d, only: reconstruct_d61
   implicit none
...
subroutine     reconstruct_group2(coeffs)
   ...
   use p6_ubbar_hepneg_d34h0l1, only: numerator_d34 => numerator_golem95
   use p6_ubbar_hepneg_d34h0l1d, only: reconstruct_d34
   use p6_ubbar_hepneg_d40h0l1, only: numerator_d40 => numerator_golem95
   use p6_ubbar_hepneg_d40h0l1d, only: reconstruct_d40
   use p6_ubbar_hepneg_d60h0l1, only: numerator_d60 => numerator_golem95
   use p6_ubbar_hepneg_d60h0l1d, only: reconstruct_d60
   use p6_ubbar_hepneg_d92h0l1, only: numerator_d92 => numerator_golem95
   use p6_ubbar_hepneg_d92h0l1d, only: reconstruct_d92
   implicit none
...
subroutine     reconstruct_group3(coeffs)
   ...
   use p6_ubbar_hepneg_d30h0l1, only: numerator_d30 => numerator_golem95
   use p6_ubbar_hepneg_d30h0l1d, only: reconstruct_d30
   use p6_ubbar_hepneg_d37h0l1, only: numerator_d37 => numerator_golem95
   use p6_ubbar_hepneg_d37h0l1d, only: reconstruct_d37
   use p6_ubbar_hepneg_d59h0l1, only: numerator_d59 => numerator_golem95
   use p6_ubbar_hepneg_d59h0l1d, only: reconstruct_d59
   use p6_ubbar_hepneg_d94h0l1, only: numerator_d94 => numerator_golem95
   use p6_ubbar_hepneg_d94h0l1d, only: reconstruct_d94
   implicit none
...
!---#] subroutine reconstruct_group3:
end module p6_ubbar_hepneg_golem95h0
