module     p11_csbar_hepneg_d37h0l1
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HWJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p11_csbar_hepneg/helicity0d37h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p11_csbar_hepneg_abbrevd37h0
      implicit none
      ...
      acc37(6)=abb37(11)
      acc37(7)=abb37(13)
      acc37(8)=acc37(7)*Qspk6
      acc37(9)=acc37(6)*Qspe6
      acc37(10)=acc37(5)*Qspvak1k6
      acc37(11)=acc37(3)*Qspvak6k1
      acc37(12)=acc37(2)*Qspvae6k1
      acc37(13)=acc37(1)*Qspk1
...
!           & sign => diagram37_sign, shift => diagram37_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p11_csbar_hepneg_d37h0l1
