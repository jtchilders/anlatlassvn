module     p12_cbbar_hepneg_diagramsh0l0
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HWJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p12_cbbar_hepneg/helicity0diagramsl0.f90
...
!---#[ function amplitude:
   function amplitude()
      ...
      use p12_cbbar_hepneg_config, only: debug_lo_diagrams, &
        & use_sorted_sum
      use p12_cbbar_hepneg_accu, only: sorted_sum
      use p12_cbbar_hepneg_util, only: inspect_lo_diagram
      implicit none
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(5)=abb(6)+abb(5)
      abb(5)=2.0_ki*abb(1)*abb(2)*CVBC*gHWW*i_*abb(5)*gW**2
      amplitude=c1*abb(5)
...
!---#] function amplitude:
end module p12_cbbar_hepneg_diagramsh0l0
