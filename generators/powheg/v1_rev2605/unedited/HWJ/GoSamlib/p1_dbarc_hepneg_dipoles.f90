module     p1_dbarc_hepneg_dipoles
   use p1_dbarc_hepneg_config, only: ki
   use p1_dbarc_hepneg_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T6, &
       & T2T6
   use p1_dbarc_hepneg_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p1_dbarc_hepneg_dipoles
