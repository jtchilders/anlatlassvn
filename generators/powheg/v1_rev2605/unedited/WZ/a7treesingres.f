      double complex function a7treesra(j1,j2,j3,j4,j5,j6,j7,za,zb)
      implicit none
!      include 'constants.f'
...
c     -- sing res real contributions      
      ...
      integer i1,i2,i3,i4
      integer k1,k2,k3,k4,k5, p,l1,l2,l3
      ...
      zab(l1,l2,l3) = za(l1,l2)*zb(l2,l3)
...
c    arbitrary momentum -- gauge choice
     ...
     .     /(s(j1,j7)*t356)
      ...
      a7treesra = (gup56on4+gdo56on4+gup56on3+gdo56on3)

c --  overall propagator
      a7treesra = a7treesra/t127/s56
