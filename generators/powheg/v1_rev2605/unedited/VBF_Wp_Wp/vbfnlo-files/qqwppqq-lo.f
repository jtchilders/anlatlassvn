...
c Born part only: 
c      
      subroutine qqwppqq_lo(pbar,sign, L,bos,ans)
c
...
c  eps1=v,eps2=j_lower,eps3=v'
      m5ue = 
     &s1c(psiwu(1,isig1,2),jqq(0,isig3,2),.true.,isig1,psiwe(1,isig1,1))
      m5eu = 
     &s1c(psiwe(1,isig1,2),jqq(0,isig3,2),.true.,isig1,psiwu(1,isig1,1))
...
c  eps1=v,eps2=j_upper,eps3=v'
      m5ue = 
     &s1c(psiwu(1,isig3,4),jqq(0,isig1,1),.true.,isig3,psiwe(1,isig3,3))
      m5eu = 
     &s1c(psiwe(1,isig3,4),jqq(0,isig1,1),.true.,isig3,psiwu(1,isig3,3))
