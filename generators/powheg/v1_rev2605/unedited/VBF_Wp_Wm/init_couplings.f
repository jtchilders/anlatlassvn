...
c Higgs parameters: (are to be specified in powheg.input)
      ph_Hmass   = powheginput('hmass')
      ph_Hwidth   = powheginput('hwidth')
C Z boson parameters:
      ph_Zmass   = 91.188d0     
      ph_Zwidth  =  2.51d0
c W boson parameters: (are to be specified in powheg.input)
...
c      asmzopi=pwhg_alphas(ph_Zmass2,st_lambda5MSB,5)/pi
