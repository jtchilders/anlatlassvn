...
c--- imode=3   ! compare the two calculations 
      ...
      if ((imode .eq. 1) .or. (imode .eq. 3)) then
c        call HAQggnew(i1,i2,i3,i4,
c     .                Hqagg_1,Hqagg_ab_1,Hqagg_ba_1,Hqagg_sym_1)
      endif
...
c--- imode=3   ! compare the two calculations 
      ...
      if ((imode .eq. 1) .or. (imode .eq. 3)) then
c        call Ampsq_AQaq_nonid(i1,i2,i3,i4,Hqarb_1)
      endif
...
c--- imode=3   ! compare the two calculations 
      ...
      if ((imode .eq. 1) .or. (imode .eq. 3)) then
c        call Ampsq_AQaq_ident(i1,i2,i3,i4,
c     .                        Hqaqa_1,Hqaqa_a_1,Hqaqa_b_1,Hqaqa_i_1)
      endif
