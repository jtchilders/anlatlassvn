...
C---end of terms proportional to lowest order      
     ...
     .  +Dble(Lsm1(-s34,-s134,-s14,-s134))*fun1(i1,i2,i3,i4))
      ...
      Hqarbvsq=Hqarbvsq
     . +fun2(i1,i2,i3,i4)*dble(L1(-s123,-s12))*(1d0/xn+xn)*0.5d0*V_i2
     . +fun2(i2,i1,i4,i3)*dble(L1(-s124,-s12))*(1d0/xn+xn)*0.5d0*V_i2  
     . +fun2(i4,i3,i2,i1)*dble(L1(-s234,-s34))*(1d0/xn+xn)*0.5d0*V_i2     
     . +fun2(i3,i4,i1,i2)*dble(L1(-s134,-s34))*(1d0/xn+xn)*0.5d0*V_i2

     . +fun3(i1,i2,i3,i4)*dble(L0(-s123,-s12))*xn*0.5d0*V_i2
     . +fun3(i2,i1,i4,i3)*dble(L0(-s124,-s12))*xn*0.5d0*V_i2  
     . +fun3(i4,i3,i2,i1)*dble(L0(-s234,-s34))*xn*0.5d0*V_i2     
     . +fun3(i3,i4,i1,i2)*dble(L0(-s134,-s34))*xn*0.5d0*V_i2

     . +fun4(i1,i2,i3,i4)*dble(L0(-s123,-s12))/xn*0.5d0*V_i2
     . +fun4(i2,i1,i4,i3)*dble(L0(-s124,-s12))/xn*0.5d0*V_i2  
     . +fun4(i4,i3,i2,i1)*dble(L0(-s234,-s34))/xn*0.5d0*V_i2     
     . +fun4(i3,i4,i1,i2)*dble(L0(-s134,-s34))/xn*0.5d0*V_i2

     . +fun5(i1,i2,i3,i4)*dble(L0(-s124,-s14))*0.5d0*V_i2*(-xn/2+1d0/xn)
     . +fun5(i2,i1,i4,i3)*dble(L0(-s123,-s23))*0.5d0*V_i2*(-xn/2+1d0/xn)
     . +fun5(i4,i3,i2,i1)*dble(L0(-s134,-s14))*0.5d0*V_i2*(-xn/2+1d0/xn)
     . +fun5(i3,i4,i1,i2)*dble(L0(-s234,-s23))*0.5d0*V_i2*(-xn/2+1d0/xn)

     . -fun5(i1,i2,i4,i3)*dble(L0(-s123,-s13))/xn*0.5d0*V_i2
     . -fun5(i2,i1,i3,i4)*dble(L0(-s124,-s24))/xn*0.5d0*V_i2  
     . -fun5(i4,i3,i1,i2)*dble(L0(-s234,-s24))/xn*0.5d0*V_i2     
     . -fun5(i3,i4,i2,i1)*dble(L0(-s134,-s13))/xn*0.5d0*V_i2

      Hqarbvsq=Hqarbvsq
     . +0.5d0*V_i2*xn*dble(lnrat(-s123,-s12))*fun6(i1,i2,i3,i4)
     . +0.5d0*V_i2*xn*dble(lnrat(-s124,-s12))*fun6(i2,i1,i4,i3)
     . +0.5d0*V_i2*xn*dble(lnrat(-s234,-s34))*fun6(i4,i3,i2,i1)
     . +0.5d0*V_i2*xn*dble(lnrat(-s134,-s34))*fun6(i3,i4,i1,i2)

     . +0.5d0*V_i2*xn*dble(lnrat(-s123,-s23))*fun7(i1,i2,i3,i4)
     . +0.5d0*V_i2*xn*dble(lnrat(-s124,-s14))*fun7(i2,i1,i4,i3)
     . +0.5d0*V_i2*xn*dble(lnrat(-s234,-s23))*fun7(i4,i3,i2,i1)
     . +0.5d0*V_i2*xn*dble(lnrat(-s134,-s14))*fun7(i3,i4,i1,i2)

     . +0.5d0*V_i2*xn*dble(lnrat(-s12,-s14))*fun8(i1,i2,i3,i4)
     . +0.5d0*V_i2*xn*dble(lnrat(-s12,-s14))*fun8(i2,i1,i4,i3)
     . +0.5d0*V_i2*xn*dble(lnrat(-s34,-s23))*fun8(i4,i3,i2,i1)
     . +0.5d0*V_i2*xn*dble(lnrat(-s34,-s23))*fun8(i3,i4,i1,i2)


      Hqarbvsq=Hqarbvsq
     . +0.5d0*V_i2/xn*dble(lnrat(-s123,-s12))*fun9(i1,i2,i3,i4)
     . +0.5d0*V_i2/xn*dble(lnrat(-s124,-s12))*fun9(i2,i1,i4,i3)
     . +0.5d0*V_i2/xn*dble(lnrat(-s234,-s34))*fun9(i4,i3,i2,i1)
     . +0.5d0*V_i2/xn*dble(lnrat(-s134,-s34))*fun9(i3,i4,i1,i2)

     . +0.5d0*V_i2/xn*dble(lnrat(-s123,-s13))*fun10(i1,i2,i3,i4)
     . +0.5d0*V_i2/xn*dble(lnrat(-s124,-s24))*fun10(i2,i1,i4,i3)
     . +0.5d0*V_i2/xn*dble(lnrat(-s234,-s24))*fun10(i4,i3,i2,i1)
     . +0.5d0*V_i2/xn*dble(lnrat(-s134,-s13))*fun10(i3,i4,i1,i2)

     . +0.5d0*V_i2/xn*dble(lnrat(-s12,-s13))*fun11(i1,i2,i3,i4)
     . +0.5d0*V_i2/xn*dble(lnrat(-s12,-s23))*fun11(i2,i1,i4,i3)
     . +0.5d0*V_i2/xn*dble(lnrat(-s34,-s24))*fun11(i4,i3,i2,i1)
     . +0.5d0*V_i2/xn*dble(lnrat(-s34,-s14))*fun11(i3,i4,i1,i2)


      Hqarbvsq=Hqarbvsq

     . -0.5d0*V_i2/xn*dble(lnrat(-s123,-s23))*fun10(i2,i1,i3,i4)
     . -0.5d0*V_i2/xn*dble(lnrat(-s124,-s14))*fun10(i1,i2,i4,i3)
     . -0.5d0*V_i2/xn*dble(lnrat(-s234,-s23))*fun10(i3,i4,i2,i1)
     . -0.5d0*V_i2/xn*dble(lnrat(-s134,-s14))*fun10(i4,i3,i1,i2)

     . -0.5d0*V_i2/xn*dble(lnrat(-s12,-s13))*fun11(i2,i1,i3,i4)
     . -0.5d0*V_i2/xn*dble(lnrat(-s12,-s14))*fun11(i1,i2,i4,i3)
     . -0.5d0*V_i2/xn*dble(lnrat(-s34,-s23))*fun11(i3,i4,i2,i1)
     . -0.5d0*V_i2/xn*dble(lnrat(-s34,-s24))*fun11(i4,i3,i1,i2)


     . +fun12(i1,i2,i3,i4)*0.5d0*V_i2*(xn+1d0/xn)
     . +fun12(i2,i1,i4,i3)*0.5d0*V_i2*(xn+1d0/xn)
     . +fun12(i4,i3,i2,i1)*0.5d0*V_i2*(xn+1d0/xn)
     . +fun12(i3,i4,i1,i2)*0.5d0*V_i2*(xn+1d0/xn)
