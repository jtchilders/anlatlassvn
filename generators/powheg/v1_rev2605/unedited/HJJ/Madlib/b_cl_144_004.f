...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(5,ihel).eq.-1) THEN
                 T=B_CL_144_004(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_144_004(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL VVSHXX(W(1,8   ),W(1,9   ),W(1,3   ),GH ,AMP(2   ))             
      CALL JVSHXX(W(1,5   ),W(1,3   ),GH ,ZERO    ,ZERO    ,W(1,10  ))     
     ...
     &     ZERO    ,W(1,12  ))                                             
      CALL IOVXXX(W(1,4   ),W(1,1   ),W(1,12  ),GG ,AMP(5   ))             
      CALL VVVXXX(W(1,5   ),W(1,6   ),W(1,8   ),G ,AMP(6   ))              
      CALL FVIXXX(W(1,4   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,13  ),W(1,1   ),W(1,10  ),GG ,AMP(7   ))             
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
     ...
     &             -AMP(   8)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_144_004=B_CL_144_004 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_144_004=B_CL_144_004 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
