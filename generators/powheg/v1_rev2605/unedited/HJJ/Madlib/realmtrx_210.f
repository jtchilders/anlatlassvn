      SUBROUTINE SREALMTRX_210(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_210/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=REALMTRX_210(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION REALMTRX_210(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,10  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
     ...
     &     AMP(6   ))                                                      
      ...
      CALL FVOXXX(W(1,4   ),W(1,17  ),GG ,BMASS   ,ZERO    ,W(1,18  ))     
     ...
     &     W(1,24  ))                                                      
      ...
      CALL FVIXXX(W(1,1   ),W(1,17  ),GG ,BMASS   ,ZERO    ,W(1,26  ))     
     ...
     &     AMP(17  ))                                                      
      ...
      CALL FVOXXX(W(1,4   ),W(1,31  ),GG ,BMASS   ,ZERO    ,W(1,32  ))     
     ...
     &     W(1,37  ))                                                      
      ...
      CALL FVIXXX(W(1,1   ),W(1,31  ),GG ,BMASS   ,ZERO    ,W(1,39  ))     
     ...
     &     W(1,42  ))                                                      
      ...
      CALL FVOXXX(W(1,4   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,43  ))     
      CALL FVOXXX(W(1,43  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,44  ))     
      ...
      CALL FVIXXX(W(1,1   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,48  ))     
      CALL FVIXXX(W(1,48  ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,49  ))     
     ...
     &     ZERO    ,W(1,51  ))                                             
      CALL FVOXXX(W(1,4   ),W(1,51  ),GG ,BMASS   ,ZERO    ,W(1,52  ))     
     ...
     &     ZERO    ,W(1,53  ))                                             
      ...
      CALL FVIXXX(W(1,1   ),W(1,51  ),GG ,BMASS   ,ZERO    ,W(1,54  ))     
     ...
     &     ZERO    ,W(1,55  ))                                             
      ...
      CALL FVOXXX(W(1,4   ),W(1,56  ),GG ,BMASS   ,ZERO    ,W(1,57  ))     
     ...
     &     W(1,60  ))                                                      
      ...
      CALL FVIXXX(W(1,1   ),W(1,56  ),GG ,BMASS   ,ZERO    ,W(1,64  ))     
     ...
     &     W(1,67  ))                                                      
      ...
      CALL FVIXXX(W(1,73  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,77  ))     
     ...
     &     AMP(68  ))                                                      
      ...
      CALL FVIXXX(W(1,1   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,90  ))     
      ...
      CALL FVIXXX(W(1,90  ),W(1,30  ),GG ,BMASS   ,ZERO    ,W(1,93  ))     
     ...
     &     AMP(80  ))                                                      
      ...
      CALL FVIXXX(W(1,90  ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,96  ))     
     ...
     &             -AMP(  82)+AMP(  84)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          REALMTRX_210 =REALMTRX_210+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
