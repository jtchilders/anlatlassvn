...
C  
C FOR PROCESS : g g -> h d d~ g  
C  
C BORN AMPLITUDE IS g g -> h d d~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(2,ihel).eq.-1) THEN
                 T=B_CL_171_002(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_171_002(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,5   ),W(1,11  ),W(1,2   ),GG ,AMP(4   ))             
      CALL JVVXXX(W(1,10  ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,12  ))      
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,12  ),GG ,AMP(5   ))             
      CALL FVOXXX(W(1,4   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,5   ),W(1,13  ),W(1,10  ),GG ,AMP(6   ))             
      CALL JVVXXX(W(1,1   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,14  ))      
      CALL JVSHXX(W(1,14  ),W(1,3   ),GH ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,15  ),GG ,AMP(7   ))             
     ...
     &             -AMP(   8)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_171_002=B_CL_171_002 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_171_002=B_CL_171_002 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
