      SUBROUTINE SB_SF_122_005(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_122_005(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_122_005(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            9/                                       
      DATA (CF(i,1  ),i=1  ,2  ) /   -21,   -1/                            
C               T[ 4, 5]T[ 2, 1]                                           
      DATA Denom(2  )/            9/                                       
      DATA (CF(i,2  ),i=1  ,2  ) /    -1,    3/                            
C               T[ 4, 1]T[ 2, 5]                                           
C ----------
C BEGIN CODE
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_122_005 =B_SF_122_005+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
