...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(1,ihel).eq.-1) THEN
                 T=B_CL_162_001(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_162_001(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,4   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,6   ))     
      CALL JVSHXX(W(1,5   ),W(1,3   ),GH ,ZERO    ,ZERO    ,W(1,7   ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,7   ),GG ,AMP(1   ))             
      CALL JIOXXX(W(1,2   ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,8   ))     
      CALL JVVXXX(W(1,5   ),W(1,1   ),G ,ZERO    ,ZERO    ,W(1,9   ))      
      CALL VVSHXX(W(1,9   ),W(1,8   ),W(1,3   ),GH ,AMP(2   ))             
      CALL JVSHXX(W(1,1   ),W(1,3   ),GH ,ZERO    ,ZERO    ,W(1,10  ))     
      CALL FVOXXX(W(1,4   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,2   ),W(1,11  ),W(1,5   ),GG ,AMP(3   ))             
      CALL VVVXXX(W(1,1   ),W(1,8   ),W(1,7   ),G ,AMP(4   ))              
      CALL FVIXXX(W(1,2   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,12  ),W(1,4   ),W(1,5   ),GG ,AMP(5   ))             
      CALL JVVSXX(W(1,1   ),W(1,5   ),W(1,3   ),DUM1 ,GH4 ,ZERO    ,       
     &     ZERO    ,W(1,13  ))                                             
      CALL IOVXXX(W(1,2   ),W(1,4   ),W(1,13  ),GG ,AMP(6   ))             
      CALL VVVXXX(W(1,5   ),W(1,10  ),W(1,8   ),G ,AMP(7   ))              
      CALL FVIXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL JIOXXX(W(1,14  ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL VVSHXX(W(1,5   ),W(1,15  ),W(1,3   ),GH ,AMP(8   ))             
      do i=1,ngraphs
         if(ihel.eq.-1)then
      ...
      JAMP(   1) = +AMP(   1)-AMP(   2)+AMP(   3)-AMP(   4)+AMP(   6)
     &             -AMP(   7)
      JAMP(   2) = +AMP(   2)+AMP(   4)+AMP(   5)-AMP(   6)+AMP(   7)
     &             +AMP(   8)
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_162_001=B_CL_162_001 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_162_001=B_CL_162_001 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
