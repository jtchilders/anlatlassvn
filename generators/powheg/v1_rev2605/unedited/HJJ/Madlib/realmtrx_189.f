...
C ----------
      ...
      CALL FVOXXX(W(1,10  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
     ...
     &     AMP(6   ))                                                      
      ...
      CALL IOVXXX(W(1,8   ),W(1,10  ),W(1,6   ),GG ,AMP(8   ))             
      CALL JVVXXX(W(1,5   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,16  ))      
      CALL JVSHXX(W(1,16  ),W(1,3   ),GH ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL FVIXXX(W(1,4   ),W(1,17  ),GG ,BMASS   ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,18  ),W(1,1   ),W(1,6   ),GG ,AMP(9   ))             
      CALL JIOXXX(W(1,4   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
     ...
     &     W(1,24  ))                                                      
      ...
      CALL FVOXXX(W(1,1   ),W(1,17  ),GG ,BMASS   ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,4   ),W(1,26  ),W(1,6   ),GG ,AMP(14  ))             
     ...
     &     AMP(17  ))                                                      
      ...
      CALL FVIXXX(W(1,4   ),W(1,31  ),GG ,BMASS   ,ZERO    ,W(1,32  ))     
      CALL IOVXXX(W(1,32  ),W(1,1   ),W(1,6   ),GG ,AMP(22  ))             
     ...
     &     W(1,37  ))                                                      
      ...
      CALL FVOXXX(W(1,1   ),W(1,31  ),GG ,BMASS   ,ZERO    ,W(1,39  ))     
      CALL IOVXXX(W(1,4   ),W(1,39  ),W(1,6   ),GG ,AMP(27  ))             
     ...
     &     W(1,42  ))                                                      
      ...
      CALL FVIXXX(W(1,4   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,43  ))     
      CALL FVIXXX(W(1,43  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,44  ))     
      CALL IOVXXX(W(1,44  ),W(1,1   ),W(1,6   ),GG ,AMP(35  ))             
      CALL JIOXXX(W(1,43  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,45  ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,48  ))     
      CALL FVOXXX(W(1,48  ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,49  ))     
      CALL IOVXXX(W(1,4   ),W(1,49  ),W(1,6   ),GG ,AMP(38  ))             
      CALL JIOXXX(W(1,4   ),W(1,48  ),GG ,ZERO    ,ZERO    ,W(1,50  ))     
     ...
     &     AMP(40  ))                                                      
      ...
      CALL IOVXXX(W(1,43  ),W(1,48  ),W(1,6   ),GG ,AMP(42  ))             
      CALL JVVSXX(W(1,5   ),W(1,2   ),W(1,3   ),DUM1 ,GH4 ,ZERO    ,       
     &     ZERO    ,W(1,51  ))                                             
      CALL FVIXXX(W(1,4   ),W(1,51  ),GG ,BMASS   ,ZERO    ,W(1,52  ))     
      CALL IOVXXX(W(1,52  ),W(1,1   ),W(1,6   ),GG ,AMP(43  ))             
      CALL JVVSXX(W(1,19  ),W(1,5   ),W(1,3   ),DUM1 ,GH4 ,ZERO    ,       
     &     ZERO    ,W(1,53  ))                                             
      CALL VVVXXX(W(1,6   ),W(1,2   ),W(1,53  ),G ,AMP(44  ))              
      CALL FVOXXX(W(1,1   ),W(1,51  ),GG ,BMASS   ,ZERO    ,W(1,54  ))     
     ...
     &     ZERO    ,W(1,55  ))                                             
      ...
      CALL FVIXXX(W(1,4   ),W(1,56  ),GG ,BMASS   ,ZERO    ,W(1,57  ))     
      CALL IOVXXX(W(1,57  ),W(1,1   ),W(1,6   ),GG ,AMP(48  ))             
     ...
     &     W(1,60  ))                                                      
      ...
      CALL FVOXXX(W(1,1   ),W(1,56  ),GG ,BMASS   ,ZERO    ,W(1,64  ))     
      CALL IOVXXX(W(1,4   ),W(1,64  ),W(1,6   ),GG ,AMP(53  ))             
     ...
     &     W(1,67  ))                                                      
      ...
      CALL FVIXXX(W(1,4   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,68  ))     
      CALL JIOXXX(W(1,68  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,69  ))     
      CALL VVSHXX(W(1,6   ),W(1,69  ),W(1,3   ),GH ,AMP(61  ))             
      CALL FVIXXX(W(1,4   ),W(1,16  ),GG ,BMASS   ,ZERO    ,W(1,70  ))     
      CALL JIOXXX(W(1,70  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,71  ))     
      CALL VVSHXX(W(1,6   ),W(1,71  ),W(1,3   ),GH ,AMP(62  ))             
      CALL FVIXXX(W(1,68  ),W(1,30  ),GG ,BMASS   ,ZERO    ,W(1,72  ))     
      CALL IOVXXX(W(1,72  ),W(1,1   ),W(1,6   ),GG ,AMP(63  ))             
      CALL FVOXXX(W(1,1   ),W(1,30  ),GG ,BMASS   ,ZERO    ,W(1,73  ))     
      CALL JIOXXX(W(1,4   ),W(1,73  ),GG ,ZERO    ,ZERO    ,W(1,74  ))     
      CALL VVVXXX(W(1,6   ),W(1,2   ),W(1,74  ),G ,AMP(64  ))              
      CALL JIOXXX(W(1,68  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,75  ))     
      CALL JVVXXX(W(1,5   ),W(1,75  ),G ,ZERO    ,ZERO    ,W(1,76  ))      
      CALL VVSHXX(W(1,6   ),W(1,76  ),W(1,3   ),GH ,AMP(65  ))             
      CALL FVOXXX(W(1,73  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,77  ))     
      CALL IOVXXX(W(1,4   ),W(1,77  ),W(1,6   ),GG ,AMP(66  ))             
     ...
     &     AMP(68  ))                                                      
      CALL IOVXXX(W(1,68  ),W(1,73  ),W(1,6   ),GG ,AMP(69  ))             
      CALL VVVXXX(W(1,6   ),W(1,75  ),W(1,30  ),G ,AMP(70  ))              
      CALL FVIXXX(W(1,43  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,79  ))     
      CALL JIOXXX(W(1,79  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,80  ))     
      CALL VVSHXX(W(1,6   ),W(1,80  ),W(1,3   ),GH ,AMP(71  ))             
      CALL FVIXXX(W(1,68  ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,81  ))     
      CALL JIOXXX(W(1,81  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,82  ))     
      CALL VVSHXX(W(1,6   ),W(1,82  ),W(1,3   ),GH ,AMP(72  ))             
      CALL FVOXXX(W(1,10  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,83  ))     
      CALL JIOXXX(W(1,4   ),W(1,83  ),GG ,ZERO    ,ZERO    ,W(1,84  ))     
      CALL VVSHXX(W(1,6   ),W(1,84  ),W(1,3   ),GH ,AMP(73  ))             
      CALL FVOXXX(W(1,1   ),W(1,16  ),GG ,BMASS   ,ZERO    ,W(1,85  ))     
      CALL JIOXXX(W(1,4   ),W(1,85  ),GG ,ZERO    ,ZERO    ,W(1,86  ))     
      CALL VVSHXX(W(1,6   ),W(1,86  ),W(1,3   ),GH ,AMP(74  ))             
      CALL FVIXXX(W(1,4   ),W(1,30  ),GG ,BMASS   ,ZERO    ,W(1,87  ))     
      CALL FVIXXX(W(1,87  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,88  ))     
      CALL IOVXXX(W(1,88  ),W(1,1   ),W(1,6   ),GG ,AMP(75  ))             
      CALL JIOXXX(W(1,87  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,89  ))     
      CALL VVVXXX(W(1,6   ),W(1,2   ),W(1,89  ),G ,AMP(76  ))              
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,90  ))     
      ...
      CALL FVOXXX(W(1,90  ),W(1,30  ),GG ,BMASS   ,ZERO    ,W(1,93  ))     
     ...
     &     AMP(80  ))                                                      
      ...
      CALL JIOXXX(W(1,43  ),W(1,90  ),GG ,ZERO    ,ZERO    ,W(1,95  ))     
     ...
     &             -AMP(  73)-AMP(  74)
      JAMP(   3) = -AMP(   2)+AMP(   3)+AMP(   5)+AMP(   6)-AMP(   7)
