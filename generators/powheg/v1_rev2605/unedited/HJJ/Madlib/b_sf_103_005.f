      SUBROUTINE SB_SF_103_005(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_103_005(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_103_005(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            9/                                       
      DATA (CF(i,1  ),i=1  ,2  ) /    -6,   10/                            
C               T[ 2, 4]T[ 1, 5]                                           
      DATA Denom(2  )/            9/                                       
      DATA (CF(i,2  ),i=1  ,2  ) /    10,   -6/                            
C               T[ 2, 5]T[ 1, 4]                                           
C ----------
C BEGIN CODE
C ----------
      ...
      CALL JIOXXX(W(1,4   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,6   ))     
      CALL JIOXXX(W(1,5   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      CALL VVSHXX(W(1,6   ),W(1,7   ),W(1,3   ),GH ,AMP(1   ))             
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_SF_103_005 =B_SF_103_005+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
