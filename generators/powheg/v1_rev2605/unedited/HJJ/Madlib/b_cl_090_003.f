...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(4,ihel).eq.-1) THEN
                 T=B_CL_090_003(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_090_003(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,6   ))     
      CALL JVSHXX(W(1,5   ),W(1,3   ),GH ,ZERO    ,ZERO    ,W(1,7   ))     
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,7   ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,2   ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,8   ))     
     ...
     &             +AMP(   8)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_090_003=B_CL_090_003 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_090_003=B_CL_090_003 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
