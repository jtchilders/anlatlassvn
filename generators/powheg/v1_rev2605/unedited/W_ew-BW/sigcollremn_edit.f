      ...
      include 'pwhg_flg.h'
      include 'pwhg_par.h'
      real * 8 xrad,rescoll(flst_nborn),www,un
      integer i !WZGRAD EDIT
      real * 8 rescoll_EW_CC(flst_nborn),powheginput !WZGRAD EDIT
      parameter (un=1d0)
...
c     begin WZGRAD EDIT-------------------------------------------------
      ...
      call sigcollremn_EW_CC(xjac1,xjac2,z1,z2,rescoll_EW_CC)
      else
         do i = 1,flst_nborn
         rescoll_EW_CC(i)=0d0
         enddo
