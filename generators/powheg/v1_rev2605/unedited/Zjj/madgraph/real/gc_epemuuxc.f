      SUBROUTINE Sgc_epemuuxc(P1,ANS)
C  
...
C  
      ...
      common/to_amps_gc_epemuuxc/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gc_epemuuxc(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION gc_epemuuxc(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,7   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,13  ))    
      ...
      CALL FVIXXX(W(1,2   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,16  ))    
      ...
      CALL FVIXXX(W(1,2   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,19  ))    
      ...
      CALL FVOXXX(W(1,7   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      ...
      CALL FVIXXX(W(1,16  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL JIOXXX(W(1,33  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,34  ),GG ,AMP(13  ))             
      CALL FVIXXX(W(1,19  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      ...
      CALL FVIXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
     ...
     &             -AMP(  47)-AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gc_epemuuxc =gc_epemuuxc+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
