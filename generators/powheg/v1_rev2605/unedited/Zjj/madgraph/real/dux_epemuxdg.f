      SUBROUTINE Sdux_epemuxdg(P1,ANS)
C  
...
C  
      ...
      common/to_amps_dux_epemuxdg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=dux_epemuxdg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION dux_epemuxdg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,5   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      ...
      CALL JIOXXX(W(1,5   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      ...
      CALL JIOXXX(W(1,5   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      ...
      CALL JIOXXX(W(1,20  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      ...
      CALL JIOXXX(W(1,51  ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,55  ),GG ,AMP(39  ))             
      CALL JIOXXX(W(1,53  ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,56  ),GG ,AMP(40  ))             
      CALL FVIXXX(W(1,20  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,57  ))    
      CALL JIOXXX(W(1,57  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,58  ),GG ,AMP(41  ))             
      CALL FVIXXX(W(1,20  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,59  ))    
     ...
     &             -AMP(  43)-AMP(  44)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          dux_epemuxdg =dux_epemuxdg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
