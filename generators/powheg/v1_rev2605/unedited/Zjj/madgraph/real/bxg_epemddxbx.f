      SUBROUTINE Sbxg_epemddxbx(P1,ANS)
C  
...
C  
C FOR PROCESS : b~ g -> e+ e- d d~ b~  
C  
C Crossing   1 is b~ g -> e+ e- d d~ b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      double precision bxg_epemddxbx
...
C  
      ...
      common/to_amps_bxg_epemddxbx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bxg_epemddxbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION bxg_epemddxbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,26  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,28  ))    
      ...
      CALL IOVXXX(W(1,6   ),W(1,49  ),W(1,8   ),GAD ,AMP(23  ))            
      CALL IOVXXX(W(1,6   ),W(1,49  ),W(1,12  ),GZD ,AMP(24  ))            
      ...
      CALL FVOXXX(W(1,5   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,50  ))    
      CALL FVOXXX(W(1,50  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,51  ))     
      CALL IOVXXX(W(1,6   ),W(1,51  ),W(1,9   ),GG ,AMP(29  ))             
      CALL FVOXXX(W(1,5   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,52  ))    
      ...
      CALL IOVXXX(W(1,6   ),W(1,66  ),W(1,8   ),GAD ,AMP(43  ))            
      CALL IOVXXX(W(1,6   ),W(1,66  ),W(1,12  ),GZD ,AMP(44  ))            
     ...
     &             +AMP(  47)+AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bxg_epemddxbx =bxg_epemddxbx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
