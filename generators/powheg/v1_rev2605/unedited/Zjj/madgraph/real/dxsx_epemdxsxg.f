      SUBROUTINE Sdxsx_epemdxsxg(P1,ANS)
C  
...
C  
      ...
      double precision dxsx_epemdxsxg
...
C  
      ...
      common/to_amps_dxsx_epemdxsxg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=dxsx_epemdxsxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION dxsx_epemdxsxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &             -AMP(  43)-AMP(  44)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          dxsx_epemdxsxg =dxsx_epemdxsxg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
