      SUBROUTINE Sbxg_epemuuxbx(P1,ANS)
C  
...
C  
C FOR PROCESS : b~ g -> e+ e- u u~ b~  
C  
C Crossing   1 is b~ g -> e+ e- u u~ b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      double precision bxg_epemuuxbx
...
C  
      ...
      common/to_amps_bxg_epemuuxbx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bxg_epemuuxbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION bxg_epemuuxbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,7   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
      CALL FVIXXX(W(1,14  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,15  ))    
      CALL JIOXXX(W(1,15  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,16  ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,14  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,17  ))    
      CALL JIOXXX(W(1,17  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,18  ),GG ,AMP(4   ))             
      CALL FVIXXX(W(1,7   ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,19  ))    
      CALL FVIXXX(W(1,19  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,20  ))     
      CALL JIOXXX(W(1,20  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,21  ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,7   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,22  ))    
      CALL FVIXXX(W(1,22  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,23  ))     
      CALL JIOXXX(W(1,23  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,24  ),GG ,AMP(6   ))             
      CALL FVOXXX(W(1,10  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      ...
      CALL IOVXXX(W(1,6   ),W(1,27  ),W(1,9   ),GG ,AMP(9   ))             
      CALL FVOXXX(W(1,26  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,28  ))    
      CALL IOVXXX(W(1,6   ),W(1,28  ),W(1,9   ),GG ,AMP(10  ))             
      CALL JIOXXX(W(1,19  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL FVOXXX(W(1,5   ),W(1,29  ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL IOVXXX(W(1,6   ),W(1,30  ),W(1,2   ),GG ,AMP(11  ))             
      CALL JIOXXX(W(1,22  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      CALL FVOXXX(W(1,5   ),W(1,31  ),GG ,ZERO    ,ZERO    ,W(1,32  ))     
      CALL IOVXXX(W(1,6   ),W(1,32  ),W(1,2   ),GG ,AMP(12  ))             
      ...
      CALL IOVXXX(W(1,6   ),W(1,35  ),W(1,2   ),GG ,AMP(13  ))             
      CALL FVOXXX(W(1,1   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,36  ))    
      CALL JIOXXX(W(1,7   ),W(1,36  ),GG ,ZERO    ,ZERO    ,W(1,37  ))     
      CALL FVOXXX(W(1,5   ),W(1,37  ),GG ,ZERO    ,ZERO    ,W(1,38  ))     
      CALL IOVXXX(W(1,6   ),W(1,38  ),W(1,2   ),GG ,AMP(14  ))             
      CALL JIOXXX(W(1,14  ),W(1,33  ),GG ,ZERO    ,ZERO    ,W(1,39  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,39  ),GG ,AMP(15  ))             
      CALL JIOXXX(W(1,14  ),W(1,36  ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,40  ),GG ,AMP(16  ))             
      CALL JVVXXX(W(1,29  ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,41  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,41  ),GG ,AMP(17  ))             
      CALL JVVXXX(W(1,31  ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,42  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,42  ),GG ,AMP(18  ))             
      CALL JVVXXX(W(1,34  ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,43  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,43  ),GG ,AMP(19  ))             
      CALL JVVXXX(W(1,37  ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,44  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,44  ),GG ,AMP(20  ))             
      CALL FVOXXX(W(1,33  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,45  ))     
      CALL JIOXXX(W(1,7   ),W(1,45  ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,46  ),GG ,AMP(21  ))             
      CALL FVOXXX(W(1,36  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,47  ))     
      CALL JIOXXX(W(1,7   ),W(1,47  ),GG ,ZERO    ,ZERO    ,W(1,48  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,48  ),GG ,AMP(22  ))             
      CALL FVOXXX(W(1,26  ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL IOVXXX(W(1,6   ),W(1,49  ),W(1,8   ),GAU ,AMP(23  ))            
      CALL IOVXXX(W(1,6   ),W(1,49  ),W(1,12  ),GZU ,AMP(24  ))            
      CALL IOVXXX(W(1,6   ),W(1,26  ),W(1,29  ),GG ,AMP(25  ))             
      CALL IOVXXX(W(1,6   ),W(1,26  ),W(1,31  ),GG ,AMP(26  ))             
      CALL IOVXXX(W(1,6   ),W(1,26  ),W(1,34  ),GG ,AMP(27  ))             
      CALL IOVXXX(W(1,6   ),W(1,26  ),W(1,37  ),GG ,AMP(28  ))             
      CALL FVOXXX(W(1,5   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,50  ))    
      CALL FVOXXX(W(1,50  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,51  ))     
      CALL IOVXXX(W(1,6   ),W(1,51  ),W(1,9   ),GG ,AMP(29  ))             
      CALL FVOXXX(W(1,5   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,52  ))    
      CALL FVOXXX(W(1,52  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,53  ))     
      CALL IOVXXX(W(1,6   ),W(1,53  ),W(1,9   ),GG ,AMP(30  ))             
      CALL FVOXXX(W(1,50  ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,54  ))     
      CALL IOVXXX(W(1,6   ),W(1,54  ),W(1,2   ),GG ,AMP(31  ))             
      CALL FVOXXX(W(1,52  ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,6   ),W(1,55  ),W(1,2   ),GG ,AMP(32  ))             
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,56  ))     
      CALL JIOXXX(W(1,19  ),W(1,56  ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,57  ),GG ,AMP(33  ))             
      CALL JIOXXX(W(1,22  ),W(1,56  ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,58  ),GG ,AMP(34  ))             
      CALL FVOXXX(W(1,56  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,59  ))    
      CALL JIOXXX(W(1,7   ),W(1,59  ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,60  ),GG ,AMP(35  ))             
      CALL FVOXXX(W(1,56  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,61  ))    
      CALL JIOXXX(W(1,7   ),W(1,61  ),GG ,ZERO    ,ZERO    ,W(1,62  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,62  ),GG ,AMP(36  ))             
      CALL JVVXXX(W(1,9   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,63  ))      
      CALL IOVXXX(W(1,6   ),W(1,50  ),W(1,63  ),GG ,AMP(37  ))             
      CALL IOVXXX(W(1,6   ),W(1,52  ),W(1,63  ),GG ,AMP(38  ))             
      CALL JIOXXX(W(1,14  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,64  ))     
      CALL IOVXXX(W(1,6   ),W(1,50  ),W(1,64  ),GG ,AMP(39  ))             
      CALL IOVXXX(W(1,6   ),W(1,52  ),W(1,64  ),GG ,AMP(40  ))             
      CALL JIOXXX(W(1,7   ),W(1,56  ),GG ,ZERO    ,ZERO    ,W(1,65  ))     
      CALL IOVXXX(W(1,6   ),W(1,50  ),W(1,65  ),GG ,AMP(41  ))             
      CALL IOVXXX(W(1,6   ),W(1,52  ),W(1,65  ),GG ,AMP(42  ))             
      CALL FVOXXX(W(1,5   ),W(1,63  ),GG ,ZERO    ,ZERO    ,W(1,66  ))     
      CALL IOVXXX(W(1,6   ),W(1,66  ),W(1,8   ),GAU ,AMP(43  ))            
      CALL IOVXXX(W(1,6   ),W(1,66  ),W(1,12  ),GZU ,AMP(44  ))            
      CALL FVOXXX(W(1,5   ),W(1,64  ),GG ,ZERO    ,ZERO    ,W(1,67  ))     
      CALL IOVXXX(W(1,6   ),W(1,67  ),W(1,8   ),GAU ,AMP(45  ))            
      CALL IOVXXX(W(1,6   ),W(1,67  ),W(1,12  ),GZU ,AMP(46  ))            
      CALL FVOXXX(W(1,5   ),W(1,65  ),GG ,ZERO    ,ZERO    ,W(1,68  ))     
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,8   ),GAU ,AMP(47  ))            
      CALL IOVXXX(W(1,6   ),W(1,68  ),W(1,12  ),GZU ,AMP(48  ))            
      JAMP(   1) = +AMP(   1)+AMP(   2)+AMP(   7)+AMP(   8)+AMP(  11)
     &             +AMP(  12)+AMP(  13)+AMP(  14)+AMP(  19)+AMP(  20)
     &             +AMP(  31)+AMP(  32)+AMP(  37)+AMP(  38)+AMP(  43)
     &             +AMP(  44)
      JAMP(   2) = +AMP(   3)+AMP(   4)+AMP(   5)+AMP(   6)+AMP(  15)
     &             +AMP(  16)-AMP(  17)-AMP(  18)+AMP(  39)+AMP(  40)
     &             +AMP(  45)+AMP(  46)
      JAMP(   3) = +AMP(   9)+AMP(  10)-AMP(  19)-AMP(  20)+AMP(  23)
     &             +AMP(  24)+AMP(  25)+AMP(  26)+AMP(  27)+AMP(  28)
     &             +AMP(  29)+AMP(  30)-AMP(  37)-AMP(  38)-AMP(  43)
     &             -AMP(  44)
      JAMP(   4) = +AMP(  17)+AMP(  18)+AMP(  21)+AMP(  22)+AMP(  33)
     &             +AMP(  34)+AMP(  35)+AMP(  36)+AMP(  41)+AMP(  42)
     &             +AMP(  47)+AMP(  48)
      bxg_epemuuxbx = 0.d0 
      DO I = 1, NCOLOR
          ZTEMP = (0.d0,0.d0)
          ...
          ENDDO
          bxg_epemuuxbx =bxg_epemuuxbx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
