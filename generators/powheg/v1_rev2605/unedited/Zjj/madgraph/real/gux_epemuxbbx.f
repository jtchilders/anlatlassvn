      SUBROUTINE Sgux_epemuxbbx(P1,ANS)
C  
...
C  
      ...
      double precision gux_epemuxbbx
...
C  
      ...
      common/to_amps_gux_epemuxbbx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gux_epemuxbbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION gux_epemuxbbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,5   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      ...
      CALL FVIXXX(W(1,19  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,22  ))    
      ...
      CALL FVOXXX(W(1,13  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL JIOXXX(W(1,5   ),W(1,26  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,27  ),GG ,AMP(10  ))             
      CALL JIOXXX(W(1,19  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      ...
      CALL JIOXXX(W(1,19  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,32  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,32  ),GG ,AMP(15  ))             
      CALL JIOXXX(W(1,19  ),W(1,13  ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,33  ),GG ,AMP(16  ))             
      CALL JIOXXX(W(1,5   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      ...
      CALL FVIXXX(W(1,5   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,48  ))    
      CALL JIOXXX(W(1,48  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL IOVXXX(W(1,9   ),W(1,6   ),W(1,49  ),GG ,AMP(33  ))             
      CALL FVIXXX(W(1,5   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,50  ))    
      ...
      CALL FVIXXX(W(1,48  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      CALL JIOXXX(W(1,56  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,57  ),GG ,AMP(39  ))             
      CALL FVIXXX(W(1,50  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
     ...
     &             +AMP(  31)+AMP(  32)+AMP(  33)+AMP(  34)
      JAMP(   2) = -AMP(   3)-AMP(   4)+AMP(   7)+AMP(   8)+AMP(  11)
     &             +AMP(  12)+AMP(  13)+AMP(  14)+AMP(  15)+AMP(  16)
     &             -AMP(  35)-AMP(  36)+AMP(  39)+AMP(  40)
      JAMP(   3) = +AMP(   3)+AMP(   4)+AMP(   9)+AMP(  10)+AMP(  35)
     ...
     &             +AMP(  27)+AMP(  28)+AMP(  37)+AMP(  38)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gux_epemuxbbx =gux_epemuxbbx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
