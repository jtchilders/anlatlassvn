      SUBROUTINE Scxg_epemuuxcx(P1,ANS)
C  
...
C  
C FOR PROCESS : c~ g -> e+ e- u u~ c~  
C  
C Crossing   1 is c~ g -> e+ e- u u~ c~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      double precision cxg_epemuuxcx
...
C  
      ...
      common/to_amps_cxg_epemuuxcx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=cxg_epemuuxcx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION cxg_epemuuxcx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,7   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL FVIXXX(W(1,14  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,15  ))    
      CALL JIOXXX(W(1,15  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,16  ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,14  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,17  ))    
      CALL JIOXXX(W(1,17  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,18  ),GG ,AMP(4   ))             
      CALL FVIXXX(W(1,7   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,19  ))    
      CALL FVIXXX(W(1,19  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL JIOXXX(W(1,20  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,21  ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,7   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,22  ))    
      CALL FVIXXX(W(1,22  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,36  ))    
      ...
      CALL FVOXXX(W(1,33  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,45  ))     
      CALL JIOXXX(W(1,7   ),W(1,45  ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,46  ),GG ,AMP(21  ))             
      CALL FVOXXX(W(1,36  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      ...
      CALL FVOXXX(W(1,56  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,59  ))    
      CALL JIOXXX(W(1,7   ),W(1,59  ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,60  ),GG ,AMP(35  ))             
      CALL FVOXXX(W(1,56  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,61  ))    
     ...
     &             +AMP(  47)+AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          cxg_epemuuxcx =cxg_epemuuxcx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
