...
C  
C FOR PROCESS : g d -> e+ e- d g g  
C  
C Crossing   1 is g d -> e+ e- d g g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_gd_epemdgg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gd_epemdgg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION gd_epemdgg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,20  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,67  ))    
      CALL JIOXXX(W(1,2   ),W(1,67  ),GG ,ZERO    ,ZERO    ,W(1,68  ))     
      CALL VVVXXX(W(1,6   ),W(1,1   ),W(1,68  ),G ,AMP(59  ))              
      CALL FVOXXX(W(1,20  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,69  ))    
     ...
     &             +AMP( 108)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gd_epemdgg =gd_epemdgg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
