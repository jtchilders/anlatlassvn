      SUBROUTINE Sug_epemubbx(P1,ANS)
C  
...
C  
C FOR PROCESS : u g -> e+ e- u b b~  
C  
C Crossing   1 is u g -> e+ e- u b b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_ug_epemubbx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=ug_epemubbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION ug_epemubbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,7   ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,10  ))    
      CALL FVIXXX(W(1,10  ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      ...
      CALL FVIXXX(W(1,13  ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,14  ),W(1,6   ),W(1,2   ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,7   ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      ...
      CALL FVIXXX(W(1,7   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,18  ))     
      CALL FVIXXX(W(1,18  ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,19  ))     
      ...
      CALL FVIXXX(W(1,7   ),W(1,20  ),GG ,BMASS   ,ZERO    ,W(1,21  ))     
      CALL IOVXXX(W(1,21  ),W(1,6   ),W(1,8   ),GAD ,AMP(7   ))            
      CALL IOVXXX(W(1,21  ),W(1,6   ),W(1,12  ),GZD ,AMP(8   ))            
      CALL FVIXXX(W(1,15  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,22  ))     
      ...
      CALL FVIXXX(W(1,18  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,23  ))    
      CALL IOVXXX(W(1,23  ),W(1,6   ),W(1,9   ),GG ,AMP(13  ))             
      CALL FVIXXX(W(1,18  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,24  ))    
      CALL IOVXXX(W(1,24  ),W(1,6   ),W(1,9   ),GG ,AMP(14  ))             
      CALL FVIXXX(W(1,10  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,25  ))     
      CALL IOVXXX(W(1,25  ),W(1,6   ),W(1,9   ),GG ,AMP(15  ))             
      CALL FVIXXX(W(1,13  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,26  ))     
      ...
      CALL FVIXXX(W(1,7   ),W(1,33  ),GG ,BMASS   ,ZERO    ,W(1,38  ))     
      CALL IOVXXX(W(1,38  ),W(1,6   ),W(1,2   ),GG ,AMP(23  ))             
      CALL FVIXXX(W(1,7   ),W(1,35  ),GG ,BMASS   ,ZERO    ,W(1,39  ))     
      ...
      CALL FVIXXX(W(1,7   ),W(1,44  ),GG ,BMASS   ,ZERO    ,W(1,45  ))     
      ...
      CALL FVIXXX(W(1,7   ),W(1,54  ),GG ,BMASS   ,ZERO    ,W(1,58  ))     
      CALL IOVXXX(W(1,58  ),W(1,6   ),W(1,2   ),GG ,AMP(39  ))             
      CALL FVIXXX(W(1,7   ),W(1,55  ),GG ,BMASS   ,ZERO    ,W(1,59  ))     
     ...
     &             -AMP(  45)-AMP(  46)-AMP(  47)-AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          ug_epemubbx =ug_epemubbx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
