      SUBROUTINE Sdxg_epemdxgg(P1,ANS)
C  
...
C  
      ...
      common/to_amps_dxg_epemdxgg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=dxg_epemdxgg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION dxg_epemdxgg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,5   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
      CALL FVOXXX(W(1,1   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,10  ))     
      CALL FVIXXX(W(1,9   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,11  ))    
      ...
      CALL FVIXXX(W(1,15  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,17  ))    
      CALL IOVXXX(W(1,17  ),W(1,1   ),W(1,6   ),GG ,AMP(4   ))             
      CALL FVIXXX(W(1,5   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL FVIXXX(W(1,18  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL FVIXXX(W(1,19  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,20  ))    
      CALL IOVXXX(W(1,20  ),W(1,1   ),W(1,6   ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,19  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,21  ))    
      CALL IOVXXX(W(1,21  ),W(1,1   ),W(1,6   ),GG ,AMP(6   ))             
      CALL JIOXXX(W(1,11  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL VVVXXX(W(1,7   ),W(1,6   ),W(1,22  ),G ,AMP(7   ))              
      CALL JIOXXX(W(1,13  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL VVVXXX(W(1,7   ),W(1,6   ),W(1,23  ),G ,AMP(8   ))              
      CALL FVIXXX(W(1,9   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL FVIXXX(W(1,24  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,25  ))    
      CALL IOVXXX(W(1,25  ),W(1,1   ),W(1,6   ),GG ,AMP(9   ))             
      CALL FVIXXX(W(1,24  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,26  ))    
      CALL IOVXXX(W(1,26  ),W(1,1   ),W(1,6   ),GG ,AMP(10  ))             
      CALL FVIXXX(W(1,11  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL IOVXXX(W(1,27  ),W(1,1   ),W(1,6   ),GG ,AMP(11  ))             
      CALL FVIXXX(W(1,13  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,28  ),W(1,1   ),W(1,6   ),GG ,AMP(12  ))             
      CALL FVOXXX(W(1,10  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,29  ))    
      CALL JIOXXX(W(1,5   ),W(1,29  ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL VVVXXX(W(1,6   ),W(1,2   ),W(1,30  ),G ,AMP(13  ))              
      CALL FVOXXX(W(1,10  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,31  ))    
      ...
      CALL JIOXXX(W(1,18  ),W(1,33  ),GG ,ZERO    ,ZERO    ,W(1,37  ))     
      CALL VVVXXX(W(1,6   ),W(1,2   ),W(1,37  ),G ,AMP(17  ))              
      CALL JIOXXX(W(1,18  ),W(1,35  ),GG ,ZERO    ,ZERO    ,W(1,38  ))     
      ...
      CALL FVOXXX(W(1,33  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
      CALL JIOXXX(W(1,5   ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL VVVXXX(W(1,6   ),W(1,2   ),W(1,42  ),G ,AMP(27  ))              
      CALL FVOXXX(W(1,35  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,43  ))     
      ...
      CALL FVOXXX(W(1,29  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      CALL IOVXXX(W(1,5   ),W(1,47  ),W(1,6   ),GG ,AMP(31  ))             
      CALL FVOXXX(W(1,31  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,48  ))     
      CALL IOVXXX(W(1,5   ),W(1,48  ),W(1,6   ),GG ,AMP(32  ))             
      CALL FVOXXX(W(1,33  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL IOVXXX(W(1,5   ),W(1,49  ),W(1,6   ),GG ,AMP(33  ))             
      CALL FVOXXX(W(1,35  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,50  ))     
      CALL IOVXXX(W(1,5   ),W(1,50  ),W(1,6   ),GG ,AMP(34  ))             
      CALL FVOXXX(W(1,33  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,51  ))     
      CALL IOVXXX(W(1,18  ),W(1,51  ),W(1,6   ),GG ,AMP(35  ))             
      CALL FVOXXX(W(1,35  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,52  ))     
      CALL IOVXXX(W(1,18  ),W(1,52  ),W(1,6   ),GG ,AMP(36  ))             
      ...
      CALL FVOXXX(W(1,41  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,5   ),W(1,55  ),W(1,6   ),GG ,AMP(39  ))             
      CALL FVOXXX(W(1,43  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      CALL IOVXXX(W(1,5   ),W(1,56  ),W(1,6   ),GG ,AMP(40  ))             
      CALL FVOXXX(W(1,51  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      CALL IOVXXX(W(1,5   ),W(1,57  ),W(1,6   ),GG ,AMP(41  ))             
      CALL FVOXXX(W(1,52  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      CALL IOVXXX(W(1,5   ),W(1,58  ),W(1,6   ),GG ,AMP(42  ))             
      CALL IOVXXX(W(1,9   ),W(1,29  ),W(1,6   ),GG ,AMP(43  ))             
      CALL IOVXXX(W(1,9   ),W(1,31  ),W(1,6   ),GG ,AMP(44  ))             
      CALL IOVXXX(W(1,15  ),W(1,33  ),W(1,6   ),GG ,AMP(45  ))             
      CALL IOVXXX(W(1,15  ),W(1,35  ),W(1,6   ),GG ,AMP(46  ))             
      CALL IOVXXX(W(1,19  ),W(1,33  ),W(1,6   ),GG ,AMP(47  ))             
      CALL IOVXXX(W(1,19  ),W(1,35  ),W(1,6   ),GG ,AMP(48  ))             
      CALL JIOXXX(W(1,9   ),W(1,33  ),GG ,ZERO    ,ZERO    ,W(1,59  ))     
      CALL VVVXXX(W(1,7   ),W(1,6   ),W(1,59  ),G ,AMP(49  ))              
      CALL JIOXXX(W(1,9   ),W(1,35  ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
      CALL VVVXXX(W(1,7   ),W(1,6   ),W(1,60  ),G ,AMP(50  ))              
      CALL IOVXXX(W(1,9   ),W(1,41  ),W(1,6   ),GG ,AMP(51  ))             
      CALL IOVXXX(W(1,9   ),W(1,43  ),W(1,6   ),GG ,AMP(52  ))             
      CALL IOVXXX(W(1,24  ),W(1,33  ),W(1,6   ),GG ,AMP(53  ))             
      CALL IOVXXX(W(1,24  ),W(1,35  ),W(1,6   ),GG ,AMP(54  ))             
      CALL FVIXXX(W(1,5   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,61  ))    
      CALL FVIXXX(W(1,61  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,62  ))     
      CALL IOVXXX(W(1,62  ),W(1,10  ),W(1,6   ),GG ,AMP(55  ))             
      CALL FVIXXX(W(1,5   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,63  ))    
      CALL FVIXXX(W(1,63  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,64  ))     
      CALL IOVXXX(W(1,64  ),W(1,10  ),W(1,6   ),GG ,AMP(56  ))             
      CALL FVIXXX(W(1,61  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,65  ))     
      CALL IOVXXX(W(1,65  ),W(1,1   ),W(1,6   ),GG ,AMP(57  ))             
      CALL FVIXXX(W(1,63  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,66  ))     
      CALL IOVXXX(W(1,66  ),W(1,1   ),W(1,6   ),GG ,AMP(58  ))             
      CALL FVIXXX(W(1,18  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,67  ))    
      CALL FVIXXX(W(1,67  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,68  ))     
      CALL IOVXXX(W(1,68  ),W(1,1   ),W(1,6   ),GG ,AMP(59  ))             
      CALL FVIXXX(W(1,18  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,69  ))    
      CALL FVIXXX(W(1,69  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,70  ))     
      CALL IOVXXX(W(1,70  ),W(1,1   ),W(1,6   ),GG ,AMP(60  ))             
      CALL JIOXXX(W(1,62  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,71  ))     
      CALL VVVXXX(W(1,7   ),W(1,6   ),W(1,71  ),G ,AMP(61  ))              
      CALL JIOXXX(W(1,64  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,72  ))     
      CALL VVVXXX(W(1,7   ),W(1,6   ),W(1,72  ),G ,AMP(62  ))              
      CALL FVIXXX(W(1,61  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,73  ))     
      CALL FVIXXX(W(1,73  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,74  ))     
      CALL IOVXXX(W(1,74  ),W(1,1   ),W(1,6   ),GG ,AMP(63  ))             
      CALL FVIXXX(W(1,63  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,75  ))     
      CALL FVIXXX(W(1,75  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,76  ))     
      CALL IOVXXX(W(1,76  ),W(1,1   ),W(1,6   ),GG ,AMP(64  ))             
      CALL FVIXXX(W(1,62  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,77  ))     
      CALL IOVXXX(W(1,77  ),W(1,1   ),W(1,6   ),GG ,AMP(65  ))             
      CALL FVIXXX(W(1,64  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,78  ))     
      CALL IOVXXX(W(1,78  ),W(1,1   ),W(1,6   ),GG ,AMP(66  ))             
      CALL JIOXXX(W(1,61  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,79  ))     
      CALL VVVXXX(W(1,6   ),W(1,2   ),W(1,79  ),G ,AMP(67  ))              
      CALL JIOXXX(W(1,63  ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,80  ))     
      CALL VVVXXX(W(1,6   ),W(1,2   ),W(1,80  ),G ,AMP(68  ))              
      CALL JIOXXX(W(1,61  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,81  ))     
      CALL VVVXXX(W(1,6   ),W(1,14  ),W(1,81  ),G ,AMP(69  ))              
      CALL JIOXXX(W(1,63  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,82  ))     
      CALL VVVXXX(W(1,6   ),W(1,14  ),W(1,82  ),G ,AMP(70  ))              
      CALL JIOXXX(W(1,67  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,83  ))     
      CALL VVVXXX(W(1,6   ),W(1,2   ),W(1,83  ),G ,AMP(71  ))              
      CALL JIOXXX(W(1,69  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,84  ))     
      ...
      CALL JIOXXX(W(1,73  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,87  ))     
      CALL VVVXXX(W(1,6   ),W(1,2   ),W(1,87  ),G ,AMP(81  ))              
      CALL JIOXXX(W(1,75  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,88  ))     
      ...
      CALL FVOXXX(W(1,10  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,91  ))     
      CALL FVOXXX(W(1,91  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,92  ))    
      CALL IOVXXX(W(1,5   ),W(1,92  ),W(1,6   ),GG ,AMP(85  ))             
      CALL FVOXXX(W(1,91  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,93  ))    
      CALL IOVXXX(W(1,5   ),W(1,93  ),W(1,6   ),GG ,AMP(86  ))             
      CALL FVOXXX(W(1,1   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,94  ))     
      CALL FVOXXX(W(1,94  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,95  ))    
      CALL IOVXXX(W(1,5   ),W(1,95  ),W(1,6   ),GG ,AMP(87  ))             
      CALL FVOXXX(W(1,94  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,96  ))    
      CALL IOVXXX(W(1,5   ),W(1,96  ),W(1,6   ),GG ,AMP(88  ))             
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,97  ))     
      CALL FVOXXX(W(1,97  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,98  ))    
      CALL IOVXXX(W(1,18  ),W(1,98  ),W(1,6   ),GG ,AMP(89  ))             
      CALL FVOXXX(W(1,97  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,99  ))    
      CALL IOVXXX(W(1,18  ),W(1,99  ),W(1,6   ),GG ,AMP(90  ))             
      ...
      CALL FVOXXX(W(1,97  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,102 ))     
      CALL FVOXXX(W(1,102 ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,103 ))    
      CALL IOVXXX(W(1,5   ),W(1,103 ),W(1,6   ),GG ,AMP(93  ))             
      CALL FVOXXX(W(1,102 ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,104 ))    
      CALL IOVXXX(W(1,5   ),W(1,104 ),W(1,6   ),GG ,AMP(94  ))             
      CALL FVOXXX(W(1,98  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,105 ))     
      CALL IOVXXX(W(1,5   ),W(1,105 ),W(1,6   ),GG ,AMP(95  ))             
      CALL FVOXXX(W(1,99  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,106 ))     
     ...
     &             -AMP(  84)
      JAMP(   3) = -AMP(   3)-AMP(   4)+AMP(   7)+AMP(   8)-AMP(   9)
     ...
     &             -AMP( 108)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          dxg_epemdxgg =dxg_epemdxgg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
