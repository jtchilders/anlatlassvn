...
C  
      ...
      common/to_amps_dd_epemddg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=dd_epemddg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION dd_epemddg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,32  ),W(1,6   ),W(1,8   ),GAD ,AMP(13  ))            
      CALL IOVXXX(W(1,32  ),W(1,6   ),W(1,12  ),GZD ,AMP(14  ))            
      CALL JIOXXX(W(1,15  ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL FVIXXX(W(1,1   ),W(1,33  ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,34  ),W(1,6   ),W(1,8   ),GAD ,AMP(15  ))            
      CALL IOVXXX(W(1,34  ),W(1,6   ),W(1,12  ),GZD ,AMP(16  ))            
      CALL JIOXXX(W(1,2   ),W(1,20  ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL FVIXXX(W(1,1   ),W(1,35  ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
      CALL IOVXXX(W(1,36  ),W(1,6   ),W(1,8   ),GAD ,AMP(17  ))            
      CALL IOVXXX(W(1,36  ),W(1,6   ),W(1,12  ),GZD ,AMP(18  ))            
      ...
      CALL FVIXXX(W(1,9   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,43  ))    
      CALL IOVXXX(W(1,43  ),W(1,6   ),W(1,31  ),GG ,AMP(25  ))             
      CALL FVIXXX(W(1,9   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,44  ))    
      CALL IOVXXX(W(1,44  ),W(1,6   ),W(1,31  ),GG ,AMP(26  ))             
      CALL FVIXXX(W(1,1   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,45  ))    
      CALL IOVXXX(W(1,45  ),W(1,6   ),W(1,33  ),GG ,AMP(27  ))             
      CALL FVIXXX(W(1,1   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,46  ))    
      ...
      CALL FVOXXX(W(1,5   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,51  ))    
      CALL JIOXXX(W(1,2   ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,52  ))     
      CALL IOVXXX(W(1,9   ),W(1,6   ),W(1,52  ),GG ,AMP(37  ))             
      CALL FVOXXX(W(1,5   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,53  ))    
      ...
      CALL FVOXXX(W(1,20  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,57  ))    
      CALL JIOXXX(W(1,2   ),W(1,57  ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,58  ),GG ,AMP(41  ))             
      CALL FVOXXX(W(1,20  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,59  ))    
      ...
      CALL IOVXXX(W(1,70  ),W(1,6   ),W(1,8   ),GAD ,AMP(49  ))            
      CALL IOVXXX(W(1,70  ),W(1,6   ),W(1,12  ),GZD ,AMP(50  ))            
      CALL JIOXXX(W(1,1   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,71  ))     
      CALL FVIXXX(W(1,15  ),W(1,71  ),GG ,ZERO    ,ZERO    ,W(1,72  ))     
      CALL IOVXXX(W(1,72  ),W(1,6   ),W(1,8   ),GAD ,AMP(51  ))            
      CALL IOVXXX(W(1,72  ),W(1,6   ),W(1,12  ),GZD ,AMP(52  ))            
      CALL JIOXXX(W(1,1   ),W(1,20  ),GG ,ZERO    ,ZERO    ,W(1,73  ))     
      CALL FVIXXX(W(1,2   ),W(1,73  ),GG ,ZERO    ,ZERO    ,W(1,74  ))     
      CALL IOVXXX(W(1,74  ),W(1,6   ),W(1,8   ),GAD ,AMP(53  ))            
      CALL IOVXXX(W(1,74  ),W(1,6   ),W(1,12  ),GZD ,AMP(54  ))            
      CALL FVIXXX(W(1,2   ),W(1,71  ),GG ,ZERO    ,ZERO    ,W(1,75  ))     
      CALL FVIXXX(W(1,75  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,76  ))    
      CALL IOVXXX(W(1,76  ),W(1,6   ),W(1,7   ),GG ,AMP(55  ))             
      CALL FVIXXX(W(1,75  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,77  ))    
      ...
      CALL IOVXXX(W(1,80  ),W(1,6   ),W(1,8   ),GAD ,AMP(59  ))            
      CALL IOVXXX(W(1,80  ),W(1,6   ),W(1,12  ),GZD ,AMP(60  ))            
     ...
     &             -AMP(  91)-AMP(  92)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          dd_epemddg =dd_epemddg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
