      SUBROUTINE Suxg_epemuxgg(P1,ANS)
C  
...
C  
      ...
      common/to_amps_uxg_epemuxgg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=uxg_epemuxgg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION uxg_epemuxgg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,9   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,11  ))    
      ...
      CALL FVIXXX(W(1,15  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,17  ))    
      ...
      CALL FVIXXX(W(1,19  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,20  ))    
      CALL IOVXXX(W(1,20  ),W(1,1   ),W(1,6   ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,19  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,21  ))    
      ...
      CALL FVIXXX(W(1,24  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,25  ))    
      CALL IOVXXX(W(1,25  ),W(1,1   ),W(1,6   ),GG ,AMP(9   ))             
      CALL FVIXXX(W(1,24  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,26  ))    
      ...
      CALL FVOXXX(W(1,10  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,29  ))    
      CALL JIOXXX(W(1,5   ),W(1,29  ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL VVVXXX(W(1,6   ),W(1,2   ),W(1,30  ),G ,AMP(13  ))              
      CALL FVOXXX(W(1,10  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,31  ))    
      ...
      CALL FVIXXX(W(1,5   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,61  ))    
      CALL FVIXXX(W(1,61  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,62  ))     
      CALL IOVXXX(W(1,62  ),W(1,10  ),W(1,6   ),GG ,AMP(55  ))             
      CALL FVIXXX(W(1,5   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,63  ))    
      ...
      CALL FVIXXX(W(1,18  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,67  ))    
      CALL FVIXXX(W(1,67  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,68  ))     
      CALL IOVXXX(W(1,68  ),W(1,1   ),W(1,6   ),GG ,AMP(59  ))             
      CALL FVIXXX(W(1,18  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,69  ))    
      ...
      CALL FVOXXX(W(1,102 ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,103 ))    
      CALL IOVXXX(W(1,5   ),W(1,103 ),W(1,6   ),GG ,AMP(93  ))             
      CALL FVOXXX(W(1,102 ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,104 ))    
     ...
     &             -AMP( 108)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          uxg_epemuxgg =uxg_epemuxgg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
