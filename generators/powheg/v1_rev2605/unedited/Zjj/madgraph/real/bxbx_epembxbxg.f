      SUBROUTINE Sbxbx_epembxbxg(P1,ANS)
C  
...
C  
      ...
      double precision bxbx_epembxbxg
...
C  
      ...
      common/to_amps_bxbx_epembxbxg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bxbx_epembxbxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION bxbx_epembxbxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,5   ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,51  ))    
      CALL JIOXXX(W(1,51  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,52  ))     
      CALL IOVXXX(W(1,6   ),W(1,9   ),W(1,52  ),GG ,AMP(37  ))             
      CALL FVIXXX(W(1,5   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,53  ))    
      ...
      CALL FVIXXX(W(1,20  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,57  ))    
      CALL JIOXXX(W(1,57  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,58  ),GG ,AMP(41  ))             
      CALL FVIXXX(W(1,20  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,59  ))    
      ...
      CALL FVIXXX(W(1,51  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,63  ))     
      CALL JIOXXX(W(1,63  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,64  ))     
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,64  ),GG ,AMP(45  ))             
      CALL FVIXXX(W(1,53  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,65  ))     
      ...
      CALL FVOXXX(W(1,15  ),W(1,71  ),GG ,BMASS   ,ZERO    ,W(1,72  ))     
      ...
      CALL FVOXXX(W(1,2   ),W(1,73  ),GG ,BMASS   ,ZERO    ,W(1,74  ))     
      CALL IOVXXX(W(1,6   ),W(1,74  ),W(1,8   ),GAD ,AMP(53  ))            
      CALL IOVXXX(W(1,6   ),W(1,74  ),W(1,12  ),GZD ,AMP(54  ))            
      CALL FVOXXX(W(1,2   ),W(1,71  ),GG ,BMASS   ,ZERO    ,W(1,75  ))     
      CALL FVOXXX(W(1,75  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,76  ))    
      CALL IOVXXX(W(1,6   ),W(1,76  ),W(1,7   ),GG ,AMP(55  ))             
      CALL FVOXXX(W(1,75  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,77  ))    
      ...
      CALL FVOXXX(W(1,2   ),W(1,79  ),GG ,BMASS   ,ZERO    ,W(1,80  ))     
      ...
      CALL FVOXXX(W(1,10  ),W(1,71  ),GG ,BMASS   ,ZERO    ,W(1,81  ))     
      CALL IOVXXX(W(1,6   ),W(1,81  ),W(1,7   ),GG ,AMP(67  ))             
      CALL FVOXXX(W(1,13  ),W(1,71  ),GG ,BMASS   ,ZERO    ,W(1,82  ))     
      ...
      CALL FVOXXX(W(1,2   ),W(1,85  ),GG ,BMASS   ,ZERO    ,W(1,89  ))     
      CALL IOVXXX(W(1,6   ),W(1,89  ),W(1,7   ),GG ,AMP(79  ))             
      CALL FVOXXX(W(1,2   ),W(1,86  ),GG ,BMASS   ,ZERO    ,W(1,90  ))     
      ...
      CALL FVOXXX(W(1,2   ),W(1,97  ),GG ,BMASS   ,ZERO    ,W(1,101 ))     
      CALL IOVXXX(W(1,6   ),W(1,101 ),W(1,7   ),GG ,AMP(91  ))             
      CALL FVOXXX(W(1,2   ),W(1,98  ),GG ,BMASS   ,ZERO    ,W(1,102 ))     
     ...
     &             -AMP(  91)-AMP(  92)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bxbx_epembxbxg =bxbx_epembxbxg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
