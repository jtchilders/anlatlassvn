      SUBROUTINE Sbxg_epembxgg(P1,ANS)
C  
...
C  
      ...
      common/to_amps_bxg_epembxgg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bxg_epembxgg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION bxg_epembxgg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,5   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,9   ))     
      CALL FVOXXX(W(1,1   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,10  ))     
      CALL FVIXXX(W(1,9   ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,11  ))    
      ...
      CALL FVIXXX(W(1,5   ),W(1,14  ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      ...
      CALL FVIXXX(W(1,5   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,18  ))     
      CALL FVIXXX(W(1,18  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,19  ))     
      CALL FVIXXX(W(1,19  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,20  ))    
      CALL IOVXXX(W(1,20  ),W(1,1   ),W(1,6   ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,19  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,21  ))    
      ...
      CALL FVIXXX(W(1,9   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,24  ))     
      CALL FVIXXX(W(1,24  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,25  ))    
      CALL IOVXXX(W(1,25  ),W(1,1   ),W(1,6   ),GG ,AMP(9   ))             
      CALL FVIXXX(W(1,24  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,26  ))    
      CALL IOVXXX(W(1,26  ),W(1,1   ),W(1,6   ),GG ,AMP(10  ))             
      CALL FVIXXX(W(1,11  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,27  ))     
      CALL IOVXXX(W(1,27  ),W(1,1   ),W(1,6   ),GG ,AMP(11  ))             
      CALL FVIXXX(W(1,13  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,28  ),W(1,1   ),W(1,6   ),GG ,AMP(12  ))             
      CALL FVOXXX(W(1,10  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,29  ))    
      CALL JIOXXX(W(1,5   ),W(1,29  ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL VVVXXX(W(1,6   ),W(1,2   ),W(1,30  ),G ,AMP(13  ))              
      CALL FVOXXX(W(1,10  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,31  ))    
      ...
      CALL FVOXXX(W(1,33  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,41  ))     
      CALL JIOXXX(W(1,5   ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL VVVXXX(W(1,6   ),W(1,2   ),W(1,42  ),G ,AMP(27  ))              
      CALL FVOXXX(W(1,35  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,43  ))     
      ...
      CALL FVOXXX(W(1,29  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,47  ))     
      CALL IOVXXX(W(1,5   ),W(1,47  ),W(1,6   ),GG ,AMP(31  ))             
      CALL FVOXXX(W(1,31  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,48  ))     
      CALL IOVXXX(W(1,5   ),W(1,48  ),W(1,6   ),GG ,AMP(32  ))             
      CALL FVOXXX(W(1,33  ),W(1,14  ),GG ,BMASS   ,ZERO    ,W(1,49  ))     
      CALL IOVXXX(W(1,5   ),W(1,49  ),W(1,6   ),GG ,AMP(33  ))             
      CALL FVOXXX(W(1,35  ),W(1,14  ),GG ,BMASS   ,ZERO    ,W(1,50  ))     
      CALL IOVXXX(W(1,5   ),W(1,50  ),W(1,6   ),GG ,AMP(34  ))             
      CALL FVOXXX(W(1,33  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,51  ))     
      CALL IOVXXX(W(1,18  ),W(1,51  ),W(1,6   ),GG ,AMP(35  ))             
      CALL FVOXXX(W(1,35  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,52  ))     
      ...
      CALL FVOXXX(W(1,41  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,5   ),W(1,55  ),W(1,6   ),GG ,AMP(39  ))             
      CALL FVOXXX(W(1,43  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,56  ))     
      ...
      CALL FVIXXX(W(1,61  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,62  ))     
      ...
      CALL FVIXXX(W(1,61  ),W(1,14  ),GG ,BMASS   ,ZERO    ,W(1,65  ))     
      CALL IOVXXX(W(1,65  ),W(1,1   ),W(1,6   ),GG ,AMP(57  ))             
      CALL FVIXXX(W(1,63  ),W(1,14  ),GG ,BMASS   ,ZERO    ,W(1,66  ))     
      CALL IOVXXX(W(1,66  ),W(1,1   ),W(1,6   ),GG ,AMP(58  ))             
      CALL FVIXXX(W(1,18  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,67  ))    
      CALL FVIXXX(W(1,67  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,68  ))     
      CALL IOVXXX(W(1,68  ),W(1,1   ),W(1,6   ),GG ,AMP(59  ))             
      CALL FVIXXX(W(1,18  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,69  ))    
      ...
      CALL FVIXXX(W(1,73  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,74  ))     
      CALL IOVXXX(W(1,74  ),W(1,1   ),W(1,6   ),GG ,AMP(63  ))             
      CALL FVIXXX(W(1,63  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,75  ))     
      CALL FVIXXX(W(1,75  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,76  ))     
      CALL IOVXXX(W(1,76  ),W(1,1   ),W(1,6   ),GG ,AMP(64  ))             
      CALL FVIXXX(W(1,62  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,77  ))     
      CALL IOVXXX(W(1,77  ),W(1,1   ),W(1,6   ),GG ,AMP(65  ))             
      CALL FVIXXX(W(1,64  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,78  ))     
      ...
      CALL FVOXXX(W(1,10  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,91  ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,14  ),GG ,BMASS   ,ZERO    ,W(1,94  ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,97  ))     
     ...
     &             -AMP( 108)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bxg_epembxgg =bxg_epembxgg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
