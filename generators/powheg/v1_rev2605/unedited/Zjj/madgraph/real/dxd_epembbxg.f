      SUBROUTINE Sdxd_epembbxg(P1,ANS)
C  
...
C  
C FOR PROCESS : d~ d -> e+ e- b b~ g  
C  
C Crossing   1 is d~ d -> e+ e- b b~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_dxd_epembbxg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=dxd_epembbxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION dxd_epembbxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,13  ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      ...
      CALL JIOXXX(W(1,10  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL IOVXXX(W(1,6   ),W(1,20  ),W(1,21  ),GG ,AMP(5   ))             
      CALL JIOXXX(W(1,13  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL IOVXXX(W(1,6   ),W(1,20  ),W(1,22  ),GG ,AMP(6   ))             
      CALL FVOXXX(W(1,5   ),W(1,21  ),GG ,BMASS   ,ZERO    ,W(1,23  ))     
      CALL IOVXXX(W(1,6   ),W(1,23  ),W(1,7   ),GG ,AMP(7   ))             
      CALL FVOXXX(W(1,5   ),W(1,22  ),GG ,BMASS   ,ZERO    ,W(1,24  ))     
      ...
      CALL FVOXXX(W(1,9   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,31  ))    
      CALL JIOXXX(W(1,2   ),W(1,31  ),GG ,ZERO    ,ZERO    ,W(1,32  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,32  ),GG ,AMP(13  ))             
      CALL FVOXXX(W(1,9   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,33  ))    
      CALL JIOXXX(W(1,2   ),W(1,33  ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,34  ),GG ,AMP(14  ))             
      CALL FVOXXX(W(1,1   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,35  ))    
      CALL JIOXXX(W(1,15  ),W(1,35  ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,36  ),GG ,AMP(15  ))             
      CALL FVOXXX(W(1,1   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,37  ))    
      CALL JIOXXX(W(1,15  ),W(1,37  ),GG ,ZERO    ,ZERO    ,W(1,38  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,38  ),GG ,AMP(16  ))             
      CALL JIOXXX(W(1,2   ),W(1,35  ),GG ,ZERO    ,ZERO    ,W(1,39  ))     
      CALL IOVXXX(W(1,6   ),W(1,20  ),W(1,39  ),GG ,AMP(17  ))             
      CALL JIOXXX(W(1,2   ),W(1,37  ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
      CALL IOVXXX(W(1,6   ),W(1,20  ),W(1,40  ),GG ,AMP(18  ))             
      CALL FVOXXX(W(1,5   ),W(1,39  ),GG ,BMASS   ,ZERO    ,W(1,41  ))     
      CALL IOVXXX(W(1,6   ),W(1,41  ),W(1,7   ),GG ,AMP(19  ))             
      CALL FVOXXX(W(1,5   ),W(1,40  ),GG ,BMASS   ,ZERO    ,W(1,42  ))     
      ...
      CALL FVOXXX(W(1,5   ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,49  ))    
      CALL JIOXXX(W(1,2   ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,50  ))     
      CALL IOVXXX(W(1,6   ),W(1,49  ),W(1,50  ),GG ,AMP(25  ))             
      CALL FVOXXX(W(1,5   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,51  ))    
      CALL IOVXXX(W(1,6   ),W(1,51  ),W(1,50  ),GG ,AMP(26  ))             
      CALL JIOXXX(W(1,15  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,52  ))     
      CALL IOVXXX(W(1,6   ),W(1,49  ),W(1,52  ),GG ,AMP(27  ))             
      CALL IOVXXX(W(1,6   ),W(1,51  ),W(1,52  ),GG ,AMP(28  ))             
      CALL JIOXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,53  ))     
      CALL FVOXXX(W(1,20  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,54  ))    
      CALL IOVXXX(W(1,6   ),W(1,54  ),W(1,53  ),GG ,AMP(29  ))             
      CALL FVOXXX(W(1,20  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,55  ))    
      CALL IOVXXX(W(1,6   ),W(1,55  ),W(1,53  ),GG ,AMP(30  ))             
      CALL FVOXXX(W(1,49  ),W(1,53  ),GG ,BMASS   ,ZERO    ,W(1,56  ))     
      CALL IOVXXX(W(1,6   ),W(1,56  ),W(1,7   ),GG ,AMP(31  ))             
      CALL FVOXXX(W(1,51  ),W(1,53  ),GG ,BMASS   ,ZERO    ,W(1,57  ))     
      ...
      CALL FVOXXX(W(1,5   ),W(1,58  ),GG ,BMASS   ,ZERO    ,W(1,67  ))     
      CALL IOVXXX(W(1,6   ),W(1,67  ),W(1,8   ),GAD ,AMP(45  ))            
      CALL IOVXXX(W(1,6   ),W(1,67  ),W(1,12  ),GZD ,AMP(46  ))            
      CALL FVOXXX(W(1,64  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,68  ))     
     ...
     &             +AMP(  32)+AMP(  43)+AMP(  44)+AMP(  47)+AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          dxd_epembbxg =dxd_epembbxg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
