      SUBROUTINE Sgdx_epemdxssx(P1,ANS)
C  
...
C  
      ...
      double precision gdx_epemdxssx
...
C  
      ...
      common/to_amps_gdx_epemdxssx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gdx_epemdxssx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION gdx_epemdxssx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &             +AMP(  27)+AMP(  28)+AMP(  37)+AMP(  38)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gdx_epemdxssx =gdx_epemdxssx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
