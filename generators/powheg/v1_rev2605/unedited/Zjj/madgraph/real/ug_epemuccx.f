      SUBROUTINE Sug_epemuccx(P1,ANS)
C  
...
C  
C FOR PROCESS : u g -> e+ e- u c c~  
C  
C Crossing   1 is u g -> e+ e- u c c~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_ug_epemuccx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=ug_epemuccx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION ug_epemuccx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,7   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,10  ))    
      ...
      CALL FVIXXX(W(1,7   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,13  ))    
      ...
      CALL IOVXXX(W(1,19  ),W(1,6   ),W(1,8   ),GAU ,AMP(5   ))            
      CALL IOVXXX(W(1,19  ),W(1,6   ),W(1,12  ),GZU ,AMP(6   ))            
      CALL JVVXXX(W(1,9   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,20  ))      
      CALL FVIXXX(W(1,7   ),W(1,20  ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL IOVXXX(W(1,21  ),W(1,6   ),W(1,8   ),GAU ,AMP(7   ))            
      CALL IOVXXX(W(1,21  ),W(1,6   ),W(1,12  ),GZU ,AMP(8   ))            
      CALL FVIXXX(W(1,15  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL IOVXXX(W(1,22  ),W(1,6   ),W(1,8   ),GAU ,AMP(9   ))            
      CALL IOVXXX(W(1,22  ),W(1,6   ),W(1,12  ),GZU ,AMP(10  ))            
      CALL IOVXXX(W(1,10  ),W(1,6   ),W(1,20  ),GG ,AMP(11  ))             
      CALL IOVXXX(W(1,13  ),W(1,6   ),W(1,20  ),GG ,AMP(12  ))             
      CALL FVIXXX(W(1,18  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,23  ))    
      CALL IOVXXX(W(1,23  ),W(1,6   ),W(1,9   ),GG ,AMP(13  ))             
      CALL FVIXXX(W(1,18  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,24  ))    
      ...
      CALL IOVXXX(W(1,45  ),W(1,6   ),W(1,8   ),GAU ,AMP(27  ))            
      CALL IOVXXX(W(1,45  ),W(1,6   ),W(1,12  ),GZU ,AMP(28  ))            
     ...
     &             -AMP(  45)-AMP(  46)-AMP(  47)-AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          ug_epemuccx =ug_epemuccx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
