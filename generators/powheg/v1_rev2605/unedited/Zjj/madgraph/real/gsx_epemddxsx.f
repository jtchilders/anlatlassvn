      SUBROUTINE Sgsx_epemddxsx(P1,ANS)
C  
...
C  
C FOR PROCESS : g s~ -> e+ e- d d~ s~  
C  
C Crossing   1 is g s~ -> e+ e- d d~ s~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      double precision gsx_epemddxsx
...
C  
      ...
      common/to_amps_gsx_epemddxsx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gsx_epemddxsx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION gsx_epemddxsx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,22  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,24  ))    
      CALL IOVXXX(W(1,6   ),W(1,24  ),W(1,23  ),GG ,AMP(5   ))             
      CALL FVOXXX(W(1,22  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,25  ))    
      ...
      CALL IOVXXX(W(1,6   ),W(1,37  ),W(1,8   ),GAD ,AMP(15  ))            
      CALL IOVXXX(W(1,6   ),W(1,37  ),W(1,12  ),GZD ,AMP(16  ))            
      ...
      CALL FVOXXX(W(1,38  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,39  ))    
      CALL IOVXXX(W(1,6   ),W(1,39  ),W(1,1   ),GG ,AMP(21  ))             
      CALL FVOXXX(W(1,38  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,40  ))    
      ...
      CALL IOVXXX(W(1,6   ),W(1,49  ),W(1,8   ),GAD ,AMP(27  ))            
      CALL IOVXXX(W(1,6   ),W(1,49  ),W(1,12  ),GZD ,AMP(28  ))            
     ...
     &             +AMP(  47)+AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gsx_epemddxsx =gsx_epemddxsx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
