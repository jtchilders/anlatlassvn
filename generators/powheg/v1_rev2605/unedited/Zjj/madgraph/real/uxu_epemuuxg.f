      SUBROUTINE Suxu_epemuuxg(P1,ANS)
C  
...
C  
      ...
      common/to_amps_uxu_epemuuxg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=uxu_epemuuxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION uxu_epemuuxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,5   ),W(1,73  ),GG ,ZERO    ,ZERO    ,W(1,75  ))     
      CALL IOVXXX(W(1,6   ),W(1,75  ),W(1,7   ),GG ,AMP(55  ))             
      CALL FVOXXX(W(1,5   ),W(1,74  ),GG ,ZERO    ,ZERO    ,W(1,76  ))     
      ...
      CALL FVOXXX(W(1,5   ),W(1,85  ),GG ,ZERO    ,ZERO    ,W(1,87  ))     
      CALL IOVXXX(W(1,6   ),W(1,87  ),W(1,7   ),GG ,AMP(67  ))             
      CALL FVOXXX(W(1,5   ),W(1,86  ),GG ,ZERO    ,ZERO    ,W(1,88  ))     
      ...
      CALL FVOXXX(W(1,51  ),W(1,95  ),GG ,ZERO    ,ZERO    ,W(1,96  ))     
      CALL IOVXXX(W(1,6   ),W(1,96  ),W(1,7   ),GG ,AMP(79  ))             
      CALL FVOXXX(W(1,53  ),W(1,95  ),GG ,ZERO    ,ZERO    ,W(1,97  ))     
      ...
      CALL FVOXXX(W(1,5   ),W(1,93  ),GG ,ZERO    ,ZERO    ,W(1,99  ))     
      CALL IOVXXX(W(1,6   ),W(1,99  ),W(1,8   ),GAU ,AMP(85  ))            
      CALL IOVXXX(W(1,6   ),W(1,99  ),W(1,12  ),GZU ,AMP(86  ))            
      CALL FVOXXX(W(1,5   ),W(1,94  ),GG ,ZERO    ,ZERO    ,W(1,100 ))     
      CALL IOVXXX(W(1,6   ),W(1,100 ),W(1,8   ),GAU ,AMP(87  ))            
      CALL IOVXXX(W(1,6   ),W(1,100 ),W(1,12  ),GZU ,AMP(88  ))            
      CALL FVOXXX(W(1,20  ),W(1,95  ),GG ,ZERO    ,ZERO    ,W(1,101 ))     
      CALL IOVXXX(W(1,6   ),W(1,101 ),W(1,8   ),GAU ,AMP(89  ))            
      CALL IOVXXX(W(1,6   ),W(1,101 ),W(1,12  ),GZU ,AMP(90  ))            
      CALL FVOXXX(W(1,5   ),W(1,95  ),GG ,ZERO    ,ZERO    ,W(1,102 ))     
      ...
      CALL FVOXXX(W(1,5   ),W(1,98  ),GG ,ZERO    ,ZERO    ,W(1,105 ))     
     ...
     &             +AMP(  80)+AMP(  91)+AMP(  92)+AMP(  95)+AMP(  96)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          uxu_epemuuxg =uxu_epemuuxg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
