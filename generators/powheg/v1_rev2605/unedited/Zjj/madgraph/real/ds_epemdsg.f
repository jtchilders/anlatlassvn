...
C  
C FOR PROCESS : d s -> e+ e- d s g  
C  
C Crossing   1 is d s -> e+ e- d s g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_ds_epemdsg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=ds_epemdsg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION ds_epemdsg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,2   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      ...
      CALL FVIXXX(W(1,14  ),W(1,13  ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      ...
      CALL FVIXXX(W(1,2   ),W(1,13  ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      ...
      CALL FVIXXX(W(1,19  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      ...
      CALL FVIXXX(W(1,2   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,25  ))    
      CALL IOVXXX(W(1,25  ),W(1,6   ),W(1,10  ),GG ,AMP(13  ))             
      CALL FVIXXX(W(1,2   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,26  ))    
      CALL IOVXXX(W(1,26  ),W(1,6   ),W(1,10  ),GG ,AMP(14  ))             
      CALL FVIXXX(W(1,14  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,27  ))    
      CALL IOVXXX(W(1,27  ),W(1,6   ),W(1,13  ),GG ,AMP(15  ))             
      CALL FVIXXX(W(1,14  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,28  ))    
      ...
      CALL FVIXXX(W(1,25  ),W(1,13  ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      ...
      CALL FVIXXX(W(1,25  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      CALL IOVXXX(W(1,31  ),W(1,6   ),W(1,13  ),GG ,AMP(21  ))             
      CALL FVIXXX(W(1,26  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,32  ))     
      ...
      CALL FVIXXX(W(1,2   ),W(1,38  ),GG ,ZERO    ,ZERO    ,W(1,43  ))     
      CALL IOVXXX(W(1,43  ),W(1,6   ),W(1,7   ),GG ,AMP(31  ))             
      CALL FVIXXX(W(1,2   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,44  ))     
      ...
      CALL FVIXXX(W(1,2   ),W(1,55  ),GG ,ZERO    ,ZERO    ,W(1,61  ))     
      CALL IOVXXX(W(1,61  ),W(1,6   ),W(1,7   ),GG ,AMP(43  ))             
      CALL FVIXXX(W(1,2   ),W(1,56  ),GG ,ZERO    ,ZERO    ,W(1,62  ))     
     ...
     &             -AMP(  43)-AMP(  44)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          ds_epemdsg =ds_epemdsg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
