      SUBROUTINE Sdxdx_epemdxdxg(P1,ANS)
C  
...
C  
      ...
      double precision dxdx_epemdxdxg
...
C  
      ...
      common/to_amps_dxdx_epemdxdxg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=dxdx_epemdxdxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION dxdx_epemdxdxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,9   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,43  ))    
      CALL IOVXXX(W(1,6   ),W(1,43  ),W(1,31  ),GG ,AMP(25  ))             
      CALL FVOXXX(W(1,9   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,44  ))    
      CALL IOVXXX(W(1,6   ),W(1,44  ),W(1,31  ),GG ,AMP(26  ))             
      CALL FVOXXX(W(1,1   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,45  ))    
      CALL IOVXXX(W(1,6   ),W(1,45  ),W(1,33  ),GG ,AMP(27  ))             
      CALL FVOXXX(W(1,1   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,46  ))    
     ...
     &             -AMP(  91)-AMP(  92)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          dxdx_epemdxdxg =dxdx_epemdxdxg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
