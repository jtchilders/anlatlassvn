      SUBROUTINE Sgbx_epemuuxbx(P1,ANS)
C  
...
C  
      ...
      double precision gbx_epemuuxbx
...
C  
      ...
      common/to_amps_gbx_epemuuxbx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gbx_epemuuxbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION gbx_epemuuxbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,2   ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,16  ))    
      ...
      CALL FVOXXX(W(1,2   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,19  ))    
      ...
      CALL FVOXXX(W(1,16  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,33  ))     
      CALL JIOXXX(W(1,7   ),W(1,33  ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,34  ),GG ,AMP(13  ))             
      CALL FVOXXX(W(1,19  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,35  ))     
      ...
      CALL FVOXXX(W(1,2   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,56  ))     
     ...
     &             +AMP(  47)+AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gbx_epemuuxbx =gbx_epemuuxbx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
