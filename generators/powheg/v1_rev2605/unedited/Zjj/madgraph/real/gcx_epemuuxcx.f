      SUBROUTINE Sgcx_epemuuxcx(P1,ANS)
C  
...
C  
C FOR PROCESS : g c~ -> e+ e- u u~ c~  
C  
C Crossing   1 is g c~ -> e+ e- u u~ c~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      double precision gcx_epemuuxcx
...
C  
      ...
      common/to_amps_gcx_epemuuxcx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gcx_epemuuxcx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION gcx_epemuuxcx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,5   ),W(1,10  ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      ...
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,1   ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,2   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,16  ))    
      ...
      CALL FVOXXX(W(1,2   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,19  ))    
      CALL JIOXXX(W(1,7   ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL FVOXXX(W(1,5   ),W(1,20  ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL IOVXXX(W(1,6   ),W(1,21  ),W(1,1   ),GG ,AMP(4   ))             
      CALL FVOXXX(W(1,5   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL JIOXXX(W(1,7   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL FVOXXX(W(1,22  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,24  ))    
      CALL IOVXXX(W(1,6   ),W(1,24  ),W(1,23  ),GG ,AMP(5   ))             
      CALL FVOXXX(W(1,22  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,25  ))    
      CALL IOVXXX(W(1,6   ),W(1,25  ),W(1,23  ),GG ,AMP(6   ))             
      CALL FVIXXX(W(1,7   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL JIOXXX(W(1,26  ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,27  ),GG ,AMP(7   ))             
      CALL JIOXXX(W(1,26  ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,28  ),GG ,AMP(8   ))             
      CALL JVVXXX(W(1,10  ),W(1,1   ),G ,ZERO    ,ZERO    ,W(1,29  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,29  ),GG ,AMP(9   ))             
      CALL JVVXXX(W(1,14  ),W(1,1   ),G ,ZERO    ,ZERO    ,W(1,30  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,30  ),GG ,AMP(10  ))             
      CALL JVVXXX(W(1,17  ),W(1,1   ),G ,ZERO    ,ZERO    ,W(1,31  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,31  ),GG ,AMP(11  ))             
      CALL JVVXXX(W(1,20  ),W(1,1   ),G ,ZERO    ,ZERO    ,W(1,32  ))      
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,32  ),GG ,AMP(12  ))             
      CALL FVOXXX(W(1,16  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL JIOXXX(W(1,7   ),W(1,33  ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,34  ),GG ,AMP(13  ))             
      CALL FVOXXX(W(1,19  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL JIOXXX(W(1,7   ),W(1,35  ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,36  ),GG ,AMP(14  ))             
      CALL FVOXXX(W(1,22  ),W(1,23  ),GG ,ZERO    ,ZERO    ,W(1,37  ))     
      CALL IOVXXX(W(1,6   ),W(1,37  ),W(1,8   ),GAU ,AMP(15  ))            
      CALL IOVXXX(W(1,6   ),W(1,37  ),W(1,12  ),GZU ,AMP(16  ))            
      CALL IOVXXX(W(1,6   ),W(1,22  ),W(1,10  ),GG ,AMP(17  ))             
      CALL IOVXXX(W(1,6   ),W(1,22  ),W(1,14  ),GG ,AMP(18  ))             
      CALL IOVXXX(W(1,6   ),W(1,22  ),W(1,17  ),GG ,AMP(19  ))             
      CALL IOVXXX(W(1,6   ),W(1,22  ),W(1,20  ),GG ,AMP(20  ))             
      CALL FVOXXX(W(1,5   ),W(1,23  ),GG ,ZERO    ,ZERO    ,W(1,38  ))     
      CALL FVOXXX(W(1,38  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,39  ))    
      CALL IOVXXX(W(1,6   ),W(1,39  ),W(1,1   ),GG ,AMP(21  ))             
      CALL FVOXXX(W(1,38  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,40  ))    
      CALL IOVXXX(W(1,6   ),W(1,40  ),W(1,1   ),GG ,AMP(22  ))             
      CALL FVIXXX(W(1,26  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,41  ))    
      CALL JIOXXX(W(1,41  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,42  ),GG ,AMP(23  ))             
      CALL FVIXXX(W(1,26  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,43  ))    
      CALL JIOXXX(W(1,43  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,44  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,44  ),GG ,AMP(24  ))             
      CALL FVIXXX(W(1,9   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,45  ))     
      CALL JIOXXX(W(1,45  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,46  ),GG ,AMP(25  ))             
      CALL FVIXXX(W(1,13  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      CALL JIOXXX(W(1,47  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,48  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,48  ),GG ,AMP(26  ))             
      CALL FVOXXX(W(1,38  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL IOVXXX(W(1,6   ),W(1,49  ),W(1,8   ),GAU ,AMP(27  ))            
      CALL IOVXXX(W(1,6   ),W(1,49  ),W(1,12  ),GZU ,AMP(28  ))            
      CALL FVOXXX(W(1,5   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,50  ))    
      CALL FVOXXX(W(1,50  ),W(1,23  ),GG ,ZERO    ,ZERO    ,W(1,51  ))     
      CALL IOVXXX(W(1,6   ),W(1,51  ),W(1,1   ),GG ,AMP(29  ))             
      CALL FVOXXX(W(1,5   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,52  ))    
      CALL FVOXXX(W(1,52  ),W(1,23  ),GG ,ZERO    ,ZERO    ,W(1,53  ))     
      CALL IOVXXX(W(1,6   ),W(1,53  ),W(1,1   ),GG ,AMP(30  ))             
      CALL FVOXXX(W(1,50  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,54  ))     
      CALL IOVXXX(W(1,6   ),W(1,54  ),W(1,23  ),GG ,AMP(31  ))             
      CALL FVOXXX(W(1,52  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,6   ),W(1,55  ),W(1,23  ),GG ,AMP(32  ))             
      CALL FVOXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      CALL JIOXXX(W(1,9   ),W(1,56  ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,57  ),GG ,AMP(33  ))             
      CALL JIOXXX(W(1,13  ),W(1,56  ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      ...
      CALL JIOXXX(W(1,26  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,63  ))     
      CALL IOVXXX(W(1,6   ),W(1,50  ),W(1,63  ),GG ,AMP(37  ))             
      CALL IOVXXX(W(1,6   ),W(1,52  ),W(1,63  ),GG ,AMP(38  ))             
      CALL JVVXXX(W(1,1   ),W(1,23  ),G ,ZERO    ,ZERO    ,W(1,64  ))      
     ...
     &             +AMP(  12)+AMP(  21)+AMP(  22)+AMP(  27)+AMP(  28)
     &             +AMP(  29)+AMP(  30)-AMP(  39)-AMP(  40)-AMP(  45)
     &             -AMP(  46)
      JAMP(   2) = +AMP(   5)+AMP(   6)-AMP(  11)-AMP(  12)+AMP(  15)
     &             +AMP(  16)+AMP(  17)+AMP(  18)+AMP(  19)+AMP(  20)
     &             +AMP(  31)+AMP(  32)+AMP(  39)+AMP(  40)+AMP(  45)
     &             +AMP(  46)
      JAMP(   3) = +AMP(   7)+AMP(   8)-AMP(   9)-AMP(  10)+AMP(  23)
     &             +AMP(  24)+AMP(  25)+AMP(  26)+AMP(  37)+AMP(  38)
     &             +AMP(  43)+AMP(  44)
      JAMP(   4) = +AMP(   9)+AMP(  10)+AMP(  13)+AMP(  14)+AMP(  33)
     ...
     &             +AMP(  47)+AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gcx_epemuuxcx =gcx_epemuuxcx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
