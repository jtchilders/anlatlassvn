...
C  
      ...
      common/to_amps_uc_epemucg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=uc_epemucg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION uc_epemucg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,11  ),W(1,6   ),W(1,8   ),GAU ,AMP(1   ))            
      CALL JIOXXX(W(1,3   ),W(1,4   ),GZL ,ZMASS   ,ZWIDTH  ,W(1,12  ))    
      CALL IOVXXX(W(1,11  ),W(1,6   ),W(1,12  ),GZU ,AMP(2   ))            
      ...
      CALL IOVXXX(W(1,15  ),W(1,6   ),W(1,8   ),GAU ,AMP(3   ))            
      CALL IOVXXX(W(1,15  ),W(1,6   ),W(1,12  ),GZU ,AMP(4   ))            
      ...
      CALL IOVXXX(W(1,18  ),W(1,6   ),W(1,8   ),GAU ,AMP(5   ))            
      CALL IOVXXX(W(1,18  ),W(1,6   ),W(1,12  ),GZU ,AMP(6   ))            
      ...
      CALL IOVXXX(W(1,24  ),W(1,6   ),W(1,8   ),GAU ,AMP(11  ))            
      CALL IOVXXX(W(1,24  ),W(1,6   ),W(1,12  ),GZU ,AMP(12  ))            
      CALL FVIXXX(W(1,2   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,25  ))    
      CALL IOVXXX(W(1,25  ),W(1,6   ),W(1,10  ),GG ,AMP(13  ))             
      CALL FVIXXX(W(1,2   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,26  ))    
      CALL IOVXXX(W(1,26  ),W(1,6   ),W(1,10  ),GG ,AMP(14  ))             
      CALL FVIXXX(W(1,14  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,27  ))    
      CALL IOVXXX(W(1,27  ),W(1,6   ),W(1,13  ),GG ,AMP(15  ))             
      CALL FVIXXX(W(1,14  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,28  ))    
     ...
     &             -AMP(  43)-AMP(  44)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          uc_epemucg =uc_epemucg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
