      SUBROUTINE Sgd_epemuuxd(P1,ANS)
C  
...
C  
      ...
      common/to_amps_gd_epemuuxd/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gd_epemuuxd(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION gd_epemuuxd(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,7   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,13  ))    
      ...
      CALL FVIXXX(W(1,2   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,16  ))    
      ...
      CALL FVIXXX(W(1,2   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,19  ))    
      ...
      CALL FVOXXX(W(1,26  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,41  ))    
      CALL JIOXXX(W(1,2   ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,42  ),GG ,AMP(23  ))             
      CALL FVOXXX(W(1,26  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,43  ))    
     ...
     &             -AMP(  47)-AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gd_epemuuxd =gd_epemuuxd+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
