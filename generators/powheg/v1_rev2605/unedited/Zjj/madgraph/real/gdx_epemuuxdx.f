      SUBROUTINE Sgdx_epemuuxdx(P1,ANS)
C  
...
C  
C FOR PROCESS : g d~ -> e+ e- u u~ d~  
C  
C Crossing   1 is g d~ -> e+ e- u u~ d~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      double precision gdx_epemuuxdx
...
C  
      ...
      common/to_amps_gdx_epemuuxdx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gdx_epemuuxdx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION gdx_epemuuxdx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,2   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,16  ))    
      ...
      CALL FVOXXX(W(1,2   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,19  ))    
      ...
      CALL FVIXXX(W(1,26  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,41  ))    
      CALL JIOXXX(W(1,41  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,42  ),GG ,AMP(23  ))             
      CALL FVIXXX(W(1,26  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,43  ))    
     ...
     &             +AMP(  47)+AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gdx_epemuuxdx =gdx_epemuuxdx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
