      SUBROUTINE Sug_epemuddx(P1,ANS)
C  
...
C  
C FOR PROCESS : u g -> e+ e- u d d~  
C  
C Crossing   1 is u g -> e+ e- u d d~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_ug_epemuddx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=ug_epemuddx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION ug_epemuddx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,7   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,10  ))    
      CALL FVIXXX(W(1,10  ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,11  ),W(1,6   ),W(1,2   ),GG ,AMP(1   ))             
      CALL JIOXXX(W(1,3   ),W(1,4   ),GZL ,ZMASS   ,ZWIDTH  ,W(1,12  ))    
      CALL FVIXXX(W(1,7   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,13  ))    
      CALL FVIXXX(W(1,13  ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,14  ),W(1,6   ),W(1,2   ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,7   ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL FVIXXX(W(1,15  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,16  ))    
      CALL IOVXXX(W(1,16  ),W(1,6   ),W(1,2   ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,15  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,17  ))    
      CALL IOVXXX(W(1,17  ),W(1,6   ),W(1,2   ),GG ,AMP(4   ))             
      CALL FVIXXX(W(1,7   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL FVIXXX(W(1,18  ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL IOVXXX(W(1,19  ),W(1,6   ),W(1,8   ),GAD ,AMP(5   ))            
      CALL IOVXXX(W(1,19  ),W(1,6   ),W(1,12  ),GZD ,AMP(6   ))            
      CALL JVVXXX(W(1,9   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,20  ))      
      CALL FVIXXX(W(1,7   ),W(1,20  ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL IOVXXX(W(1,21  ),W(1,6   ),W(1,8   ),GAD ,AMP(7   ))            
      CALL IOVXXX(W(1,21  ),W(1,6   ),W(1,12  ),GZD ,AMP(8   ))            
      CALL FVIXXX(W(1,15  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL IOVXXX(W(1,22  ),W(1,6   ),W(1,8   ),GAD ,AMP(9   ))            
      CALL IOVXXX(W(1,22  ),W(1,6   ),W(1,12  ),GZD ,AMP(10  ))            
      CALL IOVXXX(W(1,10  ),W(1,6   ),W(1,20  ),GG ,AMP(11  ))             
      CALL IOVXXX(W(1,13  ),W(1,6   ),W(1,20  ),GG ,AMP(12  ))             
      CALL FVIXXX(W(1,18  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,23  ))    
      CALL IOVXXX(W(1,23  ),W(1,6   ),W(1,9   ),GG ,AMP(13  ))             
      CALL FVIXXX(W(1,18  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,24  ))    
      CALL IOVXXX(W(1,24  ),W(1,6   ),W(1,9   ),GG ,AMP(14  ))             
      CALL FVIXXX(W(1,10  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL IOVXXX(W(1,25  ),W(1,6   ),W(1,9   ),GG ,AMP(15  ))             
      CALL FVIXXX(W(1,13  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,26  ),W(1,6   ),W(1,9   ),GG ,AMP(16  ))             
      CALL FVOXXX(W(1,5   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL FVOXXX(W(1,27  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,28  ))    
      CALL JIOXXX(W(1,1   ),W(1,28  ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,29  ),GG ,AMP(17  ))             
      CALL FVOXXX(W(1,27  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,30  ))    
      CALL JIOXXX(W(1,1   ),W(1,30  ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,31  ),GG ,AMP(18  ))             
      CALL FVIXXX(W(1,1   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,32  ))    
      CALL JIOXXX(W(1,32  ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL IOVXXX(W(1,18  ),W(1,6   ),W(1,33  ),GG ,AMP(19  ))             
      CALL FVIXXX(W(1,1   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,34  ))    
      CALL JIOXXX(W(1,34  ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL IOVXXX(W(1,18  ),W(1,6   ),W(1,35  ),GG ,AMP(20  ))             
      CALL JVVXXX(W(1,33  ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,36  ))      
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,36  ),GG ,AMP(21  ))             
      CALL JVVXXX(W(1,35  ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,37  ))      
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,37  ),GG ,AMP(22  ))             
      CALL FVIXXX(W(1,7   ),W(1,33  ),GG ,ZERO    ,ZERO    ,W(1,38  ))     
      CALL IOVXXX(W(1,38  ),W(1,6   ),W(1,2   ),GG ,AMP(23  ))             
      CALL FVIXXX(W(1,7   ),W(1,35  ),GG ,ZERO    ,ZERO    ,W(1,39  ))     
      CALL IOVXXX(W(1,39  ),W(1,6   ),W(1,2   ),GG ,AMP(24  ))             
      CALL FVIXXX(W(1,32  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
      CALL JIOXXX(W(1,40  ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,41  ),GG ,AMP(25  ))             
      CALL FVIXXX(W(1,34  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL JIOXXX(W(1,42  ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,43  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,43  ),GG ,AMP(26  ))             
      CALL JIOXXX(W(1,1   ),W(1,27  ),GG ,ZERO    ,ZERO    ,W(1,44  ))     
      CALL FVIXXX(W(1,7   ),W(1,44  ),GG ,ZERO    ,ZERO    ,W(1,45  ))     
      CALL IOVXXX(W(1,45  ),W(1,6   ),W(1,8   ),GAD ,AMP(27  ))            
      CALL IOVXXX(W(1,45  ),W(1,6   ),W(1,12  ),GZD ,AMP(28  ))            
      CALL IOVXXX(W(1,10  ),W(1,6   ),W(1,44  ),GG ,AMP(29  ))             
      CALL IOVXXX(W(1,13  ),W(1,6   ),W(1,44  ),GG ,AMP(30  ))             
      CALL JIOXXX(W(1,32  ),W(1,27  ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,46  ),GG ,AMP(31  ))             
      CALL JIOXXX(W(1,34  ),W(1,27  ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,47  ),GG ,AMP(32  ))             
      CALL FVOXXX(W(1,5   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,48  ))    
      CALL FVOXXX(W(1,48  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL JIOXXX(W(1,1   ),W(1,49  ),GG ,ZERO    ,ZERO    ,W(1,50  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,50  ),GG ,AMP(33  ))             
      CALL FVOXXX(W(1,5   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,51  ))    
      CALL FVOXXX(W(1,51  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,52  ))     
      CALL JIOXXX(W(1,1   ),W(1,52  ),GG ,ZERO    ,ZERO    ,W(1,53  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,53  ),GG ,AMP(34  ))             
      CALL JIOXXX(W(1,1   ),W(1,48  ),GG ,ZERO    ,ZERO    ,W(1,54  ))     
      CALL IOVXXX(W(1,18  ),W(1,6   ),W(1,54  ),GG ,AMP(35  ))             
      CALL JIOXXX(W(1,1   ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,18  ),W(1,6   ),W(1,55  ),GG ,AMP(36  ))             
      CALL JVVXXX(W(1,54  ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,56  ))      
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,56  ),GG ,AMP(37  ))             
      CALL JVVXXX(W(1,55  ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,57  ))      
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,57  ),GG ,AMP(38  ))             
      CALL FVIXXX(W(1,7   ),W(1,54  ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      CALL IOVXXX(W(1,58  ),W(1,6   ),W(1,2   ),GG ,AMP(39  ))             
      CALL FVIXXX(W(1,7   ),W(1,55  ),GG ,ZERO    ,ZERO    ,W(1,59  ))     
      CALL IOVXXX(W(1,59  ),W(1,6   ),W(1,2   ),GG ,AMP(40  ))             
      ...
      CALL JIOXXX(W(1,60  ),W(1,51  ),GG ,ZERO    ,ZERO    ,W(1,66  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,66  ),GG ,AMP(44  ))             
      CALL JIOXXX(W(1,60  ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,67  ))     
      CALL IOVXXX(W(1,10  ),W(1,6   ),W(1,67  ),GG ,AMP(45  ))             
      CALL IOVXXX(W(1,13  ),W(1,6   ),W(1,67  ),GG ,AMP(46  ))             
     ...
     &             -AMP(  23)-AMP(  24)-AMP(  39)-AMP(  40)
      JAMP(   2) = -AMP(   5)-AMP(   6)-AMP(   7)-AMP(   8)-AMP(  11)
     &             -AMP(  12)-AMP(  13)-AMP(  14)-AMP(  15)-AMP(  16)
     &             -AMP(  19)-AMP(  20)-AMP(  35)-AMP(  36)
      JAMP(   3) = -AMP(  17)-AMP(  18)-AMP(  21)-AMP(  22)-AMP(  27)
     &             -AMP(  28)-AMP(  29)-AMP(  30)-AMP(  31)-AMP(  32)
     &             -AMP(  33)-AMP(  34)-AMP(  37)-AMP(  38)
      JAMP(   4) = +AMP(  21)+AMP(  22)-AMP(  25)-AMP(  26)+AMP(  37)
     ...
     &             -AMP(  45)-AMP(  46)-AMP(  47)-AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          ug_epemuddx =ug_epemuddx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
