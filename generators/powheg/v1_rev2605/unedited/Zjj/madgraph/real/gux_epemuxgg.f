      SUBROUTINE Sgux_epemuxgg(P1,ANS)
C  
...
C  
      ...
      common/to_amps_gux_epemuxgg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gux_epemuxgg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION gux_epemuxgg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,5   ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      ...
      CALL FVIXXX(W(1,5   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      ...
      CALL FVIXXX(W(1,20  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,37  ))     
      ...
      CALL FVOXXX(W(1,10  ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      CALL IOVXXX(W(1,5   ),W(1,47  ),W(1,6   ),GG ,AMP(31  ))             
      CALL FVOXXX(W(1,13  ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,48  ))     
      CALL IOVXXX(W(1,5   ),W(1,48  ),W(1,6   ),GG ,AMP(32  ))             
      CALL FVOXXX(W(1,16  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL IOVXXX(W(1,5   ),W(1,49  ),W(1,6   ),GG ,AMP(33  ))             
      CALL FVOXXX(W(1,18  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,50  ))     
      CALL IOVXXX(W(1,5   ),W(1,50  ),W(1,6   ),GG ,AMP(34  ))             
      CALL FVOXXX(W(1,10  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,51  ))     
      CALL IOVXXX(W(1,20  ),W(1,51  ),W(1,6   ),GG ,AMP(35  ))             
      CALL FVOXXX(W(1,13  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,52  ))     
      ...
      CALL FVOXXX(W(1,25  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,5   ),W(1,55  ),W(1,6   ),GG ,AMP(39  ))             
      CALL FVOXXX(W(1,27  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      ...
      CALL FVIXXX(W(1,20  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,67  ))    
      CALL JIOXXX(W(1,67  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,68  ))     
      CALL VVVXXX(W(1,6   ),W(1,1   ),W(1,68  ),G ,AMP(59  ))              
      CALL FVIXXX(W(1,20  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,69  ))    
      ...
      CALL FVIXXX(W(1,61  ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,79  ))     
      CALL IOVXXX(W(1,79  ),W(1,2   ),W(1,6   ),GG ,AMP(73  ))             
      CALL FVIXXX(W(1,63  ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,80  ))     
      CALL IOVXXX(W(1,80  ),W(1,2   ),W(1,6   ),GG ,AMP(74  ))             
      CALL FVIXXX(W(1,61  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,81  ))     
      CALL IOVXXX(W(1,81  ),W(1,15  ),W(1,6   ),GG ,AMP(75  ))             
      CALL FVIXXX(W(1,63  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,82  ))     
      CALL IOVXXX(W(1,82  ),W(1,15  ),W(1,6   ),GG ,AMP(76  ))             
      CALL FVIXXX(W(1,67  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,83  ))     
      CALL IOVXXX(W(1,83  ),W(1,2   ),W(1,6   ),GG ,AMP(77  ))             
      CALL FVIXXX(W(1,69  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,84  ))     
      ...
      CALL FVIXXX(W(1,73  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,87  ))     
      CALL IOVXXX(W(1,87  ),W(1,2   ),W(1,6   ),GG ,AMP(81  ))             
      CALL FVIXXX(W(1,75  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,88  ))     
      ...
      CALL FVIXXX(W(1,82  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,90  ))     
      CALL IOVXXX(W(1,90  ),W(1,2   ),W(1,6   ),GG ,AMP(84  ))             
      CALL FVOXXX(W(1,2   ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,91  ))     
      ...
      CALL FVOXXX(W(1,15  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,94  ))     
      ...
      CALL FVOXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,97  ))     
     ...
     &             -AMP( 108)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gux_epemuxgg =gux_epemuxgg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
