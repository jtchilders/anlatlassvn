      SUBROUTINE Sgb_epemuuxb(P1,ANS)
C  
...
C  
C FOR PROCESS : g b -> e+ e- u u~ b  
C  
C Crossing   1 is g b -> e+ e- u u~ b  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_gb_epemuuxb/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gb_epemuuxb(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION gb_epemuuxb(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,7   ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,9   ))    
      ...
      CALL FVOXXX(W(1,7   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,13  ))    
      ...
      CALL FVIXXX(W(1,2   ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,16  ))    
      ...
      CALL FVIXXX(W(1,2   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,19  ))    
      ...
      CALL JIOXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      ...
      CALL FVOXXX(W(1,7   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,26  ))     
      CALL JIOXXX(W(1,16  ),W(1,26  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,27  ),GG ,AMP(7   ))             
      CALL JIOXXX(W(1,19  ),W(1,26  ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      ...
      CALL FVIXXX(W(1,16  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,33  ))     
      CALL JIOXXX(W(1,33  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,34  ),GG ,AMP(13  ))             
      CALL FVIXXX(W(1,19  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,35  ))     
      ...
      CALL FVIXXX(W(1,2   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,56  ))     
      CALL JIOXXX(W(1,56  ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,57  ),GG ,AMP(33  ))             
      CALL JIOXXX(W(1,56  ),W(1,13  ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      ...
      CALL JIOXXX(W(1,2   ),W(1,26  ),GG ,ZERO    ,ZERO    ,W(1,63  ))     
     ...
     &             -AMP(  47)-AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gb_epemuuxb =gb_epemuuxb+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
