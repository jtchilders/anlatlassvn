      SUBROUTINE Suxu_epemccxg(P1,ANS)
C  
...
C  
C FOR PROCESS : u~ u -> e+ e- c c~ g  
C  
C Crossing   1 is u~ u -> e+ e- c c~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_uxu_epemccxg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=uxu_epemccxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION uxu_epemccxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,5   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,49  ))    
      ...
      CALL FVOXXX(W(1,20  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,54  ))    
      CALL IOVXXX(W(1,6   ),W(1,54  ),W(1,53  ),GG ,AMP(29  ))             
      CALL FVOXXX(W(1,20  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,55  ))    
      ...
      CALL IOVXXX(W(1,6   ),W(1,61  ),W(1,8   ),GAU ,AMP(37  ))            
      CALL IOVXXX(W(1,6   ),W(1,61  ),W(1,12  ),GZU ,AMP(38  ))            
      CALL FVOXXX(W(1,5   ),W(1,52  ),GG ,ZERO    ,ZERO    ,W(1,62  ))     
      CALL IOVXXX(W(1,6   ),W(1,62  ),W(1,8   ),GAU ,AMP(39  ))            
      CALL IOVXXX(W(1,6   ),W(1,62  ),W(1,12  ),GZU ,AMP(40  ))            
      CALL FVOXXX(W(1,20  ),W(1,53  ),GG ,ZERO    ,ZERO    ,W(1,63  ))     
      CALL IOVXXX(W(1,6   ),W(1,63  ),W(1,8   ),GAU ,AMP(41  ))            
      CALL IOVXXX(W(1,6   ),W(1,63  ),W(1,12  ),GZU ,AMP(42  ))            
     ...
     &             +AMP(  32)+AMP(  43)+AMP(  44)+AMP(  47)+AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          uxu_epemccxg =uxu_epemccxg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
