      SUBROUTINE Sbg_epemuuxb(P1,ANS)
C  
...
C  
      ...
      common/to_amps_bg_epemuuxb/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bg_epemuuxb(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION bg_epemuuxb(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,7   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
      CALL FVOXXX(W(1,14  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,15  ))    
      ...
      CALL FVOXXX(W(1,7   ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,19  ))    
      CALL FVOXXX(W(1,19  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,20  ))     
      CALL JIOXXX(W(1,1   ),W(1,20  ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,21  ),GG ,AMP(5   ))             
      CALL FVOXXX(W(1,7   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,22  ))    
      CALL FVOXXX(W(1,22  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,23  ))     
      ...
      CALL JIOXXX(W(1,1   ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL FVOXXX(W(1,5   ),W(1,29  ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL IOVXXX(W(1,6   ),W(1,30  ),W(1,2   ),GG ,AMP(11  ))             
      CALL JIOXXX(W(1,1   ),W(1,22  ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      ...
      CALL FVIXXX(W(1,1   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,36  ))    
      ...
      CALL JIOXXX(W(1,33  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,39  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,39  ),GG ,AMP(15  ))             
      CALL JIOXXX(W(1,36  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
      ...
      CALL FVIXXX(W(1,33  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,45  ))     
      CALL JIOXXX(W(1,45  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,46  ),GG ,AMP(21  ))             
      CALL FVIXXX(W(1,36  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,47  ))     
      CALL JIOXXX(W(1,47  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,48  ))     
      ...
      CALL FVIXXX(W(1,1   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,56  ))     
      CALL JIOXXX(W(1,56  ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,57  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,57  ),GG ,AMP(33  ))             
      CALL JIOXXX(W(1,56  ),W(1,22  ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,58  ),GG ,AMP(34  ))             
      CALL FVIXXX(W(1,56  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,59  ))    
      CALL JIOXXX(W(1,59  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,60  ),GG ,AMP(35  ))             
      CALL FVIXXX(W(1,56  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,61  ))    
      CALL JIOXXX(W(1,61  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,62  ))     
      ...
      CALL JIOXXX(W(1,1   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,64  ))     
      CALL IOVXXX(W(1,6   ),W(1,50  ),W(1,64  ),GG ,AMP(39  ))             
      CALL IOVXXX(W(1,6   ),W(1,52  ),W(1,64  ),GG ,AMP(40  ))             
      CALL JIOXXX(W(1,56  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,65  ))     
     ...
     &             -AMP(  47)-AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bg_epemuuxb =bg_epemuuxb+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
