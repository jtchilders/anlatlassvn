      SUBROUTINE Sgd_epemdbbx(P1,ANS)
C  
...
C  
C FOR PROCESS : g d -> e+ e- d b b~  
C  
C Crossing   1 is g d -> e+ e- d b b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_gd_epemdbbx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gd_epemdbbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION gd_epemdbbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &             -AMP(  27)-AMP(  28)-AMP(  37)-AMP(  38)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gd_epemdbbx =gd_epemdbbx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
