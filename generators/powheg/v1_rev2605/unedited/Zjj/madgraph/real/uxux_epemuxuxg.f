      SUBROUTINE Suxux_epemuxuxg(P1,ANS)
C  
...
C  
      ...
      double precision uxux_epemuxuxg
...
C  
      ...
      common/to_amps_uxux_epemuxuxg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=uxux_epemuxuxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION uxux_epemuxuxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,1   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      ...
      CALL FVOXXX(W(1,9   ),W(1,31  ),GG ,ZERO    ,ZERO    ,W(1,32  ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,33  ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,6   ),W(1,34  ),W(1,8   ),GAU ,AMP(15  ))            
      CALL IOVXXX(W(1,6   ),W(1,34  ),W(1,12  ),GZU ,AMP(16  ))            
      CALL JIOXXX(W(1,20  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL FVOXXX(W(1,1   ),W(1,35  ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
      CALL IOVXXX(W(1,6   ),W(1,36  ),W(1,8   ),GAU ,AMP(17  ))            
      CALL IOVXXX(W(1,6   ),W(1,36  ),W(1,12  ),GZU ,AMP(18  ))            
      CALL FVOXXX(W(1,1   ),W(1,31  ),GG ,ZERO    ,ZERO    ,W(1,37  ))     
      ...
      CALL FVOXXX(W(1,37  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
      CALL IOVXXX(W(1,6   ),W(1,40  ),W(1,8   ),GAU ,AMP(21  ))            
      CALL IOVXXX(W(1,6   ),W(1,40  ),W(1,12  ),GZU ,AMP(22  ))            
      CALL JVVXXX(W(1,7   ),W(1,31  ),G ,ZERO    ,ZERO    ,W(1,41  ))      
      CALL FVOXXX(W(1,1   ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL IOVXXX(W(1,6   ),W(1,42  ),W(1,8   ),GAU ,AMP(23  ))            
      CALL IOVXXX(W(1,6   ),W(1,42  ),W(1,12  ),GZU ,AMP(24  ))            
      CALL FVOXXX(W(1,9   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,43  ))    
      CALL IOVXXX(W(1,6   ),W(1,43  ),W(1,31  ),GG ,AMP(25  ))             
      CALL FVOXXX(W(1,9   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,44  ))    
      CALL IOVXXX(W(1,6   ),W(1,44  ),W(1,31  ),GG ,AMP(26  ))             
      CALL FVOXXX(W(1,1   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,45  ))    
      CALL IOVXXX(W(1,6   ),W(1,45  ),W(1,33  ),GG ,AMP(27  ))             
      CALL FVOXXX(W(1,1   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,46  ))    
      ...
      CALL FVOXXX(W(1,45  ),W(1,31  ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      CALL IOVXXX(W(1,6   ),W(1,47  ),W(1,7   ),GG ,AMP(31  ))             
      CALL FVOXXX(W(1,46  ),W(1,31  ),GG ,ZERO    ,ZERO    ,W(1,48  ))     
      CALL IOVXXX(W(1,6   ),W(1,48  ),W(1,7   ),GG ,AMP(32  ))             
      CALL FVOXXX(W(1,45  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL IOVXXX(W(1,6   ),W(1,49  ),W(1,31  ),GG ,AMP(33  ))             
      CALL FVOXXX(W(1,46  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,50  ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,52  ),GG ,ZERO    ,ZERO    ,W(1,61  ))     
      CALL IOVXXX(W(1,6   ),W(1,61  ),W(1,7   ),GG ,AMP(43  ))             
      CALL FVOXXX(W(1,1   ),W(1,54  ),GG ,ZERO    ,ZERO    ,W(1,62  ))     
      ...
      CALL JIOXXX(W(1,5   ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,69  ))     
      CALL FVOXXX(W(1,2   ),W(1,69  ),GG ,ZERO    ,ZERO    ,W(1,70  ))     
      CALL IOVXXX(W(1,6   ),W(1,70  ),W(1,8   ),GAU ,AMP(49  ))            
      CALL IOVXXX(W(1,6   ),W(1,70  ),W(1,12  ),GZU ,AMP(50  ))            
      CALL JIOXXX(W(1,5   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,71  ))     
      CALL FVOXXX(W(1,15  ),W(1,71  ),GG ,ZERO    ,ZERO    ,W(1,72  ))     
      CALL IOVXXX(W(1,6   ),W(1,72  ),W(1,8   ),GAU ,AMP(51  ))            
      CALL IOVXXX(W(1,6   ),W(1,72  ),W(1,12  ),GZU ,AMP(52  ))            
      CALL JIOXXX(W(1,20  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,73  ))     
      CALL FVOXXX(W(1,2   ),W(1,73  ),GG ,ZERO    ,ZERO    ,W(1,74  ))     
      CALL IOVXXX(W(1,6   ),W(1,74  ),W(1,8   ),GAU ,AMP(53  ))            
      CALL IOVXXX(W(1,6   ),W(1,74  ),W(1,12  ),GZU ,AMP(54  ))            
      CALL FVOXXX(W(1,2   ),W(1,71  ),GG ,ZERO    ,ZERO    ,W(1,75  ))     
      CALL FVOXXX(W(1,75  ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,76  ))    
      CALL IOVXXX(W(1,6   ),W(1,76  ),W(1,7   ),GG ,AMP(55  ))             
      CALL FVOXXX(W(1,75  ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,77  ))    
      CALL IOVXXX(W(1,6   ),W(1,77  ),W(1,7   ),GG ,AMP(56  ))             
      CALL FVOXXX(W(1,75  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,78  ))     
      CALL IOVXXX(W(1,6   ),W(1,78  ),W(1,8   ),GAU ,AMP(57  ))            
      CALL IOVXXX(W(1,6   ),W(1,78  ),W(1,12  ),GZU ,AMP(58  ))            
      CALL JVVXXX(W(1,7   ),W(1,71  ),G ,ZERO    ,ZERO    ,W(1,79  ))      
      CALL FVOXXX(W(1,2   ),W(1,79  ),GG ,ZERO    ,ZERO    ,W(1,80  ))     
      CALL IOVXXX(W(1,6   ),W(1,80  ),W(1,8   ),GAU ,AMP(59  ))            
      CALL IOVXXX(W(1,6   ),W(1,80  ),W(1,12  ),GZU ,AMP(60  ))            
      ...
      CALL JIOXXX(W(1,5   ),W(1,43  ),GG ,ZERO    ,ZERO    ,W(1,83  ))     
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,83  ),GG ,AMP(73  ))             
      CALL JIOXXX(W(1,5   ),W(1,44  ),GG ,ZERO    ,ZERO    ,W(1,84  ))     
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,84  ),GG ,AMP(74  ))             
      CALL JIOXXX(W(1,5   ),W(1,45  ),GG ,ZERO    ,ZERO    ,W(1,85  ))     
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,85  ),GG ,AMP(75  ))             
      CALL JIOXXX(W(1,5   ),W(1,46  ),GG ,ZERO    ,ZERO    ,W(1,86  ))     
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,86  ),GG ,AMP(76  ))             
      CALL JIOXXX(W(1,20  ),W(1,45  ),GG ,ZERO    ,ZERO    ,W(1,87  ))     
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,87  ),GG ,AMP(77  ))             
      CALL JIOXXX(W(1,20  ),W(1,46  ),GG ,ZERO    ,ZERO    ,W(1,88  ))     
      ...
      CALL JIOXXX(W(1,5   ),W(1,49  ),GG ,ZERO    ,ZERO    ,W(1,91  ))     
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,91  ),GG ,AMP(81  ))             
      CALL JIOXXX(W(1,5   ),W(1,50  ),GG ,ZERO    ,ZERO    ,W(1,92  ))     
      ...
      CALL JIOXXX(W(1,51  ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,95  ))     
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,95  ),GG ,AMP(85  ))             
      CALL JIOXXX(W(1,53  ),W(1,9   ),GG ,ZERO    ,ZERO    ,W(1,96  ))     
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,96  ),GG ,AMP(86  ))             
      CALL JIOXXX(W(1,51  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,97  ))     
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,97  ),GG ,AMP(87  ))             
      CALL JIOXXX(W(1,53  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,98  ))     
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,98  ),GG ,AMP(88  ))             
      CALL JIOXXX(W(1,57  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,99  ))     
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,99  ),GG ,AMP(89  ))             
      CALL JIOXXX(W(1,59  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,100 ))     
      ...
      CALL JIOXXX(W(1,63  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,103 ))     
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,103 ),GG ,AMP(93  ))             
      CALL JIOXXX(W(1,65  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,104 ))     
     ...
     &             -AMP(  91)-AMP(  92)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          uxux_epemuxuxg =uxux_epemuxuxg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
