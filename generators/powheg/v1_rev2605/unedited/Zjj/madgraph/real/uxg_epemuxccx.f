      SUBROUTINE Suxg_epemuxccx(P1,ANS)
C  
...
C  
      ...
      double precision uxg_epemuxccx
...
C  
      ...
      common/to_amps_uxg_epemuxccx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=uxg_epemuxccx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION uxg_epemuxccx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,32  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
      CALL JIOXXX(W(1,5   ),W(1,40  ),GG ,ZERO    ,ZERO    ,W(1,41  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,41  ),GG ,AMP(25  ))             
      CALL FVOXXX(W(1,34  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL JIOXXX(W(1,5   ),W(1,42  ),GG ,ZERO    ,ZERO    ,W(1,43  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,43  ),GG ,AMP(26  ))             
      CALL JIOXXX(W(1,27  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,44  ))     
      ...
      CALL JIOXXX(W(1,27  ),W(1,32  ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,46  ),GG ,AMP(31  ))             
      CALL JIOXXX(W(1,27  ),W(1,34  ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      ...
      CALL FVIXXX(W(1,5   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,51  ))    
      CALL FVIXXX(W(1,51  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,52  ))     
      CALL JIOXXX(W(1,52  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,53  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,53  ),GG ,AMP(34  ))             
      CALL JIOXXX(W(1,48  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,54  ))     
      ...
      CALL JIOXXX(W(1,51  ),W(1,60  ),GG ,ZERO    ,ZERO    ,W(1,66  ))     
     ...
     &             +AMP(  45)+AMP(  46)+AMP(  47)+AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          uxg_epemuxccx =uxg_epemuxccx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
