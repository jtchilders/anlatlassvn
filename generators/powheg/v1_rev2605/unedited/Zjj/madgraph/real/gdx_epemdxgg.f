      SUBROUTINE Sgdx_epemdxgg(P1,ANS)
C  
...
C  
      ...
      common/to_amps_gdx_epemdxgg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gdx_epemdxgg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION gdx_epemdxgg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,20  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,67  ))    
      CALL JIOXXX(W(1,67  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,68  ))     
      CALL VVVXXX(W(1,6   ),W(1,1   ),W(1,68  ),G ,AMP(59  ))              
      CALL FVIXXX(W(1,20  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,69  ))    
     ...
     &             -AMP( 108)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gdx_epemdxgg =gdx_epemdxgg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
