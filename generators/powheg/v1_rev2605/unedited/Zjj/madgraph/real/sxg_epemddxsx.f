      SUBROUTINE Ssxg_epemddxsx(P1,ANS)
C  
...
C  
C FOR PROCESS : s~ g -> e+ e- d d~ s~  
C  
C Crossing   1 is s~ g -> e+ e- d d~ s~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      double precision sxg_epemddxsx
...
C  
      ...
      common/to_amps_sxg_epemddxsx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=sxg_epemddxsx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION sxg_epemddxsx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &             +AMP(  47)+AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          sxg_epemddxsx =sxg_epemddxsx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
