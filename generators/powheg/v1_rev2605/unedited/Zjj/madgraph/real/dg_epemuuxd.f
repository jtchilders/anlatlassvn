      SUBROUTINE Sdg_epemuuxd(P1,ANS)
C  
...
C  
      ...
      common/to_amps_dg_epemuuxd/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=dg_epemuuxd(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION dg_epemuuxd(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,14  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,15  ))    
      ...
      CALL FVOXXX(W(1,7   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,19  ))    
      ...
      CALL FVOXXX(W(1,7   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,22  ))    
      CALL FVOXXX(W(1,22  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      ...
      CALL FVIXXX(W(1,1   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,36  ))    
      ...
      CALL FVIXXX(W(1,33  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,45  ))     
      CALL JIOXXX(W(1,45  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,46  ),GG ,AMP(21  ))             
      CALL FVIXXX(W(1,36  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      ...
      CALL FVIXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,56  ))     
      ...
      CALL FVIXXX(W(1,56  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,59  ))    
      CALL JIOXXX(W(1,59  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,60  ),GG ,AMP(35  ))             
      CALL FVIXXX(W(1,56  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,61  ))    
     ...
     &             -AMP(  47)-AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          dg_epemuuxd =dg_epemuuxd+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
