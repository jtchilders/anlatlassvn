      SUBROUTINE Sbbx_epembbxg(P1,ANS)
C  
...
C  
      ...
      common/to_amps_bbx_epembbxg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bbx_epembbxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION bbx_epembbxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,37  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,45  ))     
     ...
     &             +AMP(  91)+AMP(  92)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bbx_epembbxg =bbx_epembbxg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
