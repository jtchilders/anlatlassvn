...
C  
C FOR PROCESS : d b -> e+ e- d b g  
C  
C Crossing   1 is d b -> e+ e- d b g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_db_epemdbg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=db_epemdbg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION db_epemdbg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,16  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,57  ))    
      CALL JIOXXX(W(1,1   ),W(1,57  ),GG ,ZERO    ,ZERO    ,W(1,58  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,58  ),GG ,AMP(41  ))             
      CALL FVOXXX(W(1,16  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,59  ))    
     ...
     &             -AMP(  43)-AMP(  44)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          db_epemdbg =db_epemdbg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
