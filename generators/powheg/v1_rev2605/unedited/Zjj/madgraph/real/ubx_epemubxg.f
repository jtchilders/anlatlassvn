      SUBROUTINE Subx_epemubxg(P1,ANS)
C  
...
C  
      ...
      common/to_amps_ubx_epemubxg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=ubx_epemubxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION ubx_epemubxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,2   ),W(1,10  ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,6   ),W(1,11  ),W(1,8   ),GAD ,AMP(1   ))            
      CALL JIOXXX(W(1,3   ),W(1,4   ),GZL ,ZMASS   ,ZWIDTH  ,W(1,12  ))    
      CALL IOVXXX(W(1,6   ),W(1,11  ),W(1,12  ),GZD ,AMP(2   ))            
      CALL JIOXXX(W(1,1   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL FVOXXX(W(1,2   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
      CALL FVOXXX(W(1,14  ),W(1,13  ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,8   ),GAD ,AMP(3   ))            
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,12  ),GZD ,AMP(4   ))            
      CALL FVOXXX(W(1,5   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL JIOXXX(W(1,1   ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL FVOXXX(W(1,2   ),W(1,17  ),GG ,BMASS   ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,6   ),W(1,18  ),W(1,8   ),GAD ,AMP(5   ))            
      CALL IOVXXX(W(1,6   ),W(1,18  ),W(1,12  ),GZD ,AMP(6   ))            
      CALL FVOXXX(W(1,2   ),W(1,13  ),GG ,BMASS   ,ZERO    ,W(1,19  ))     
      ...
      CALL FVOXXX(W(1,19  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,22  ))     
      CALL IOVXXX(W(1,6   ),W(1,22  ),W(1,8   ),GAD ,AMP(9   ))            
      CALL IOVXXX(W(1,6   ),W(1,22  ),W(1,12  ),GZD ,AMP(10  ))            
      CALL JVVXXX(W(1,7   ),W(1,13  ),G ,ZERO    ,ZERO    ,W(1,23  ))      
      CALL FVOXXX(W(1,2   ),W(1,23  ),GG ,BMASS   ,ZERO    ,W(1,24  ))     
      CALL IOVXXX(W(1,6   ),W(1,24  ),W(1,8   ),GAD ,AMP(11  ))            
      CALL IOVXXX(W(1,6   ),W(1,24  ),W(1,12  ),GZD ,AMP(12  ))            
      CALL FVOXXX(W(1,2   ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,25  ))    
      CALL IOVXXX(W(1,6   ),W(1,25  ),W(1,10  ),GG ,AMP(13  ))             
      CALL FVOXXX(W(1,2   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,26  ))    
      CALL IOVXXX(W(1,6   ),W(1,26  ),W(1,10  ),GG ,AMP(14  ))             
      CALL FVOXXX(W(1,14  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,27  ))    
      CALL IOVXXX(W(1,6   ),W(1,27  ),W(1,13  ),GG ,AMP(15  ))             
      CALL FVOXXX(W(1,14  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,28  ))    
      ...
      CALL FVOXXX(W(1,25  ),W(1,13  ),GG ,BMASS   ,ZERO    ,W(1,29  ))     
      ...
      CALL FVOXXX(W(1,25  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,31  ))     
      CALL IOVXXX(W(1,6   ),W(1,31  ),W(1,13  ),GG ,AMP(21  ))             
      CALL FVOXXX(W(1,26  ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,32  ))     
      ...
      CALL FVOXXX(W(1,2   ),W(1,38  ),GG ,BMASS   ,ZERO    ,W(1,43  ))     
      CALL IOVXXX(W(1,6   ),W(1,43  ),W(1,7   ),GG ,AMP(31  ))             
      CALL FVOXXX(W(1,2   ),W(1,40  ),GG ,BMASS   ,ZERO    ,W(1,44  ))     
      ...
      CALL FVOXXX(W(1,2   ),W(1,55  ),GG ,BMASS   ,ZERO    ,W(1,61  ))     
      CALL IOVXXX(W(1,6   ),W(1,61  ),W(1,7   ),GG ,AMP(43  ))             
      CALL FVOXXX(W(1,2   ),W(1,56  ),GG ,BMASS   ,ZERO    ,W(1,62  ))     
     ...
     &             +AMP(  43)+AMP(  44)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          ubx_epemubxg =ubx_epemubxg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
