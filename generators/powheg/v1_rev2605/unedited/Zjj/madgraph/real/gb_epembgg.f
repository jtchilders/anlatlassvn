...
C  
      ...
      common/to_amps_gb_epembgg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gb_epembgg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION gb_epembgg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,5   ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,31  ))     
      ...
      CALL FVOXXX(W(1,5   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,34  ))     
      ...
      CALL FVOXXX(W(1,20  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,37  ))     
      ...
      CALL FVIXXX(W(1,10  ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,47  ))     
      CALL IOVXXX(W(1,47  ),W(1,5   ),W(1,6   ),GG ,AMP(31  ))             
      CALL FVIXXX(W(1,13  ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,48  ))     
      CALL IOVXXX(W(1,48  ),W(1,5   ),W(1,6   ),GG ,AMP(32  ))             
      CALL FVIXXX(W(1,16  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,49  ))     
      CALL IOVXXX(W(1,49  ),W(1,5   ),W(1,6   ),GG ,AMP(33  ))             
      CALL FVIXXX(W(1,18  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,50  ))     
      CALL IOVXXX(W(1,50  ),W(1,5   ),W(1,6   ),GG ,AMP(34  ))             
      CALL FVIXXX(W(1,10  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,51  ))     
      CALL IOVXXX(W(1,51  ),W(1,20  ),W(1,6   ),GG ,AMP(35  ))             
      CALL FVIXXX(W(1,13  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,52  ))     
      ...
      CALL FVIXXX(W(1,25  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,55  ),W(1,5   ),W(1,6   ),GG ,AMP(39  ))             
      CALL FVIXXX(W(1,27  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,56  ))     
      ...
      CALL FVOXXX(W(1,20  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,67  ))    
      CALL JIOXXX(W(1,2   ),W(1,67  ),GG ,ZERO    ,ZERO    ,W(1,68  ))     
      CALL VVVXXX(W(1,6   ),W(1,1   ),W(1,68  ),G ,AMP(59  ))              
      CALL FVOXXX(W(1,20  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,69  ))    
      ...
      CALL FVIXXX(W(1,2   ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,91  ))     
      ...
      CALL FVIXXX(W(1,15  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,94  ))     
      ...
      CALL FVIXXX(W(1,2   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,97  ))     
     ...
     &             +AMP( 108)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gb_epembgg =gb_epembgg+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
