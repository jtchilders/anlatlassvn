      SUBROUTINE Sgdx_epemdxbbx(P1,ANS)
C  
...
C  
      ...
      double precision gdx_epemdxbbx
...
C  
      ...
      common/to_amps_gdx_epemdxbbx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gdx_epemdxbbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION gdx_epemdxbbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,19  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,22  ))    
      ...
      CALL FVIXXX(W(1,5   ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,48  ))    
      CALL JIOXXX(W(1,48  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL IOVXXX(W(1,9   ),W(1,6   ),W(1,49  ),GG ,AMP(33  ))             
      CALL FVIXXX(W(1,5   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,50  ))    
      ...
      CALL FVOXXX(W(1,60  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,61  ))    
      CALL JIOXXX(W(1,5   ),W(1,61  ),GG ,ZERO    ,ZERO    ,W(1,62  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,62  ),GG ,AMP(41  ))             
      CALL FVOXXX(W(1,60  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,63  ))    
     ...
     &             +AMP(  27)+AMP(  28)+AMP(  37)+AMP(  38)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gdx_epemdxbbx =gdx_epemdxbbx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
