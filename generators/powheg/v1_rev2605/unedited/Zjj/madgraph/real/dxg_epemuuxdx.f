      SUBROUTINE Sdxg_epemuuxdx(P1,ANS)
C  
...
C  
C FOR PROCESS : d~ g -> e+ e- u u~ d~  
C  
C Crossing   1 is d~ g -> e+ e- u u~ d~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      double precision dxg_epemuuxdx
...
C  
      ...
      common/to_amps_dxg_epemuuxdx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=dxg_epemuuxdx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      double precision FUNCTION dxg_epemuuxdx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,7   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,22  ))    
      ...
      CALL FVOXXX(W(1,1   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,36  ))    
      ...
      CALL FVOXXX(W(1,56  ),W(1,8   ),GAD ,ZERO    ,ZERO    ,W(1,59  ))    
      CALL JIOXXX(W(1,7   ),W(1,59  ),GG ,ZERO    ,ZERO    ,W(1,60  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,60  ),GG ,AMP(35  ))             
      CALL FVOXXX(W(1,56  ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,61  ))    
     ...
     &             +AMP(  47)+AMP(  48)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          dxg_epemuuxdx =dxg_epemuuxdx+ZTEMP*conjg(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
