...
c     gdx -> tuxdx
     ...
     #(three_ch(idup_loc(4)).eq.-2)) then
               call Sgdx_tuxbx_S(klab_undec,amp2mad)
c     gu -> tddx
...
c     dxg -> tuxdx
     ...
     #(three_ch(idup_loc(4)).eq.-2)) then
               call Sdxg_tuxbx_S(klab_undec,amp2mad)
c     ug -> tddx
...
c     udx
            if ((three_ch(idup_loc(1)).eq.2).and.
     #(three_ch(idup_loc(2)).eq.1)) then
               call Sudx_tbxg(klab_undec,amp2mad)
c     dxu
            elseif ((three_ch(idup_loc(1)).eq.1).and.
     #(three_ch(idup_loc(2)).eq.2)) then
...
c     udx
         if ((three_ch(idup_loc(1)).eq.2).and.
     #(three_ch(idup_loc(2)).eq.1)) then
            call sudx_epvebbx(kbcm_mad,amp2mad)
c     dxu
         elseif ((three_ch(idup_loc(1)).eq.1).and.
     #(three_ch(idup_loc(2)).eq.2)) then
            call sdxu_epvebbx(kbcm_mad,amp2mad)   
         else
...
c     gdx -> tuxdx
            if((three_ch(idup_loc(2)).eq.1).and.
     #(three_ch(idup_loc(4)).eq.-2)) then
               call Sgdx_epvebuxbx_S(krcm_mad,amp2mad)
c     gu -> tddx
            elseif((three_ch(idup_loc(2)).eq.2).and.
     #(three_ch(idup_loc(4)).eq.-1)) then
...
c     dxg -> tuxdx
            if((three_ch(idup_loc(1)).eq.1).and.
     #(three_ch(idup_loc(4)).eq.-2)) then
               call Sdxg_epvebuxbx_S(krcm_mad,amp2mad)
c     ug -> tddx
            elseif((three_ch(idup_loc(1)).eq.2).and.
     #(three_ch(idup_loc(4)).eq.-1)) then
...
c     udx
            if ((three_ch(idup_loc(1)).eq.2).and.
     #(three_ch(idup_loc(2)).eq.1)) then
               call Sudx_epvebbxg(krcm_mad,amp2mad)
c     dxu
            elseif ((three_ch(idup_loc(1)).eq.1).and.
     #(three_ch(idup_loc(2)).eq.2)) then
