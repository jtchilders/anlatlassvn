...
C  
      ...
      common/to_amps_bu_epvebdg/  amp2bu_epvebdg,       jamp2bu_epvebdg
      ...
      common/to_matrix_bu_epvebdg/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bu_epvebdg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bu_epvebdg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,11  ),GWF ,AMP(1   ))            
      ...
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,16  ),GWF ,AMP(3   ))            
      CALL FVIXXX(W(1,2   ),W(1,13  ),GWF ,ZERO    ,ZERO    ,W(1,17  ))    
...
!ER:      CALL FVOXXX(W(1,9   ),W(1,7   ),GG ,TMASS   ,TWIDTH  ,W(1,18  ))     
      ...
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,19  ),GWF ,AMP(5   ))            
...
c      JAMP(   1) = -AMP(   1)-AMP(   3)-AMP(   5)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bu_epvebdg =bu_epvebdg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
