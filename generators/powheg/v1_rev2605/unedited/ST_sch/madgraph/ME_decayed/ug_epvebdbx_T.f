      SUBROUTINE Sug_epvebdbx_T(P1,ANS)
C  
...
C  
      ...
      common/to_amps_ug_epvebdbx_T/  amp2ug_epvebdbx_T,       jamp2ug_epvebdbx_T
      ...
      common/to_matrix_ug_epvebdbx_T/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=ug_epvebdbx_T(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION ug_epvebdbx_T(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,11  ),GWF ,AMP(1   ))            
!ER:      CALL FVOXXX(W(1,9   ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,12  ))     
      ...
      CALL FVIXXX(W(1,1   ),W(1,14  ),GWF ,ZERO    ,ZERO    ,W(1,15  ))    
      CALL IOVXXX(W(1,15  ),W(1,6   ),W(1,2   ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,16  ),W(1,6   ),W(1,14  ),GWF ,AMP(4   ))            
      JAMP(   1) = +AMP(   1)+AMP(   2)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          ug_epvebdbx_T =ug_epvebdbx_T+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
