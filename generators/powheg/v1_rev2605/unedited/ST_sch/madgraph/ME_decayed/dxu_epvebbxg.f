      SUBROUTINE Sdxu_epvebbxg(P1,ANS)
C  
...
C  
      ...
      common/to_amps_dxu_epvebbxg/  amp2dxu_epvebbxg,       jamp2dxu_epvebbxg
      ...
      common/to_matrix_dxu_epvebbxg/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=dxu_epvebbxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION dxu_epvebbxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,2   ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,14  ))    
...
c      JAMP(   2) = +AMP(   3)+AMP(   4)+AMP(   5)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          dxu_epvebbxg =dxu_epvebbxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
