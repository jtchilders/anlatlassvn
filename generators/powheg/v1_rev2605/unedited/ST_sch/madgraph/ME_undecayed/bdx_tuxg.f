...
C  
      ...
      common/to_amps_bdx_tuxg/  amp2bdx_tuxg,       jamp2bdx_tuxg
      ...
      common/to_matrix_bdx_tuxg/isum_hel, multi_channel
...
C ----------
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bdx_tuxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bdx_tuxg =bdx_tuxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
