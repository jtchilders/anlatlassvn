...
C  
      ...
      common/to_amps_dxu_tbxg/  amp2dxu_tbxg,       jamp2dxu_tbxg
      ...
      common/to_matrix_dxu_tbxg/isum_hel, multi_channel
...
C ----------
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION dxu_tbxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,2   ),W(1,7   ),W(1,6   ),GWF ,AMP(1   ))            
      CALL FVIXXX(W(1,2   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,8   ))     
      CALL IOVXXX(W(1,8   ),W(1,1   ),W(1,6   ),GWF ,AMP(2   ))            
      CALL JIOXXX(W(1,2   ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,9   ))    
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          dxu_tbxg =dxu_tbxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
