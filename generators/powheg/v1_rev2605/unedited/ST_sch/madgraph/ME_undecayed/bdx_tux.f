...
C  
      ...
      common/to_amps_bdx_tux/  amp2bdx_tux,       jamp2bdx_tux
      ...
      common/to_matrix_bdx_tux/isum_hel, multi_channel
...
C ----------
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bdx_tux(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bdx_tux =bdx_tux+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
