...
C  
      ...
      common/to_amps_bg_tuxd_T/  amp2bg_tuxd_T,       jamp2bg_tuxd_T
      ...
      common/to_matrix_bg_tuxd_T/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bg_tuxd_T(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bg_tuxd_T(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,1   ),W(1,6   ),GWF ,WMASS   ,WWIDTH  ,W(1,7   ))    
      CALL IOVXXX(W(1,4   ),W(1,5   ),W(1,7   ),GWF ,AMP(1   ))            
      ...
      CALL FVIXXX(W(1,4   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,10  ))     
      CALL IOVXXX(W(1,10  ),W(1,5   ),W(1,8   ),GWF ,AMP(3   ))            
      CALL FVIXXX(W(1,1   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      CALL JIOXXX(W(1,11  ),W(1,3   ),GWF ,WMASS   ,WWIDTH  ,W(1,12  ))    
      CALL IOVXXX(W(1,4   ),W(1,5   ),W(1,12  ),GWF ,AMP(4   ))            
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bg_tuxd_T =bg_tuxd_T+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
