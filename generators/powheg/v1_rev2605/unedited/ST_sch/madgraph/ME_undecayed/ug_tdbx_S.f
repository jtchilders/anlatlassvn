...
C  
      ...
      common/to_amps_ug_tdbx_S/  amp2ug_tdbx_S,       jamp2ug_tdbx_S
      ...
      common/to_matrix_ug_tdbx_S/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=ug_tdbx_S(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION ug_tdbx_S(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,4   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
      CALL JIOXXX(W(1,5   ),W(1,3   ),GWF ,WMASS   ,WWIDTH  ,W(1,10  ))    
      CALL IOVXXX(W(1,1   ),W(1,9   ),W(1,10  ),GWF ,AMP(3   ))            
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          ug_tdbx_S =ug_tdbx_S+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      !ug_tdbx_S=12d0*jamp(2)*dconjg(jamp(2)) !!!!!!!!!!!!!!!!!!!
      Do I = 1, NGRAPHS
