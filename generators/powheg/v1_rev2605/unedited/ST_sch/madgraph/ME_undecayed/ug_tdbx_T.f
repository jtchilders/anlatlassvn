...
C  
      ...
      common/to_amps_ug_tdbx_T/  amp2ug_tdbx_T,       jamp2ug_tdbx_T
      ...
      common/to_matrix_ug_tdbx_T/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=ug_tdbx_T(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION ug_tdbx_T(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          ug_tdbx_T =ug_tdbx_T+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      !ug_tdbx_T=12d0*jamp(2)*dconjg(jamp(2)) !!!!!!!!!!!!!!!!!!!
      Do I = 1, NGRAPHS
