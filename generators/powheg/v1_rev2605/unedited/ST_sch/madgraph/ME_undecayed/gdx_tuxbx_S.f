c     !ER:
      SUBROUTINE Sgdx_tuxbx_S(P1,ANS)
C  
...
C  
      ...
      common/to_amps_gdx_tuxbx_S/  amp2gdx_tuxbx_S,       jamp2gdx_tuxbx_S
      ...
      common/to_matrix_gdx_tuxbx_S/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gdx_tuxbx_S(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gdx_tuxbx_S(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,5   ),W(1,3   ),GWF ,WMASS   ,WWIDTH  ,W(1,7   ))    
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,7   ),GWF ,AMP(1   ))            
      CALL JIOXXX(W(1,4   ),W(1,2   ),GWF ,WMASS   ,WWIDTH  ,W(1,8   ))    
      CALL FVIXXX(W(1,5   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,9   ))     
      CALL IOVXXX(W(1,9   ),W(1,3   ),W(1,8   ),GWF ,AMP(2   ))            
      CALL FVOXXX(W(1,3   ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,10  ))     
      CALL IOVXXX(W(1,5   ),W(1,10  ),W(1,8   ),GWF ,AMP(3   ))            
      CALL FVOXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL JIOXXX(W(1,4   ),W(1,11  ),GWF ,WMASS   ,WWIDTH  ,W(1,12  ))    
      CALL IOVXXX(W(1,5   ),W(1,3   ),W(1,12  ),GWF ,AMP(4   ))            
      JAMP(   1) = -AMP(   1)-AMP(   4)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gdx_tuxbx_S =gdx_tuxbx_S+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
