...
c formfactor which is taken as 
c
...
c of lambda and nform.  The formfactors and modified parameters are 
c calculated using the subrouting anomal_formfactor
c
...
c
     ...
     &                spvpm(0:3),spv12(0:3),e1vpm,e2vpm,emv12,epv12
      ...
      double precision facG, facK, facL, fac
