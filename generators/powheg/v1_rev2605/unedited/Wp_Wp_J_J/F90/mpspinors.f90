...
module mpspinors
  ...
  type(mp_real), public :: hc(16)
  ! --- dirac spinors
  type(mp_complex), public :: u(8,16),uz(8,16),ux(8,16)
  !-----Weyl spinors
  type(mp_complex), public :: wz(8,16),wx(8,16),wy(8,16)
  type(mp_complex), public :: bwz(8,16), bwx(8,16), bwy(8,16)
