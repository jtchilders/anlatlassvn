...
contains 
  ...
  function vggg(e1,k1,e2,k2)
    type(mp_complex), intent(in) :: e1(:), e2(:)
    type(mp_complex), intent(in) :: k1(:), k2(:)
    type(mp_complex)             :: vggg(size(e1))
    ! -----------------------------------------
    type(mp_complex):: sk1e2,se1e2,sk2e1,xx
  ...
  function  vgggg(e1,e2,e3)              
    type(mp_complex), intent(in) :: e1(:),e2(:),e3(:)
    type(mp_complex)             :: vgggg(size(e1))
    ! -----------------------------------------
    type(mp_complex):: se1e3,se2e3,se1e2
  ...
  function vqg(sp,e1)
    type(mp_complex), intent(in) :: e1(:)
    type(mp_complex), intent(in) :: sp(:)
    type(mp_complex) :: vqg(size(sp))
  ...
  function vbqq(Dv,sp1,sp2)
    type(mp_complex), intent(in) :: sp1(:), sp2(:)
    integer, intent(in) ::  Dv
    ! -------------------------------------------       
    type(mp_complex) :: vbqq(Dv)
    type(mp_complex) :: rr, va(Dv),sp1a(size(sp1))
    integer :: i
  ...
  function vbqW(sp,e1)
    type(mp_complex), intent(in) :: e1(:)
    type(mp_complex), intent(in) :: sp(:)
    type(mp_complex) :: vbqW(size(sp)),sp5(size(sp))
  ...
  function vWq(e1,sp)
    type(mp_complex), intent(in) :: e1(:)
    type(mp_complex), intent(in) :: sp(:)
    type(mp_complex) :: vWq(size(sp)),sp5(size(sp))
  ...
  recursive function vgluon(e,k,giarray,pol_int) result(res)
    ...
    type(mp_complex)             :: res(size(e,dim=1))
    ! -----------------------------------------------------
    type(mp_complex) :: k1(size(e,dim=1)),k2(size(e,dim=1)),k3(size(e,dim=1))
    type(mp_complex) :: e1(size(e,dim=1)),e2(size(e,dim=1)),e3(size(e,dim=1))
    type(mp_complex) :: tmp(size(e,dim=1))
    type(mp_complex) :: k1sq, k2sq, k3sq
    integer       :: npart, m, m1
    logical :: done 
  ...
  recursive function f(e,k,sp,p,flout,flin,ms,giarray,qiarray,pol_int) &
       &result(res)
    type(mp_complex), intent(in) :: e(:,:), k(:,:), sp(:), p(:)
...
end module mprecurrencebitsone
