...
contains 
  ...
  recursive function fW(e,k,sp,p,flon,floff,&
    ...
    type(mp_complex)             :: res_stored(size(sp))
  ...
  recursive function gW_sbsfbf(e,k,sp,p,fll,eW,kW,&
    ...
    type(mp_complex)             :: res(size(e,dim=1))
    type(mp_complex)             :: tmp(size(e,dim=1))
    type(mp_complex)             :: k1(size(p,dim=1))
    type(mp_complex)             :: k2(size(p,dim=1))
    type(mp_complex)             :: sp1(size(sp,dim=1))
    type(mp_complex)             :: sp2(size(sp,dim=1))
    type(mp_complex)             :: e1(size(e,dim=1))
    type(mp_complex)             :: e2(size(e,dim=1))
  ...
  recursive function gW_sbsfbf_3(e,k,sp,p,fll,eW,kW,&
    ...
    type(mp_complex)             :: k1(size(p,dim=1))
    type(mp_complex)             :: k2(size(p,dim=1))
    type(mp_complex)             :: k3(size(p,dim=1))
    type(mp_complex)             :: k4(size(p,dim=1))
    type(mp_complex)             :: sp1(size(sp,dim=1))
    type(mp_complex)             :: sp2(size(sp,dim=1))
    ...
    type(mp_complex)             :: kdumm(size(k,dim=1),Ndumm)
    type(mp_complex)             :: edumm(size(e,dim=1),Ndumm)
    type(mp_complex)  :: k2sq,k3sq,k1sq,k4sq
    logical                   :: done 
  ...
  recursive function fsW_fbfbf(e,k,sp,p,fll,fl0,&
    ...
    integer, parameter :: Ndumm=0
    type(mp_complex)             :: res(size(sp,dim=1))
    type(mp_complex)             :: res_stored(size(sp,dim=1))
    type(mp_complex)             :: tmp(size(sp,dim=1))
    type(mp_complex)             :: k1(size(k,dim=1))
    type(mp_complex)             :: k2(size(k,dim=1))
    type(mp_complex)             :: sp1(size(sp,dim=1))
  ...
  recursive function fW_bffbffbf(e,k,sp,p,fll,fl0,&
    ...
    type(mp_complex)             :: k1(size(k,dim=1))
    type(mp_complex)             :: k2(size(k,dim=1))
    type(mp_complex)             :: k3(size(k,dim=1))
    type(mp_complex)             :: k4(size(k,dim=1)), k5(size(k,dim=1))
    type(mp_complex)             :: sp1(size(sp,dim=1))
    type(mp_complex)             :: sp2(size(sp,dim=1))
    type(mp_complex)             :: sp3(size(sp,dim=1))
    type(mp_complex)             :: sp4(size(sp,dim=1))
    ...
    type(mp_complex)             :: e2(size(e,dim=1))
    type(mp_complex)             :: e3(size(e,dim=1))
    type(mp_complex)             :: e4(size(e,dim=1))
    type(mp_complex)             :: e5(size(e,dim=1))
    type(mp_complex)             :: kdumm(size(k,dim=1),Ndumm)
    type(mp_complex)             :: edumm(size(e,dim=1),Ndumm)
    type(mp_complex)  :: k1sq,k2sq,k3sq,k4sq, k5sq
    logical                   :: done 
...
end module mprecurrencebitsthree
