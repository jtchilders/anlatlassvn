...
module dpspinors
  ...
  real(dp), public :: hc(16)
  ! --- dirac spinors
  complex(dp), public :: u(8,16),uz(8,16),ux(8,16)
  !-----Weyl spinors
  complex(dp), public :: wz(8,16),wx(8,16),wy(8,16)
  complex(dp), public :: bwz(8,16), bwx(8,16), bwy(8,16)
