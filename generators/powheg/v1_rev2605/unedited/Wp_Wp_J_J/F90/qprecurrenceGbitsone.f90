...
contains 
  ...
  function vggg(e1,k1,e2,k2)
    complex(qp), intent(in) :: e1(:), e2(:)
    complex(qp), intent(in) :: k1(:), k2(:)
    complex(qp)             :: vggg(size(e1))
    ! -----------------------------------------
    complex(qp):: sk1e2,se1e2,sk2e1,xx
  ...
  function  vgggg(e1,e2,e3)              
    complex(qp), intent(in) :: e1(:),e2(:),e3(:)
    complex(qp)             :: vgggg(size(e1))
    ! -----------------------------------------
    complex(qp):: se1e3,se2e3,se1e2
  ...
  function vqg(sp,e1)
    complex(qp), intent(in) :: e1(:)
    complex(qp), intent(in) :: sp(:)
    complex(qp) :: vqg(size(sp))
  ...
  function vbqq(Dv,sp1,sp2)
    complex(qp), intent(in) :: sp1(:), sp2(:)
    integer, intent(in) ::  Dv
    ! -------------------------------------------       
    complex(qp) :: vbqq(Dv)
    complex(qp) :: rr, va(Dv),sp1a(size(sp1))
    integer :: i
  ...
  function vbqW(sp,e1)
    complex(qp), intent(in) :: e1(:)
    complex(qp), intent(in) :: sp(:)
    complex(qp) :: vbqW(size(sp)),sp5(size(sp))
  ...
  function vWq(e1,sp)
    complex(qp), intent(in) :: e1(:)
    complex(qp), intent(in) :: sp(:)
    complex(qp) :: vWq(size(sp)),sp5(size(sp))
  ...
  recursive function vgluon(e,k,giarray,pol_int) result(res)
    ...
    complex(qp)             :: res(size(e,dim=1))
    ! -----------------------------------------------------
    complex(qp) :: k1(size(e,dim=1)),k2(size(e,dim=1)),k3(size(e,dim=1))
    complex(qp) :: e1(size(e,dim=1)),e2(size(e,dim=1)),e3(size(e,dim=1))
    complex(qp) :: tmp(size(e,dim=1))
    complex(qp) :: k1sq, k2sq, k3sq
    integer       :: npart, m, m1
    logical :: done 
...
end module qprecurrencebitsone
