...
contains 
  ...
  recursive function gW_sbsfbf(e,k,sp,p,fll,eW,kW,&
    ...
    complex(dp)             :: res(size(e,dim=1))
    complex(dp)             :: tmp(size(e,dim=1))
    complex(dp)             :: k1(size(p,dim=1))
    complex(dp)             :: k2(size(p,dim=1))
    complex(dp)             :: sp1(size(sp,dim=1))
    complex(dp)             :: sp2(size(sp,dim=1))
    complex(dp)             :: e1(size(e,dim=1))
    complex(dp)             :: e2(size(e,dim=1))
  ...
  recursive function gW_sbsfbf_3(e,k,sp,p,fll,eW,kW,&
    ...
    complex(dp)             :: k1(size(p,dim=1))
    complex(dp)             :: k2(size(p,dim=1))
    complex(dp)             :: k3(size(p,dim=1))
    complex(dp)             :: k4(size(p,dim=1))
    complex(dp)             :: sp1(size(sp,dim=1))
    complex(dp)             :: sp2(size(sp,dim=1))
    ...
    complex(dp)             :: kdumm(size(k,dim=1),Ndumm)
    complex(dp)             :: edumm(size(e,dim=1),Ndumm)
    complex(dp)  :: k2sq,k3sq,k1sq,k4sq
    logical                   :: done 
  ...
  recursive function fW_bffbffbf(e,k,sp,p,fll,fl0,&
    ...
    integer :: ngluon, ng6,m1,i
    integer, parameter :: Ndumm=0
    complex(dp)             :: res(size(sp,dim=1))
    complex(dp)             :: tmp(size(sp,dim=1))
    complex(dp)             :: k1(size(k,dim=1))
    complex(dp)             :: k2(size(k,dim=1))
    complex(dp)             :: k3(size(k,dim=1))
    complex(dp)             :: k4(size(k,dim=1)), k5(size(k,dim=1))
    complex(dp)             :: sp1(size(sp,dim=1))
    complex(dp)             :: sp2(size(sp,dim=1))
    complex(dp)             :: sp3(size(sp,dim=1))
    complex(dp)             :: sp4(size(sp,dim=1))
    ...
    complex(dp)             :: e2(size(e,dim=1))
    complex(dp)             :: e3(size(e,dim=1))
    complex(dp)             :: e4(size(e,dim=1))
    complex(dp)             :: e5(size(e,dim=1))
    complex(dp)             :: kdumm(size(k,dim=1),Ndumm)
    complex(dp)             :: edumm(size(e,dim=1),Ndumm)
    complex(dp)  :: k1sq,k2sq,k3sq,k4sq, k5sq
    logical                   :: done 
...
end module dprecurrencebitsthree
