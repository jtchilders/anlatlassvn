...
module dpvvn
  ...
  use dpgram; use dpaux_functions
  implicit none 
  private 
...
contains
  ...
  subroutine give4to4vect(k1,k2,k3,k4,v)
    complex(dp), intent(in) :: k1(:),k2(:),k3(:),k4(:)
...
!    vaux(4)=cone*4.3_dp
!^^^ELSE
    vaux(1)=cmplx(0.5_dp,0.0_dp)
    vaux(2)=cmplx(2.7_dp,0.0_dp)
    vaux(3)=cmplx(3.2_dp,0.0_dp)
    vaux(4)=cmplx(4.3_dp,0.0_dp)
!^^^END
  ...
  subroutine give2to4vect(k1,k2,v)
    complex(dp),  intent(in) :: k1(:),k2(:)
    complex(dp),  intent(out) ::  v(:,:)
    ! ---------------------------------------------
    complex(dp) :: v1(4),v2(4),v3(4),v4(4)
    complex(dp) :: vaux(4)
    complex(dp) :: d2,ko1,ko2,ko3
    ...
    vaux(1)=cmplx(1.3_dp,0.0_dp)
    vaux(2)=cmplx(1.7_dp,0.0_dp)
    vaux(3)=cmplx(2.4_dp,0.0_dp)
    vaux(4)=cmplx(3.5_dp,0.0_dp)
...
!    vaux(4)=czero+0.5_dp
!^^^ELSE
    vaux(1)=cmplx(2.1_dp,0.0_dp)
    vaux(2)=cmplx(1.2_dp,0.0_dp)
    vaux(3)=cmplx(3.4_dp,0.0_dp)
    vaux(4)=cmplx(0.5_dp,0.0_dp)
!^^^END
...
!^^^IFmp
!    v2aux(1)=czero+1.3_dp
!    v2aux(2)=czero+1.7_dp
!    v2aux(3)=czero+2.3_dp
!    v2aux(4)=czero+3.4_dp
!^^^ELSE
    v2aux(1)=cmplx(1.3_dp,0.0_dp)
    v2aux(2)=cmplx(1.7_dp,0.0_dp)
    v2aux(3)=cmplx(2.3_dp,0.0_dp)
    v2aux(4)=cmplx(3.4_dp,0.0_dp)
!^^^END
    a1v = sc(v2aux,v1)
...
!^^^IFmp
!    vaux(1)=czero + 1.5_dp
!    vaux(2)=czero + 13.2_dp
!    vaux(3)=czero + 14.1_dp
!    vaux(4)=czero + 9.1_dp
!^^^ELSE
    vaux(1)=cmplx(1.5_dp,0.0_dp)
    vaux(2)=cmplx(13.2_dp,0.0_dp)
    vaux(3)=cmplx(14.1_dp,0.0_dp)
    vaux(4)=cmplx(9.1_dp,0.0_dp)  
!^^^END
    a1v = sc(v1,vaux)
    a2v = sc(v2,vaux)
...
!^^^IFmp
!    vaux1(1)=czero + 2.4_dp
!    vaux1(2)=czero + 1.3_dp
!    vaux1(3)=czero + 3.45_dp
!    vaux1(4)=czero + 0.56_dp
!^^^ELSE
    vaux1(1)=cmplx(2.4_dp,0.0_dp)
    vaux1(2)=cmplx(1.3_dp,0.0_dp)
    vaux1(3)=cmplx(3.45_dp,0.0_dp)
    vaux1(4)=cmplx(0.56_dp,0.0_dp)
!^^^END
  ...
  subroutine give1to4vect_light(k1,v)
    ...
    if (abs(d2) < tol) then 
       k1d(1)=1.0_dp+ci*0.0_dp
       k1d(2)=1.0_dp/sqrt3 + ci*0.0_dp
       k1d(3)=1.0_dp/sqrt3 + ci*0.0_dp
       k1d(4)=1.0_dp/sqrt3 + ci*0.0_dp
    endif
    ...
    if (abs(d2).lt. sq2tol) then 
       k1d(1)=1.0_dp + ci*0.0_dp
       k1d(2)=1.0_dp/sqrt3 + ci*0.0_dp
       k1d(3)=sqrt2/sqrt3 + ci*0.0_dp
       k1d(4)=0.0_dp + ci*0.0_dp
    endif
    ...
    vaux(1)=(1.5_dp + ci*0.0_dp)
    vaux(2)=(13.2_dp + ci*0.0_dp)
    vaux(3)=(14.1_dp + ci*0.0_dp)
    vaux(4)=(9.1_dp + ci*0.0_dp)
    ...
    vaux1(1)=(2.4_dp + ci*0.0_dp)
    vaux1(2)=(1.35_dp + ci*0.0_dp)
    vaux1(3)=(3.61_dp + ci*0.0_dp)
    vaux1(4)=(0.54_dp + ci*0.0_dp)  
