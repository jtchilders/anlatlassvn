...
module dprecurrencebitstwo
  ...
  public :: g_sbsfbf, bf_fbff, f_bffbffbf, bf_fbff_2
  ...
  recursive function f_bffbffbf(e,k,sp,p,fll,fl0,&
    ...
    if ((fl0.eq.fl3).and.(fl1.eq.fl2)&
       ...
       if (ngluon == 0) then 
          ...
          !! RR added 17/8/2010
          if (case_a2) then
             sp2 = f_bffbf_2(edumm,kdumm,sp(:,3:5),p(:,3:5),&
                  &fll(3:5),fl0,0,0,0,&
    ...
    ! RR - this interfering with W+W-4q for primitive A2,
    ! so I have put this extra logical in -- can be 
    ! replaced by the appropriate logical for ferm_loops_Z_sbs
    if ((fl0.eq.fl5).and.(fl1.eq.fl2).and.(fl3.eq.fl4).and. (.not. case_a2)) then 
...
end module dprecurrencebitstwo
