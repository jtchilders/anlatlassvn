...
module mpopp
  ...
  use types; use consts_mp; use define_ampl
  use mppol_int; use mpaux_functions; use mpvvn
  use match1; use mpamplitude; use mpglobal 
  use mpcut_utils 
  implicit none 
  private 
...
contains
  ...
  subroutine resid5(Ds,lv,k1,k2,k3,k4,l5c,f5c,ij,res)
    ...
    type(mp_complex), intent(in)  :: k1(4),k2(4),k3(4),k4(4)
    type(mp_complex), intent(in)  :: lv(5)
    type(mp_complex), intent(out) :: res
    ! ------------------------------------------------------------       
    type(mp_complex) :: q1(5),q2(5),q3(5),q4(5),q5(5)
    type(mp_complex) :: BPOL1(8,16),POL1(8,16)
    type(mp_complex) :: BPOL2(8,16),POL2(8,16)
    type(mp_complex) :: BPOL3(8,16),POL3(8,16)
    type(mp_complex) :: BPOL4(8,16),POL4(8,16)
    type(mp_complex) :: BPOL5(8,16),POL5(8,16)
    type(mp_complex) :: mur1(10,10),mur2(10,10)
    type(mp_complex) :: mur3(10,10),mur4(10,10)
    type(mp_complex) :: mur5(10,10)
    type(mp_complex) :: res6,res8
  ...
  subroutine resid4(Ds,lv,k1,k2,k3,l4c,f4c,ij,N5,Lc5,F5,N4,Lc4,F4,N3,Lc3,F3,N2,Lc2,F2,res)
    ...
    integer, intent(in)        :: ij
    type(mp_complex), intent(in)  :: k1(4),k2(4),k3(4)
    type(mp_complex), intent(in)  :: lv(Ds)
    integer, intent(in)        :: Lc5(:,:),Lc4(:,:),Lc3(:,:),Lc2(:,:)
    character, intent(in)      :: F5(:,:)*3,F4(:,:)*3,F3(:,:)*3,F2(:,:)*3
    type(mp_complex), intent(out) :: res
    ! --------------------------------------------------------------------       
    type(mp_complex) ::  q1(5),q2(5),q3(5),q4(5)
    type(mp_complex) ::  BPOL1(8,16),POL1(8,16)
    type(mp_complex) ::  BPOL2(8,16),POL2(8,16)
    type(mp_complex) ::  BPOL3(8,16),POL3(8,16)
    type(mp_complex) ::  BPOL4(8,16),POL4(8,16)
    ...
    type(mp_complex) ::  mur3(10,10),mur4(10,10)
    type(mp_complex) ::  res6,res8
    type(mp_complex) ::  krefa(4),lvt(5)
    type(mp_complex) ::  e(1),vprop(5),prop
    character     ::  lab*3, lab1*3, lab2*3
...
49     if (l4c(1).ne.Lc5(im,j)) then 
  ...
  subroutine resid3(Ds,lv,k1,k2,l3c,f3c,ij,N5,Lc5,F5,N4,Lc4,F4,N3,Lc3,F3,N2,Lc2,F2,res)
    ...
    type(mp_complex), intent(in)  :: k1(4),k2(4),lv(Ds)
    integer, intent(in)        :: N5,N4,N3,N2
    integer, intent(in)        :: Lc5(:,:),Lc4(:,:),Lc3(:,:),Lc2(:,:)
    character, intent(in)      :: F5(:,:)*3,F4(:,:)*3,F3(:,:)*3,F2(:,:)*3
    type(mp_complex), intent(out) :: res
    ! ----------------------------------------------------------------
    type(mp_complex) :: lvt(5)
    type(mp_complex) :: v45(4),vprop(5),prop,r1,r2,krefa(4),d(5)
    type(mp_complex) :: q1(5),q2(5),q3(5)
    type(mp_complex) :: vne(5)
    type(mp_complex) :: BPOL1(8,16),POL1(8,16)
    type(mp_complex) :: BPOL2(8,16),POL2(8,16)
    type(mp_complex) :: BPOL3(8,16),POL3(8,16)
    type(mp_complex) :: mur1(10,10),mur2(10,10)
    type(mp_complex) :: mur3(10,10)
    type(mp_complex) :: e(1)
    type(mp_complex) :: res6,res8
    type(mp_complex) :: prop1,prop2,r22
...
50     if (l3c(1).ne.Lc4(im,j)) then 
  ...
  subroutine resid2(Ds,lv,k1,l2c,f2c,ij,N5,Lc5,F5,N4,Lc4,F4,N3,Lc3,F3,N2,Lc2,F2,res)
    ...
    type(mp_complex), intent(in)  :: lv(Ds)
    type(mp_complex), intent(in)  :: k1(4)
    integer, intent(in)        :: N5,N4,N3,N2
    integer, intent(in)        :: Lc5(:,:),Lc4(:,:),Lc3(:,:),Lc2(:,:)
    character, intent(in)      :: F5(:,:)*3,F4(:,:)*3,F3(:,:)*3,F2(:,:)*3
    type(mp_complex), intent(out) :: res
    ! ------------------------------------------------------------       
    type(mp_complex) :: lvt(5),e(1)
    type(mp_complex) :: v45(4),vprop(5),prop,r1,r2,krefa(4)
    type(mp_complex) :: d(5),c(10),re
    type(mp_complex) :: prop1,prop2
    type(mp_complex) :: q1(5),q2(5)
    type(mp_complex) :: r3,r4
    type(mp_complex) :: vne(5),trikoeff
    type(mp_complex) :: v3(4),v4(4)
    type(mp_complex) :: BPOL1(8,16),POL1(8,16)
    type(mp_complex) :: BPOL2(8,16),POL2(8,16)
    type(mp_complex) :: mur1(10,10),mur2(10,10)
    type(mp_complex) :: res6,res8
    type(mp_complex) :: q12(5),prop3,r22,r32,r42
    character     :: lab*3, lab1*3, lab2*3
...
52     if (l2c(1).ne.Lc3(im,j)) then 
  ...
  subroutine pentcut(Lc5,F5,Yc5)
    ...
    ! -----------------------------------------------------------------
    type(mp_complex) :: k1(4),k2(4),k3(4),k4(4)
    type(mp_complex) :: v(4,4), v1(4),v2(4), v3(4), v4(4)
    type(mp_complex) :: lv5(5)
    type(mp_complex) :: V1234(4)
    type(mp_complex) :: x1,x2,x3,r1,r2,r3,r4,ltr,x4
    type(mp_complex) :: summ,sump
    type(mp_complex) :: e(1)
    type(mp_real)    :: m(5)
    integer       :: i,j,ij      
    integer       :: l5cut(5)
    ...
    character     :: f5cut(5)*3
    ! ------------------------------------
    type(mp_complex) :: pred(4,4), vi(4,4)  
...
!------changed, KM, divided by ltr**2
  ...
  subroutine quadcut(Lc5,F5,Yc5,Lc4,F4,Yc4,Lc3,F3,Yc3,Lc2,F2,Yc2)  ! quadrupole cut
    ...
    ! ------------------------------------------------------------      
    type(mp_complex) ::  k1(4),k2(4),k3(4)
    type(mp_complex) ::  v(4,4), v1(4),v2(4), v3(4), v4(4)
    type(mp_complex) ::  lv4(4),lv5(5)
    type(mp_complex) ::  V123(4)
    type(mp_complex) ::  x1,x2,x3,r1,r2,r3,ltr,xtr,xe,x4
    type(mp_complex) ::  koeffp, koeffm, koeff1, koeff2
    type(mp_complex) ::  summ,sump
    type(mp_complex) ::  d(5)
    type(mp_real)    :: m(4)
    integer       ::  i,j,ij      
    ...
    integer       :: N5,N4,N3,N2
    ! ------------------------------------
    type(mp_complex) :: ni(4,1), pred(4,3), vi(4,3)  
    ...
    do i=1,N4
       ...
       d(3)=-half*(mpreal('9.0')*koeff1-mpreal('16.0')*koeff2)/ltr**2
       d(5)= mpreal('3.0')*(mpreal('3.0')*koeff1-mpreal('4.0')*koeff2)/ltr**4
  ...
  subroutine tripcut(Lc5,F5,Yc5,Lc4,F4,Yc4,Lc3,F3,Yc3,Lc2,F2,Yc2)
    ...
    integer, intent(in)   :: Yc5(:,:),Yc4(:,:),Yc3(:,:),Yc2(:,:)
    ! ----------------------------------------------------------       
    type(mp_complex) :: k1(4),k2(4)
    type(mp_complex) :: v(4,4), v1(4),v2(4), v3(4), v4(4)
    type(mp_complex) :: lv4(4),lva(5),lvb(5),lv4a(4),lv4b(4)
    type(mp_complex) :: V12(4)
    type(mp_complex) :: x1,x2,r1,r2,ltr,xtr,xe,x4
    type(mp_complex) :: summ,sump
    type(mp_complex) :: c(10)
    type(mp_complex) :: lhs_eqs(7), lhseq_new(4),lhseq(4)
    type(mp_complex) :: lhseqa,lhseqb
    type(mp_complex) :: phi1,r3a,r4a,r3b,r4b
    type(mp_complex) :: bcoeff(-3:3)
    type(mp_complex) :: dcp,dsp
    type(mp_real)    :: m(3)
    type(mp_real)    :: buff, phi
    integer       :: i,j,kk,ss,i1,ij      
    integer       :: l3cut(3)
    character     :: f3cut(3)*3
    integer       :: N5,N4,N3,N2
    ! ------------------------------------
    type(mp_complex) :: ni(4,2), pred(4,2),vi(4,2)
    ! -- variables needed for stability test 
    type(mp_complex) :: rnx,lv_rn(5),res_v1,res_v2,res_err
    type(mp_complex) :: ldv3,ldv4,lvsq
    type(mp_real)    :: rn1,rn2,rn3
    ...
    do i=1,N3
       ...
       if (abs(ltr).ge.buff) then 
          ...
          do kk=1,7
             phi=mpreal('2.0')*pi*(kk-1)/mpreal('7.0')
             dcp=ltr*cos(phi)
             dsp=ltr*sin(phi)
          ...
          do j=1,7
             ...
             bcoeff(ss)=czero
             do kk=1,7
                phi1= mpreal('-2.0')*pi*ci/mpreal('7.0')*(kk-1)*ss
                bcoeff(ss)= bcoeff(ss)+mpreal('1.0')/mpreal('7.0')*lhs_eqs(kk)*exp(phi1)
             enddo
          enddo


          c(1)=bcoeff(0)
          c(4)= mpreal('-2.0')*ci*(bcoeff(-2)-bcoeff(2))/ltr**2
          c(5)=(bcoeff(-2)+bcoeff(2))/ltr**2
          c(6)= mpreal('-4.0')*ci*(bcoeff(-3)-bcoeff(3))/ltr**3
          c(7)= mpreal('-4.0')*(bcoeff(-3)+bcoeff(3))/ltr**3
          c(2)= mpreal('0.25')*(-c(7)*ltr**3+4*bcoeff(-1)+mpreal('4.0')*bcoeff(1))/ltr
          c(3)= mpreal('0.25')*ci*(c(6)*ltr**3*ci   &
               &-mpreal('4.0')*bcoeff(-1)+mpreal('4.0')*bcoeff(1))/ltr

          ! -- stability check in 4 dimensions 
          !rnx = mpreal('17.')/mpreal('19.')
          ...
          !   write(*,*) 'not ZERO?',mptodp(res_v1-res_v2)
          !endif
          ...
          c(9)=(lhseqb - lhseqa)/mpreal('2.0')/r3b/xe**2
          ...
          rn1=mpreal('17.')/mpreal('19.')
          rn2= mpreal('-5.')/mpreal('7.')
          rn3=mpreal('23.')/mpreal('29.')
       ...
       elseif (abs(ltr).lt.buff) then 
          ...
          do kk=1,4
             phi=mpreal('2.0')*pi/four*(kk-1)
             xtr=exp(ci*phi)+ci*mpreal('10.')*tol 
          ...
          do i1=1,4
             ...
             do kk=1,4  
                phi1= mpreal('-2.0')*pi*ci/four*(kk-1)*ss
                bcoeff(ss)=bcoeff(ss)+mpreal('0.25')*lhseq(kk)*exp(phi1)
             enddo
          enddo
          ...
          c(4)=(lhseq_new(1)-lhseq_new(3))/mpreal('2.0')
          c(3)=(lhseq_new(1)+lhseq_new(2)-(cone+ci)*c(4))/mpreal('2.0')
          c(6)=(lhseq_new(1)-lhseq_new(2)-(cone-ci)*c(4))/mpreal('2.0')


          !! -- stability check in 4 dimension 
          !rnx = exp(ci*(mpreal('17.')/mpreal('19.')))
          !x4 = sqrt(ltr**2-rnx**2)
          ...
          !
          !if (abs(res_v1-res_v2) > sq2tol) then 
          !   write(*,*) 'small buff: not ZERO?',mptodp(res_v1-res_v2),&
          !        &mptodp(res_v1),mptodp(res_v2)
          !endif

          !------now determine  ep-dimensional structures

          xtr=cone-ci*mpreal('10.')*tol
  ...
  subroutine doubcut(Lc5,F5,Yc5,Lc4,F4,Yc4,Lc3,F3,Yc3,Lc2,F2,Yc2)
    ...
    integer, intent(in)   :: Yc5(:,:),Yc4(:,:),Yc3(:,:),Yc2(:,:)
    ! --------------------------------------------------------------       
    type(mp_complex) :: k1(4),k1d(4)
    type(mp_complex) :: d1k1_test
    type(mp_complex) :: v1(4),v2(4), v3(4), v4(4)
    type(mp_complex) :: V1234(4,4),lv(5),V12(4)
    type(mp_complex) :: x1,x2,x3,r1,r2,r3,r4,ltr,xtr,xe,x4
    type(mp_complex) :: ltr2a,ltr2b
    type(mp_complex) :: sump,lhseqc
    type(mp_complex) :: b(10),phi1
    type(mp_complex) :: lhs_eqs(7)
    type(mp_complex) :: lhseqa,lhseqb,lhseqd,lhs_eqa(3), lhs_eqb(3)
    type(mp_complex) :: lhseq1,lhseq47a,lhseq47b,lhseq2new
    type(mp_complex) :: lhseq4new,lhseq3,lhseq36a,lhseq36b
    type(mp_complex) :: lhseq1new,lhseq2
    type(mp_complex) :: lhs_eqm(3),lhs_eqp(3),b1eff
    type(mp_complex) :: bcoeff(-3:3)
    type(mp_complex) :: dcp,dsp
    type(mp_real)    :: m(2)
    type(mp_real)    :: buff, phi
    ...
    integer       :: N5,N4,N3,N2
    ! ------------------------------------
    type(mp_complex) :: ni(4,3), pred(4,1) 
    ! -- variables needed to test stability 
    type(mp_complex) :: rnx,lv_rn(5),res_v1,res_v2,res_err
    type(mp_complex) :: ldv2,ldv3,ldv4,lvsq
    type(mp_real)    :: rn1,rn2,rn3,rn4
    ...
    do i=1,N2
       ...
       if (abs(d1k1_test).eq.zero) then 
          ...
          lhseq1=mpreal('0.25')*(lhseqa+lhseqb+lhseqc+lhseqd)

          b(9)=mpreal('0.25')/(-x4)*(lhseqa-lhseqc-lhseqb+lhseqd)

          lhseq47a=mpreal('0.25')/(-x4)*(lhseqa-lhseqc+lhseqb-lhseqd)
          lhseq36a=(lhseqa-lhseqb)/mpreal('2.0') - b(9)*(-x4)
          ...
          lhseq3=mpreal('0.25')*(lhseqa+lhseqb+lhseqc+lhseqd)

          lhseq47b=mpreal('0.25')/(-x4)*(lhseqa-lhseqc+lhseqb-lhseqd)
          lhseq36b=(lhseqa-lhseqb)/mpreal('2.0')-b(9)*(-x4)
          ...
          b(8)=mpreal('2.0')/mpreal('3.0')*(lhseq1-lhseq2new)
          ...
          lhseq1new=lhseq1-b(8)*(mpreal('2.0')-ltr2a) -b(2)/two*r1

          b(1)=(mpreal('4.0')*lhseq4new - lhseq1new)/mpreal('3.0')
          b(5)=mpreal('16.0')/r1*(lhseq4new - b(1))
          ...
          if (abs(ltr) > buff ) then 
             ...
             do kk=1,6
                ...
                phi=mpreal('2.0')*pi/mpreal('6.0')*(kk-1)
                dcp=ltr*cos(phi)
                dsp=ltr*sin(phi)
             ...
             do i1=1,6
                ...
                do kk=1,6  
                   phi1= mpreal('-2.0')*pi*ci/mpreal('6.0')*(kk-1)*ss
                   bcoeff(ss)=bcoeff(ss)+one/mpreal('6.')*lhs_eqs(kk)*exp(phi1)
                enddo
             enddo

             !-------------------------------------b1eff is b1 + b6*ltr**2
             b1eff=bcoeff(0)
             b(2)=mpreal('1.0')/ltr*(bcoeff(1)+bcoeff(-1))
             b(3)=ci/ltr*(bcoeff(1)-bcoeff(-1))
             b(5)=mpreal('1.0')/ltr**2*(bcoeff(2)+bcoeff(-2))
             b(7)=mpreal('2.0')*ci/ltr**2*(bcoeff(2)-bcoeff(-2))
             ...
             b(6)=mpreal('2.0')/mpreal('3.0')/ltr**2*(b1eff-(lhseq2+lhseq3)/&
                  &mpreal('2.0') -b(8)*ltr**2/mpreal('2.0'))
             ...
             b(9)=mpreal('2.0')/ltr**2*(lhseq1-b(1)-b(2)*r2-b(3)*r3-b(4)*r4-b(5)&
                  &*(r2**2-r3**2)-b(6)*(r2**2 + r3**2 - 2*r4**2)-b(7)*r2*r3 -b(8)*r2*r4)


             !! -- stability check in 4 dimension 
             !rn1=mpreal('7.')/mpreal('19.')
             !rn2= mpreal('-5.')/mpreal('17.')
             ...
             !
             !if (abs(res_v1-res_v2) > sq2tol) then 
             !   write(*,*) 'bub: big buff ZERO2?',mptodp(abs(res_v1-res_v2))&
             !        &,mptodp(abs(res_v1)),mptodp(abs(res_v2))
             !endif
             ...
             do kk=1,3
                phi=mpreal('2.0')*pi/three*(kk-1)
                xtr=exp(ci*phi)

                x3=sqrt(ltr**2 - xtr**2-ci*mpreal('10.')*tol)
             ...
             do i1=1,3
                ...
                do kk=1,3
                   bcoeff(ss)=bcoeff(ss)+mpreal('1.0')/three*lhs_eqp(kk)&
                        &*exp(-mpreal('2.0')*pi*ci/three*(kk-1)*ss)
                enddo
             enddo

             b(5)=bcoeff(2)/mpreal('2.0')
             b(2)=bcoeff(1)

             b1eff=(bcoeff(0)+b(5)*ltr**2)


             b(7)=(lhs_eqm(1)-lhs_eqm(2))/(cone -exp(mpreal('2.0')*pi/three*ci))
             b(3)=lhs_eqm(1) - b(7)
          ...
          if (abs(ltr) > buff ) then 
             ...
             rn1=mpreal('11.')/mpreal('19.')
             rn2= mpreal('-1.')/mpreal('7.')
             rn3= mpreal('3.')/mpreal('29.')
