...
module qprecurrencebitsthree
  ...
  public :: fW,bfW,gW_fbf,gW_bff,fW_bffbf, fW_bffbf_2W
  public :: fsW_fbfbf
...
contains 
  ...
  recursive function fW(e,k,sp,p,flon,floff,&
    ...
    complex(qp)             :: res_stored(size(sp))
    complex(qp)             :: tmp(size(sp))
    complex(qp)             :: k1(size(p))
    complex(qp)             :: k2(size(p))
  ...
  recursive function fW_bffbf(e,k,sp,p,fll,fl0,&
    ...
    if (ngluon == 0) then 
       ...
       if (((sw.eq.3).or.(sw.eq.4)) .and. ((qbq_WW_and_gluons .eqv. .false.) &
            &.or. (case_a3 .eqv. .true.))) then 
  ...
  recursive function gW_sbsfbf(e,k,sp,p,fll,eW,kW,&
    ...
    complex(qp)             :: res(size(e,dim=1))
    complex(qp)             :: tmp(size(e,dim=1))
    complex(qp)             :: k1(size(p,dim=1))
    complex(qp)             :: k2(size(p,dim=1))
    complex(qp)             :: sp1(size(sp,dim=1))
    complex(qp)             :: sp2(size(sp,dim=1))
    complex(qp)             :: e1(size(e,dim=1))
    complex(qp)             :: e2(size(e,dim=1))
  ...
  recursive function gW_sbsfbf_3(e,k,sp,p,fll,eW,kW,&
    ...
    complex(qp)             :: k1(size(p,dim=1))
    complex(qp)             :: k2(size(p,dim=1))
    complex(qp)             :: k3(size(p,dim=1))
    complex(qp)             :: k4(size(p,dim=1))
    complex(qp)             :: sp1(size(sp,dim=1))
    complex(qp)             :: sp2(size(sp,dim=1))
    ...
    complex(qp)             :: kdumm(size(k,dim=1),Ndumm)
    complex(qp)             :: edumm(size(e,dim=1),Ndumm)
    complex(qp)  :: k2sq,k3sq,k1sq,k4sq
    logical                   :: done 
  ...
  recursive function fsW_fbfbf(e,k,sp,p,fll,fl0,&
    ...
    integer, parameter :: Ndumm=0
    complex(qp)             :: res(size(sp,dim=1))
    complex(qp)             :: res_stored(size(sp,dim=1))
    complex(qp)             :: tmp(size(sp,dim=1))
    complex(qp)             :: k1(size(k,dim=1))
    complex(qp)             :: k2(size(k,dim=1))
    complex(qp)             :: sp1(size(sp,dim=1))
  ...
  recursive function fW_bffbffbf(e,k,sp,p,fll,fl0,&
    ...
    complex(qp)             :: k1(size(k,dim=1))
    complex(qp)             :: k2(size(k,dim=1))
    complex(qp)             :: k3(size(k,dim=1))
    complex(qp)             :: k4(size(k,dim=1)), k5(size(k,dim=1))
    complex(qp)             :: sp1(size(sp,dim=1))
    complex(qp)             :: sp2(size(sp,dim=1))
    complex(qp)             :: sp3(size(sp,dim=1))
    complex(qp)             :: sp4(size(sp,dim=1))
    ...
    complex(qp)             :: e2(size(e,dim=1))
    complex(qp)             :: e3(size(e,dim=1))
    complex(qp)             :: e4(size(e,dim=1))
    complex(qp)             :: e5(size(e,dim=1))
    complex(qp)             :: kdumm(size(k,dim=1),Ndumm)
    complex(qp)             :: edumm(size(e,dim=1),Ndumm)
    complex(qp)  :: k1sq,k2sq,k3sq,k4sq, k5sq
    logical                   :: done 
...
end module qprecurrencebitsthree
