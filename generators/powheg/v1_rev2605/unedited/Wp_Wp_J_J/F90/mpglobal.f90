...
module mpglobal 
  ...
  type(mp_complex), allocatable   ,public   :: mom(:,:,:)
  type(mp_complex), allocatable   ,public   :: mom2(:,:,:,:)
  type(mp_complex), allocatable   ,public   :: hel(:,:,:)
  type(mp_complex), allocatable   ,public   :: hel2(:,:,:,:)
  type(mp_complex), allocatable   ,public   :: momline(:,:,:)
  type(mp_complex), allocatable   ,public   :: momline2(:,:,:,:)
  ...
  type(mp_complex), allocatable   ,public   :: coeff5(:,:),propv5(:,:)
  type(mp_complex), allocatable   ,public   :: coeff4(:,:)
  type(mp_complex), allocatable   ,public   :: refvect4(:,:),propv4(:,:)
  type(mp_complex), allocatable   ,public   :: coeff3(:,:),refvect3(:,:)
  type(mp_complex), allocatable   ,public   :: propv3(:,:)
  type(mp_complex), allocatable   ,public   :: coeff2(:,:),refvect2(:,:)
  type(mp_complex), allocatable   ,public   :: propv2(:,:)
  type(mp_complex), allocatable   ,public   :: coeff1(:,:)	

  type(mp_complex), allocatable   ,public   :: dcoeff1(:,:),dcoeff2(:,:)
  type(mp_complex), allocatable   ,public   :: dcoeff3(:,:),dcoeff4(:,:)
  type(mp_complex), allocatable   ,public   :: dcoeff5(:,:)

  type(mp_real), allocatable      ,public   :: mass5(:,:),mass4(:,:),mass3(:,:)
  type(mp_real), allocatable      ,public   :: mass2(:,:),mass1(:,:)
  type(mp_real)                   ,public   :: en,ptcut,etacut, eg
  ...
  type(mp_complex), public :: MCFMpol_ext_qq(2,4,-1:1)  
  type(mp_complex), public :: MCFMpol_ext_gg(2,4,-1:1)  
  type(mp_complex), public :: MCFMpol_ext_ww(2,4,-1:1) 
  type(mp_complex), public :: MCFMpol_ext_z(4) 
  type(mp_real), public    :: MCFMhardscale, MCFMsqrthardscale 
