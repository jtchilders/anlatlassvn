...
contains
  ...
  subroutine pamplWpWp(pext,pl,pa,hl,lncuts,N5,N4,N3,tN2,N2,N1,&
    ...
    logical:: nodum
    type(mp_complex), intent(out) :: tree
    type(mp_real), intent(in)     :: mu
    type(mp_complex), intent(out) :: div2, div1, div3
    ! -------------------------------------------------
    ...
    integer :: Yc2a(tN2,1)
    type(mp_complex) :: e(size(pext,dim=1),4)
    type(mp_complex) :: sp(4,Npoint), p(4,Npoint)
    character :: fl1(Npoint)*3
    integer :: ng,nq,nW
    type(mp_complex) :: vg(4), vs(4)
  ...
  subroutine  oneloopdiv(mu,p,rdiv2,rdiv1,rdiv3)
    ...
    type(mp_real), intent(in)     :: mu
    type(mp_complex), intent(out) :: rdiv2, rdiv1,rdiv3
    ! ---------------------------------------------
    type(mp_complex) :: ap1(size(p,dim=1)), ap2(size(p,dim=1))
    type(mp_complex) :: s
    type(mp_real)    :: mu2
    integer       :: i, Nmax
