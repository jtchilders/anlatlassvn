...
module dpopp
  ...
  use match1; use dpamplitude; use dpglobal 
  use dpcut_utils 
  implicit none 
  private 
...
contains
  ...
  subroutine resid5(Ds,lv,k1,k2,k3,k4,l5c,f5c,ij,res)
    ...
    complex(dp), intent(in)  :: k1(4),k2(4),k3(4),k4(4)
    complex(dp), intent(in)  :: lv(5)
    complex(dp), intent(out) :: res
    ! ------------------------------------------------------------       
    complex(dp) :: q1(5),q2(5),q3(5),q4(5),q5(5)
    complex(dp) :: BPOL1(8,16),POL1(8,16)
    complex(dp) :: BPOL2(8,16),POL2(8,16)
    complex(dp) :: BPOL3(8,16),POL3(8,16)
    complex(dp) :: BPOL4(8,16),POL4(8,16)
    complex(dp) :: BPOL5(8,16),POL5(8,16)
    complex(dp) :: mur1(10,10),mur2(10,10)
    complex(dp) :: mur3(10,10),mur4(10,10)
    complex(dp) :: mur5(10,10)
    complex(dp) :: res6,res8
  ...
  subroutine resid4(Ds,lv,k1,k2,k3,l4c,f4c,ij,N5,Lc5,F5,N4,Lc4,F4,N3,Lc3,F3,N2,Lc2,F2,res)
    ...
    complex(dp) ::  mur3(10,10),mur4(10,10)
    complex(dp) ::  res6,res8
    complex(dp) ::  krefa(4),lvt(5)
    complex(dp) ::  e(1),vprop(5),prop
    character     ::  lab*3, lab1*3, lab2*3
    ...
    if (Ds.eq.5) then 
       ...
       do j=1,4
          !          if (f4c(j).eq.'top'.or.f4c(j).eq.'bot'.or.f4c(j).eq.'str'.or.f4c(j).eq.'chr') then 
          if (quark_flavour(f4c(j))) then 
             res = ci*res
          else
             res = (-ci)*res
...
49     if (l4c(1).ne.Lc5(im,j)) then 
  ...
  subroutine resid3(Ds,lv,k1,k2,l3c,f3c,ij,N5,Lc5,F5,N4,Lc4,F4,N3,Lc3,F3,N2,Lc2,F2,res)
    ...
    complex(dp), intent(in)  :: k1(4),k2(4),lv(Ds)
    integer, intent(in)        :: N5,N4,N3,N2
    integer, intent(in)        :: Lc5(:,:),Lc4(:,:),Lc3(:,:),Lc2(:,:)
    character, intent(in)      :: F5(:,:)*3,F4(:,:)*3,F3(:,:)*3,F2(:,:)*3
    complex(dp), intent(out) :: res
    ! ----------------------------------------------------------------
    complex(dp) :: lvt(5)
    complex(dp) :: v45(4),vprop(5),prop,r1,r2,krefa(4),d(5)
    complex(dp) :: q1(5),q2(5),q3(5)
    complex(dp) :: vne(5)
    complex(dp) :: BPOL1(8,16),POL1(8,16)
    complex(dp) :: BPOL2(8,16),POL2(8,16)
    complex(dp) :: BPOL3(8,16),POL3(8,16)
    complex(dp) :: mur1(10,10),mur2(10,10)
    complex(dp) :: mur3(10,10)
    complex(dp) :: e(1)
    complex(dp) :: res6,res8
    complex(dp) :: prop1,prop2,r22
...
50     if (l3c(1).ne.Lc4(im,j)) then 
  ...
  subroutine resid2(Ds,lv,k1,l2c,f2c,ij,N5,Lc5,F5,N4,Lc4,F4,N3,Lc3,F3,N2,Lc2,F2,res)
    ...
    complex(dp), intent(out) :: res
    ! ------------------------------------------------------------       
    complex(dp) :: lvt(5),e(1)
    complex(dp) :: v45(4),vprop(5),prop,r1,r2,krefa(4)
    complex(dp) :: d(5),c(10),re
    complex(dp) :: prop1,prop2
    complex(dp) :: q1(5),q2(5)
    complex(dp) :: r3,r4
    complex(dp) :: vne(5),trikoeff
    complex(dp) :: v3(4),v4(4)
    complex(dp) :: BPOL1(8,16),POL1(8,16)
    complex(dp) :: BPOL2(8,16),POL2(8,16)
    complex(dp) :: mur1(10,10),mur2(10,10)
    complex(dp) :: res6,res8
    complex(dp) :: q12(5),prop3,r22,r32,r42
    character     :: lab*3, lab1*3, lab2*3
...
52     if (l2c(1).ne.Lc3(im,j)) then 
  ...
  subroutine pentcut(Lc5,F5,Yc5)
    ...
    ! -----------------------------------------------------------------
    complex(dp) :: k1(4),k2(4),k3(4),k4(4)
    complex(dp) :: v(4,4), v1(4),v2(4), v3(4), v4(4)
    complex(dp) :: lv5(5)
    complex(dp) :: V1234(4)
    complex(dp) :: x1,x2,x3,r1,r2,r3,r4,ltr,x4
    complex(dp) :: summ,sump
    complex(dp) :: e(1)
    real(dp)    :: m(5)
    integer       :: i,j,ij      
    integer       :: l5cut(5)
  ...
  subroutine quadcut(Lc5,F5,Yc5,Lc4,F4,Yc4,Lc3,F3,Yc3,Lc2,F2,Yc2)  ! quadrupole cut
    ...
    ! ------------------------------------------------------------      
    complex(dp) ::  k1(4),k2(4),k3(4)
    complex(dp) ::  v(4,4), v1(4),v2(4), v3(4), v4(4)
    complex(dp) ::  lv4(4),lv5(5)
    complex(dp) ::  V123(4)
    complex(dp) ::  x1,x2,x3,r1,r2,r3,ltr,xtr,xe,x4
    complex(dp) ::  koeffp, koeffm, koeff1, koeff2
    complex(dp) ::  summ,sump
    complex(dp) ::  d(5)
    real(dp)    :: m(4)
    integer       ::  i,j,ij      
    ...
    integer       :: N5,N4,N3,N2
    ! ------------------------------------
    complex(dp) :: ni(4,1), pred(4,3), vi(4,3)  
    ...
    do i=1,N4
       ...
       d(3)=-half*(9.0_dp*koeff1-16.0_dp*koeff2)/ltr**2
       d(5)= 3.0_dp*(3.0_dp*koeff1-4.0_dp*koeff2)/ltr**4
  ...
  subroutine tripcut(Lc5,F5,Yc5,Lc4,F4,Yc4,Lc3,F3,Yc3,Lc2,F2,Yc2)
    ...
    integer, intent(in)   :: Yc5(:,:),Yc4(:,:),Yc3(:,:),Yc2(:,:)
    ! ----------------------------------------------------------       
    complex(dp) :: k1(4),k2(4)
    complex(dp) :: v(4,4), v1(4),v2(4), v3(4), v4(4)
    complex(dp) :: lv4(4),lva(5),lvb(5),lv4a(4),lv4b(4)
    complex(dp) :: V12(4)
    complex(dp) :: x1,x2,r1,r2,ltr,xtr,xe,x4
    complex(dp) :: summ,sump
    complex(dp) :: c(10)
    complex(dp) :: lhs_eqs(7), lhseq_new(4),lhseq(4)
    complex(dp) :: lhseqa,lhseqb
    complex(dp) :: phi1,r3a,r4a,r3b,r4b
    complex(dp) :: bcoeff(-3:3)
    complex(dp) :: dcp,dsp
    real(dp)    :: m(3)
    real(dp)    :: buff, phi
    ...
    integer       :: N5,N4,N3,N2
    ! ------------------------------------
    complex(dp) :: ni(4,2), pred(4,2),vi(4,2)
    ! -- variables needed for stability test 
    complex(dp) :: rnx,lv_rn(5),res_v1,res_v2,res_err
    complex(dp) :: ldv3,ldv4,lvsq
    real(dp)    :: rn1,rn2,rn3
    ...
    do i=1,N3
       ...
       if (abs(ltr).ge.buff) then 
          ...
          do j=1,7
             ...
             bcoeff(ss)=czero
             do kk=1,7
                phi1=-2.0_dp*pi*ci/7.0_dp*(kk-1)*ss
                bcoeff(ss)= bcoeff(ss)+1.0_dp/7.0_dp*lhs_eqs(kk)*exp(phi1)
             enddo
          enddo


          c(1)=bcoeff(0)
          c(4)=-2.0_dp*ci*(bcoeff(-2)-bcoeff(2))/ltr**2
          c(5)=(bcoeff(-2)+bcoeff(2))/ltr**2
          c(6)=-4.0_dp*ci*(bcoeff(-3)-bcoeff(3))/ltr**3
          c(7)=-4.0_dp*(bcoeff(-3)+bcoeff(3))/ltr**3
          c(2)= 0.25_dp*(-c(7)*ltr**3+4*bcoeff(-1)+4.0_dp*bcoeff(1))/ltr
          c(3)= 0.25_dp*ci*(c(6)*ltr**3*ci   &
               &-4.0_dp*bcoeff(-1)+4.0_dp*bcoeff(1))/ltr
          ...
          c(9)=(lhseqb - lhseqa)/2.0_dp/r3b/xe**2
       ...
       elseif (abs(ltr).lt.buff) then 
          ...
          do kk=1,4
             phi=2.0_dp*pi/four*(kk-1)
             xtr=exp(ci*phi)+ci*10._dp*tol 
          ...
          do i1=1,4
             ...
             do kk=1,4  
                phi1=-2.0_dp*pi*ci/four*(kk-1)*ss
                bcoeff(ss)=bcoeff(ss)+0.25_dp*lhseq(kk)*exp(phi1)
             enddo
          enddo
          ...
          c(4)=(lhseq_new(1)-lhseq_new(3))/2.0_dp
          c(3)=(lhseq_new(1)+lhseq_new(2)-(cone+ci)*c(4))/2.0_dp
          c(6)=(lhseq_new(1)-lhseq_new(2)-(cone-ci)*c(4))/2.0_dp


          !! -- stability check in 4 dimension 
          !rnx = exp(ci*(17._dp/19._dp))
          !x4 = sqrt(ltr**2-rnx**2)
  ...
  subroutine doubcut(Lc5,F5,Yc5,Lc4,F4,Yc4,Lc3,F3,Yc3,Lc2,F2,Yc2)
    ...
    integer, intent(in)   :: Yc5(:,:),Yc4(:,:),Yc3(:,:),Yc2(:,:)
    ! --------------------------------------------------------------       
    complex(dp) :: k1(4),k1d(4)
    complex(dp) :: d1k1_test
    complex(dp) :: v1(4),v2(4), v3(4), v4(4)
    complex(dp) :: V1234(4,4),lv(5),V12(4)
    complex(dp) :: x1,x2,x3,r1,r2,r3,r4,ltr,xtr,xe,x4
    complex(dp) :: ltr2a,ltr2b
    complex(dp) :: sump,lhseqc
    complex(dp) :: b(10),phi1
    complex(dp) :: lhs_eqs(7)
    complex(dp) :: lhseqa,lhseqb,lhseqd,lhs_eqa(3), lhs_eqb(3)
    complex(dp) :: lhseq1,lhseq47a,lhseq47b,lhseq2new
    complex(dp) :: lhseq4new,lhseq3,lhseq36a,lhseq36b
    complex(dp) :: lhseq1new,lhseq2
    complex(dp) :: lhs_eqm(3),lhs_eqp(3),b1eff
    complex(dp) :: bcoeff(-3:3)
    complex(dp) :: dcp,dsp
    real(dp)    :: m(2)
    real(dp)    :: buff, phi
    ...
    complex(dp) :: rnx,lv_rn(5),res_v1,res_v2,res_err
    complex(dp) :: ldv2,ldv3,ldv4,lvsq
    real(dp)    :: rn1,rn2,rn3,rn4
    ...
    do i=1,N2
       ...
       if (abs(d1k1_test).eq.zero) then 
          ...
          lhseq1=0.25_dp*(lhseqa+lhseqb+lhseqc+lhseqd)

          b(9)=0.25_dp/(-x4)*(lhseqa-lhseqc-lhseqb+lhseqd)

          lhseq47a=0.25_dp/(-x4)*(lhseqa-lhseqc+lhseqb-lhseqd)
          lhseq36a=(lhseqa-lhseqb)/2.0_dp - b(9)*(-x4)
          ...
          lhseq3=0.25_dp*(lhseqa+lhseqb+lhseqc+lhseqd)

          lhseq47b=0.25_dp/(-x4)*(lhseqa-lhseqc+lhseqb-lhseqd)
          lhseq36b=(lhseqa-lhseqb)/2.0_dp-b(9)*(-x4)
          ...
          b(8)=2.0_dp/3.0_dp*(lhseq1-lhseq2new)
          ...
          lhseq1new=lhseq1-b(8)*(2.0_dp-ltr2a) -b(2)/two*r1

          b(1)=(4.0_dp*lhseq4new - lhseq1new)/3.0_dp
          b(5)=16.0_dp/r1*(lhseq4new - b(1))
          ...
          if (abs(ltr) > buff ) then 
             ...
             do i1=1,6
                ...
                do kk=1,6  
                   phi1=-2.0_dp*pi*ci/6.0_dp*(kk-1)*ss
                   bcoeff(ss)=bcoeff(ss)+one/6._dp*lhs_eqs(kk)*exp(phi1)
                enddo
             enddo

             !-------------------------------------b1eff is b1 + b6*ltr**2
             b1eff=bcoeff(0)
             b(2)=1.0_dp/ltr*(bcoeff(1)+bcoeff(-1))
             b(3)=ci/ltr*(bcoeff(1)-bcoeff(-1))
             b(5)=1.0_dp/ltr**2*(bcoeff(2)+bcoeff(-2))
             b(7)=2.0_dp*ci/ltr**2*(bcoeff(2)-bcoeff(-2))
             ...
             b(6)=2.0_dp/3.0_dp/ltr**2*(b1eff-(lhseq2+lhseq3)/2.0_dp -b(8)*ltr**2/2.0_dp)
             ...
             b(9)=2.0_dp/ltr**2*(lhseq1-b(1)-b(2)*r2-b(3)*r3-b(4)*r4-b(5)&
             ...
             do kk=1,3
                phi=2.0_dp*pi/three*(kk-1)
                xtr=exp(ci*phi)

                x3=sqrt(ltr**2 - xtr**2-ci*10._dp*tol) 
             ...
             do i1=1,3
                ...
                do kk=1,3
                   bcoeff(ss)=bcoeff(ss)+1.0_dp/three*lhs_eqp(kk)&
                        &*exp(-2.0_dp*pi*ci/three*(kk-1)*ss)
                enddo
             enddo
             ...
             b(7)=(lhs_eqm(1)-lhs_eqm(2))/(cone -exp(2.0_dp*pi/three*ci))
             b(3)=lhs_eqm(1) - b(7)
