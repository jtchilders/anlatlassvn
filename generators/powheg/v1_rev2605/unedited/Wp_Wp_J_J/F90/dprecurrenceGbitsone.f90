...
module dprecurrencebitsone
  ...
  public :: vggg, vgggg,vqg,vgq,vbqg,vgbq,vbqq,vbqW,vWq
  public :: vgluon,f,bf
...
contains 
  ...
  function vggg(e1,k1,e2,k2)
    complex(dp), intent(in) :: e1(:), e2(:)
    complex(dp), intent(in) :: k1(:), k2(:)
    complex(dp)             :: vggg(size(e1))
    ! -----------------------------------------
    complex(dp):: sk1e2,se1e2,sk2e1,xx
  ...
  function  vgggg(e1,e2,e3)              
    complex(dp), intent(in) :: e1(:),e2(:),e3(:)
    complex(dp)             :: vgggg(size(e1))
    ! -----------------------------------------
    complex(dp):: se1e3,se2e3,se1e2
  ...
  function vqg(sp,e1)
    complex(dp), intent(in) :: e1(:)
    complex(dp), intent(in) :: sp(:)
    complex(dp) :: vqg(size(sp))
  ...
  function vbqq(Dv,sp1,sp2)
    complex(dp), intent(in) :: sp1(:), sp2(:)
    integer, intent(in) ::  Dv
    ! -------------------------------------------       
    complex(dp) :: vbqq(Dv)
    complex(dp) :: rr, va(Dv),sp1a(size(sp1))
    integer :: i
  ...
  function vbqW(sp,e1)
    complex(dp), intent(in) :: e1(:)
    complex(dp), intent(in) :: sp(:)
    complex(dp) :: vbqW(size(sp)),sp5(size(sp))
  ...
  function vWq(e1,sp)
    complex(dp), intent(in) :: e1(:)
    complex(dp), intent(in) :: sp(:)
    complex(dp) :: vWq(size(sp)),sp5(size(sp))
  ...
  recursive function vgluon(e,k,giarray,pol_int) result(res)
    ...
    complex(dp)             :: res(size(e,dim=1))
    ! -----------------------------------------------------
    complex(dp) :: k1(size(e,dim=1)),k2(size(e,dim=1)),k3(size(e,dim=1))
    complex(dp) :: e1(size(e,dim=1)),e2(size(e,dim=1)),e3(size(e,dim=1))
...
end module dprecurrencebitsone
