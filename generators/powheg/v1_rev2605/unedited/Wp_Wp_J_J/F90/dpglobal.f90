...
module dpglobal 
  ...
  complex(dp), allocatable   ,public   :: mom(:,:,:)
  complex(dp), allocatable   ,public   :: mom2(:,:,:,:)
  complex(dp), allocatable   ,public   :: hel(:,:,:)
  complex(dp), allocatable   ,public   :: hel2(:,:,:,:)
  complex(dp), allocatable   ,public   :: momline(:,:,:)
  complex(dp), allocatable   ,public   :: momline2(:,:,:,:)
  ...
  complex(dp), allocatable   ,public   :: coeff5(:,:),propv5(:,:)
  complex(dp), allocatable   ,public   :: coeff4(:,:)
  complex(dp), allocatable   ,public   :: refvect4(:,:),propv4(:,:)
  complex(dp), allocatable   ,public   :: coeff3(:,:),refvect3(:,:)
  complex(dp), allocatable   ,public   :: propv3(:,:)
  complex(dp), allocatable   ,public   :: coeff2(:,:),refvect2(:,:)
  complex(dp), allocatable   ,public   :: propv2(:,:)
  complex(dp), allocatable   ,public   :: coeff1(:,:)	

  complex(dp), allocatable   ,public   :: dcoeff1(:,:),dcoeff2(:,:)
  complex(dp), allocatable   ,public   :: dcoeff3(:,:),dcoeff4(:,:)
  complex(dp), allocatable   ,public   :: dcoeff5(:,:)

  real(dp), allocatable      ,public   :: mass5(:,:),mass4(:,:),mass3(:,:)
  real(dp), allocatable      ,public   :: mass2(:,:),mass1(:,:)
  real(dp)                   ,public   :: en,ptcut,etacut, eg
  ...
  complex(dp), public :: MCFMpol_ext_qq(2,4,-1:1)  
  complex(dp), public :: MCFMpol_ext_gg(2,4,-1:1)  
  complex(dp), public :: MCFMpol_ext_ww(2,4,-1:1) 
  complex(dp), public :: MCFMpol_ext_z(4) 
  real(dp), public    :: MCFMhardscale, MCFMsqrthardscale 
