...
C  
      ...
      common/to_amps_cg_tbxd/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION cg_tbxd(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,4   ),W(1,6   ),GWFTB ,WMASS   ,WWIDTH  ,W(1,        
     &     7   ))                                                          
     ...
     &     9   ))                                                          
      CALL IOVXXX(W(1,8   ),W(1,3   ),W(1,9   ),GWFTB ,AMP(2   ))          
      JAMP(   1) = -AMP(   1)-AMP(   2)


c$$$      print*, 'bmass ',bmass
c$$$      print*, 'tmass ',tmass
c$$$      print*, 'twidth ',twidth
c$$$      print*, 'wmass ',wmass
c$$$      print*, 'wwidth ',wwidth
c$$$      print*, 'gg ',gg
c$$$      print*, 'gwftb ',gwftb
c$$$      print*, 'gwfcd ',gwfcd
c$$$      stop
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          cg_tbxd =cg_tbxd+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
