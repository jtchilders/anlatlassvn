      SUBROUTINE Suxux_txbuxdx(P1,ANS)
C  
...
C  
C FOR PROCESS : u~ u~ -> t~ b u~ d~  
C  
C Crossing   1 is u~ u~ -> t~ b u~ d~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_uxux_txbuxdx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=uxux_txbuxdx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION uxux_txbuxdx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,3   ),W(1,8   ),GWFTB ,WMASS   ,WWIDTH  ,W(1,        
     &     9   ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,9   ),GWFUD ,AMP(1   ))          
      CALL FVIXXX(W(1,3   ),W(1,7   ),GG ,TMASS   ,TWIDTH  ,W(1,10  ))     
      CALL JIOXXX(W(1,10  ),W(1,4   ),GWFTB ,WMASS   ,WWIDTH  ,W(1,        
     &     11  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,11  ),GWFUD ,AMP(2   ))          
      CALL JIOXXX(W(1,5   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL FVIXXX(W(1,3   ),W(1,12  ),GG ,TMASS   ,TWIDTH  ,W(1,13  ))     
      CALL JIOXXX(W(1,13  ),W(1,4   ),GWFTB ,WMASS   ,WWIDTH  ,W(1,        
     &     14  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,14  ),GWFUD ,AMP(3   ))          
      CALL FVOXXX(W(1,4   ),W(1,12  ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL JIOXXX(W(1,3   ),W(1,15  ),GWFTB ,WMASS   ,WWIDTH  ,W(1,        
     &     16  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,16  ),GWFUD ,AMP(4   ))          
      JAMP(   1) = -AMP(   1)-AMP(   2)
      JAMP(   2) = +AMP(   3)+AMP(   4)
      uxux_txbuxdx = 0.D0 
      DO I = 1, NCOLOR
          ...
          ENDDO
          uxux_txbuxdx =uxux_txbuxdx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
