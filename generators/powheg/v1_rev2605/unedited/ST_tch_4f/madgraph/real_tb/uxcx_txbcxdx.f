      SUBROUTINE Suxcx_txbcxdx(P1,ANS)
C  
...
C  
C FOR PROCESS : u~ c~ -> t~ b c~ d~  
C  
C Crossing   1 is u~ c~ -> t~ b c~ d~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_uxcx_txbcxdx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=uxcx_txbcxdx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION uxcx_txbcxdx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,3   ),W(1,7   ),GG ,TMASS   ,TWIDTH  ,W(1,8   ))     
      CALL JIOXXX(W(1,8   ),W(1,4   ),GWFTB ,WMASS   ,WWIDTH  ,W(1,        
     &     9   ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,9   ),GWFUD ,AMP(1   ))          
      CALL FVOXXX(W(1,4   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,10  ))     
      CALL JIOXXX(W(1,3   ),W(1,10  ),GWFTB ,WMASS   ,WWIDTH  ,W(1,        
     &     11  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,11  ),GWFUD ,AMP(2   ))          
      JAMP(   1) = +AMP(   1)+AMP(   2)
      uxcx_txbcxdx = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          uxcx_txbcxdx =uxcx_txbcxdx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
