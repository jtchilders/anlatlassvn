...
C  
C FOR PROCESS : d c -> t~ b c c  
C  
C Crossing   1 is d c -> t~ b c c  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_dc_txbcc/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION dc_txbcc(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     8   ))                                                          
      CALL JIOXXX(W(1,3   ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
     ...
     &     16  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          dc_txbcc =dc_txbcc+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
