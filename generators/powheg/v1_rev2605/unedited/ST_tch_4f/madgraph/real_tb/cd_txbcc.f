...
C  
C FOR PROCESS : c d -> t~ b c c  
C  
C Crossing   1 is c d -> t~ b c c  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_cd_txbcc/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION cd_txbcc(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     15  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          cd_txbcc =cd_txbcc+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
