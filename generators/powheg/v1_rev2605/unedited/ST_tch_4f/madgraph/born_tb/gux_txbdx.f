...
C  
C FOR PROCESS : g u~ -> t~ b d~  
C  
C Crossing   1 is g u~ -> t~ b d~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_gux_txbdx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gux_txbdx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gux_txbdx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     7   ))                                                          
      CALL IOVXXX(W(1,3   ),W(1,6   ),W(1,7   ),GWFTB ,AMP(1   ))          
      CALL FVIXXX(W(1,3   ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,8   ))     
      CALL JIOXXX(W(1,8   ),W(1,4   ),GWFTB ,WMASS   ,WWIDTH  ,W(1,        
     &     9   ))                                                          
      CALL IOVXXX(W(1,5   ),W(1,2   ),W(1,9   ),GWFUD ,AMP(2   ))          
      JAMP(   1) = -AMP(   1)-AMP(   2)
      gux_txbdx = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          gux_txbdx =gux_txbdx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
