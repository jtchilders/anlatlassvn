...
C  
C FOR PROCESS : d g -> t~ b u  
C  
C Crossing   1 is d g -> t~ b u  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_dg_txbu/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION dg_txbu(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     7   ))                                                          
      CALL IOVXXX(W(1,1   ),W(1,5   ),W(1,7   ),GWFUD ,AMP(1   ))          
     ...
     &     9   ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          dg_txbu =dg_txbu+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
