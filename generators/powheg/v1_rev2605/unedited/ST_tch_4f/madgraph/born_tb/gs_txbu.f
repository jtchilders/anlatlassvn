...
C  
C FOR PROCESS : g s -> t~ b u  
C  
C Crossing   1 is g s -> t~ b u  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_gs_txbu/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gs_txbu(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     9   ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,5   ),W(1,9   ),GWFUS ,AMP(2   ))          
      JAMP(   1) = +AMP(   1)+AMP(   2)
      gs_txbu = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          gs_txbu =gs_txbu+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
