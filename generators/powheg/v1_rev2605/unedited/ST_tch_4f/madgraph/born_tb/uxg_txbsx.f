...
C  
C FOR PROCESS : u~ g -> t~ b s~  
C  
C Crossing   1 is u~ g -> t~ b s~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_uxg_txbsx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=uxg_txbsx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION uxg_txbsx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,3   ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,6   ))     
      CALL JIOXXX(W(1,6   ),W(1,4   ),GWFTB ,WMASS   ,WWIDTH  ,W(1,        
     &     7   ))                                                          
      CALL IOVXXX(W(1,5   ),W(1,1   ),W(1,7   ),GWFUS ,AMP(1   ))          
      CALL FVOXXX(W(1,4   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,8   ))     
      CALL JIOXXX(W(1,5   ),W(1,1   ),GWFUS ,WMASS   ,WWIDTH  ,W(1,        
     &     9   ))                                                          
      CALL IOVXXX(W(1,3   ),W(1,8   ),W(1,9   ),GWFTB ,AMP(2   ))          
      JAMP(   1) = -AMP(   1)-AMP(   2)
      uxg_txbsx = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          uxg_txbsx =uxg_txbsx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
