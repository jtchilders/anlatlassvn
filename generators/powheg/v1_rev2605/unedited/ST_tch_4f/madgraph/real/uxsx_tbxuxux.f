      SUBROUTINE Suxsx_tbxuxux(P1,ANS)
C  
...
C  
      ...
      common/to_amps_uxsx_tbxuxux/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=uxsx_tbxuxux(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION uxsx_tbxuxux(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     12  ))                                                          
      CALL FVOXXX(W(1,3   ),W(1,12  ),GWFTB ,BMASS   ,ZERO    ,W(1,        
     &     13  ))                                                          
      CALL JIOXXX(W(1,4   ),W(1,13  ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,14  ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,4   ),W(1,12  ),GWFTB ,TMASS   ,TWIDTH  ,W(1,        
     &     15  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          uxsx_tbxuxux =uxsx_tbxuxux+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
