...
C  
      ...
      common/to_amps_uu_tbxud/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION uu_tbxud(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,8   ),W(1,3   ),GWFTB ,WMASS   ,WWIDTH  ,W(1,        
     &     9   ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,9   ),GWFUD ,AMP(1   ))          
      CALL FVOXXX(W(1,3   ),W(1,7   ),GG ,TMASS   ,TWIDTH  ,W(1,10  ))     
      CALL JIOXXX(W(1,4   ),W(1,10  ),GWFTB ,WMASS   ,WWIDTH  ,W(1,        
     &     11  ))                                                          
      ...
      CALL JIOXXX(W(1,4   ),W(1,13  ),GWFTB ,WMASS   ,WWIDTH  ,W(1,        
     &     14  ))                                                          
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,14  ),GWFUD ,AMP(3   ))          
      CALL FVIXXX(W(1,4   ),W(1,12  ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
     ...
     &     16  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          uu_tbxud =uu_tbxud+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
