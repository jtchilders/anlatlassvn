...
C  
      ...
      common/to_amps_gg_tbxuxs/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gg_tbxuxs(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gg_tbxuxs(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     9   ))                                                          
      ...
      CALL FVIXXX(W(1,4   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      CALL JIOXXX(W(1,11  ),W(1,3   ),GWFTB ,WMASS   ,WWIDTH  ,W(1,        
     &     12  ))                                                          
      CALL FVIXXX(W(1,5   ),W(1,12  ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     13  ))                                                          
      CALL IOVXXX(W(1,13  ),W(1,6   ),W(1,2   ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,5   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,14  ),W(1,6   ),W(1,12  ),GWFUS ,AMP(4   ))          
      CALL FVIXXX(W(1,4   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL JIOXXX(W(1,15  ),W(1,3   ),GWFTB ,WMASS   ,WWIDTH  ,W(1,        
     &     16  ))                                                          
      CALL FVIXXX(W(1,5   ),W(1,16  ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     17  ))                                                          
      CALL IOVXXX(W(1,17  ),W(1,6   ),W(1,1   ),GG ,AMP(5   ))             
      CALL IOVXXX(W(1,10  ),W(1,6   ),W(1,16  ),GWFUS ,AMP(6   ))          
     ...
     &     20  ))                                                          
      ...
      CALL IOVXXX(W(1,14  ),W(1,6   ),W(1,19  ),GWFUS ,AMP(8   ))          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gg_tbxuxs =gg_tbxuxs+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
