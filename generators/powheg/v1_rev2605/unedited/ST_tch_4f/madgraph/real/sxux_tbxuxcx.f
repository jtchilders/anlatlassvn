      SUBROUTINE Ssxux_tbxuxcx(P1,ANS)
C  
...
C  
      ...
      common/to_amps_sxux_tbxuxcx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=sxux_tbxuxcx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION sxux_tbxuxcx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,4   ),W(1,8   ),GWFTB ,WMASS   ,WWIDTH  ,W(1,        
     &     9   ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,9   ),GWFCS ,AMP(1   ))          
      CALL FVIXXX(W(1,4   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,10  ))     
     ...
     &     11  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          sxux_tbxuxcx =sxux_tbxuxcx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
