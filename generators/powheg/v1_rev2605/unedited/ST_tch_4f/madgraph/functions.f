...
c$$$      print*,'-------------------------'
c$$$      print*, (aflav(j),j=1,n)
c$$$      print*, (bflav(j),j=1,n)


      end

     
      function flavequiv_perm_real(n,aflav,bflav,perm)
      implicit none
 ...
 10      continue
      enddo
      flavequiv_perm_real=.true.

c$$$      print*,'-------------------------'
c$$$      print*, 'per ',(perm(j),j=1,n)
c$$$      print*, 'POW ',(aflav(j),j=1,n)
c$$$      print*, 'MAD ',(bflav(j),j=1,n)
