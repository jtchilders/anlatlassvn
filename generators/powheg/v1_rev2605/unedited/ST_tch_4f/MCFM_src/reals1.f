...
c--- bottom quark.
      ...
      double precision mq,ma,mq2,ma2,g1t,g1b
 
 
      mq2 = mq**2
      ma2 = ma**2
      g1t = s(g1,t1)/2d0 + s(g1,p)*mq2/(2d0*s(t1,p))
      g1b = s(g1,b1)/2d0 + s(g1,p)*ma2/(2d0*s(b1,p))
     ...
     .            zb(g2,b1) + 
     .           g1t*za(d,p)*
     .            (zb(b1,p)*(dcmplx(ma2)+ za(g1,b1)*zb(g1,b1))*
     ...
     .         (zb(b1,p)*(dcmplx(ma2)+ za(g1,b1)*zb(g1,b1))*zb(u,g1) + 
     .           ma2*zb(g1,b1)*zb(u,p)) + 
     ...
     .        za(d,t1)*za(t1,p)*
     .         (zb(b1,p)*(g1t*(dcmplx(ma2)+ za(g1,b1)*zb(g1,b1))*
     ...
     .              g1t*(zb(b1,p)*(dcmplx(ma2)+ za(g1,b1)*zb(g1,b1))*
     .                  zb(u,g1) + ma2*zb(g1,b1)*zb(u,p)))))))/
     ...
     .               g1t*(dcmplx(ma2)+ za(g1,b1)*zb(g1,b1))*zb(u,g1))))
