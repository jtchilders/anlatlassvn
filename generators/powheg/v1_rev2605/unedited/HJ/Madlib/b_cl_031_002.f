...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(2,ihel).eq.-1) THEN
                 T=B_CL_031_002(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_031_002(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JVSHXX(W(1,2   ),W(1,3   ),GH ,ZERO    ,ZERO    ,W(1,5   ))     
      CALL VVVXXX(W(1,4   ),W(1,1   ),W(1,5   ),G ,AMP(1   ))              
      CALL JVSHXX(W(1,1   ),W(1,3   ),GH ,ZERO    ,ZERO    ,W(1,6   ))     
      CALL VVVXXX(W(1,4   ),W(1,2   ),W(1,6   ),G ,AMP(2   ))              
      CALL JVVXXX(W(1,1   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,7   ))      
      CALL VVSHXX(W(1,4   ),W(1,7   ),W(1,3   ),GH ,AMP(3   ))             
      CALL VVVSXX(W(1,1   ),W(1,2   ),W(1,4   ),W(1,3   ),DUM1 ,GH4 ,      
     &     AMP(4   ))                                                      
      do i=1,ngraphs
         if(ihel.eq.-1)then
      ...
      JAMP(   2) =      2*( +AMP(   1)-AMP(   2)+AMP(   3)+AMP(   4))
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_031_002=B_CL_031_002 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_031_002=B_CL_031_002 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
