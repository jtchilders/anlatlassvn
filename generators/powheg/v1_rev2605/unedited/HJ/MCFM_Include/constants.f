...
c-----------------------------------------------------
      double precision cf,ca,xn,xnsq,xn4,v_i2,
     &     tr,qu,qd,qe,aem,Von4,ninth,Nc
      parameter(cf=4d0/3d0,ca=3d0,xn=3d0,v_i2=8d0,
     &     Nc=3d0,xnsq=9d0,tr=0.5d0)
!------ Changed v => v_i2 due to Madgraph conflict, shouldnt be used in H+j   
      ...
      parameter(aveqq=0.25d0/xnsq,aveqg=0.25d0/xn/v_i2,
     &     avegg=0.25d0/v_i2**2)
c-----------------------------------------------------
