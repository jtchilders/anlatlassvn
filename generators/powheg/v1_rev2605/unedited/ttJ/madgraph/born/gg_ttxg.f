      SUBROUTINE Sgg_ttxg(P1,ANS,ANSJK,ANSMUNU)
C  
...
C  
      ...
      common/to_amps_gg_ttxg/  amp2,       jamp2
...
C 
      ...
      DATA (bflav(i),i=1,NEXTERNAL_BORN) / 0, 0, 6, -6, 0 /
      ...
      common/to_POWHEG_gg_ttxg/amp2jk,cCF,cDENOM,amphel,helindex
C          
C BEGIN CODE
C ----------
      NTRY=NTRY+1
...
C 
      ...
      REAL*8 FUNCTION gg_ttxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C COLOR DATA
      ...
      DATA (CF_CLBS(i,1  ,1,2),i=1  ,6  ) /-24,  3, -3,  0, -6,  0/ 
C               T[ 3,4,2,1,5]                                          
      DATA Denom_CLBS(2  ,1,2)/         2/                                    
      DATA (CF_CLBS(i,2  ,1,2),i=1  ,6  ) /  3,  3,  3,  6,  0,  0/ 
C               T[ 3,4,2,5,1]                                          
      DATA Denom_CLBS(3  ,1,2)/         2/                                    
      DATA (CF_CLBS(i,3  ,1,2),i=1  ,6  ) / -3,  3,-24,  0,  0, -6/ 
C               T[ 3,4,5,2,1]                                          
      DATA Denom_CLBS(4  ,1,2)/         2/                                    
      DATA (CF_CLBS(i,4  ,1,2),i=1  ,6  ) /  0,  6,  0,  3,  3,  3/ 
C               T[ 3,4,1,5,2]                                          
      DATA Denom_CLBS(5  ,1,2)/         2/                                    
      DATA (CF_CLBS(i,5  ,1,2),i=1  ,6  ) / -6,  0,  0,  3,-24, -3/ 
C               T[ 3,4,5,1,2]                                          
      DATA Denom_CLBS(6  ,1,2)/         2/                                    
      DATA (CF_CLBS(i,6  ,1,2),i=1  ,6  ) /  0,  0, -6,  3, -3,-24/ 
C               T[ 3,4,1,2,5]                                          
C  
      DATA Denom_CLBS(1  ,1,3)/         6/                                    
      DATA (CF_CLBS(i,1  ,1,3),i=1  ,6  ) /  8, -1,  8, -1,  8,  8/ 
C               T[ 3,4,2,1,5]                                          
      DATA Denom_CLBS(2  ,1,3)/         6/                                    
      DATA (CF_CLBS(i,2  ,1,3),i=1  ,6  ) / -1, -1,-10,-10,  8, -1/ 
C               T[ 3,4,2,5,1]                                          
      DATA Denom_CLBS(3  ,1,3)/         6/                                    
      DATA (CF_CLBS(i,3  ,1,3),i=1  ,6  ) /  8,-10, -1, -1, -1,-10/ 
C               T[ 3,4,5,2,1]                                          
      DATA Denom_CLBS(4  ,1,3)/         6/                                    
      DATA (CF_CLBS(i,4  ,1,3),i=1  ,6  ) / -1,-10, -1,-64,  8,  8/ 
C               T[ 3,4,1,5,2]                                          
      DATA Denom_CLBS(5  ,1,3)/         6/                                    
      DATA (CF_CLBS(i,5  ,1,3),i=1  ,6  ) /  8,  8, -1,  8,  8, -1/ 
C               T[ 3,4,5,1,2]                                          
      DATA Denom_CLBS(6  ,1,3)/         6/                                    
      DATA (CF_CLBS(i,6  ,1,3),i=1  ,6  ) /  8, -1,-10,  8, -1,-64/ 
C               T[ 3,4,1,2,5]                                          
C  
      DATA Denom_CLBS(1  ,1,4)/         6/                                    
      DATA (CF_CLBS(i,1  ,1,4),i=1  ,6  ) /  8,  8, -1,  8,  8, -1/ 
C               T[ 3,4,2,1,5]                                          
      DATA Denom_CLBS(2  ,1,4)/         6/                                    
      DATA (CF_CLBS(i,2  ,1,4),i=1  ,6  ) /  8,-64,  8,-10, -1, -1/ 
C               T[ 3,4,2,5,1]                                          
      DATA Denom_CLBS(3  ,1,4)/         6/                                    
      DATA (CF_CLBS(i,3  ,1,4),i=1  ,6  ) / -1,  8,-64, -1,  8,-10/ 
C               T[ 3,4,5,2,1]                                          
      DATA Denom_CLBS(4  ,1,4)/         6/                                    
      DATA (CF_CLBS(i,4  ,1,4),i=1  ,6  ) /  8,-10, -1, -1, -1,-10/ 
C               T[ 3,4,1,5,2]                                          
      DATA Denom_CLBS(5  ,1,4)/         6/                                    
      DATA (CF_CLBS(i,5  ,1,4),i=1  ,6  ) /  8, -1,  8, -1,  8,  8/ 
C               T[ 3,4,5,1,2]                                          
      DATA Denom_CLBS(6  ,1,4)/         6/                                    
      DATA (CF_CLBS(i,6  ,1,4),i=1  ,6  ) / -1, -1,-10,-10,  8, -1/ 
C               T[ 3,4,1,2,5]                                          
C  
      DATA Denom_CLBS(1  ,1,5)/         2/                                    
      DATA (CF_CLBS(i,1  ,1,5),i=1  ,6  ) /-24,  0,  0, -3, -6,  3/ 
C               T[ 3,4,2,1,5]                                          
      DATA Denom_CLBS(2  ,1,5)/         2/                                    
      DATA (CF_CLBS(i,2  ,1,5),i=1  ,6  ) /  0,-24,  3, -6, -3,  0/ 
C               T[ 3,4,2,5,1]                                          
      DATA Denom_CLBS(3  ,1,5)/         2/                                    
      DATA (CF_CLBS(i,3  ,1,5),i=1  ,6  ) /  0,  3,  3,  0,  3,  6/ 
C               T[ 3,4,5,2,1]                                          
      DATA Denom_CLBS(4  ,1,5)/         2/                                    
      DATA (CF_CLBS(i,4  ,1,5),i=1  ,6  ) / -3, -6,  0,-24,  0,  3/ 
C               T[ 3,4,1,5,2]                                          
      DATA Denom_CLBS(5  ,1,5)/         2/                                    
      DATA (CF_CLBS(i,5  ,1,5),i=1  ,6  ) / -6, -3,  3,  0,-24,  0/ 
C               T[ 3,4,5,1,2]                                          
      DATA Denom_CLBS(6  ,1,5)/         2/                                    
      DATA (CF_CLBS(i,6  ,1,5),i=1  ,6  ) /  3,  0,  6,  3,  0,  3/ 
C               T[ 3,4,1,2,5]                                          
C  
      DATA Denom_CLBS(1  ,2,3)/         6/                                    
      DATA (CF_CLBS(i,1  ,2,3),i=1  ,6  ) /-64,  8, -1, -1,-10,  8/ 
C               T[ 3,4,2,1,5]                                          
      DATA Denom_CLBS(2  ,2,3)/         6/                                    
      DATA (CF_CLBS(i,2  ,2,3),i=1  ,6  ) /  8,-64,  8,-10, -1, -1/ 
C               T[ 3,4,2,5,1]                                          
      DATA Denom_CLBS(3  ,2,3)/         6/                                    
      DATA (CF_CLBS(i,3  ,2,3),i=1  ,6  ) / -1,  8,  8,  8, -1,  8/ 
C               T[ 3,4,5,2,1]                                          
      DATA Denom_CLBS(4  ,2,3)/         6/                                    
      DATA (CF_CLBS(i,4  ,2,3),i=1  ,6  ) / -1,-10,  8, -1,-10, -1/ 
C               T[ 3,4,1,5,2]                                          
      DATA Denom_CLBS(5  ,2,3)/         6/                                    
      DATA (CF_CLBS(i,5  ,2,3),i=1  ,6  ) /-10, -1, -1,-10, -1,  8/ 
C               T[ 3,4,5,1,2]                                          
      DATA Denom_CLBS(6  ,2,3)/         6/                                    
      DATA (CF_CLBS(i,6  ,2,3),i=1  ,6  ) /  8, -1,  8, -1,  8,  8/ 
C               T[ 3,4,1,2,5]                                          
C  
      DATA Denom_CLBS(1  ,2,4)/         6/                                    
      DATA (CF_CLBS(i,1  ,2,4),i=1  ,6  ) / -1,-10,  8, -1,-10, -1/ 
C               T[ 3,4,2,1,5]                                          
      DATA Denom_CLBS(2  ,2,4)/         6/                                    
      DATA (CF_CLBS(i,2  ,2,4),i=1  ,6  ) /-10, -1, -1,-10, -1,  8/ 
C               T[ 3,4,2,5,1]                                          
      DATA Denom_CLBS(3  ,2,4)/         6/                                    
      DATA (CF_CLBS(i,3  ,2,4),i=1  ,6  ) /  8, -1,  8, -1,  8,  8/ 
C               T[ 3,4,5,2,1]                                          
      DATA Denom_CLBS(4  ,2,4)/         6/                                    
      DATA (CF_CLBS(i,4  ,2,4),i=1  ,6  ) / -1,-10, -1,-64,  8,  8/ 
C               T[ 3,4,1,5,2]                                          
      DATA Denom_CLBS(5  ,2,4)/         6/                                    
      DATA (CF_CLBS(i,5  ,2,4),i=1  ,6  ) /-10, -1,  8,  8,-64, -1/ 
C               T[ 3,4,5,1,2]                                          
      DATA Denom_CLBS(6  ,2,4)/         6/                                    
      DATA (CF_CLBS(i,6  ,2,4),i=1  ,6  ) / -1,  8,  8,  8, -1,  8/ 
C               T[ 3,4,1,2,5]                                          
C  
      DATA Denom_CLBS(1  ,2,5)/         2/                                    
      DATA (CF_CLBS(i,1  ,2,5),i=1  ,6  ) /  3,  3,  0,  0,  6,  3/ 
C               T[ 3,4,2,1,5]                                          
      DATA Denom_CLBS(2  ,2,5)/         2/                                    
      DATA (CF_CLBS(i,2  ,2,5),i=1  ,6  ) /  3,-24,  0, -6,  0, -3/ 
C               T[ 3,4,2,5,1]                                          
      DATA Denom_CLBS(3  ,2,5)/         2/                                    
      DATA (CF_CLBS(i,3  ,2,5),i=1  ,6  ) /  0,  0,-24, -3,  3, -6/ 
C               T[ 3,4,5,2,1]                                          
      DATA Denom_CLBS(4  ,2,5)/         2/                                    
      DATA (CF_CLBS(i,4  ,2,5),i=1  ,6  ) /  0, -6, -3,-24,  3,  0/ 
C               T[ 3,4,1,5,2]                                          
      DATA Denom_CLBS(5  ,2,5)/         2/                                    
      DATA (CF_CLBS(i,5  ,2,5),i=1  ,6  ) /  6,  0,  3,  3,  3,  0/ 
C               T[ 3,4,5,1,2]                                          
      DATA Denom_CLBS(6  ,2,5)/         2/                                    
      DATA (CF_CLBS(i,6  ,2,5),i=1  ,6  ) /  3, -3, -6,  0,  0,-24/ 
C               T[ 3,4,1,2,5]                                          
C  
      DATA Denom_CLBS(1  ,3,4)/        54/                                    
      DATA (CF_CLBS(i,1  ,3,4),i=1  ,6  ) /  1, 10,-62,-62, 28, 10/ 
C               T[ 3,4,2,1,5]                                          
      DATA Denom_CLBS(2  ,3,4)/        54/                                    
      DATA (CF_CLBS(i,2  ,3,4),i=1  ,6  ) / 10,  1, 10, 28,-62,-62/ 
C               T[ 3,4,2,5,1]                                          
      DATA Denom_CLBS(3  ,3,4)/        54/                                    
      DATA (CF_CLBS(i,3  ,3,4),i=1  ,6  ) /-62, 10,  1,-62, 10, 28/ 
C               T[ 3,4,5,2,1]                                          
      DATA Denom_CLBS(4  ,3,4)/        54/                                    
      DATA (CF_CLBS(i,4  ,3,4),i=1  ,6  ) /-62, 28,-62,  1, 10, 10/ 
C               T[ 3,4,1,5,2]                                          
      DATA Denom_CLBS(5  ,3,4)/        54/                                    
      DATA (CF_CLBS(i,5  ,3,4),i=1  ,6  ) / 28,-62, 10, 10,  1,-62/ 
C               T[ 3,4,5,1,2]                                          
      DATA Denom_CLBS(6  ,3,4)/        54/                                    
      DATA (CF_CLBS(i,6  ,3,4),i=1  ,6  ) / 10,-62, 28, 10,-62,  1/ 
C               T[ 3,4,1,2,5]                                          
C  
      DATA Denom_CLBS(1  ,3,5)/         6/                                    
      DATA (CF_CLBS(i,1  ,3,5),i=1  ,6  ) / -1, -1, -1,  8,-10,-10/ 
C               T[ 3,4,2,1,5]                                          
      DATA Denom_CLBS(2  ,3,5)/         6/                                    
      DATA (CF_CLBS(i,2  ,3,5),i=1  ,6  ) / -1,  8,  8,  8, -1,  8/ 
C               T[ 3,4,2,5,1]                                          
      DATA Denom_CLBS(3  ,3,5)/         6/                                    
      DATA (CF_CLBS(i,3  ,3,5),i=1  ,6  ) / -1,  8,-64, -1,  8,-10/ 
C               T[ 3,4,5,2,1]                                          
      DATA Denom_CLBS(4  ,3,5)/         6/                                    
      DATA (CF_CLBS(i,4  ,3,5),i=1  ,6  ) /  8,  8, -1,  8,  8, -1/ 
C               T[ 3,4,1,5,2]                                          
      DATA Denom_CLBS(5  ,3,5)/         6/                                    
      DATA (CF_CLBS(i,5  ,3,5),i=1  ,6  ) /-10, -1,  8,  8,-64, -1/ 
C               T[ 3,4,5,1,2]                                          
      DATA Denom_CLBS(6  ,3,5)/         6/                                    
      DATA (CF_CLBS(i,6  ,3,5),i=1  ,6  ) /-10,  8,-10, -1, -1, -1/ 
C               T[ 3,4,1,2,5]                                          
C  
      DATA Denom_CLBS(1  ,4,5)/         6/                                    
      DATA (CF_CLBS(i,1  ,4,5),i=1  ,6  ) /-64,  8, -1, -1,-10,  8/ 
C               T[ 3,4,2,1,5]                                          
      DATA Denom_CLBS(2  ,4,5)/         6/                                    
      DATA (CF_CLBS(i,2  ,4,5),i=1  ,6  ) /  8,  8, -1,  8,  8, -1/ 
C               T[ 3,4,2,5,1]                                          
      DATA Denom_CLBS(3  ,4,5)/         6/                                    
      DATA (CF_CLBS(i,3  ,4,5),i=1  ,6  ) / -1, -1, -1,  8,-10,-10/ 
C               T[ 3,4,5,2,1]                                          
      DATA Denom_CLBS(4  ,4,5)/         6/                                    
      DATA (CF_CLBS(i,4  ,4,5),i=1  ,6  ) / -1,  8,  8,  8, -1,  8/ 
C               T[ 3,4,1,5,2]                                          
      DATA Denom_CLBS(5  ,4,5)/         6/                                    
      DATA (CF_CLBS(i,5  ,4,5),i=1  ,6  ) /-10,  8,-10, -1, -1, -1/ 
C               T[ 3,4,5,1,2]                                          
      DATA Denom_CLBS(6  ,4,5)/         6/                                    
      DATA (CF_CLBS(i,6  ,4,5),i=1  ,6  ) /  8, -1,-10,  8, -1,-64/ 
C               T[ 3,4,1,2,5]                                          
C  
C  
      DATA Denom(1  )/            9/                                       
     ...
     &             -AMP(  17)+AMP(  18)
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ...
              cCF(J,I)=CF(J,I)
          ENDDO
          gg_ttxg =gg_ttxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
C 
         do jjj=1,NEXTERNAL_BORN
