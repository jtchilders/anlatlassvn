      SUBROUTINE Sgbx_ttxbx(P1,ANS,ANSJK,ANSMUNU)
C  
...
C  
C FOR PROCESS : g b~ -> t t~ b~  
C  
C Crossing   1 is g b~ -> t t~ b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_gbx_ttxbx/  amp2,       jamp2
...
C 
      ...
      DATA (bflav(i),i=1,NEXTERNAL_BORN) / 0, -5, 6, -6, -5 /
      ...
      common/to_POWHEG_gbx_ttxbx/amp2jk,cCF,cDENOM,amphel,helindex
C          
C BEGIN CODE
C ----------
      NTRY=NTRY+1
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                helindex=ihel
                 T=gbx_ttxbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
...
C 
      ...
      REAL*8 FUNCTION gbx_ttxbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C               T[ 3,5]T[ 2,4,1]                                        
C  
      DATA Denom_CLBS(1  ,1,3)/         2/                                    
      DATA (CF_CLBS(i,1  ,1,3),i=1  ,4  ) /  1,  1,  0,  0/             
C               T[ 3,5]T[ 2,4,1]                                        
      DATA Denom_CLBS(2  ,1,3)/         2/                                    
      DATA (CF_CLBS(i,2  ,1,3),i=1  ,4  ) /  1, -8, -7,  2/             
C               T[ 2,4]T[ 3,5,1]                                        
      DATA Denom_CLBS(3  ,1,3)/         2/                                    
      DATA (CF_CLBS(i,3  ,1,3),i=1  ,4  ) /  0, -7, -7,  0/             
C               T[ 3,5,1]T[ 2,4]                                        
      DATA Denom_CLBS(4  ,1,3)/         1/                                    
      DATA (CF_CLBS(i,4  ,1,3),i=1  ,4  ) /  0,  1,  0, -1/             
C               T[ 3,5]T[ 2,4,1]                                        
C  
      DATA Denom_CLBS(1  ,1,4)/         2/                                    
      DATA (CF_CLBS(i,1  ,1,4),i=1  ,4  ) / -8,  1,  2, -7/             
C               T[ 3,5]T[ 2,4,1]                                        
      DATA Denom_CLBS(2  ,1,4)/         2/                                    
      DATA (CF_CLBS(i,2  ,1,4),i=1  ,4  ) /  1,  1,  0,  0/             
C               T[ 2,4]T[ 3,5,1]                                        
      DATA Denom_CLBS(3  ,1,4)/         1/                                    
      DATA (CF_CLBS(i,3  ,1,4),i=1  ,4  ) /  1,  0, -1,  0/             
C               T[ 3,5,1]T[ 2,4]                                        
      DATA Denom_CLBS(4  ,1,4)/         2/                                    
      DATA (CF_CLBS(i,4  ,1,4),i=1  ,4  ) / -7,  0,  0, -7/             
C               T[ 3,5]T[ 2,4,1]                                        
C  
      DATA Denom_CLBS(1  ,1,5)/         1/                                    
      DATA (CF_CLBS(i,1  ,1,5),i=1  ,4  ) / -1,  0,  1,  0/             
C               T[ 3,5]T[ 2,4,1]                                        
      DATA Denom_CLBS(2  ,1,5)/         2/                                    
      DATA (CF_CLBS(i,2  ,1,5),i=1  ,4  ) /  0, -7, -7,  0/             
C               T[ 2,4]T[ 3,5,1]                                        
      DATA Denom_CLBS(3  ,1,5)/         2/                                    
      DATA (CF_CLBS(i,3  ,1,5),i=1  ,4  ) /  2, -7, -8,  1/             
C               T[ 3,5,1]T[ 2,4]                                        
      DATA Denom_CLBS(4  ,1,5)/         2/                                    
      DATA (CF_CLBS(i,4  ,1,5),i=1  ,4  ) /  0,  0,  1,  1/             
C               T[ 3,5]T[ 2,4,1]                                        
C  
      DATA Denom_CLBS(1  ,2,3)/         9/                                    
      DATA (CF_CLBS(i,1  ,2,3),i=1  ,4  ) / -8,  1,  6, -3/             
C               T[ 3,5]T[ 2,4,1]                                        
      DATA Denom_CLBS(2  ,2,3)/         9/                                    
      DATA (CF_CLBS(i,2  ,2,3),i=1  ,4  ) /  1,  1, -3, -3/             
C               T[ 2,4]T[ 3,5,1]                                        
      DATA Denom_CLBS(3  ,2,3)/         9/                                    
      DATA (CF_CLBS(i,3  ,2,3),i=1  ,4  ) /  6, -3, -8,  1/             
C               T[ 3,5,1]T[ 2,4]                                        
      DATA Denom_CLBS(4  ,2,3)/         9/                                    
      DATA (CF_CLBS(i,4  ,2,3),i=1  ,4  ) / -3, -3,  1,  1/             
C               T[ 3,5]T[ 2,4,1]                                        
C  
      DATA Denom_CLBS(1  ,2,4)/        18/                                    
      DATA (CF_CLBS(i,1  ,2,4),i=1  ,4  ) /  7,  7,  6,  6/             
C               T[ 3,5]T[ 2,4,1]                                        
      DATA Denom_CLBS(2  ,2,4)/        18/                                    
      DATA (CF_CLBS(i,2  ,2,4),i=1  ,4  ) /  7,-56,-57,  6/             
C               T[ 2,4]T[ 3,5,1]                                        
      DATA Denom_CLBS(3  ,2,4)/        18/                                    
      DATA (CF_CLBS(i,3  ,2,4),i=1  ,4  ) /  6,-57,-56,  7/             
C               T[ 3,5,1]T[ 2,4]                                        
      DATA Denom_CLBS(4  ,2,4)/        18/                                    
      DATA (CF_CLBS(i,4  ,2,4),i=1  ,4  ) /  6,  6,  7,  7/             
C               T[ 3,5]T[ 2,4,1]                                        
C  
      DATA Denom_CLBS(1  ,2,5)/        18/                                    
      DATA (CF_CLBS(i,1  ,2,5),i=1  ,4  ) /  8, -1, -2,  7/             
C               T[ 3,5]T[ 2,4,1]                                        
      DATA Denom_CLBS(2  ,2,5)/        18/                                    
      DATA (CF_CLBS(i,2  ,2,5),i=1  ,4  ) / -1,  8,  7, -2/             
C               T[ 2,4]T[ 3,5,1]                                        
      DATA Denom_CLBS(3  ,2,5)/        18/                                    
      DATA (CF_CLBS(i,3  ,2,5),i=1  ,4  ) / -2,  7, -1,-10/             
C               T[ 3,5,1]T[ 2,4]                                        
      DATA Denom_CLBS(4  ,2,5)/        18/                                    
      DATA (CF_CLBS(i,4  ,2,5),i=1  ,4  ) /  7, -2,-10, -1/             
C               T[ 3,5]T[ 2,4,1]                                        
C  
...
C               T[ 3,5]T[ 2,4,1]                                        
C  
      DATA Denom_CLBS(1  ,3,5)/        18/                                    
      DATA (CF_CLBS(i,1  ,3,5),i=1  ,4  ) /-56,  7,  6,-57/             
C               T[ 3,5]T[ 2,4,1]                                        
      DATA Denom_CLBS(2  ,3,5)/        18/                                    
      DATA (CF_CLBS(i,2  ,3,5),i=1  ,4  ) /  7,  7,  6,  6/             
C               T[ 2,4]T[ 3,5,1]                                        
      DATA Denom_CLBS(3  ,3,5)/        18/                                    
      DATA (CF_CLBS(i,3  ,3,5),i=1  ,4  ) /  6,  6,  7,  7/             
C               T[ 3,5,1]T[ 2,4]                                        
      DATA Denom_CLBS(4  ,3,5)/        18/                                    
      DATA (CF_CLBS(i,4  ,3,5),i=1  ,4  ) /-57,  6,  7,-56/             
C               T[ 3,5]T[ 2,4,1]                                        
C  
      DATA Denom_CLBS(1  ,4,5)/         9/                                    
      DATA (CF_CLBS(i,1  ,4,5),i=1  ,4  ) /  1,  1, -3, -3/             
C               T[ 3,5]T[ 2,4,1]                                        
      DATA Denom_CLBS(2  ,4,5)/         9/                                    
      DATA (CF_CLBS(i,2  ,4,5),i=1  ,4  ) /  1, -8, -3,  6/             
C               T[ 2,4]T[ 3,5,1]                                        
      DATA Denom_CLBS(3  ,4,5)/         9/                                    
      DATA (CF_CLBS(i,3  ,4,5),i=1  ,4  ) / -3, -3,  1,  1/             
C               T[ 3,5,1]T[ 2,4]                                        
      DATA Denom_CLBS(4  ,4,5)/         9/                                    
      DATA (CF_CLBS(i,4  ,4,5),i=1  ,4  ) / -3,  6,  1, -8/             
C               T[ 3,5]T[ 2,4,1]                                        
C  
C  
      DATA Denom(1  )/            3/                                       
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ...
              cCF(J,I)=CF(J,I)
          ENDDO
          gbx_ttxbx =gbx_ttxbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
C 
         do jjj=1,NEXTERNAL_BORN
