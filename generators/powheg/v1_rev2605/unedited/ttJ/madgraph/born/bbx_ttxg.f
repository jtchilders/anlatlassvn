      SUBROUTINE Sbbx_ttxg(P1,ANS,ANSJK,ANSMUNU)
C  
...
C  
C FOR PROCESS : b b~ -> t t~ g  
C  
C Crossing   1 is b b~ -> t t~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_bbx_ttxg/  amp2,       jamp2
...
C 
      ...
      DATA (bflav(i),i=1,NEXTERNAL_BORN) / 5, -5, 6, -6, 0 /
      ...
      common/to_POWHEG_bbx_ttxg/amp2jk,cCF,cDENOM,amphel,helindex
C          
C BEGIN CODE
C ----------
      NTRY=NTRY+1
...
C 
      ...
      REAL*8 FUNCTION bbx_ttxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C COLOR DATA
      ...
      DATA (CF_CLBS(i,1  ,1,2),i=1  ,4  ) / -1,-10,  7, -2/             
C               T[ 3,1,5]T[ 2,4]                                        
      DATA Denom_CLBS(2  ,1,2)/        18/                                    
      DATA (CF_CLBS(i,2  ,1,2),i=1  ,4  ) /-10, -1, -2,  7/             
C               T[ 3,1]T[ 2,4,5]                                        
      DATA Denom_CLBS(3  ,1,2)/        18/                                    
      DATA (CF_CLBS(i,3  ,1,2),i=1  ,4  ) /  7, -2,  8, -1/             
C               T[ 2,4]T[ 3,1,5]                                        
...
C               T[ 3,1,5]T[ 2,4]                                        
      ...
      DATA (CF_CLBS(i,2  ,1,3),i=1  ,4  ) /  7,-56,  6,-57/             
C               T[ 3,1]T[ 2,4,5]                                        
      DATA Denom_CLBS(3  ,1,3)/        18/                                    
      DATA (CF_CLBS(i,3  ,1,3),i=1  ,4  ) /  6,  6,  7,  7/             
C               T[ 2,4]T[ 3,1,5]                                        
      DATA Denom_CLBS(4  ,1,3)/        18/                                    
      DATA (CF_CLBS(i,4  ,1,3),i=1  ,4  ) /  6,-57,  7,-56/             
C               T[ 3,1]T[ 2,4,5]                                        
C  
      DATA Denom_CLBS(1  ,1,4)/         9/                                    
      DATA (CF_CLBS(i,1  ,1,4),i=1  ,4  ) /  1,  1, -3, -3/             
C               T[ 3,1,5]T[ 2,4]                                        
      DATA Denom_CLBS(2  ,1,4)/         9/                                    
      DATA (CF_CLBS(i,2  ,1,4),i=1  ,4  ) /  1, -8,  6, -3/             
C               T[ 3,1]T[ 2,4,5]                                        
      DATA Denom_CLBS(3  ,1,4)/         9/                                    
      DATA (CF_CLBS(i,3  ,1,4),i=1  ,4  ) / -3,  6, -8,  1/             
C               T[ 2,4]T[ 3,1,5]                                        
...
C               T[ 3,1]T[ 2,4,5]                                        
      ...
      DATA (CF_CLBS(i,3  ,1,5),i=1  ,4  ) / -7,  0, -7,  0/             
C               T[ 2,4]T[ 3,1,5]                                        
      DATA Denom_CLBS(4  ,1,5)/         1/                                    
      DATA (CF_CLBS(i,4  ,1,5),i=1  ,4  ) /  1,  0,  0, -1/             
C               T[ 3,1]T[ 2,4,5]                                        
C  
      DATA Denom_CLBS(1  ,2,3)/         9/                                    
      DATA (CF_CLBS(i,1  ,2,3),i=1  ,4  ) / -8,  1, -3,  6/             
C               T[ 3,1,5]T[ 2,4]                                        
      DATA Denom_CLBS(2  ,2,3)/         9/                                    
      DATA (CF_CLBS(i,2  ,2,3),i=1  ,4  ) /  1,  1, -3, -3/             
C               T[ 3,1]T[ 2,4,5]                                        
      DATA Denom_CLBS(3  ,2,3)/         9/                                    
      DATA (CF_CLBS(i,3  ,2,3),i=1  ,4  ) / -3, -3,  1,  1/             
C               T[ 2,4]T[ 3,1,5]                                        
      DATA Denom_CLBS(4  ,2,3)/         9/                                    
      DATA (CF_CLBS(i,4  ,2,3),i=1  ,4  ) /  6, -3,  1, -8/             
C               T[ 3,1]T[ 2,4,5]                                        
C  
      DATA Denom_CLBS(1  ,2,4)/        18/                                    
      DATA (CF_CLBS(i,1  ,2,4),i=1  ,4  ) /-56,  7,-57,  6/             
C               T[ 3,1,5]T[ 2,4]                                        
      DATA Denom_CLBS(2  ,2,4)/        18/                                    
      DATA (CF_CLBS(i,2  ,2,4),i=1  ,4  ) /  7,  7,  6,  6/             
C               T[ 3,1]T[ 2,4,5]                                        
      DATA Denom_CLBS(3  ,2,4)/        18/                                    
      DATA (CF_CLBS(i,3  ,2,4),i=1  ,4  ) /-57,  6,-56,  7/             
C               T[ 2,4]T[ 3,1,5]                                        
...
C               T[ 3,1]T[ 2,4,5]                                        
      DATA Denom_CLBS(3  ,2,5)/         1/                                    
      DATA (CF_CLBS(i,3  ,2,5),i=1  ,4  ) /  0,  1, -1,  0/             
C               T[ 2,4]T[ 3,1,5]                                        
      DATA Denom_CLBS(4  ,2,5)/         2/                                    
      DATA (CF_CLBS(i,4  ,2,5),i=1  ,4  ) /  0, -7,  0, -7/             
C               T[ 3,1]T[ 2,4,5]                                        
C  
      DATA Denom_CLBS(1  ,3,4)/        18/                                    
      DATA (CF_CLBS(i,1  ,3,4),i=1  ,4  ) /  8, -1,  7, -2/             
C               T[ 3,1,5]T[ 2,4]                                        
      DATA Denom_CLBS(2  ,3,4)/        18/                                    
      DATA (CF_CLBS(i,2  ,3,4),i=1  ,4  ) / -1,  8, -2,  7/             
C               T[ 3,1]T[ 2,4,5]                                        
      DATA Denom_CLBS(3  ,3,4)/        18/                                    
      DATA (CF_CLBS(i,3  ,3,4),i=1  ,4  ) /  7, -2, -1,-10/             
C               T[ 2,4]T[ 3,1,5]                                        
      DATA Denom_CLBS(4  ,3,4)/        18/                                    
      DATA (CF_CLBS(i,4  ,3,4),i=1  ,4  ) / -2,  7,-10, -1/             
C               T[ 3,1]T[ 2,4,5]                                        
C  
      DATA Denom_CLBS(1  ,3,5)/         2/                                    
      DATA (CF_CLBS(i,1  ,3,5),i=1  ,4  ) / -7,  0, -7,  0/             
C               T[ 3,1,5]T[ 2,4]                                        
      DATA Denom_CLBS(2  ,3,5)/         1/                                    
      DATA (CF_CLBS(i,2  ,3,5),i=1  ,4  ) /  0, -1,  1,  0/             
C               T[ 3,1]T[ 2,4,5]                                        
      DATA Denom_CLBS(3  ,3,5)/         2/                                    
      DATA (CF_CLBS(i,3  ,3,5),i=1  ,4  ) / -7,  2, -8,  1/             
C               T[ 2,4]T[ 3,1,5]                                        
      DATA Denom_CLBS(4  ,3,5)/         2/                                    
      DATA (CF_CLBS(i,4  ,3,5),i=1  ,4  ) /  0,  0,  1,  1/             
C               T[ 3,1]T[ 2,4,5]                                        
C  
      DATA Denom_CLBS(1  ,4,5)/         1/                                    
      DATA (CF_CLBS(i,1  ,4,5),i=1  ,4  ) / -1,  0,  0,  1/             
C               T[ 3,1,5]T[ 2,4]                                        
      DATA Denom_CLBS(2  ,4,5)/         2/                                    
      DATA (CF_CLBS(i,2  ,4,5),i=1  ,4  ) /  0, -7,  0, -7/             
C               T[ 3,1]T[ 2,4,5]                                        
      DATA Denom_CLBS(3  ,4,5)/         2/                                    
      DATA (CF_CLBS(i,3  ,4,5),i=1  ,4  ) /  0,  0,  1,  1/             
C               T[ 2,4]T[ 3,1,5]                                        
      DATA Denom_CLBS(4  ,4,5)/         2/                                    
      DATA (CF_CLBS(i,4  ,4,5),i=1  ,4  ) /  2, -7,  1, -8/             
C               T[ 3,1]T[ 2,4,5]                                        
C  
C  
      DATA Denom(1  )/            3/                                       
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ...
              cCF(J,I)=CF(J,I)
          ENDDO
          bbx_ttxg =bbx_ttxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
C 
         do jjj=1,NEXTERNAL_BORN
