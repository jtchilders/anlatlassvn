      SUBROUTINE Sbg_ttxb(P1,ANS,ANSJK,ANSMUNU)
C  
...
C  
      ...
      common/to_amps_bg_ttxb/  amp2,       jamp2
...
C 
      ...
      common/to_POWHEG_bg_ttxb/amp2jk,cCF,cDENOM,amphel,helindex
C          
C BEGIN CODE
C ----------
      NTRY=NTRY+1
...
C 
      ...
      REAL*8 FUNCTION bg_ttxb(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ...
              cCF(J,I)=CF(J,I)
          ENDDO
          bg_ttxb =bg_ttxb+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
C 
         do jjj=1,NEXTERNAL_BORN
