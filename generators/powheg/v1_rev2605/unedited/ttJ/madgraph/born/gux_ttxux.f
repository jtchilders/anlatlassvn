      SUBROUTINE Sgux_ttxux(P1,ANS,ANSJK,ANSMUNU)
C  
...
C  
      ...
      common/to_amps_gux_ttxux/  amp2,       jamp2
...
C 
      ...
      DATA (bflav(i),i=1,NEXTERNAL_BORN) / 0, -2, 6, -6, -2 /
      ...
      common/to_POWHEG_gux_ttxux/amp2jk,cCF,cDENOM,amphel,helindex
C          
C BEGIN CODE
C ----------
      NTRY=NTRY+1
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                helindex=ihel
                 T=gux_ttxux(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
...
C 
      ...
      REAL*8 FUNCTION gux_ttxux(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ...
              cCF(J,I)=CF(J,I)
          ENDDO
          gux_ttxux =gux_ttxux+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
C 
         do jjj=1,NEXTERNAL_BORN
