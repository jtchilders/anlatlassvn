      SUBROUTINE Suxg_ttxux(P1,ANS,ANSJK,ANSMUNU)
C  
...
C  
      ...
      common/to_amps_uxg_ttxux/  amp2,       jamp2
...
C 
      ...
      common/to_POWHEG_uxg_ttxux/amp2jk,cCF,cDENOM,amphel,helindex
C          
C BEGIN CODE
C ----------
      NTRY=NTRY+1
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                helindex=ihel
                 T=uxg_ttxux(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
...
C 
      ...
      REAL*8 FUNCTION uxg_ttxux(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ...
              cCF(J,I)=CF(J,I)
          ENDDO
          uxg_ttxux =uxg_ttxux+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
C 
         do jjj=1,NEXTERNAL_BORN
