      SUBROUTINE Sgg_bepvebxemvexg(P1,ANS)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C AND HELICITIES
C FOR THE POINT IN PHASE SPACE P(0:3,NEXTERNAL_BORN_DECAY)
C  
C FOR PROCESS : g g -> b e+ ve b~ e- ve~ g  
C  
C Crossing   1 is g g -> b e+ ve b~ e- ve~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ARGUMENTS 
C  
      REAL*8 P1(0:3,NEXTERNAL_BORN_DECAY),ANS(NCROSS)
C  
C LOCAL VARIABLES 
C  
      INTEGER NHEL(NEXTERNAL_BORN_DECAY,NCOMB),NTRY
      REAL*8 T, P(0:3,NEXTERNAL_BORN_DECAY)
      REAL*8 gg_bepvebxemvexg
      INTEGER IHEL,IDEN(NCROSS),IC(NEXTERNAL_BORN_DECAY,NCROSS)
      INTEGER IPROC,JC(NEXTERNAL_BORN_DECAY), I
...
C  
      ...
      common/to_amps_gg_bepvebxemvexg/  amp2,       jamp2
...
C ----------
      NTRY=NTRY+1
      DO IPROC=1,NCROSS
      CALL SWITCHMOM(P1,P,IC(1,IPROC),JC,NEXTERNAL_BORN_DECAY)
      DO IHEL=1,NEXTERNAL_BORN_DECAY
         JC(IHEL) = +1
      ENDDO
      ...
      ENDIF
      ANS(IPROC) = 0D0
      write(hel_buff,'(16i5)') (0,i=1,NEXTERNAL_BORN_DECAY)
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gg_bepvebxemvexg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
          ...
          IF (ISUM_HEL .EQ. 1) THEN
              WRITE(HEL_BUFF,'(16i5)')(NHEL(i,IHEL),i=1,NEXTERNAL_BORN_DECAY)
          ENDIF
      ENDIF
      IF (MULTI_CHANNEL) THEN
          XTOT=0D0
      ...
      REAL*8 FUNCTION gg_bepvebxemvexg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT WITH EXTERNAL LINES W(0:6,NEXTERNAL_BORN_DECAY)
C  
C FOR PROCESS : g g -> b e+ ve b~ e- ve~ g  
C  
      IMPLICIT NONE
...
C ARGUMENTS 
C  
      REAL*8 P(0:3,NEXTERNAL_BORN_DECAY)
      INTEGER NHEL(NEXTERNAL_BORN_DECAY), IC(NEXTERNAL_BORN_DECAY)
C  
C LOCAL VARIABLES 
C  
      INTEGER I,J
...
C ----------
      ...
      CALL JVVXXX(W(1,9   ),W(1,1   ),G ,ZERO    ,ZERO    ,W(1,12  ))      
      CALL FVOXXX(W(1,3   ),W(1,10  ),GWF ,TMASS   ,TWIDTH  ,W(1,13  ))    
      CALL FVOXXX(W(1,13  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,14  ))     
      CALL FVOXXX(W(1,14  ),W(1,12  ),GG ,TMASS   ,TWIDTH  ,W(1,15  ))     
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,11  ),GWF ,AMP(1   ))            
      CALL JVVXXX(W(1,9   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,16  ))      
      CALL FVOXXX(W(1,13  ),W(1,16  ),GG ,TMASS   ,TWIDTH  ,W(1,17  ))     
      CALL FVOXXX(W(1,17  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,18  ))     
      CALL IOVXXX(W(1,6   ),W(1,18  ),W(1,11  ),GWF ,AMP(2   ))            
      CALL FVOXXX(W(1,13  ),W(1,9   ),GG ,TMASS   ,TWIDTH  ,W(1,19  ))     
      CALL FVOXXX(W(1,19  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,20  ))     
      CALL FVOXXX(W(1,20  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,21  ))     
      CALL IOVXXX(W(1,6   ),W(1,21  ),W(1,11  ),GWF ,AMP(3   ))            
      CALL FVOXXX(W(1,14  ),W(1,9   ),GG ,TMASS   ,TWIDTH  ,W(1,22  ))     
      CALL FVOXXX(W(1,22  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,23  ))     
      CALL IOVXXX(W(1,6   ),W(1,23  ),W(1,11  ),GWF ,AMP(4   ))            
      CALL FVOXXX(W(1,14  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,24  ))     
      CALL FVOXXX(W(1,24  ),W(1,9   ),GG ,TMASS   ,TWIDTH  ,W(1,25  ))     
      CALL IOVXXX(W(1,6   ),W(1,25  ),W(1,11  ),GWF ,AMP(5   ))            
      CALL FVOXXX(W(1,13  ),W(1,12  ),GG ,TMASS   ,TWIDTH  ,W(1,26  ))     
      CALL FVOXXX(W(1,26  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,27  ))     
      CALL IOVXXX(W(1,6   ),W(1,27  ),W(1,11  ),GWF ,AMP(6   ))            
      CALL FVOXXX(W(1,13  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,28  ))     
      CALL FVOXXX(W(1,28  ),W(1,16  ),GG ,TMASS   ,TWIDTH  ,W(1,29  ))     
      CALL IOVXXX(W(1,6   ),W(1,29  ),W(1,11  ),GWF ,AMP(7   ))            
      CALL FVOXXX(W(1,19  ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,30  ))     
      CALL FVOXXX(W(1,30  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,31  ))     
      CALL IOVXXX(W(1,6   ),W(1,31  ),W(1,11  ),GWF ,AMP(8   ))            
      CALL FVOXXX(W(1,28  ),W(1,9   ),GG ,TMASS   ,TWIDTH  ,W(1,32  ))     
      CALL FVOXXX(W(1,32  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,33  ))     
      CALL IOVXXX(W(1,6   ),W(1,33  ),W(1,11  ),GWF ,AMP(9   ))            
      CALL FVOXXX(W(1,28  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,34  ))     
      CALL FVOXXX(W(1,34  ),W(1,9   ),GG ,TMASS   ,TWIDTH  ,W(1,35  ))     
      CALL IOVXXX(W(1,6   ),W(1,35  ),W(1,11  ),GWF ,AMP(10  ))            
      CALL JVVXXX(W(1,12  ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,36  ))      
      CALL FVOXXX(W(1,13  ),W(1,36  ),GG ,TMASS   ,TWIDTH  ,W(1,37  ))     
      CALL IOVXXX(W(1,6   ),W(1,37  ),W(1,11  ),GWF ,AMP(11  ))            
      CALL JVVXXX(W(1,1   ),W(1,16  ),G ,ZERO    ,ZERO    ,W(1,38  ))      
      CALL FVOXXX(W(1,13  ),W(1,38  ),GG ,TMASS   ,TWIDTH  ,W(1,39  ))     
      CALL IOVXXX(W(1,6   ),W(1,39  ),W(1,11  ),GWF ,AMP(12  ))            
      CALL JGGGXX(W(1,1   ),W(1,2   ),W(1,9   ),G ,W(1,40  ))              
      CALL FVOXXX(W(1,13  ),W(1,40  ),GG ,TMASS   ,TWIDTH  ,W(1,41  ))     
      CALL IOVXXX(W(1,6   ),W(1,41  ),W(1,11  ),GWF ,AMP(13  ))            
      CALL JGGGXX(W(1,9   ),W(1,1   ),W(1,2   ),G ,W(1,42  ))              
      CALL FVOXXX(W(1,13  ),W(1,42  ),GG ,TMASS   ,TWIDTH  ,W(1,43  ))     
      CALL IOVXXX(W(1,6   ),W(1,43  ),W(1,11  ),GWF ,AMP(14  ))            
      CALL JGGGXX(W(1,2   ),W(1,9   ),W(1,1   ),G ,W(1,44  ))              
      CALL FVOXXX(W(1,13  ),W(1,44  ),GG ,TMASS   ,TWIDTH  ,W(1,45  ))     
      CALL IOVXXX(W(1,6   ),W(1,45  ),W(1,11  ),GWF ,AMP(15  ))            
      CALL JVVXXX(W(1,1   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,46  ))      
      CALL FVOXXX(W(1,19  ),W(1,46  ),GG ,TMASS   ,TWIDTH  ,W(1,47  ))     
      CALL IOVXXX(W(1,6   ),W(1,47  ),W(1,11  ),GWF ,AMP(16  ))            
      CALL JVVXXX(W(1,9   ),W(1,46  ),G ,ZERO    ,ZERO    ,W(1,48  ))      
      CALL FVOXXX(W(1,13  ),W(1,48  ),GG ,TMASS   ,TWIDTH  ,W(1,49  ))     
      CALL IOVXXX(W(1,6   ),W(1,49  ),W(1,11  ),GWF ,AMP(17  ))            
      CALL FVOXXX(W(1,13  ),W(1,46  ),GG ,TMASS   ,TWIDTH  ,W(1,50  ))     
      CALL FVOXXX(W(1,50  ),W(1,9   ),GG ,TMASS   ,TWIDTH  ,W(1,51  ))     
      CALL IOVXXX(W(1,6   ),W(1,51  ),W(1,11  ),GWF ,AMP(18  ))            
      JAMP(   1) = -AMP(   1)+AMP(   5)+AMP(  11)+AMP(  13)-AMP(  14)
     &             +AMP(  17)-AMP(  18)
     ...
     &             +AMP(  16)+AMP(  17)
      JAMP(   6) = -AMP(   7)+AMP(  10)-AMP(  12)-AMP(  13)+AMP(  15)
     &             -AMP(  17)+AMP(  18)
      gg_bepvebxemvexg = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          gg_bepvebxemvexg =gg_bepvebxemvexg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
