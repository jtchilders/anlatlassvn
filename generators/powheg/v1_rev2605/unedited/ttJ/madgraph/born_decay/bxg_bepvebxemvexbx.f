      SUBROUTINE Sbxg_bepvebxemvexbx(P1,ANS)
C  
...
C  
C FOR PROCESS : b~ g -> b e+ ve b~ e- ve~ b~  
C  
C Crossing   1 is b~ g -> b e+ ve b~ e- ve~ b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_bxg_bepvebxemvexbx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bxg_bepvebxemvexbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bxg_bepvebxemvexbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      ...
      PARAMETER (NWAVEFUNCS=  25, NCOLOR=   4) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
C  
C ARGUMENTS 
...
C ----------
      ...
      CALL JIOXXX(W(1,9   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      ...
      CALL FVOXXX(W(1,13  ),W(1,12  ),GG ,TMASS   ,TWIDTH  ,W(1,16  ))     
      CALL FVOXXX(W(1,16  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,17  ))     
      CALL IOVXXX(W(1,6   ),W(1,17  ),W(1,11  ),GWF ,AMP(2   ))            
      CALL JVVXXX(W(1,12  ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,18  ))      
      CALL FVOXXX(W(1,13  ),W(1,18  ),GG ,TMASS   ,TWIDTH  ,W(1,19  ))     
      CALL IOVXXX(W(1,6   ),W(1,19  ),W(1,11  ),GWF ,AMP(3   ))            
      CALL FVIXXX(W(1,9   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,20  ))     
      CALL JIOXXX(W(1,20  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL FVOXXX(W(1,13  ),W(1,21  ),GG ,TMASS   ,TWIDTH  ,W(1,22  ))     
      CALL IOVXXX(W(1,6   ),W(1,22  ),W(1,11  ),GWF ,AMP(4   ))            
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,23  ))     
      CALL JIOXXX(W(1,9   ),W(1,23  ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL FVOXXX(W(1,13  ),W(1,24  ),GG ,TMASS   ,TWIDTH  ,W(1,25  ))     
      CALL IOVXXX(W(1,6   ),W(1,25  ),W(1,11  ),GWF ,AMP(5   ))            
      JAMP(   1) = -AMP(   1)+AMP(   3)
      JAMP(   2) = -AMP(   2)-AMP(   3)
      JAMP(   3) = -AMP(   4)
      JAMP(   4) = -AMP(   5)
      bxg_bepvebxemvexbx = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          bxg_bepvebxemvexbx =bxg_bepvebxemvexbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
