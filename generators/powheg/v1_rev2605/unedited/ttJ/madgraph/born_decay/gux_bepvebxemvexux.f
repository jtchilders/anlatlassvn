      SUBROUTINE Sgux_bepvebxemvexux(P1,ANS)
C  
...
C  
C FOR PROCESS : g u~ -> b e+ ve b~ e- ve~ u~  
C  
C Crossing   1 is g u~ -> b e+ ve b~ e- ve~ u~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_gux_bepvebxemvexux/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gux_bepvebxemvexux(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gux_bepvebxemvexux(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,9   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      ...
      JAMP(   3) = -AMP(   3)
      JAMP(   4) = -AMP(   5)
      gux_bepvebxemvexux = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          gux_bepvebxemvexux =gux_bepvebxemvexux+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
