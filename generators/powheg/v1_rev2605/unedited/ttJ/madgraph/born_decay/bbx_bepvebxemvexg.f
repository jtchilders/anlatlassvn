      SUBROUTINE Sbbx_bepvebxemvexg(P1,ANS)
C  
...
C  
C FOR PROCESS : b b~ -> b e+ ve b~ e- ve~ g  
C  
C Crossing   1 is b b~ -> b e+ ve b~ e- ve~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_bbx_bepvebxemvexg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bbx_bepvebxemvexg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bbx_bepvebxemvexg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,12  ))     
      CALL JIOXXX(W(1,12  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL FVOXXX(W(1,3   ),W(1,10  ),GWF ,TMASS   ,TWIDTH  ,W(1,14  ))    
      ...
      CALL FVOXXX(W(1,14  ),W(1,17  ),GG ,TMASS   ,TWIDTH  ,W(1,18  ))     
      CALL IOVXXX(W(1,6   ),W(1,18  ),W(1,11  ),GWF ,AMP(2   ))            
      CALL JIOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL FVOXXX(W(1,14  ),W(1,9   ),GG ,TMASS   ,TWIDTH  ,W(1,20  ))     
      CALL FVOXXX(W(1,20  ),W(1,19  ),GG ,TMASS   ,TWIDTH  ,W(1,21  ))     
      CALL IOVXXX(W(1,6   ),W(1,21  ),W(1,11  ),GWF ,AMP(3   ))            
      CALL JVVXXX(W(1,9   ),W(1,19  ),G ,ZERO    ,ZERO    ,W(1,22  ))      
      CALL FVOXXX(W(1,14  ),W(1,22  ),GG ,TMASS   ,TWIDTH  ,W(1,23  ))     
      CALL IOVXXX(W(1,6   ),W(1,23  ),W(1,11  ),GWF ,AMP(4   ))            
      CALL FVOXXX(W(1,14  ),W(1,19  ),GG ,TMASS   ,TWIDTH  ,W(1,24  ))     
      ...
      JAMP(   3) = +AMP(   3)
      JAMP(   4) = +AMP(   5)
      bbx_bepvebxemvexg = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          bbx_bepvebxemvexg =bbx_bepvebxemvexg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
