...
C  
C FOR PROCESS : b u~ -> t t~ u~ b  
C  
C Crossing   1 is b u~ -> t t~ u~ b  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_bux_ttxuxb/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bux_ttxuxb(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bux_ttxuxb(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      ...
      PARAMETER (NWAVEFUNCS=  19, NCOLOR=   6) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
C  
C ARGUMENTS 
...
C ----------
      ...
      CALL FVOXXX(W(1,2   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      ...
      CALL FVIXXX(W(1,1   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,16  ),W(1,6   ),W(1,12  ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,1   ),W(1,12  ),GG ,BMASS   ,ZERO    ,W(1,17  ))     
      CALL IOVXXX(W(1,17  ),W(1,6   ),W(1,7   ),GG ,AMP(6   ))             
      CALL FVIXXX(W(1,5   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bux_ttxuxb =bux_ttxuxb+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
