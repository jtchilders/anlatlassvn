...
C  
C FOR PROCESS : b~ b -> t t~ u u~  
C  
C Crossing   1 is b~ b -> t t~ u u~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_bxb_ttxuux/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bxb_ttxuux(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bxb_ttxuux(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,3   ),W(1,12  ),GG ,TMASS   ,TWIDTH  ,W(1,15  ))     
      CALL JIOXXX(W(1,4   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,16  ),GG ,AMP(4   ))             
      CALL JVVXXX(W(1,7   ),W(1,12  ),G ,ZERO    ,ZERO    ,W(1,17  ))      
      ...
      CALL FVOXXX(W(1,5   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bxb_ttxuux =bxb_ttxuux+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
