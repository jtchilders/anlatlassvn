...
C  
      ...
      common/to_amps_bb_ttxbb/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bb_ttxbb(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,20  ),GG ,BMASS   ,ZERO    ,W(1,27  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bb_ttxbb =bb_ttxbb+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
