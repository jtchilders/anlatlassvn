...
C  
      ...
      common/to_amps_gg_ttxbbx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gg_ttxbbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gg_ttxbbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,5   ),W(1,8   ),GG ,BMASS   ,ZERO    ,W(1,9   ))     
      ...
      CALL FVOXXX(W(1,5   ),W(1,23  ),GG ,BMASS   ,ZERO    ,W(1,24  ))     
      ...
      CALL FVOXXX(W(1,11  ),W(1,35  ),GG ,BMASS   ,ZERO    ,W(1,38  ))     
      ...
      CALL FVOXXX(W(1,11  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,40  ))     
      CALL IOVXXX(W(1,6   ),W(1,40  ),W(1,35  ),GG ,AMP(22  ))             
      CALL IOVXXX(W(1,6   ),W(1,11  ),W(1,36  ),GG ,AMP(23  ))             
      CALL FVOXXX(W(1,16  ),W(1,35  ),GG ,BMASS   ,ZERO    ,W(1,41  ))     
      ...
      CALL FVOXXX(W(1,16  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,45  ))     
      ...
      CALL FVOXXX(W(1,5   ),W(1,35  ),GG ,BMASS   ,ZERO    ,W(1,54  ))     
      CALL FVOXXX(W(1,54  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,55  ))     
      CALL IOVXXX(W(1,6   ),W(1,55  ),W(1,1   ),GG ,AMP(34  ))             
      CALL FVOXXX(W(1,54  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,56  ))     
      ...
      CALL FVOXXX(W(1,5   ),W(1,46  ),GG ,BMASS   ,ZERO    ,W(1,58  ))     
     ...
     &             -AMP(  32)+AMP(  36)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gg_ttxbbx =gg_ttxbbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
