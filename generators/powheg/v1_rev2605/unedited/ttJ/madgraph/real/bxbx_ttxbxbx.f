      SUBROUTINE Sbxbx_ttxbxbx(P1,ANS)
C  
...
C  
      ...
      common/to_amps_bxbx_ttxbxbx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bxbx_ttxbxbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bxbx_ttxbxbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,1   ),W(1,12  ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL JIOXXX(W(1,5   ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,17  ),GG ,AMP(6   ))             
      CALL FVIXXX(W(1,5   ),W(1,12  ),GG ,BMASS   ,ZERO    ,W(1,18  ))     
      ...
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,24  ),GG ,AMP(9   ))             
      CALL JIOXXX(W(1,5   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      ...
      CALL FVOXXX(W(1,1   ),W(1,20  ),GG ,BMASS   ,ZERO    ,W(1,27  ))     
      CALL IOVXXX(W(1,6   ),W(1,27  ),W(1,12  ),GG ,AMP(12  ))             
      CALL IOVXXX(W(1,6   ),W(1,16  ),W(1,20  ),GG ,AMP(13  ))             
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bxbx_ttxbxbx =bxbx_ttxbxbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
