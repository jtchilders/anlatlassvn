module     p16_bbarb_hepemg_d537h2l1d
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p16_bbarb_hepemg/helicity2d537h2l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p16_bbarb_hepemg_abbrevd537h2
      implicit none
      complex(ki), dimension(4), intent(in) :: Q
      complex(ki), intent(in) :: mu2
      complex(ki), dimension(48) :: acd537
      complex(ki) :: brack
      ...
      acd537(6)=dotproduct(qshift,spvak1k5)
      acd537(7)=abb537(16)
      acd537(8)=dotproduct(qshift,spvak4k2)
      acd537(9)=abb537(25)
      acd537(10)=dotproduct(qshift,spvak4k5)
      acd537(11)=abb537(26)
      acd537(12)=dotproduct(qshift,spvae6k2)
      acd537(13)=abb537(11)
      acd537(14)=abb537(18)
      ...
      acd537(17)=abb537(30)
      acd537(18)=abb537(22)
      acd537(19)=dotproduct(qshift,spvak1k2)
      acd537(20)=abb537(14)
      acd537(21)=abb537(13)
      acd537(22)=dotproduct(qshift,spvak6k2)
      acd537(23)=abb537(19)
      acd537(24)=abb537(12)
      ...
      acd537(31)=abb537(28)
      acd537(32)=abb537(29)
      acd537(33)=dotproduct(qshift,spvak1k6)
      acd537(34)=abb537(7)
      acd537(35)=abb537(24)
      acd537(36)=abb537(10)
      acd537(37)=abb537(8)
      acd537(38)=abb537(9)
      acd537(39)=acd537(11)*acd537(5)
      acd537(40)=acd537(19)*acd537(2)
      acd537(41)=acd537(20)*acd537(40)
      acd537(42)=-acd537(28)*acd537(25)
      acd537(43)=acd537(31)*acd537(12)
      acd537(44)=acd537(32)*acd537(22)
      acd537(45)=-acd537(34)*acd537(33)
      acd537(39)=-acd537(35)+acd537(45)+acd537(44)+acd537(43)+acd537(42)+acd537&
      &(41)+acd537(39)
      acd537(39)=acd537(10)*acd537(39)
      acd537(41)=acd537(5)+acd537(1)
      acd537(41)=acd537(3)*acd537(41)
      acd537(42)=acd537(17)*acd537(6)
      acd537(43)=acd537(18)*acd537(8)
      acd537(44)=acd537(23)*acd537(22)
      acd537(41)=acd537(41)-acd537(24)+acd537(44)+acd537(43)+acd537(42)
      acd537(41)=acd537(2)*acd537(41)
      acd537(42)=-acd537(7)*acd537(6)
      acd537(43)=acd537(9)*acd537(8)
      acd537(44)=-acd537(13)*acd537(12)
      acd537(42)=acd537(44)+acd537(43)+acd537(42)
      acd537(43)=acd537(15)-acd537(5)
      acd537(42)=acd537(43)*acd537(42)
      acd537(43)=-acd537(26)*acd537(6)
      acd537(44)=-acd537(27)*acd537(8)
      acd537(45)=-acd537(29)*acd537(12)
      acd537(43)=acd537(30)+acd537(45)+acd537(44)+acd537(43)
      acd537(43)=acd537(25)*acd537(43)
      acd537(44)=-acd537(4)*acd537(1)
      acd537(45)=-acd537(14)*acd537(5)
      acd537(46)=-acd537(16)*acd537(15)
      acd537(40)=acd537(21)*acd537(40)
      acd537(47)=-acd537(36)*acd537(12)
      acd537(48)=-acd537(37)*acd537(22)
      brack=acd537(38)+acd537(39)+acd537(40)+acd537(41)+acd537(42)+acd537(43)+a&
      &cd537(44)+acd537(45)+acd537(46)+acd537(47)+acd537(48)
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      acd537(20)=abb537(30)
      acd537(21)=abb537(22)
      acd537(22)=dotproduct(qshift,spvak1k2)
      acd537(23)=abb537(14)
      acd537(24)=abb537(13)
      acd537(25)=dotproduct(qshift,spvak6k2)
      acd537(26)=abb537(19)
      acd537(27)=abb537(12)
      ...
      acd537(32)=abb537(21)
      acd537(33)=abb537(20)
      acd537(34)=spvak1k5(iv1)
      acd537(35)=dotproduct(k6,qshift)
      acd537(36)=dotproduct(qshift,qshift)
      acd537(37)=spvak4k2(iv1)
      acd537(38)=spvak4k5(iv1)
      acd537(39)=abb537(28)
      acd537(40)=abb537(29)
      acd537(41)=dotproduct(qshift,spvak1k6)
      acd537(42)=abb537(7)
      acd537(43)=abb537(24)
      acd537(44)=spvae6k2(iv1)
      acd537(45)=abb537(10)
      acd537(46)=spvak1k2(iv1)
      acd537(47)=spvak6k2(iv1)
      acd537(48)=abb537(8)
      acd537(49)=spvak1k6(iv1)
...
!---#[ function brack_3:
   pure function brack_3(Q, mu2) result(brack)
      ...
      complex(ki) :: brack
      acd537(1)=d(iv1,iv2)
      acd537(2)=dotproduct(qshift,spvak1k5)
      acd537(3)=abb537(6)
      acd537(4)=dotproduct(qshift,spvak4k2)
      acd537(5)=abb537(23)
      acd537(6)=dotproduct(qshift,spvak4k5)
      acd537(7)=abb537(27)
      acd537(8)=dotproduct(qshift,spvae6k2)
      acd537(9)=abb537(21)
      acd537(10)=abb537(20)
      acd537(11)=k1(iv1)
      acd537(12)=e6(iv2)
      ...
      acd537(15)=e6(iv1)
      acd537(16)=k2(iv1)
      acd537(17)=spvak1k5(iv2)
      acd537(18)=abb537(16)
      acd537(19)=spvak4k2(iv2)
      acd537(20)=abb537(25)
      acd537(21)=spvak4k5(iv2)
      acd537(22)=abb537(26)
      acd537(23)=spvae6k2(iv2)
      acd537(24)=abb537(11)
      acd537(25)=k2(iv2)
      acd537(26)=spvak1k5(iv1)
      acd537(27)=spvak4k2(iv1)
      acd537(28)=spvak4k5(iv1)
      acd537(29)=spvae6k2(iv1)
      acd537(30)=k6(iv1)
      acd537(31)=k6(iv2)
      acd537(32)=abb537(30)
      acd537(33)=abb537(22)
      acd537(34)=dotproduct(qshift,spvak1k2)
      acd537(35)=abb537(14)
      acd537(36)=spvak1k2(iv2)
      acd537(37)=abb537(13)
      acd537(38)=spvak6k2(iv2)
      acd537(39)=abb537(19)
      acd537(40)=spvak1k2(iv1)
      acd537(41)=spvak6k2(iv1)
      acd537(42)=qshift(iv1)
      acd537(43)=qshift(iv2)
      acd537(44)=abb537(28)
      acd537(45)=dotproduct(e6,qshift)
      acd537(46)=abb537(29)
      acd537(47)=spvak1k6(iv2)
      acd537(48)=abb537(7)
      acd537(49)=spvak1k6(iv1)
...
!---#[ function brack_4:
   pure function brack_4(Q, mu2) result(brack)
      ...
      complex(ki) :: brack
      acd537(1)=d(iv1,iv2)
      acd537(2)=spvak1k5(iv3)
      acd537(3)=abb537(6)
      acd537(4)=spvak4k2(iv3)
      acd537(5)=abb537(23)
      acd537(6)=spvak4k5(iv3)
      acd537(7)=abb537(27)
      acd537(8)=spvae6k2(iv3)
      acd537(9)=abb537(21)
      acd537(10)=d(iv1,iv3)
      acd537(11)=spvak1k5(iv2)
      acd537(12)=spvak4k2(iv2)
      acd537(13)=spvak4k5(iv2)
      acd537(14)=spvae6k2(iv2)
      acd537(15)=d(iv2,iv3)
      acd537(16)=spvak1k5(iv1)
      acd537(17)=spvak4k2(iv1)
      acd537(18)=spvak4k5(iv1)
      acd537(19)=spvae6k2(iv1)
      acd537(20)=e6(iv1)
      acd537(21)=spvak1k2(iv3)
      acd537(22)=abb537(14)
      acd537(23)=spvak1k2(iv2)
      acd537(24)=e6(iv2)
      acd537(25)=spvak1k2(iv1)
      acd537(26)=e6(iv3)
...
!---#] subroutine reconstruct_d537:
end module     p16_bbarb_hepemg_d537h2l1d
