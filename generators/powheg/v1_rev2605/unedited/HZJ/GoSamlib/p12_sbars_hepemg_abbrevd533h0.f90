module     p12_sbars_hepemg_abbrevd533h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb533(3)=NC**(-1)
      abb533(4)=spbk6e6*spak5k6
      abb533(5)=spak1k5*spbe6k1
      abb533(4)=abb533(4)-abb533(5)
      abb533(4)=abb533(4)*spbk4k2
      abb533(6)=gSl*gel*abb533(3)*abb533(1)*abb533(2)*gHZZ*c1*TR*i_
      abb533(7)=2.0_ki*abb533(6)
      abb533(8)=abb533(7)*spak1e6
      abb533(9)=abb533(8)*es12*abb533(4)
      abb533(10)=spak1k5*es12
      abb533(11)=-spak1k2*spak5k6*spbk6k2
      abb533(10)=abb533(11)+abb533(10)
      abb533(11)=4.0_ki*abb533(6)
      abb533(12)=abb533(11)*spbk4k2
      abb533(10)=abb533(10)*abb533(12)
      abb533(13)=spbe6k2*spak1k2
      abb533(14)=spbk4k2*spak5e6
      ...
      abb533(6)=8.0_ki*spak1k5*abb533(6)*spbk4k2
      abb533(17)=-spbe6k4*spbk2k1
      abb533(18)=spbe6k2*spbk4k1
      abb533(17)=abb533(17)+abb533(18)
      abb533(17)=abb533(17)*spak1e6
      abb533(18)=-spbe6k2*spae6k6*spbk6k4
      abb533(17)=abb533(17)+abb533(18)
      abb533(17)=spak1k5*abb533(17)
      abb533(15)=abb533(15)+abb533(17)
      abb533(15)=abb533(15)*abb533(7)
      abb533(17)=abb533(11)*spak1k5
      abb533(18)=-spbk4k2*abb533(17)
      abb533(19)=abb533(17)*spbe6k4
      abb533(20)=spbe6k4*abb533(7)*spak1k5
      abb533(21)=abb533(14)*abb533(11)
      abb533(14)=-abb533(7)*abb533(14)
      abb533(22)=spbk6e6*spbk4k1
      abb533(23)=abb533(22)*abb533(8)*spak1k5
      abb533(24)=-spbk6k4*abb533(17)
      ...
      abb533(32)=-spbe6k4*es12
      abb533(13)=spbk4k1*abb533(13)
      abb533(13)=abb533(13)+abb533(22)+abb533(32)
      abb533(13)=spak1e6*abb533(13)
      abb533(22)=-spbk6k4*abb533(25)
      abb533(13)=abb533(22)+abb533(13)
      abb533(7)=abb533(13)*abb533(7)
      abb533(13)=spbk6k4*spak1k6
      abb533(22)=-spbk4k2*spak1k2
      abb533(13)=abb533(13)+abb533(22)
      abb533(13)=abb533(13)*abb533(11)
      abb533(22)=abb533(27)*spbe6k4
      abb533(25)=-spbe6k4*abb533(8)
      abb533(12)=spak5k6*abb533(12)
      abb533(5)=abb533(5)*abb533(8)*spbk4k1
      abb533(8)=-spbk4k1*abb533(17)
...
end module p12_sbars_hepemg_abbrevd533h0
