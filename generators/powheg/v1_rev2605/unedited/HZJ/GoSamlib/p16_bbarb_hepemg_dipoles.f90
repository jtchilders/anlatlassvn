module     p16_bbarb_hepemg_dipoles
   use p16_bbarb_hepemg_config, only: ki
   use p16_bbarb_hepemg_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T6, &
       & T2T6
   use p16_bbarb_hepemg_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p16_bbarb_hepemg_dipoles
