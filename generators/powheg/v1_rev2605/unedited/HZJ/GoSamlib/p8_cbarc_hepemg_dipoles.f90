module     p8_cbarc_hepemg_dipoles
   use p8_cbarc_hepemg_config, only: ki
   use p8_cbarc_hepemg_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T6, &
       & T2T6
   use p8_cbarc_hepemg_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p8_cbarc_hepemg_dipoles
