module     p0_dbard_hepemg_dipoles
   use p0_dbard_hepemg_config, only: ki
   use p0_dbard_hepemg_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T6, &
       & T2T6
   use p0_dbard_hepemg_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p0_dbard_hepemg_dipoles
