module     p12_sbars_hepemg_abbrevd541h3
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb541(4)=gHZZ*c1*NC*i_*TR*gSr*ger*abb541(2)*abb541(1)
      abb541(5)=abb541(4)*spbk5k1
      abb541(6)=abb541(5)*spak2k4
      abb541(7)=abb541(6)*abb541(3)
      abb541(8)=-es61+es345-es12
      abb541(9)=abb541(7)*abb541(8)
      abb541(10)=abb541(5)*spak4k6
      ...
      abb541(14)=spbk6k5*spak2k6
      abb541(15)=abb541(4)*spbk6k1
      abb541(16)=spak4k6*abb541(15)
      abb541(17)=-abb541(16)*abb541(14)
      abb541(18)=spbk6k1*spak4k6
      ...
      abb541(18)=spak2e6*spbe6k5*abb541(18)*abb541(17)
      ...
      abb541(11)=spae6k6*spbk6k5
      abb541(25)=-spbk5k2*spak2e6
      abb541(11)=abb541(25)+abb541(11)
      abb541(11)=abb541(16)*abb541(11)
      abb541(25)=abb541(5)*spak4e6
...
end module p12_sbars_hepemg_abbrevd541h3
