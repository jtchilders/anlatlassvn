module     p16_bbarb_hepemg_d413h2l1
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p16_bbarb_hepemg/helicity2d413h2l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc413(10)=acc413(5)*Qspvak6k1
      acc413(11)=acc413(4)*Qspvak4k5
      acc413(12)=acc413(2)*Qspvak4k2
      acc413(13)=acc413(1)*Qspvak1k6
...
!           & sign => diagram413_sign, shift => diagram413_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p16_bbarb_hepemg_d413h2l1
