module     p16_bbarb_hepemg_d413h1l1
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p16_bbarb_hepemg/helicity1d413h1l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p16_bbarb_hepemg_abbrevd413h1
      implicit none
      ...
      acc413(6)=abb413(12)
      acc413(7)=abb413(15)
      acc413(8)=Qspvak6k1*acc413(1)
      acc413(9)=Qspvak5k4*acc413(4)
      acc413(10)=Qspvak2k4*acc413(2)
      acc413(11)=Qspvak1k6*acc413(5)
...
!           & sign => diagram413_sign, shift => diagram413_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p16_bbarb_hepemg_d413h1l1
