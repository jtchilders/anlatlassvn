module     p12_sbars_hepemg_d613h1l1
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p12_sbars_hepemg/helicity1d613h1l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p12_sbars_hepemg_abbrevd613h1
      implicit none
      ...
      acc613(12)=abb613(19)
      acc613(13)=abb613(20)
      acc613(14)=acc613(4)*Qspk1
      acc613(15)=acc613(7)*Qspvak2k4
      acc613(16)=acc613(10)*Qspvak5k4
      acc613(17)=acc613(13)*Qspk6
      acc613(18)=Qspvak6k1*acc613(11)
      acc613(14)=acc613(18)+acc613(17)+acc613(16)+acc613(15)+acc613(6)+acc613(1&
      &4)
      acc613(14)=Qspe6*acc613(14)
      acc613(15)=acc613(1)*Qspk1
      acc613(16)=acc613(2)*Qspvak2k4
      acc613(17)=acc613(5)*Qspk6
      acc613(18)=acc613(12)*Qspvak5k4
      acc613(19)=Qspvae6k1*acc613(8)
      acc613(20)=QspQ*acc613(3)
...
!           & sign => diagram613_sign, shift => diagram613_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p12_sbars_hepemg_d613h1l1
