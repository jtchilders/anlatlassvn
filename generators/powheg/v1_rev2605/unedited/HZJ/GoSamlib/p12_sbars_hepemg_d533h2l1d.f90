module     p12_sbars_hepemg_d533h2l1d
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p12_sbars_hepemg/helicity2d533h2l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p12_sbars_hepemg_abbrevd533h2
      implicit none
      ...
      acd533(3)=abb533(6)
      acd533(4)=dotproduct(qshift,spvak4k2)
      acd533(5)=abb533(22)
...
!---#[ function brack_4:
   pure function brack_4(Q, mu2) result(brack)
      ...
      acd533(10)=d(iv1,iv3)
      acd533(11)=e6(iv2)
      acd533(12)=spvak4k2(iv2)
      acd533(13)=spvak1e6(iv2)
      acd533(14)=spvae6k2(iv2)
      acd533(15)=d(iv2,iv3)
      acd533(16)=e6(iv1)
      acd533(17)=spvak4k2(iv1)
...
!---#] subroutine reconstruct_d533:
end module     p12_sbars_hepemg_d533h2l1d
