module     p16_bbarb_hepemg_abbrevd605h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb605(4)=NC**(-1)
      abb605(5)=gBl*gHZZ*spak1k4*c1*i_*TR*ger*abb605(3)*abb605(2)*abb605(1)
      abb605(6)=abb605(4)*abb605(5)*spbk6k5
      abb605(7)=spae6k6*spbe6k2
      abb605(8)=abb605(7)*abb605(6)
      abb605(9)=abb605(5)*NC
      abb605(10)=abb605(9)*spbk6k5
...
end module p16_bbarb_hepemg_abbrevd605h2
