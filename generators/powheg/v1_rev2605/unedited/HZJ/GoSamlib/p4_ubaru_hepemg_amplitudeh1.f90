...
!---#[ function finite_renormalisation:
   ...
   function     samplitude(scale2,ok,rational2,opt_amp0,opt_perm)
     ...
     & only: init_lo, rat2
      use p4_ubaru_hepemg_abbrevd541h1, only: init_abbrevd541 => init_abbrev
      use p4_ubaru_hepemg_abbrevd279h1, only: init_abbrevd279 => init_abbrev
      use p4_ubaru_hepemg_abbrevd333h1, only: init_abbrevd333 => init_abbrev
      use p4_ubaru_hepemg_abbrevd421h1, only: init_abbrevd421 => init_abbrev
      use p4_ubaru_hepemg_abbrevd537h1, only: init_abbrevd537 => init_abbrev
      use p4_ubaru_hepemg_abbrevd605h1, only: init_abbrevd605 => init_abbrev
      use p4_ubaru_hepemg_abbrevd323h1, only: init_abbrevd323 => init_abbrev
      use p4_ubaru_hepemg_abbrevd413h1, only: init_abbrevd413 => init_abbrev
      use p4_ubaru_hepemg_abbrevd533h1, only: init_abbrevd533 => init_abbrev
      use p4_ubaru_hepemg_abbrevd613h1, only: init_abbrevd613 => init_abbrev
      use p4_ubaru_hepemg_abbrevd101h1, only: init_abbrevd101 => init_abbrev
      use p4_ubaru_hepemg_abbrevd553h1, only: init_abbrevd553 => init_abbrev
      use p4_ubaru_hepemg_abbrevd77h1, only: init_abbrevd77 => init_abbrev
      use p4_ubaru_hepemg_abbrevd45h1, only: init_abbrevd45 => init_abbrev
      use p4_ubaru_hepemg_abbrevd277h1, only: init_abbrevd277 => init_abbrev
      use p4_ubaru_hepemg_diagramsh1l0, only: amplitudel0 => amplitude
      use p4_ubaru_hepemg_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group3(scale2,samplitude,ok)
   ...
   use p4_ubaru_hepemg_samuraih1, only: samurai_reduce => reduce_group3
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group4(scale2,samplitude,ok)
   ...
   use p4_ubaru_hepemg_samuraih1, only: samurai_reduce => reduce_group4
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group5(scale2,samplitude,ok)
   ...
   use p4_ubaru_hepemg_samuraih1, only: samurai_reduce => reduce_group5
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
