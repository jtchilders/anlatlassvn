module     p16_bbarb_hepemg_abbrevd541h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb541(4)=gHZZ*c1*NC*i_*TR*gBl*ger*abb541(2)*abb541(1)
      abb541(5)=abb541(4)*spak1k4
      abb541(6)=abb541(5)*spbk5k2
      abb541(7)=abb541(6)*abb541(3)
      abb541(8)=-es61+es345-es12
      abb541(9)=abb541(7)*abb541(8)
      abb541(10)=abb541(5)*spbk6k5
      ...
      abb541(14)=spak4k6*spbk6k2
      abb541(15)=abb541(4)*spak1k6
      abb541(16)=spbk6k5*abb541(15)
      abb541(17)=-abb541(16)*abb541(14)
      abb541(18)=spak1k6*spbk6k5
      ...
      abb541(18)=spbe6k2*spak4e6*abb541(18)*abb541(17)
      ...
      abb541(11)=spbk6e6*spak4k6
      abb541(25)=-spak2k4*spbe6k2
      abb541(11)=abb541(25)+abb541(11)
      abb541(11)=abb541(16)*abb541(11)
      abb541(25)=abb541(5)*spbe6k5
      ...
      abb541(27)=spak2k4*abb541(21)*spbk6k2
...
end module p16_bbarb_hepemg_abbrevd541h2
