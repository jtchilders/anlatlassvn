module     p12_sbars_hepemg_color
   ! file:      /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/Go
   ! Sam_POWHEG/Virtual/p12_sbars_hepemg/common/color.f90
   ! generator: haggies (1.1)
   use p12_sbars_hepemg_config, only: ki
   use p12_sbars_hepemg_model, only: NC, Nf
   implicit none
   save
...
end module p12_sbars_hepemg_color
