module     p16_bbarb_hepemg_diagramsh1l0
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_POWHEG/Virtual/p16_bbarb_hepemg/helicity1diagramsl0.f90 
...
!---#[ function amplitude:
   function amplitude()
      ...
      use p16_bbarb_hepemg_config, only: debug_lo_diagrams, &
        & use_sorted_sum
      use p16_bbarb_hepemg_accu, only: sorted_sum
      use p16_bbarb_hepemg_util, only: inspect_lo_diagram
      implicit none
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(5)=abb(6)+abb(5)
      abb(5)=2.0_ki*abb(1)*abb(2)*gel*gBr*gHZZ*i_*abb(5)
...
!---#] function amplitude:
end module p16_bbarb_hepemg_diagramsh1l0
