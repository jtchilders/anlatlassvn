module     p12_sbars_hepemg_d421h3l1
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p12_sbars_hepemg/helicity3d421h3l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc421(5)=abb421(9)
      acc421(6)=abb421(10)
      acc421(7)=acc421(5)*Qspk6
      acc421(8)=acc421(4)*Qspk2
      acc421(9)=acc421(3)*Qspvak2e6
      acc421(10)=acc421(2)*Qspe6
      acc421(11)=acc421(1)*Qspvak6k2
...
!           & sign => diagram421_sign, shift => diagram421_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p12_sbars_hepemg_d421h3l1
