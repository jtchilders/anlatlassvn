module     p4_ubaru_hepemg_diagramsh1l0
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_POWHEG/Virtual/p4_ubaru_hepemg/helicity1diagramsl0.f90 
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(5)=abb(6)+abb(5)
      abb(5)=2.0_ki*abb(1)*abb(2)*gel*gUr*gHZZ*i_*abb(5)
...
!---#] function amplitude:
end module p4_ubaru_hepemg_diagramsh1l0
