module     p8_cbarc_hepemg_diagramsh2l0
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_POWHEG/Virtual/p8_cbarc_hepemg/helicity2diagramsl0.f90 
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(5)=abb(6)+abb(5)
      abb(5)=2.0_ki*abb(1)*abb(2)*ger*gCl*gHZZ*i_*abb(5)
...
!---#] function amplitude:
end module p8_cbarc_hepemg_diagramsh2l0
