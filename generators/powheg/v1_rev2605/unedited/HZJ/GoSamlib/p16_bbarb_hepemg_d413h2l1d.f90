module     p16_bbarb_hepemg_d413h2l1d
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p16_bbarb_hepemg/helicity2d413h2l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p16_bbarb_hepemg_abbrevd413h2
      implicit none
      ...
      acd413(6)=abb413(5)
      acd413(7)=dotproduct(qshift,spvak4k2)
      acd413(8)=abb413(6)
      acd413(9)=dotproduct(qshift,spvak4k5)
      acd413(10)=abb413(8)
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      acd413(6)=abb413(5)
      acd413(7)=spvak4k2(iv1)
      acd413(8)=abb413(6)
      acd413(9)=spvak4k5(iv1)
      acd413(10)=abb413(8)
...
!---#] subroutine reconstruct_d413:
end module     p16_bbarb_hepemg_d413h2l1d
