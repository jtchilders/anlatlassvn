module     p12_sbars_hepemg_dipoles
   use p12_sbars_hepemg_config, only: ki
   use p12_sbars_hepemg_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T6, &
       & T2T6
   use p12_sbars_hepemg_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p12_sbars_hepemg_dipoles
