...
!---#[ function finite_renormalisation:
   function     finite_renormalisation(scale2) result(amp)
      ...
      use p8_cbarc_hepemg_diagramsh2l0, only: amplitudel0 => amplitude
      implicit none
   ...
   function     samplitude(scale2,ok,rational2,opt_amp0,opt_perm)
     ...
     & only: init_lo, rat2
      use p8_cbarc_hepemg_abbrevd541h2, only: init_abbrevd541 => init_abbrev
      use p8_cbarc_hepemg_abbrevd279h2, only: init_abbrevd279 => init_abbrev
      use p8_cbarc_hepemg_abbrevd333h2, only: init_abbrevd333 => init_abbrev
      use p8_cbarc_hepemg_abbrevd421h2, only: init_abbrevd421 => init_abbrev
      use p8_cbarc_hepemg_abbrevd537h2, only: init_abbrevd537 => init_abbrev
      use p8_cbarc_hepemg_abbrevd605h2, only: init_abbrevd605 => init_abbrev
      use p8_cbarc_hepemg_abbrevd323h2, only: init_abbrevd323 => init_abbrev
      use p8_cbarc_hepemg_abbrevd413h2, only: init_abbrevd413 => init_abbrev
      use p8_cbarc_hepemg_abbrevd533h2, only: init_abbrevd533 => init_abbrev
      use p8_cbarc_hepemg_abbrevd613h2, only: init_abbrevd613 => init_abbrev
      use p8_cbarc_hepemg_abbrevd101h2, only: init_abbrevd101 => init_abbrev
      use p8_cbarc_hepemg_abbrevd553h2, only: init_abbrevd553 => init_abbrev
      use p8_cbarc_hepemg_abbrevd77h2, only: init_abbrevd77 => init_abbrev
      use p8_cbarc_hepemg_abbrevd45h2, only: init_abbrevd45 => init_abbrev
      use p8_cbarc_hepemg_abbrevd277h2, only: init_abbrevd277 => init_abbrev
      use p8_cbarc_hepemg_diagramsh2l0, only: amplitudel0 => amplitude
      use p8_cbarc_hepemg_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   ...
   use p8_cbarc_hepemg_golem95h2, only: reconstruct_golem95 => reconstruct_group
   use p8_cbarc_hepemg_groups, only: contract_golem95, &
      & global_coeffs => coeffs_group0, &
      & reduce_numetens => reduce_numetens_group0
   use p8_cbarc_hepemg_samuraih2, only: samurai_reduce => reduce_group0
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   ...
   use p8_cbarc_hepemg_samuraih2, only: samurai_reduce => reduce_group1
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   ...
   use p8_cbarc_hepemg_samuraih2, only: samurai_reduce => reduce_group2
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group3(scale2,samplitude,ok)
   ...
   use p8_cbarc_hepemg_samuraih2, only: samurai_reduce => reduce_group3
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group4(scale2,samplitude,ok)
   ...
   use p8_cbarc_hepemg_samuraih2, only: samurai_reduce => reduce_group4
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group5(scale2,samplitude,ok)
   ...
   use p8_cbarc_hepemg_samuraih2, only: samurai_reduce => reduce_group5
   use options, only: samurai_out => iout
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
!---#] subroutine evaluate_group5:
end module p8_cbarc_hepemg_amplitudeh2
