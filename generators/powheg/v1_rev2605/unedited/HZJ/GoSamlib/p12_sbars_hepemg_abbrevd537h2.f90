module     p12_sbars_hepemg_abbrevd537h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb537(25)=spbe6k5*abb537(25)
      abb537(23)=spbe6k5*abb537(23)
      abb537(30)=abb537(14)*spak4k6*spbk6k2
      abb537(6)=-abb537(6)*abb537(15)
      abb537(13)=-spbk5k1*abb537(13)
      R2d537=0.0_ki
      rat2 = rat2 + R2d537
...
end module p12_sbars_hepemg_abbrevd537h2
