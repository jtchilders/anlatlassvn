module     p12_sbars_hepemg_abbrevd421h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb421(6)=gHZZ*spak1k4*c1*abb421(1)**2*i_*TR*gSl*ger*abb421(3)*abb421(2)
      abb421(7)=abb421(5)*abb421(6)*spbk6k5*spbe6k2
      abb421(8)=-spae6k6*abb421(7)
      abb421(9)=-es61+es345-es12
      abb421(10)=-2.0_ki*abb421(8)*abb421(9)
      abb421(5)=-spbk5k2*abb421(6)*abb421(5)
...
end module p12_sbars_hepemg_abbrevd421h2
