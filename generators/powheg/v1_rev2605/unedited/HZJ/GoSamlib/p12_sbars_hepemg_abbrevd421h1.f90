module     p12_sbars_hepemg_abbrevd421h1
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb421(6)=gHZZ*spbk4k1*c1*abb421(1)**2*i_*TR*gSr*gel*abb421(3)*abb421(2)
      abb421(7)=abb421(5)*abb421(6)*spak5k6*spak2e6
      abb421(8)=-spbk6e6*abb421(7)
      abb421(9)=-es61+es345-es12
      abb421(10)=-2.0_ki*abb421(8)*abb421(9)
      abb421(5)=-spak2k5*abb421(6)*abb421(5)
...
end module p12_sbars_hepemg_abbrevd421h1
