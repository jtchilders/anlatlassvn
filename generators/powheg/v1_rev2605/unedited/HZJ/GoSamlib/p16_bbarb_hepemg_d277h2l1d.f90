module     p16_bbarb_hepemg_d277h2l1d
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p16_bbarb_hepemg/helicity2d277h2l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p16_bbarb_hepemg_abbrevd277h2
      implicit none
      ...
      acd277(3)=abb277(46)
      acd277(4)=dotproduct(qshift,spvak1e6)
      acd277(5)=abb277(29)
      acd277(6)=dotproduct(qshift,spvae6k2)
      acd277(7)=abb277(34)
      acd277(8)=dotproduct(qshift,spvak4e6)
      acd277(9)=abb277(55)
      acd277(10)=dotproduct(qshift,spvae6k5)
      acd277(11)=abb277(52)
      acd277(12)=abb277(37)
      acd277(13)=dotproduct(k2,qshift)
      acd277(14)=abb277(40)
      acd277(15)=dotproduct(k6,qshift)
      acd277(16)=dotproduct(qshift,spvak1k2)
      acd277(17)=abb277(35)
      acd277(18)=dotproduct(qshift,spvak1k5)
      acd277(19)=abb277(66)
      acd277(20)=dotproduct(qshift,spvak4k2)
      acd277(21)=abb277(64)
      acd277(22)=abb277(30)
      ...
      acd277(26)=abb277(65)
      acd277(27)=abb277(58)
      acd277(28)=dotproduct(qshift,spvak1k6)
      acd277(29)=abb277(31)
      acd277(30)=dotproduct(qshift,spvak6k2)
      acd277(31)=abb277(62)
      acd277(32)=abb277(22)
      acd277(33)=abb277(26)
      acd277(34)=abb277(17)
      ...
      acd277(37)=abb277(28)
      acd277(38)=abb277(48)
      acd277(39)=dotproduct(qshift,spvak4k5)
      acd277(40)=abb277(24)
      acd277(41)=abb277(47)
      acd277(42)=abb277(41)
      acd277(43)=abb277(63)
      ...
      acd277(47)=abb277(39)
      acd277(48)=abb277(50)
      acd277(49)=dotproduct(qshift,spvak4k6)
      acd277(50)=abb277(51)
      acd277(51)=dotproduct(qshift,spvak6k5)
      acd277(52)=abb277(49)
      acd277(53)=dotproduct(qshift,spvae6k1)
      acd277(54)=abb277(19)
      acd277(55)=dotproduct(qshift,spvak2e6)
      acd277(56)=abb277(21)
      acd277(57)=abb277(25)
      acd277(58)=abb277(23)
      acd277(59)=abb277(20)
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      acd277(29)=abb277(65)
      acd277(30)=abb277(58)
      acd277(31)=dotproduct(qshift,spvak1k6)
      acd277(32)=abb277(31)
      acd277(33)=dotproduct(qshift,spvak6k2)
      acd277(34)=abb277(62)
      acd277(35)=abb277(22)
      ...
      acd277(40)=abb277(16)
      acd277(41)=abb277(28)
      acd277(42)=spvak1e6(iv1)
      acd277(43)=dotproduct(k6,qshift)
      acd277(44)=abb277(48)
      acd277(45)=dotproduct(qshift,spvak4k5)
      acd277(46)=abb277(24)
      acd277(47)=abb277(47)
      acd277(48)=spvae6k2(iv1)
      acd277(49)=abb277(41)
      acd277(50)=abb277(63)
      acd277(51)=abb277(60)
      acd277(52)=spvak4e6(iv1)
      acd277(53)=abb277(27)
      acd277(54)=abb277(54)
      acd277(55)=spvae6k5(iv1)
      acd277(56)=abb277(39)
      acd277(57)=abb277(50)
      acd277(58)=spvak1k2(iv1)
      acd277(59)=dotproduct(qshift,spvak4k6)
      acd277(60)=abb277(51)
      acd277(61)=dotproduct(qshift,spvak6k5)
      acd277(62)=abb277(49)
      acd277(63)=dotproduct(qshift,spvae6k1)
      acd277(64)=abb277(19)
      acd277(65)=dotproduct(qshift,spvak2e6)
      acd277(66)=abb277(21)
      acd277(67)=abb277(25)
      acd277(68)=spvak1k5(iv1)
      acd277(69)=abb277(23)
      acd277(70)=spvak4k2(iv1)
      acd277(71)=abb277(20)
      acd277(72)=spvak1k6(iv1)
      acd277(73)=abb277(36)
      acd277(74)=spvak6k2(iv1)
      acd277(75)=abb277(38)
      acd277(76)=spvak4k6(iv1)
      acd277(77)=abb277(45)
      acd277(78)=spvak6k5(iv1)
      acd277(79)=abb277(43)
      acd277(80)=spvae6k1(iv1)
      acd277(81)=spvak2e6(iv1)
      acd277(82)=spvak4k5(iv1)
      acd277(83)=abb277(44)
...
!---#[ function brack_3:
   pure function brack_3(Q, mu2) result(brack)
      ...
      acd277(2)=dotproduct(e6,qshift)
      acd277(3)=abb277(42)
      acd277(4)=dotproduct(qshift,spvak1k2)
      acd277(5)=abb277(33)
      acd277(6)=dotproduct(qshift,spvak1k5)
      acd277(7)=abb277(16)
      acd277(8)=dotproduct(qshift,spvak4k2)
      acd277(9)=abb277(28)
      acd277(10)=dotproduct(qshift,spvak1e6)
      acd277(11)=abb277(29)
      acd277(12)=dotproduct(qshift,spvae6k2)
      acd277(13)=abb277(34)
      acd277(14)=dotproduct(qshift,spvak4e6)
      acd277(15)=abb277(26)
      acd277(16)=dotproduct(qshift,spvae6k5)
      acd277(17)=abb277(17)
      acd277(18)=k1(iv1)
      acd277(19)=e6(iv2)
      acd277(20)=abb277(46)
      acd277(21)=spvak1e6(iv2)
      acd277(22)=spvae6k2(iv2)
      acd277(23)=spvak4e6(iv2)
      acd277(24)=abb277(55)
      acd277(25)=spvae6k5(iv2)
      acd277(26)=abb277(52)
      acd277(27)=k1(iv2)
      acd277(28)=e6(iv1)
      acd277(29)=spvak1e6(iv1)
      acd277(30)=spvae6k2(iv1)
      acd277(31)=spvak4e6(iv1)
      acd277(32)=spvae6k5(iv1)
      acd277(33)=k2(iv1)
      acd277(34)=k2(iv2)
      acd277(35)=k6(iv1)
      acd277(36)=spvak1k2(iv2)
      acd277(37)=abb277(35)
      acd277(38)=spvak1k5(iv2)
      acd277(39)=abb277(66)
      acd277(40)=spvak4k2(iv2)
      acd277(41)=abb277(64)
      acd277(42)=k6(iv2)
      acd277(43)=spvak1k2(iv1)
      acd277(44)=spvak1k5(iv1)
      acd277(45)=spvak4k2(iv1)
      acd277(46)=qshift(iv2)
      acd277(47)=abb277(32)
      acd277(48)=abb277(65)
      acd277(49)=abb277(58)
      acd277(50)=spvak1k6(iv2)
      acd277(51)=abb277(31)
      acd277(52)=spvak6k2(iv2)
      acd277(53)=abb277(62)
      acd277(54)=qshift(iv1)
      acd277(55)=spvak1k6(iv1)
      acd277(56)=spvak6k2(iv1)
      acd277(57)=abb277(48)
      acd277(58)=abb277(41)
      acd277(59)=abb277(27)
      acd277(60)=abb277(39)
      acd277(61)=spvak4k6(iv2)
      acd277(62)=abb277(51)
      acd277(63)=spvak6k5(iv2)
      acd277(64)=abb277(49)
      acd277(65)=spvae6k1(iv2)
      acd277(66)=abb277(19)
      acd277(67)=spvak2e6(iv2)
      acd277(68)=abb277(21)
      acd277(69)=spvak4k6(iv1)
      acd277(70)=spvak6k5(iv1)
      acd277(71)=spvae6k1(iv1)
      acd277(72)=spvak2e6(iv1)
      acd277(73)=spvak4k5(iv2)
      acd277(74)=abb277(24)
      acd277(75)=spvak4k5(iv1)
      acd277(76)=abb277(63)
      acd277(77)=abb277(36)
      acd277(78)=abb277(38)
...
!---#[ function brack_4:
   pure function brack_4(Q, mu2) result(brack)
      ...
      acd277(2)=e6(iv3)
      acd277(3)=abb277(42)
      acd277(4)=spvak1k2(iv3)
      acd277(5)=abb277(33)
      acd277(6)=spvak1k5(iv3)
      acd277(7)=abb277(16)
      acd277(8)=spvak4k2(iv3)
      acd277(9)=abb277(28)
      acd277(10)=spvak1e6(iv3)
      acd277(11)=abb277(29)
      acd277(12)=spvae6k2(iv3)
      acd277(13)=abb277(34)
      acd277(14)=spvak4e6(iv3)
      acd277(15)=abb277(26)
      acd277(16)=spvae6k5(iv3)
      acd277(17)=abb277(17)
      acd277(18)=d(iv1,iv3)
      acd277(19)=e6(iv2)
      acd277(20)=spvak1k2(iv2)
      acd277(21)=spvak1k5(iv2)
      acd277(22)=spvak4k2(iv2)
      acd277(23)=spvak1e6(iv2)
      acd277(24)=spvae6k2(iv2)
      acd277(25)=spvak4e6(iv2)
      acd277(26)=spvae6k5(iv2)
      acd277(27)=d(iv2,iv3)
      acd277(28)=e6(iv1)
      acd277(29)=spvak1k2(iv1)
      acd277(30)=spvak1k5(iv1)
      acd277(31)=spvak4k2(iv1)
      acd277(32)=spvak1e6(iv1)
      acd277(33)=spvae6k2(iv1)
      acd277(34)=spvak4e6(iv1)
      acd277(35)=spvae6k5(iv1)
...
!---#[ subroutine reconstruct_d277:
   subroutine     reconstruct_d277(coeffs)
      use p16_bbarb_hepemg_groups, only: tensrec_info_group5
      implicit none
...
!---#] subroutine reconstruct_d277:
end module     p16_bbarb_hepemg_d277h2l1d
