module     p16_bbarb_hepemg_abbrevd333h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb333(4)=NC**(-1)
      abb333(5)=spae6k6*spak1k5
      abb333(6)=abb333(5)*spbk6k4
      abb333(7)=NC-abb333(4)
      abb333(7)=abb333(7)*gBl*gHZZ*c1*i_*TR*gel*abb333(3)*abb333(2)*abb333(1)
      abb333(8)=spbe6k2*abb333(7)
      abb333(9)=abb333(6)*abb333(8)
      abb333(10)=spak1k2*spbk4k2
      ...
      abb333(10)=spak2k5*abb333(10)
      abb333(11)=abb333(11)*abb333(19)
      abb333(19)=-abb333(8)*spbk6k4*spak1k5
      ...
      abb333(8)=spak2k5*abb333(12)*abb333(8)
      R2d333=abb333(9)
      rat2 = rat2 + R2d333
...
end module p16_bbarb_hepemg_abbrevd333h0
