module     p12_sbars_hepemg_golem95h2
...
subroutine     reconstruct_group0(coeffs)
   ...
   use p12_sbars_hepemg_d541h2l1, only: numerator_d541 => numerator_golem95
   use p12_sbars_hepemg_d541h2l1d, only: reconstruct_d541
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use p12_sbars_hepemg_d279h2l1, only: numerator_d279 => numerator_golem95
   use p12_sbars_hepemg_d279h2l1d, only: reconstruct_d279
   use p12_sbars_hepemg_d333h2l1, only: numerator_d333 => numerator_golem95
   use p12_sbars_hepemg_d333h2l1d, only: reconstruct_d333
   use p12_sbars_hepemg_d421h2l1, only: numerator_d421 => numerator_golem95
   use p12_sbars_hepemg_d421h2l1d, only: reconstruct_d421
   use p12_sbars_hepemg_d537h2l1, only: numerator_d537 => numerator_golem95
   use p12_sbars_hepemg_d537h2l1d, only: reconstruct_d537
   use p12_sbars_hepemg_d605h2l1, only: numerator_d605 => numerator_golem95
   use p12_sbars_hepemg_d605h2l1d, only: reconstruct_d605
   implicit none
...
subroutine     reconstruct_group2(coeffs)
   ...
   use p12_sbars_hepemg_d323h2l1, only: numerator_d323 => numerator_golem95
   use p12_sbars_hepemg_d323h2l1d, only: reconstruct_d323
   use p12_sbars_hepemg_d413h2l1, only: numerator_d413 => numerator_golem95
   use p12_sbars_hepemg_d413h2l1d, only: reconstruct_d413
   use p12_sbars_hepemg_d533h2l1, only: numerator_d533 => numerator_golem95
   use p12_sbars_hepemg_d533h2l1d, only: reconstruct_d533
   use p12_sbars_hepemg_d613h2l1, only: numerator_d613 => numerator_golem95
   use p12_sbars_hepemg_d613h2l1d, only: reconstruct_d613
   implicit none
...
subroutine     reconstruct_group3(coeffs)
   ...
   use p12_sbars_hepemg_d101h2l1, only: numerator_d101 => numerator_golem95
   use p12_sbars_hepemg_d101h2l1d, only: reconstruct_d101
   use p12_sbars_hepemg_d553h2l1, only: numerator_d553 => numerator_golem95
   use p12_sbars_hepemg_d553h2l1d, only: reconstruct_d553
   implicit none
...
subroutine     reconstruct_group4(coeffs)
   ...
   use p12_sbars_hepemg_d77h2l1, only: numerator_d77 => numerator_golem95
   use p12_sbars_hepemg_d77h2l1d, only: reconstruct_d77
   implicit none
...
subroutine     reconstruct_group5(coeffs)
   ...
   use p12_sbars_hepemg_d45h2l1, only: numerator_d45 => numerator_golem95
   use p12_sbars_hepemg_d45h2l1d, only: reconstruct_d45
   use p12_sbars_hepemg_d277h2l1, only: numerator_d277 => numerator_golem95
   use p12_sbars_hepemg_d277h2l1d, only: reconstruct_d277
   implicit none
...
!---#] subroutine reconstruct_group5:
end module p12_sbars_hepemg_golem95h2
