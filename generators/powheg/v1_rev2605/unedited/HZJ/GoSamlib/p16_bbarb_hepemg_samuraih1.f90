module     p16_bbarb_hepemg_samuraih1
...
function     numeval_group0(icut, Q, mu2) result(num)
   ...
   use p16_bbarb_hepemg_d541h1l1, only: numerator_d541 => numerator_samurai
   implicit none
...
function     numeval_group1(icut, Q, mu2) result(num)
   use p16_bbarb_hepemg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d279h1l1, only: numerator_d279 => numerator_samurai
   use p16_bbarb_hepemg_d333h1l1, only: numerator_d333 => numerator_samurai
   use p16_bbarb_hepemg_d421h1l1, only: numerator_d421 => numerator_samurai
   use p16_bbarb_hepemg_d537h1l1, only: numerator_d537 => numerator_samurai
   use p16_bbarb_hepemg_d605h1l1, only: numerator_d605 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group2(icut, Q, mu2) result(num)
   use p16_bbarb_hepemg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d323h1l1, only: numerator_d323 => numerator_samurai
   use p16_bbarb_hepemg_d413h1l1, only: numerator_d413 => numerator_samurai
   use p16_bbarb_hepemg_d533h1l1, only: numerator_d533 => numerator_samurai
   use p16_bbarb_hepemg_d613h1l1, only: numerator_d613 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group3(icut, Q, mu2) result(num)
   use p16_bbarb_hepemg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d101h1l1, only: numerator_d101 => numerator_samurai
   use p16_bbarb_hepemg_d553h1l1, only: numerator_d553 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group4(icut, Q, mu2) result(num)
   use p16_bbarb_hepemg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d77h1l1, only: numerator_d77 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group5(icut, Q, mu2) result(num)
   use p16_bbarb_hepemg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d45h1l1, only: numerator_d45 => numerator_samurai
   use p16_bbarb_hepemg_d277h1l1, only: numerator_d277 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
subroutine     reduce_group0(scale2,tot,totr,ok)
   ...
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d541h1l1, only: numerator_diagram541 => numerator_samur&
   &ai
...
subroutine     reduce_group1(scale2,tot,totr,ok)
   ...
   use p16_bbarb_hepemg_kinematics
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d279h1l1, only: numerator_diagram279 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_d333h1l1, only: numerator_diagram333 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_d421h1l1, only: numerator_diagram421 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_d537h1l1, only: numerator_diagram537 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_d605h1l1, only: numerator_diagram605 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_globalsl1, only: epspow
...
subroutine     reduce_group2(scale2,tot,totr,ok)
   ...
   use p16_bbarb_hepemg_kinematics
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d323h1l1, only: numerator_diagram323 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_d413h1l1, only: numerator_diagram413 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_d533h1l1, only: numerator_diagram533 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_d613h1l1, only: numerator_diagram613 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_globalsl1, only: epspow
...
subroutine     reduce_group3(scale2,tot,totr,ok)
   ...
   use p16_bbarb_hepemg_kinematics
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d101h1l1, only: numerator_diagram101 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_d553h1l1, only: numerator_diagram553 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_globalsl1, only: epspow
...
subroutine     reduce_group4(scale2,tot,totr,ok)
   ...
   use p16_bbarb_hepemg_kinematics
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d77h1l1, only: numerator_diagram77 => numerator_samurai
   use p16_bbarb_hepemg_globalsl1, only: epspow
...
subroutine     reduce_group5(scale2,tot,totr,ok)
   ...
   use p16_bbarb_hepemg_kinematics
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d45h1l1, only: numerator_diagram45 => numerator_samurai
   use p16_bbarb_hepemg_d277h1l1, only: numerator_diagram277 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_globalsl1, only: epspow
...
!-----#] subroutine reduce_group5:
!---#] reduce groups with samurai:
end module p16_bbarb_hepemg_samuraih1
