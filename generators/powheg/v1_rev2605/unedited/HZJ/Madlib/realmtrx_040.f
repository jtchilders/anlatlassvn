...
C ----------
     ...
     &     9   ))                                                          
      CALL FVOXXX(W(1,1   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,10  ))    
      ...
      CALL FVOXXX(W(1,1   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,13  ))    
      CALL JIOXXX(W(1,2   ),W(1,13  ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,9   ),W(1,6   ),W(1,14  ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,7   ),W(1,11  ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL IOSXXX(W(1,15  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(3   ))          
      CALL FVIXXX(W(1,7   ),W(1,14  ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL IOSXXX(W(1,16  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(4   ))          
      CALL FVIXXX(W(1,2   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,17  ))    
      CALL JIOXXX(W(1,17  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,9   ),W(1,6   ),W(1,18  ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,2   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,19  ))    
      CALL JIOXXX(W(1,19  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL IOVXXX(W(1,9   ),W(1,6   ),W(1,20  ),GG ,AMP(6   ))             
      CALL FVIXXX(W(1,7   ),W(1,18  ),GG ,BMASS   ,ZERO    ,W(1,21  ))     
      CALL IOSXXX(W(1,21  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(7   ))          
      CALL FVIXXX(W(1,7   ),W(1,20  ),GG ,BMASS   ,ZERO    ,W(1,22  ))     
      CALL IOSXXX(W(1,22  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(8   ))          
      CALL JVSXXX(W(1,12  ),W(1,3   ),GZZH ,ZMASS   ,ZWIDTH  ,W(1,         
     &     23  ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,23  ),GZU ,ZERO    ,ZERO    ,W(1,24  ))    
      CALL JIOXXX(W(1,24  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL IOVXXX(W(1,7   ),W(1,6   ),W(1,25  ),GG ,AMP(9   ))             
      CALL FVOXXX(W(1,1   ),W(1,23  ),GZU ,ZERO    ,ZERO    ,W(1,26  ))    
      ...
      CALL FVIXXX(W(1,29  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,30  ))    
      CALL IOSXXX(W(1,30  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(11  ))          
      CALL FVIXXX(W(1,29  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,31  ))    
      CALL IOSXXX(W(1,31  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(12  ))          
      CALL FVIXXX(W(1,7   ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,32  ))    
      CALL FVIXXX(W(1,32  ),W(1,28  ),GG ,BMASS   ,ZERO    ,W(1,33  ))     
      CALL IOSXXX(W(1,33  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(13  ))          
      CALL FVIXXX(W(1,7   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,34  ))    
      CALL FVIXXX(W(1,34  ),W(1,28  ),GG ,BMASS   ,ZERO    ,W(1,35  ))     
      CALL IOSXXX(W(1,35  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(14  ))          
      CALL FVIXXX(W(1,9   ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,36  ))    
      CALL IOVXXX(W(1,36  ),W(1,6   ),W(1,28  ),GG ,AMP(15  ))             
      CALL FVIXXX(W(1,9   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,37  ))    
      CALL IOVXXX(W(1,37  ),W(1,6   ),W(1,28  ),GG ,AMP(16  ))             
      CALL IOVXXX(W(1,29  ),W(1,6   ),W(1,23  ),GZD ,AMP(17  ))            
      CALL FSIXXX(W(1,32  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     38  ))                                                          
      CALL IOVXXX(W(1,38  ),W(1,6   ),W(1,28  ),GG ,AMP(18  ))             
      CALL FSIXXX(W(1,34  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     39  ))                                                          
      CALL IOVXXX(W(1,39  ),W(1,6   ),W(1,28  ),GG ,AMP(19  ))             
      CALL FVIXXX(W(1,7   ),W(1,23  ),GZD ,BMASS   ,ZERO    ,W(1,40  ))    
      CALL IOVXXX(W(1,40  ),W(1,6   ),W(1,28  ),GG ,AMP(20  ))             
      CALL FVIXXX(W(1,9   ),W(1,28  ),GG ,BMASS   ,ZERO    ,W(1,41  ))     
      CALL IOVXXX(W(1,41  ),W(1,6   ),W(1,8   ),GAD ,AMP(21  ))            
      CALL IOVXXX(W(1,41  ),W(1,6   ),W(1,12  ),GZD ,AMP(22  ))            
