...
C ----------
     ...
     &     10  ))                                                          
      ...
      CALL FVIXXX(W(1,12  ),W(1,10  ),GZU ,ZERO    ,ZERO    ,W(1,13  ))    
