...
C ----------
     ...
     &     8   ))                                                          
      ...
      CALL FVOXXX(W(1,7   ),W(1,9   ),GAD ,BMASS   ,ZERO    ,W(1,10  ))    
      ...
      CALL JIOXXX(W(1,8   ),W(1,13  ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,14  ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,8   ),W(1,9   ),GAD ,BMASS   ,ZERO    ,W(1,15  ))    
      CALL JIOXXX(W(1,15  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,16  ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,8   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,17  ))    
      CALL JIOXXX(W(1,17  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,18  ),GG ,AMP(4   ))             
      CALL FSOXXX(W(1,7   ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     19  ))                                                          
      CALL JIOXXX(W(1,2   ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL FVIXXX(W(1,1   ),W(1,9   ),GAD ,ZERO    ,ZERO    ,W(1,21  ))    
      CALL IOVXXX(W(1,21  ),W(1,6   ),W(1,20  ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,1   ),W(1,12  ),GZD ,ZERO    ,ZERO    ,W(1,22  ))    
      CALL IOVXXX(W(1,22  ),W(1,6   ),W(1,20  ),GG ,AMP(6   ))             
      CALL JIOXXX(W(1,8   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL IOVXXX(W(1,21  ),W(1,6   ),W(1,23  ),GG ,AMP(7   ))             
      CALL IOVXXX(W(1,22  ),W(1,6   ),W(1,23  ),GG ,AMP(8   ))             
      CALL FVIXXX(W(1,1   ),W(1,20  ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL IOVXXX(W(1,24  ),W(1,6   ),W(1,9   ),GAD ,AMP(9   ))            
      CALL IOVXXX(W(1,24  ),W(1,6   ),W(1,12  ),GZD ,AMP(10  ))            
      ...
      CALL FVIXXX(W(1,2   ),W(1,9   ),GAD ,BMASS   ,ZERO    ,W(1,26  ))    
      CALL JIOXXX(W(1,26  ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,27  ),GG ,AMP(13  ))             
      CALL FVIXXX(W(1,2   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,28  ))    
      CALL JIOXXX(W(1,28  ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,29  ),GG ,AMP(14  ))             
      CALL FSIXXX(W(1,26  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     30  ))                                                          
      CALL JIOXXX(W(1,30  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,31  ),GG ,AMP(15  ))             
      CALL FSIXXX(W(1,28  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     32  ))                                                          
      CALL JIOXXX(W(1,32  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,33  ),GG ,AMP(16  ))             
      CALL FVOXXX(W(1,19  ),W(1,9   ),GAD ,BMASS   ,ZERO    ,W(1,34  ))    
      CALL JIOXXX(W(1,2   ),W(1,34  ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,35  ),GG ,AMP(17  ))             
      CALL FVOXXX(W(1,19  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,36  ))    
      CALL JIOXXX(W(1,2   ),W(1,36  ),GG ,ZERO    ,ZERO    ,W(1,37  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,37  ),GG ,AMP(18  ))             
      CALL JVSXXX(W(1,12  ),W(1,3   ),GZZH ,ZMASS   ,ZWIDTH  ,W(1,         
     &     38  ))                                                          
      CALL FVOXXX(W(1,7   ),W(1,38  ),GZD ,BMASS   ,ZERO    ,W(1,39  ))    
      CALL JIOXXX(W(1,2   ),W(1,39  ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,40  ),GG ,AMP(19  ))             
      CALL FSOXXX(W(1,10  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     41  ))                                                          
      CALL JIOXXX(W(1,2   ),W(1,41  ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,42  ),GG ,AMP(20  ))             
      CALL FSOXXX(W(1,13  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     43  ))                                                          
      CALL JIOXXX(W(1,2   ),W(1,43  ),GG ,ZERO    ,ZERO    ,W(1,44  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,44  ),GG ,AMP(21  ))             
      CALL FVIXXX(W(1,2   ),W(1,38  ),GZD ,BMASS   ,ZERO    ,W(1,45  ))    
      CALL JIOXXX(W(1,45  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL IOVXXX(W(1,1   ),W(1,6   ),W(1,46  ),GG ,AMP(22  ))             
      CALL JIOXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,47  ))     
      CALL FVIXXX(W(1,1   ),W(1,38  ),GZD ,ZERO    ,ZERO    ,W(1,48  ))    
      CALL IOVXXX(W(1,48  ),W(1,6   ),W(1,47  ),GG ,AMP(23  ))             
      CALL FVIXXX(W(1,1   ),W(1,47  ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL IOVXXX(W(1,49  ),W(1,6   ),W(1,38  ),GZD ,AMP(24  ))            
