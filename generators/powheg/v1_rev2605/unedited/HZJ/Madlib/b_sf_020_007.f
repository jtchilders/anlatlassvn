...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,7   ),GAD ,BMASS   ,ZERO    ,W(1,8   ))    
     ...
     &     9   ))                                                          
      ...
      CALL FVIXXX(W(1,1   ),W(1,10  ),GZD ,BMASS   ,ZERO    ,W(1,11  ))    
      CALL FSIXXX(W(1,11  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     12  ))                                                          
      CALL IOVXXX(W(1,12  ),W(1,6   ),W(1,2   ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,8   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,13  ))     
      CALL IOSXXX(W(1,13  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(3   ))          
      CALL FVIXXX(W(1,11  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
      CALL IOSXXX(W(1,14  ),W(1,6   ),W(1,3   ),GHBOT ,AMP(4   ))          
      CALL FSIXXX(W(1,1   ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     15  ))                                                          
      CALL FVIXXX(W(1,15  ),W(1,7   ),GAD ,BMASS   ,ZERO    ,W(1,16  ))    
      CALL IOVXXX(W(1,16  ),W(1,6   ),W(1,2   ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,15  ),W(1,10  ),GZD ,BMASS   ,ZERO    ,W(1,17  ))    
      CALL IOVXXX(W(1,17  ),W(1,6   ),W(1,2   ),GG ,AMP(6   ))             
      CALL FVIXXX(W(1,15  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,18  ),W(1,6   ),W(1,7   ),GAD ,AMP(7   ))            
      CALL IOVXXX(W(1,18  ),W(1,6   ),W(1,10  ),GZD ,AMP(8   ))            
      CALL JVSXXX(W(1,10  ),W(1,3   ),GZZH ,ZMASS   ,ZWIDTH  ,W(1,         
     &     19  ))                                                          
      CALL FVIXXX(W(1,1   ),W(1,19  ),GZD ,BMASS   ,ZERO    ,W(1,20  ))    
      CALL IOVXXX(W(1,20  ),W(1,6   ),W(1,2   ),GG ,AMP(9   ))             
      CALL FVIXXX(W(1,1   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,21  ))     
      CALL FVIXXX(W(1,21  ),W(1,7   ),GAD ,BMASS   ,ZERO    ,W(1,22  ))    
     ...
     &     24  ))                                                          
      CALL IOVXXX(W(1,24  ),W(1,6   ),W(1,7   ),GAD ,AMP(13  ))            
