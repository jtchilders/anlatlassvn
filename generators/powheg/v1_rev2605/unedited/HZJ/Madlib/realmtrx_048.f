...
C ----------
     ...
     &     10  ))                                                          
      CALL FVOXXX(W(1,9   ),W(1,10  ),GZU ,ZERO    ,ZERO    ,W(1,11  ))    
      CALL IOVXXX(W(1,6   ),W(1,11  ),W(1,2   ),GG ,AMP(1   ))             
      CALL JVVXXX(W(1,7   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,12  ))      
      CALL FVOXXX(W(1,1   ),W(1,10  ),GZU ,ZERO    ,ZERO    ,W(1,13  ))    
      ...
      CALL IOVXXX(W(1,6   ),W(1,16  ),W(1,10  ),GZU ,AMP(5   ))            
      CALL FVOXXX(W(1,1   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL IOVXXX(W(1,6   ),W(1,17  ),W(1,10  ),GZU ,AMP(6   ))            
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL FVOXXX(W(1,18  ),W(1,10  ),GZU ,ZERO    ,ZERO    ,W(1,19  ))    
