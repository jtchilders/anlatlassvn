...
C ----------
     ...
     &     9   ))                                                          
      CALL FVOXXX(W(1,1   ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,10  ))    
      ...
      CALL FVOXXX(W(1,1   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,13  ))    
      CALL JIOXXX(W(1,9   ),W(1,13  ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,14  ),GG ,AMP(2   ))             
     ...
     &     19  ))                                                          
      CALL FVIXXX(W(1,7   ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,20  ))    
      CALL JIOXXX(W(1,20  ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,21  ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,7   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,22  ))    
      CALL JIOXXX(W(1,22  ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,23  ),GG ,AMP(6   ))             
      CALL FVOXXX(W(1,19  ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,24  ))    
      CALL JIOXXX(W(1,7   ),W(1,24  ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,25  ),GG ,AMP(7   ))             
      CALL FVOXXX(W(1,19  ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,26  ))    
      CALL JIOXXX(W(1,7   ),W(1,26  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,27  ),GG ,AMP(8   ))             
      CALL JIOXXX(W(1,9   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL FVIXXX(W(1,2   ),W(1,8   ),GAU ,ZERO    ,ZERO    ,W(1,29  ))    
      CALL IOVXXX(W(1,29  ),W(1,6   ),W(1,28  ),GG ,AMP(9   ))             
      CALL FVIXXX(W(1,2   ),W(1,12  ),GZU ,ZERO    ,ZERO    ,W(1,30  ))    
      CALL IOVXXX(W(1,30  ),W(1,6   ),W(1,28  ),GG ,AMP(10  ))             
      CALL JIOXXX(W(1,7   ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      CALL IOVXXX(W(1,29  ),W(1,6   ),W(1,31  ),GG ,AMP(11  ))             
      CALL IOVXXX(W(1,30  ),W(1,6   ),W(1,31  ),GG ,AMP(12  ))             
      CALL FVIXXX(W(1,2   ),W(1,28  ),GG ,ZERO    ,ZERO    ,W(1,32  ))     
      CALL IOVXXX(W(1,32  ),W(1,6   ),W(1,8   ),GAU ,AMP(13  ))            
      CALL IOVXXX(W(1,32  ),W(1,6   ),W(1,12  ),GZU ,AMP(14  ))            
      CALL FVIXXX(W(1,2   ),W(1,31  ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL IOVXXX(W(1,33  ),W(1,6   ),W(1,8   ),GAU ,AMP(15  ))            
      CALL IOVXXX(W(1,33  ),W(1,6   ),W(1,12  ),GZU ,AMP(16  ))            
      CALL JIOXXX(W(1,7   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL JVSXXX(W(1,12  ),W(1,3   ),GZZH ,ZMASS   ,ZWIDTH  ,W(1,         
     &     35  ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,35  ),GZU ,ZERO    ,ZERO    ,W(1,36  ))    
      CALL IOVXXX(W(1,36  ),W(1,6   ),W(1,34  ),GG ,AMP(17  ))             
      CALL FVIXXX(W(1,9   ),W(1,8   ),GAD ,BMASS   ,ZERO    ,W(1,37  ))    
      CALL JIOXXX(W(1,37  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,38  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,38  ),GG ,AMP(18  ))             
      CALL FVIXXX(W(1,9   ),W(1,12  ),GZD ,BMASS   ,ZERO    ,W(1,39  ))    
      CALL JIOXXX(W(1,39  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,40  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,40  ),GG ,AMP(19  ))             
      CALL FVIXXX(W(1,7   ),W(1,35  ),GZD ,BMASS   ,ZERO    ,W(1,41  ))    
      CALL JIOXXX(W(1,41  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,42  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,42  ),GG ,AMP(20  ))             
      CALL FSIXXX(W(1,20  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     43  ))                                                          
      CALL JIOXXX(W(1,43  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,44  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,44  ),GG ,AMP(21  ))             
      CALL FSIXXX(W(1,22  ),W(1,3   ),GHBOT ,BMASS   ,ZERO    ,W(1,        
     &     45  ))                                                          
      CALL JIOXXX(W(1,45  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,46  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,46  ),GG ,AMP(22  ))             
      CALL FVOXXX(W(1,1   ),W(1,35  ),GZD ,BMASS   ,ZERO    ,W(1,47  ))    
      CALL JIOXXX(W(1,7   ),W(1,47  ),GG ,ZERO    ,ZERO    ,W(1,48  ))     
      CALL IOVXXX(W(1,2   ),W(1,6   ),W(1,48  ),GG ,AMP(23  ))             
      CALL FVIXXX(W(1,2   ),W(1,34  ),GG ,ZERO    ,ZERO    ,W(1,49  ))     
      CALL IOVXXX(W(1,49  ),W(1,6   ),W(1,35  ),GZU ,AMP(24  ))            
