      SUBROUTINE Sbdx_epvebuxg(P1,ANS)
C  
...
C  
      ...
      common/to_amps_bdx_epvebuxg/  amp2bdx_epvebuxg,       jamp2bdx_epvebuxg
      ...
      common/to_matrix_bdx_epvebuxg/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bdx_epvebuxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bdx_epvebuxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,11  ),GWF ,AMP(1   ))            
      ...
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,16  ),GWF ,AMP(3   ))            
      CALL FVOXXX(W(1,2   ),W(1,13  ),GWF ,ZERO    ,ZERO    ,W(1,17  ))    
...
!ER:      CALL FVOXXX(W(1,9   ),W(1,7   ),GG ,TMASS   ,TWIDTH  ,W(1,18  ))     
      ...
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,19  ),GWF ,AMP(5   ))            
...
c     JAMP(   1) = +AMP(   1)+AMP(   3)+AMP(   5)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bdx_epvebuxg =bdx_epvebuxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
