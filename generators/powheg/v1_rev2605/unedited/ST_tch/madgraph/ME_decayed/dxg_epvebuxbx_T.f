      SUBROUTINE Sdxg_epvebuxbx_T(P1,ANS)
C  
...
C  
      ...
      common/to_amps_dxg_epvebuxbx_T/  amp2dxg_epvebuxbx_T,       jamp2dxg_epvebuxbx_T
      ...
      common/to_matrix_dxg_epvebuxbx_T/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=dxg_epvebuxbx_T(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION dxg_epvebuxbx_T(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,7   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,10  ))     
      CALL JIOXXX(W(1,10  ),W(1,9   ),GWF ,WMASS   ,WWIDTH  ,W(1,11  ))    
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,11  ),GWF ,AMP(1   ))            
!ER:      CALL FVOXXX(W(1,9   ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,12  ))     
      CALL FVOXXX(W(1,9   ),W(1,2   ),GG ,TMASS   ,ZERO  ,W(1,12  ))     
      CALL JIOXXX(W(1,7   ),W(1,12  ),GWF ,WMASS   ,WWIDTH  ,W(1,13  ))    
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,13  ),GWF ,AMP(2   ))            
      CALL JIOXXX(W(1,7   ),W(1,9   ),GWF ,WMASS   ,WWIDTH  ,W(1,14  ))    
      CALL FVOXXX(W(1,1   ),W(1,14  ),GWF ,ZERO    ,ZERO    ,W(1,15  ))    
      CALL IOVXXX(W(1,6   ),W(1,15  ),W(1,2   ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,6   ),W(1,16  ),W(1,14  ),GWF ,AMP(4   ))            
      JAMP(   1) = -AMP(   1)-AMP(   2)
      JAMP(   2) = (0d0,0d0) !ER:-AMP(   3)-AMP(   4)
      dxg_epvebuxbx_T = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          dxg_epvebuxbx_T =dxg_epvebuxbx_T+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
