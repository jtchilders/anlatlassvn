      SUBROUTINE Sdxb_epvebuxg(P1,ANS)
C  
...
C  
      ...
      common/to_amps_dxb_epvebuxg/  amp2dxb_epvebuxg,       jamp2dxb_epvebuxg
      ...
      common/to_matrix_dxb_epvebuxg/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=dxb_epvebuxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION dxb_epvebuxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,2   ),W(1,9   ),GWF ,WMASS   ,WWIDTH  ,W(1,11  ))    
      CALL IOVXXX(W(1,6   ),W(1,10  ),W(1,11  ),GWF ,AMP(1   ))            
      CALL FVIXXX(W(1,2   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,12  ))     
      CALL JIOXXX(W(1,12  ),W(1,9   ),GWF ,WMASS   ,WWIDTH  ,W(1,13  ))    
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,13  ),GWF ,AMP(2   ))            
      CALL FVOXXX(W(1,5   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
      CALL FVOXXX(W(1,14  ),W(1,8   ),GWF ,TMASS   ,TWIDTH  ,W(1,15  ))    
      CALL JIOXXX(W(1,2   ),W(1,15  ),GWF ,WMASS   ,WWIDTH  ,W(1,16  ))    
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,16  ),GWF ,AMP(3   ))            
      CALL FVOXXX(W(1,1   ),W(1,11  ),GWF ,ZERO    ,ZERO    ,W(1,17  ))    
      CALL IOVXXX(W(1,6   ),W(1,17  ),W(1,7   ),GG ,AMP(4   ))             
c!ER:      CALL FVOXXX(W(1,9   ),W(1,7   ),GG ,TMASS   ,TWIDTH  ,W(1,18  ))     
      CALL FVOXXX(W(1,9   ),W(1,7   ),GG ,TMASS   ,ZERO  ,W(1,18  ))     
      CALL JIOXXX(W(1,2   ),W(1,18  ),GWF ,WMASS   ,WWIDTH  ,W(1,19  ))    
      CALL IOVXXX(W(1,6   ),W(1,1   ),W(1,19  ),GWF ,AMP(5   ))            
      JAMP(   1) = -AMP(   1)-AMP(   4)
...
c      JAMP(   2) = -AMP(   2)-AMP(   3)-AMP(   5)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          dxb_epvebuxg =dxb_epvebuxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
