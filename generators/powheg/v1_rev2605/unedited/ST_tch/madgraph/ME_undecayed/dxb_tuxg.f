...
C  
      ...
      common/to_amps_dxb_tuxg/  amp2dxb_tuxg,       jamp2dxb_tuxg
      ...
      common/to_matrix_dxb_tuxg/isum_hel, multi_channel
...
C ----------
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION dxb_tuxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          dxb_tuxg =dxb_tuxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
