c     !ER:
      SUBROUTINE Sgdx_tuxbx_T(P1,ANS)
C  
...
C  
      ...
      common/to_amps_gdx_tuxbx_T/  amp2gdx_tuxbx_T,       jamp2gdx_tuxbx_T
      ...
      common/to_matrix_gdx_tuxbx_T/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gdx_tuxbx_T(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gdx_tuxbx_T(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gdx_tuxbx_T =gdx_tuxbx_T+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
