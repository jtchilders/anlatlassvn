...
C  
      ...
      common/to_amps_udx_tbx/  amp2udx_tbx,       jamp2udx_tbx
      ...
      common/to_matrix_udx_tbx/isum_hel, multi_channel
...
C ----------
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION udx_tbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          udx_tbx =udx_tbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
