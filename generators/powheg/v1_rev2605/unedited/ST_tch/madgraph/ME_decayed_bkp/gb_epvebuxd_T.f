      SUBROUTINE Sgb_epvebuxd_T(P1,ANS)
C  
...
C  
      ...
      common/to_amps_gb_epvebuxd_T/  amp2gb_epvebuxd_T,       jamp2gb_epvebuxd_T
      ...
      common/to_matrix_gb_epvebuxd_T/isum_hel, multi_channel
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gb_epvebuxd_T(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     $             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gb_epvebuxd_T(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,7   ),W(1,11  ),GWF ,ZERO    ,ZERO    ,W(1,12  ))    
      CALL IOVXXX(W(1,6   ),W(1,12  ),W(1,1   ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,9   ),W(1,1   ),GG ,TMASS   ,TWIDTH  ,W(1,13  ))     
      CALL JIOXXX(W(1,2   ),W(1,13  ),GWF ,WMASS   ,WWIDTH  ,W(1,14  ))    
      CALL IOVXXX(W(1,6   ),W(1,7   ),W(1,14  ),GWF ,AMP(3   ))            
      CALL FVIXXX(W(1,2   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL JIOXXX(W(1,15  ),W(1,9   ),GWF ,WMASS   ,WWIDTH  ,W(1,16  ))    
      CALL IOVXXX(W(1,6   ),W(1,7   ),W(1,16  ),GWF ,AMP(4   ))            
      JAMP(   1) = +AMP(   1)+AMP(   2)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gb_epvebuxd_T =gb_epvebuxd_T+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
