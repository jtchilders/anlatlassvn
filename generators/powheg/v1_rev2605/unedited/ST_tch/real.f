...
c     gd -> tuxd
     ...
     #(three_ch(rflav_loc(4)).eq.-2)) then
               call Sgb_tuxd_T(krlab_mad,amp2_mad)
c     gdx -> tuxdx
            elseif((three_ch(rflav_loc(2)).eq.1).and.
     #(three_ch(rflav_loc(4)).eq.-2)) then
               call Sgdx_tuxbx_T(krlab_mad,amp2_mad)
c     gu -> tddx
            elseif((three_ch(rflav_loc(2)).eq.2).and.
     #(three_ch(rflav_loc(4)).eq.-1)) then
               call Sgu_tdbx_T(krlab_mad,amp2_mad)
            else
...
c     dg -> tuxd
            if((three_ch(rflav_loc(1)).eq.-1).and.
     #(three_ch(rflav_loc(4)).eq.-2)) then
               call Sbg_tuxd_T(krlab_mad,amp2_mad)
c     dxg -> tuxdx
            elseif((three_ch(rflav_loc(1)).eq.1).and.
     #(three_ch(rflav_loc(4)).eq.-2)) then
               call Sdxg_tuxbx_T(krlab_mad,amp2_mad)
c     ug -> tddx
            elseif((three_ch(rflav_loc(1)).eq.2).and.
     #(three_ch(rflav_loc(4)).eq.-1)) then
               call Sug_tdbx_T(krlab_mad,amp2_mad)
            else
...
c     ddx
     ...
     #(three_ch(rflav_loc(2)).eq.1).and.
     #(three_ch(rflav_loc(4)).eq.-2)) then
               call Sbdx_tuxg(krlab_mad,amp2_mad)
c     dxd
            elseif ((three_ch(rflav_loc(1)).eq.1).and.
     #(three_ch(rflav_loc(2)).eq.-1).and.
     #(three_ch(rflav_loc(4)).eq.-2)) then
               call Sdxb_tuxg(krlab_mad,amp2_mad)
c     ud
            elseif ((three_ch(rflav_loc(1)).eq.2).and.
     #(three_ch(rflav_loc(2)).eq.-1).and.
     #(three_ch(rflav_loc(4)).eq.-1)) then
               call Sub_tdg(krlab_mad,amp2_mad)
c     du
            elseif ((three_ch(rflav_loc(1)).eq.-1).and.
     #(three_ch(rflav_loc(2)).eq.2).and.
     #(three_ch(rflav_loc(4)).eq.-1)) then
               call Sbu_tdg(krlab_mad,amp2_mad)
            else
