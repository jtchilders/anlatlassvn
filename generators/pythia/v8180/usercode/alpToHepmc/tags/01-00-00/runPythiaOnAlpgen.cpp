...
int main(int argc,char** argv){
   ...
   // parse command line
   std::string inputAlpgenBase,inputPythiaConfig,outputHepMc,xmldoc;
   try{
      ...
      TCLAP::ValueArg<std::string> inputPythiaConfigArg("p","pythia-config","Configuraiton file for Pythia8",false,"pythia.cmnd","string",cmd);
